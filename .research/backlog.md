# Backlog of vectors
<sub>Last regenerated: 2026-06-26 12:18 UTC by routine</sub>
...
| 3 | bug | `revert-pr-1713` | investigate revert: PR #1713 root cause | open | 2026-06-26 |  |
| 3 | bug | `unchecked-todo-pr-1768` | unchecked TODOs left in PR #1768 body | open | 2026-06-26 |  |
| 3 | bug | `unchecked-todo-pr-1723` | unchecked TODOs left in PR #1723 body | open | 2026-06-26 |  |
...
| 2 | dx | `unchecked-todo-pr-1844` | unchecked TODOs left in PR #1844 body | open | 2026-06-26 |  |
| 2 | dx | `unchecked-todo-pr-1705` | unchecked TODOs left in PR #1705 body | open | 2026-06-26 |  |
| 2 | dx | `unchecked-todo-pr-1709` | unchecked TODOs left in PR #1709 body | open | 2026-06-26 |  |
| 2 | dx | `unchecked-todo-pr-1703` | unchecked TODOs left in PR #1703 body | open | 2026-06-26 |  |
| 2 | dx | `unchecked-todo-pr-1717` | unchecked TODOs left in PR #1717 body | open | 2026-06-26 |  |
| 2 | bug | `code-review-reality-server-rng-expect-password-reset` | backend/servers/reality-server/src/handlers/users/mod.rs:551 — expect('OS rng failed') on SysRng.try_fill_bytes() in pas | open | 2026-06-26 |  |
| 2 | bug | `code-review-reality-server-http-client-expect` | backend/servers/reality-server/src/state.rs:759 — expect('Failed to create HTTP client') on reqwest::Client::build() dur | open | 2026-06-26 |  |
...
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new regression t | open | 2026-06-26 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression test for the p | open | 2026-06-26 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixed in PR #1 | open | 2026-06-26 |  |
...
| 1 | refactor | `churn-hotspot-docs/screens/ppt/announcements.md` | churn-hotspot: docs/screens/ppt/announcements.md (consider split/test) | open | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-backend/crates/db/src/models/reality_portal.rs` | churn-hotspot: backend/crates/db/src/models/reality_portal.rs (consider split/test) | open | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-backend/servers/reality-server/src/services/saved_search_alerts.rs` | churn-hotspot: backend/servers/reality-server/src/services/saved_search_alerts.rs (consider split/test) | open | 2026-06-26 |  |
| 1 | refactor | `code-review-reality-server-guaranteed-unwrap` | backend/servers/reality-server/src/handlers/inquiries/mod.rs:179 — unwrap() on chars().next() after is_empty() check is  | open | 2026-06-26 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-emergency-rs` | Churn hotspot: 1021 lines changed in backend/servers/api-server/src/routes/emergency.rs (window 2026 | dropped | 2026-06-26 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-enhanced-tenant-screening-rs` | Churn hotspot: 709 lines changed in backend/servers/api-server/src/routes/enhanced_tenant_screening. | dropped | 2026-06-26 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→18:30Z) | dropped | 2026-06-26 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-10 03:05Z→18:30Z | dropped | 2026-06-26 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-06-10 03:05Z→18:30Z) | dropped | 2026-06-26 |  |
| 0 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despite metric=5 | dropped | 2026-06-26 |  |
...
| 0 | refactor | `refactor-churn-hotspot-mobile-announcements` | Churn hotspot: AnnouncementsScreen.tsx — 4 PRs this run, instability proxy | dropped | 2026-06-26 |  |
| 0 | refactor | `refactor-churn-hotspot-mobile-announcements-test` | Churn hotspot: AnnouncementsScreen.test.ts — 4 PRs this run, instability proxy | dropped | 2026-06-26 |  |
...
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected | dropped | 2026-06-26 |  |
| 0 | dx | `closed-not-merged-pr-1274` | PR #1274 (cargo-minor-patch group, /backend, 9 updates) closed unmerged — superseded by #1313 after auto-rebase fix land | dropped | 2026-06-26 |  |
| 0 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs (+404/−29 in PR #1294 Booking.com OTA retry) | dropped | 2026-06-26 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-reserve-funds-rs` | Churn hotspot: backend/servers/api-server/src/routes/reserve_funds.rs (+228/-255 in PR #1321 PAP-151 re-land) | dropped | 2026-06-26 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-sensor-rs` | Churn hotspot: backend/crates/db/src/repositories/sensor.rs (+248/-86 in PR #1321/#1322 PAP-151 re-land + fmt) | dropped | 2026-06-26 |  |

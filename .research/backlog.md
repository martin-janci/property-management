# Backlog of vectors
<sub>Last regenerated: 2026-06-24 04:00 UTC by routine</sub>
...
| 3 | bug | `code-review-reality-web-share-comparison-404` | Reality-web ComparisonUrlHandler hits non-existent /api/listings/${id} — every shared comparison URL 404s | done | 2026-06-24 | [plan](plans/code-review-reality-web-share-comparison-404.md) |
| 3 | bug | `code-review-reality-web-listing-page-ssr-crash` | Reality-web listing detail SSR crashes on partial 200 body — JSON-LD build deref of undefined fields | done | 2026-06-24 | [plan](plans/code-review-reality-web-listing-page-ssr-crash.md) |
| 3 | bug | `code-review-reality-web-realtor-mgmt-untranslated` | Reality-web RealtorManagement.tsx hardcoded English strings — agency flow not localized to sk/cs/de | done | 2026-06-24 | [plan](plans/code-review-reality-web-realtor-mgmt-untranslated.md) |
| 3 | bug | `code-review-mobile-rn-report-fault-fake-submit` | ReportFaultScreen.tsx handleSubmit() fakes API call with setTimeout(1500) — fault reports never reach backend  | done | 2026-06-24 | [plan](plans/code-review-mobile-rn-report-fault-fake-submit.md) |
| 3 | refactor | `revert-pr-1713` | Investigate revert root-cause from PR #1713 | open | 2026-06-24 |  |
| 3 | security | `code-review-api-handlers-block-user-cross-tenant` | Block-user handler lacks cross-tenant validation (IDOR) | ready | 2026-06-24 | [plan](plans/code-review-api-handlers-block-user-cross-tenant.md) |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-reserve-funds-rs` | Churn hotspot: backend/servers/api-server/src/routes/reserve_funds.rs (+228/-255 in PR #1321 PAP-151 re-land) | done | 2026-06-24 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-messaging-rs` | Address churn in backend/servers/api-server/src/routes/messaging.rs | open | 2026-06-24 |  |
| 1 | refactor | `repeated-churn-backend-servers-api-server-src-main-rs` | Persistent churn — refactor backend/servers/api-server/src/main.rs | open | 2026-06-24 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-models-messaging-rs` | Address churn in backend/crates/db/src/models/messaging.rs | open | 2026-06-24 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-main-rs` | Address churn in backend/servers/api-server/src/main.rs | open | 2026-06-24 |  |

...
| 2 | api-server main.rs vs lib.rs::create_router diverge silently (5 routes unreachable in prod, no test asserts parity) | test-gap | PR #866, issue #867, issue #836 | 2026-05-31 | open |
...
| 1 | Issue #867 (no labels, OPEN): Tech debt: api-server main.rs duplicates lib.rs::create_router — routers diverge silently | triage | #867 | 2026-05-31 | open |
| 1 | Issue #749 (no labels, OPEN): Code review findings: Story 6.1 announcement creation and targeting | triage | #749 | 2026-05-30 | open |
| 1 | Issue #750 (no labels, OPEN): Current dev review: backend/API/database findings | triage | #750 | 2026-05-30 | open |
| 1 | Issue #751 (no labels, OPEN): Current dev review: frontend/web/API-client findings | triage | #751 | 2026-05-30 | open |
| 1 | Issue #752 (no labels, OPEN): Current dev review: mobile CI tooling findings | triage | #752 | 2026-05-30 | open |
| 1 | Issue #753 (no labels, OPEN): Current dev review: Epic 6 Announcements & Communication | triage | #753 | 2026-05-30 | open |
| 1 | Issue #754 (no labels, OPEN): Current dev review: Epic 7A Basic Document Management | triage | #754 | 2026-05-30 | open |
| 1 | Issue #755 (no labels, OPEN): Current dev review: Epic 8A Notification Preferences | triage | #755 | 2026-05-30 | open |
| 1 | Issue #756 (no labels, OPEN): Current dev review: Epic 10A OAuth Provider | triage | #756 | 2026-05-30 | open |
| 1 | Issue #757 (no labels, OPEN): Current dev review: Epic 10B Platform Administration | triage | #757 | 2026-05-30 | open |
| 1 | Issue #760 (no labels, OPEN): Current dev review: Epic 79 Disputes & Mediation | triage | #760 | 2026-05-30 | open |
| 1 | Issue #761 (no labels, OPEN): Current dev review: Epic 84 E-Signature & Leases | triage | #761 | 2026-05-30 | open |
| 1 | Issue #762 (no labels, OPEN): Current dev review: Reports & Schedules | triage | #762 | 2026-05-30 | open |
| 1 | Issue #763 (no labels, OPEN): Current dev review: Reality Server & Inquiries | triage | #763 | 2026-05-30 | open |
...
| 1 | Issue #766 (no labels, OPEN): Current dev review: AI & LLM routes | triage | #766 | 2026-05-30 | open |
| 1 | Issue #767 (no labels, OPEN): Current dev review: Mobile RN Property Management app | triage | #767 | 2026-05-30 | open |
| 1 | Issue #768 (no labels, OPEN): Current dev review: Admin-web features (10B) | triage | #768 | 2026-05-30 | open |
| 1 | Issue #769 (no labels, OPEN): Current dev review: Deploy server | triage | #769 | 2026-05-30 | open |
| 1 | Issue #770 (no labels, OPEN): Current dev review: Faults & triage | triage | #770 | 2026-05-30 | open |
| 1 | Issue #771 (no labels, OPEN): Current dev review: Research dispatcher & CI automation | triage | #771 | 2026-05-30 | open |
| 1 | Issue #772 (no labels, OPEN): Current dev review: Auth core (delta confirmation) | triage | #772 | 2026-05-30 | open |
| 1 | Issue #773 (no labels, OPEN): Current dev review: Leases & rental | triage | #773 | 2026-05-30 | open |
| 1 | Issue #774 (no labels, OPEN): Current dev review: Reality server (broad) | triage | #774 | 2026-05-30 | open |
| 1 | Issue #775 (no labels, OPEN): Current dev review: WebSocket realtime | triage | #775 | 2026-05-30 | open |
| 1 | Issue #776 (no labels, OPEN): Current dev review: Equipment & audit log | triage | #776 | 2026-05-30 | open |
| 1 | Issue #777 (no labels, OPEN): Current dev review: Compliance & GDPR | triage | #777 | 2026-05-30 | open |
| 1 | Issue #778 (no labels, OPEN): Current dev review: Marketplace, voting, investor portal, impersonation | triage | #778 | 2026-05-30 | open |
...
| 1 | Issue #788 (no labels, OPEN): Dev review rounds 1-5: mobile-native + ppt-web surfaces | triage | #788 | 2026-05-30 | open |

# Backlog of vectors
<sub>Last regenerated: 2026-06-20 14:18 UTC by routine</sub>
...
| 1 | dx | `dx-stalled-review-pr-988` | Stalled review: PR #988 (Epic: reusable Playwright E2E framework + sitemap FlowRunner) open 10d, no reviewDeci | done | 2026-06-20 |  |
| 1 | dx | `dx-stalled-review-pr-1179` | PR #1179 (docs(epics) catalog backfill for 37 mounted-but-undocumented backend modules) — stalled at 7d, no re | done | 2026-06-20 |  |
| 1 | triage | `triage-issue-1538` | Issue #1538 (OPEN, ci): Backend test job is not a required check on dev — red-test PRs merge freely | open | 2026-06-20 |  |
| 1 | triage | `triage-issue-1521` | Issue #1521 (OPEN, follow-up): payment-matching UI in wrong app + broken auth + no i18n/tests | open | 2026-06-20 |  |
| 1 | triage | `triage-issue-1604` | Issue #1604 (OPEN): Dispatcher backlog exhausted — coverage.json stale (2026-06-16) | open | 2026-06-20 |  |
| 1 | triage | `triage-issue-1607` | Issue #1607 (OPEN, research-routine): Research dispatcher stalled — stale coverage + 14 quarantined rows | open | 2026-06-20 |  |
| 1 | triage | `triage-issue-1584` | Issue #1584 (OPEN, follow-up): PortalPrincipal bypasses reality_agency_members on agency_id=user_id mismatch | open | 2026-06-20 |  |

...
|-------|--------|----|----|--------|---------|------|
| 8 | test-gap | `test-gap-screen-map-drift-batch-2026-07-13` | Screen-map drift on 4 merged PRs (2 reality, 2 ppt) — heuristic cluster | needs-human-judgement | 2026-07-13 |  |
...
| 3 | bug | `bug-code-review-api-core-sync-calevent-create-idor` | Calendar-event create IDOR: create_calendar_event ignores {id} path + binds body connection_id with no ownership chec... | ready | 2026-07-13 | [plan](plans/bug-code-review-api-core-sync-calevent-create-idor.md) |
...
| 3 | bug | `code-review-mobile-rn-report-fault-fake-submit` | ReportFaultScreen.tsx handleSubmit() fakes API call with setTimeout(1500) — fault reports never reach backend (App.ts... | dropped | 2026-06-16 | [plan](plans/code-review-mobile-rn-report-fault-fake-submit.md) |
...
| 2 | bug | `bug-code-review-api-core-sync-calevent-list-idor` | Calendar-event list IDOR: list_calendar_events reads by path.id (connection id) with no verify_org_access | open | 2026-07-13 |  |
| 2 | bug | `bug-code-review-reality-web-crm-create-no-catch` | reality-web CrmConnection.tsx handleCreate has no try/catch — failed create is unhandled rejection | open | 2026-07-13 |  |
| 2 | bug | `bug-code-review-reality-web-feed-create-no-catch` | reality-web FeedImport.tsx handleCreate has no try/catch — failed create is unhandled rejection | open | 2026-07-13 |  |
...
| 1 | bug | `bug-code-review-reality-web-import-i18n` | reality-web CrmConnection/FeedImport hardcoded English strings — import flow not localized | open | 2026-07-13 |  |
| 1 | refactor | `refactor-churn-hotspot-portal-webhooks-page-2026-07-13` | New churn hotspot: ppt-web PortalWebhooksPage.tsx (+303 lines in PR #2294) | open | 2026-07-13 |  |
| 1 | refactor | `refactor-churn-hotspot-price-alerts-2026-07-13` | New churn hotspot: reality-web PriceAlerts.tsx (+283 lines in PR #2287) | open | 2026-07-13 |  |
...
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new regressio... | dropped | 2026-07-05 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression test for th... | dropped | 2026-07-05 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixed in PR... | dropped | 2026-07-05 |  |
...
| 1 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcoded MOCK... | done | 2026-07-05 |  |
| 1 | bug | `code-review-mobile-rn-deeplink-init-unhandled` | useDeepLinkRouting.ts:27-36 — initialize() re-runs on onNavigate identity change + void promise with no .catch → dupl... | dropped | 2026-07-05 |  |
...
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-10 03:05Z→18:... | dropped | 2026-07-05 |  |
...
| 0 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despite metri... | dropped | 2026-07-05 |  |
...
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injec... | dropped | 2026-07-05 |  |
| 0 | dx | `closed-not-merged-pr-1274` | PR #1274 (cargo-minor-patch group, /backend, 9 updates) closed unmerged — superseded by #1313 after auto-rebase fix l... | dropped | 2026-07-05 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-api-ecosystem-rs` | Churn hotspot: backend/servers/api-server/src/routes/api_ecosystem.rs (+106/−27 in PR #1293 PAP-171; second touch in ... | dropped | 2026-07-05 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-tests-reserve-funds-cross-org-idor-tests-rs` | Churn hotspot: backend/servers/api-server/tests/reserve_funds_cross_org_idor_tests.rs touched 2x since 2026-06-12 (wi... | dropped | 2026-07-05 |  |
...
| 0 | dx | `dx-stalled-review-pr-1179` | PR #1179 (docs(epics) catalog backfill for 37 mounted-but-undocumented backend modules) — stalled at 7d, no reviewDec... | dropped | 2026-07-05 |  |

...
<sub>Last regenerated: 2026-05-26 03:12 UTC by routine</sub>
...
|-------|-------|--------|--------|---------|--------|
| 6 | Add regression tests for inquiry mark_as_read cross-tenant IDOR fix (PR #497) | test-gap | PR #497, PR #507 | 2026-05-26 | ready |
| 3 | IDOR: reality-server realtors mark_inquiry_read flips any realtor's inquiry by ID with no owner scoping | security | issue #519, PR #508, realtors.rs:250 | 2026-05-26 | ready |
...
| 2 | Dispute state machine (PR #506) shipped with no tests + no org predicate on update_status | test-gap | PR #506, issue #520 | 2026-05-26 | open |

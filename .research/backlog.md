# Backlog of vectors
<sub>Last regenerated: 2026-07-01 14:20 UTC by routine</sub>
...
| 1 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET no | done | 2026-07-01 |  |
...
| 1 | refactor | `churn-hotspot-frontend-apps-ppt-web-src-routes-lazyRoutes-tsx` | frontend/apps/ppt-web/src/routes/lazyRoutes.tsx touched 13x since 2026-06-16 — central lazy-route re | open | 2026-07-01 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-models-mod-rs` | backend/crates/db/src/models/mod.rs touched 12x since 2026-06-16 — model registry that grows with ev | open | 2026-07-01 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-rental-rs` | backend/crates/db/src/repositories/rental.rs touched 10x since 2026-06-16 — rentals/bookings domain | open | 2026-07-01 |  |

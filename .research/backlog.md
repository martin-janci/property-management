# Backlog of vectors
<sub>Last regenerated: 2026-08-02 03:30 UTC by routine</sub>
...
| 3 | bug | `code-review-reality-server-agency-members-unauth-idor` | reality-server GET /api/v1/agencies/{id}/members has no auth or membership check — unauthenticated cross-agency member enumeration (IDOR) | needs-human-judgement | 2026-08-02 |  |

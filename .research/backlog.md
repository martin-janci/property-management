# Backlog of vectors
<sub>Last regenerated: 2026-07-31 08:45 UTC by routine</sub>
...
| 3 | security | `code-review-reality-server-sso-sessions-unbounded-map` | reality-server sso_sessions HashMap grows unbounded — unauth flood → memory DoS | ready | 2026-07-31 | [plan](plans/code-review-reality-server-sso-sessions-unbounded-map.md) |
...
| 2 | test-gap | `screen-map-drift-pr-2600-reality` | Screen-map drift for PR #2600 (reality-web SSR XSS hardening — likely false-positive) | open | 2026-07-31 |  |
| 2 | security | `code-review-reality-server-login-user-enumeration-oracle` | reality-server /users/login leaks account existence (SSO branch + timing) | ready | 2026-07-31 | [plan](plans/code-review-reality-server-login-user-enumeration-oracle.md) |
| 2 | bug | `code-review-reality-server-list-my-reports-total-is-page-size` | reality-server list_my_reports returns paged-length as total — pagination broken | open | 2026-07-31 |  |

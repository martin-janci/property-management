# Backlog of vectors
<sub>Last regenerated: 2026-07-31 06:33 UTC by routine</sub>

| Score | Vector | ID | Title | Status | Updated | Plan |
|-------|--------|----|----|--------|---------|------|
| 7 | security | `security-voice-webhook-alexa-signature-not-verified` | SECURITY: Alexa voice webhook accepts forged requests — verify_alexa_signature never checks the signature | ready | 2026-07-31 | [plan](plans/security-voice-webhooks-signature-hardening.md) |
...
| 3 | security | `code-review-api-handlers-voice-webhooks-hmac-default` | SECURITY-P0: verify_hmac_signature falls open to hardcoded default_secret when VOICE_WEBHOOK_SECRET unset + non-constant-time compare | ready | 2026-07-31 | [plan](plans/security-voice-webhooks-signature-hardening.md) |
| 3 | security | `code-review-api-handlers-voice-webhooks-auth-bypass` | SECURITY-P0: authenticate_voice_user ignores access_token — cross-tenant impersonation on every Alexa/Google voice webhook | ready | 2026-07-31 | [plan](plans/security-voice-webhooks-auth-bypass.md) |
...
| 2 | test-gap | `screen-map-drift-pr-2600-reality` | Screen-map drift: PR #2600 (inline tenant JSON XSS fix) touched reality-web route files without updating docs/screens/reality/*.md | open | 2026-07-31 |  |
...
| 1 | refactor | `churn-hotspot-frontend-apps-admin-web-src-pages-mobileconfigpage-tsx` | Churn hotspot: frontend/apps/admin-web/src/pages/MobileConfigPage.tsx — 365 lines this window (PR #2601 no-op cleanup) | open | 2026-07-31 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-voice_webhooks-rs` | Churn hotspot: backend/servers/api-server/src/routes/voice_webhooks.rs — 472 lines this window (PR #2604 tests) | open | 2026-07-31 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-reports-schedule_cadence-rs` | Churn hotspot: backend/servers/api-server/src/routes/reports/schedule_cadence.rs — 889 lines this window (PR #2599 extraction) | open | 2026-07-31 |  |

...
| 3 | refactor | `revert-pr-1713` | Revert PR #1713 — re-removes delegations frontend re-added in #1690 (BIT-213 retirement reconciliation) | open | 2026-06-25 |  |
| 3 | security | `code-review-api-handlers-install-no-manager-gate` | integrations/install.rs Airbnb/Booking connect/disconnect — verify_org_access only, no verify_manager_role_in_org (any member can wire OAuth) | ready | 2026-06-25 | [plan](plans/code-review-api-handlers-install-no-manager-gate.md) |
...
| 2 | test-gap | `unchecked-todo-pr-1705` | PR #1705 merged with unchecked `- [ ]` items in body — feat(faults): fire notifications on every fault lifecycle event (BIT-185) | open | 2026-06-25 |  |
| 2 | test-gap | `unchecked-todo-pr-1709` | PR #1709 merged with unchecked `- [ ]` items in body — feat(scheduler): payment reminders + auto-overdue transitions (Story 11.6 / BIT- | open | 2026-06-25 |  |
| 2 | test-gap | `unchecked-todo-pr-1768` | PR #1768 merged with unchecked `- [ ]` items in body — fix(messaging): camelCase wire contract for thread/message/participant API (BIT- | open | 2026-06-25 |  |
| 2 | test-gap | `unchecked-todo-pr-1703` | PR #1703 merged with unchecked `- [ ]` items in body — feat(api-server): gap-sweep Epic 12 — meter reminders + OCR stub endpoints | open | 2026-06-25 |  |
| 2 | dx | `unchecked-todo-pr-1723` | PR #1723 merged with unchecked `- [ ]` items in body — fix(financial): rustfmt compliance for financial reports routes | open | 2026-06-25 |  |
| 2 | test-gap | `unchecked-todo-pr-1717` | PR #1717 merged with unchecked `- [ ]` items in body — feat(financial): income statement, balance sheet, cash flow + PDF/xlsx export | open | 2026-06-25 |  |
| 2 | test-gap | `unchecked-todo-pr-1685` | PR #1685 merged with unchecked `- [ ]` items in body — feat(ppt-web): real-time IoT dashboard via BIT-145 WebSocket channel | open | 2026-06-25 |  |
| 2 | test-gap | `unchecked-todo-pr-1641` | PR #1641 merged with unchecked `- [ ]` items in body — feat(ppt-web): Sentiment & Predictive Maintenance dashboards (Epic 13) | open | 2026-06-25 |  |
| 2 | security | `code-review-api-handlers-emergency-lifecycle-no-gate` | emergency/incidents.rs update/resolve/close_incident missing is_emergency_manager gate (likely PR #1798 split regression) | ready | 2026-06-25 | [plan](plans/code-review-api-handlers-emergency-lifecycle-no-gate.md) |
| 2 | bug | `code-review-api-handlers-buildings-rls-leak` | buildings.rs assign_unit_owner has un-released rls early-returns — RlsConnection::Drop spams warn + delays pool return | open | 2026-06-25 |  |
...
| 1 | refactor | `churn-hotspot-frontend-apps-ppt-web-messages-en-json` | Churn hotspot: frontend/apps/ppt-web/messages/en.json (3732 lines since 2026-06-16; refactor-split window) | open | 2026-06-25 |  |
...
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected by deploy-server (staging/prod) | dropped | 2026-06-25 |  |

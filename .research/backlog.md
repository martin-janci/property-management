# Backlog of vectors
<sub>Last regenerated: 2026-07-01 12:15 UTC by routine</sub>
...
| 3 | test-gap | `test-gap-bit-351-quarantine-hides-regression-guards` | BIT-351 quarantine (#[ignore]) hides regression tests that guard just-shipped fixes across 3 recent merges | ready | 2026-07-01 | [plan](plans/test-gap-bit-351-quarantine-hides-regression-guards.md) |
| 3 | bug | `bug-multi-currency-enum-rename_all-broken-wire-and-db` | CountryCode/SupportedCurrency use SCREAMING_SNAKE_CASE — serialize to 'S_K'/'E_U_R' and mismatch DB enum label | ready | 2026-07-01 | [plan](plans/bug-multi-currency-enum-rename_all-broken-wire-and-db.md) |
...
| 2 | bug | `bug-favorite-alert-worker-non-transactional-drops-alerts` | FavoriteAlertWorker::run_once enqueue+advance are non-transactional — concurrent price-history commit silently | open | 2026-07-01 |  |
| 2 | test-gap | `test-gap-migration-import-export-still-mocked` | tenant-migration import/export still a DB-backed facade — no S3, no parse/validate, no async execute, mocked e | open | 2026-07-01 |  |
...
| 1 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcod | open | 2026-07-01 |  |
...
| 1 | refactor | `refactor-churn-messaging-routes` | Churn hotspot: backend/servers/api-server/src/routes/messaging.rs — 4 commits/15d, cross-repo bug fixes indica | open | 2026-07-01 |  |
| 1 | refactor | `refactor-churn-financial-repo` | Churn hotspot: backend/crates/db/src/repositories/financial.rs — 4 commits/15d, test-backfill campaign pressur | open | 2026-07-01 |  |
| 1 | refactor | `refactor-churn-messaging-repo` | Churn hotspot: backend/crates/db/src/repositories/messaging.rs — 3 commits/15d aligned with routes/messaging.r | open | 2026-07-01 |  |
| 1 | perf | `perf-migration-list-templates-missing-index-and-tiebreak` | MigrationRepository::list_templates: no supporting index for ORDER BY updated_at DESC; no unique tiebreak (pag | open | 2026-07-01 |  |

...
| 2 | bug | `code-review-reality-server-imports-total-page-length` | reality-server imports.rs: list_import_jobs + list_feeds report `total = page.len()` — pagination li | open | 2026-08-27 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-services-auth-policy-rs` | churn-hotspot: auth_policy.rs — 2 PRs in 24h touching the capability-grant strictest-across-orgs gat | open | 2026-08-27 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-ppt-web-src-features-compliance-pages-content-moderation-page-test-tsx` | churn-hotspot: ContentModerationPage.test.tsx — 4 PRs, ~332 lines of test churn on the overdue affor | open | 2026-08-27 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-ppt-web-src-features-compliance-pages-content-moderation-page-tsx` | churn-hotspot: ContentModerationPage.tsx — 4 PRs in one routine window (#2849/#2856/#2860/#2863) cha | open | 2026-08-27 |  |
| 1 | bug | `code-review-reality-server-agency-import-history-no-pagination` | reality-server agency_imports.rs list_import_history: hard-coded LIMIT 100, no pagination params, `t | open | 2026-08-27 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-06-19 12:17 UTC by routine</sub>
...
| 2 | refactor | `refactor-churn-hotspot-backend-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs — repeated rework | open | 2026-06-19 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1559-ppt` | Screen-map drift: PR #1559 modified ppt-web routes without screen-doc update | open | 2026-06-19 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1555-ppt` | Screen-map drift: PR #1555 modified ppt-web routes without screen-doc update | open | 2026-06-19 |  |
...
| 1 | refactor | `refactor-churn-hotspot-backend-mfa-rs` | Churn hotspot: backend api-server routes/mfa.rs — MFA recovery hardening rework | open | 2026-06-19 |  |
| 1 | refactor | `refactor-churn-hotspot-backend-developer-rls-tests` | Churn hotspot: developer OAuth FORCE RLS tests — multiple amendment commits | open | 2026-06-19 |  |
| 1 | dx | `dx-closed-not-merged-batch-2026-06-17` | Dispatcher cleanup: 11 superseded PRs closed on 2026-06-17 | open | 2026-06-19 |  |
...
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected | dropped | 2026-06-19 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-06-25 12:00 UTC by routine</sub>
...
| 3 | bug | `bug-revert-pr-1713` | Revert in PR #1713 — investigate original cause | open | 2026-06-25 |  |
| 3 | security | `code-review-ppt-web-core-accounting-query-leak` | Accounting TanStack Query cache not cleared on logout — invoices/statements survive session change | ready | 2026-06-25 | [plan](plans/code-review-ppt-web-core-accounting-query-leak.md) |
...
| 2 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcoded MOCK_* arrays — no API wiri | done | 2026-06-25 |  |
| 2 | bug | `code-review-ppt-web-core-websocket-reconnect-thrashing` | WebSocketWrapper causes reconnects on every parent render due to auth object recreation | open | 2026-06-25 |  |
...
| 2 | bug | `code-review-mobile-rn-deeplink-init-unhandled` | useDeepLinkRouting.ts:27-36 — initialize() re-runs on onNavigate identity change + void promise with no .catch → duplicate nav / unhandled r | open | 2026-06-16 |  |
...
| 1 | bug | `bug-ios-deeplink-info-plist-missing` | iOS deep-link layer dead at runtime — Info.plist missing CFBundleURLTypes + applinks entitlement | open | 2026-06-25 |  |
| 1 | bug | `bug-risky-churn-pr-963-api-main-rs` | Risky churn: api-server main.rs security-headers wiring shipped without a middleware smoke test | open | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-platform-admin-rs` | Churn hotspot: backend/crates/db/src/repositories/platform_admin.rs (top-3 churn in 9-day catch-up window) | open | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-sensor-rs` | Churn hotspot: backend/crates/db/src/repositories/sensor.rs (+248/-86 in PR #1321/#1322 PAP-151 re-land + fmt) | done | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-tests-form-rls-repo-tests-rs` | Churn hotspot: backend/crates/db/tests/form_rls_repo_tests.rs touched 2x since 2026-06-12 (window 2026-06-12→2026-06-13) | done | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs (+404/−29 in PR #1294 Booking.com OTA retry) | done | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-reserve-funds-rs` | Churn hotspot: backend/servers/api-server/src/routes/reserve_funds.rs (+228/-255 in PR #1321 PAP-151 re-land) | done | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-docs-screens-ppt-admin-contextual-help-md` | Churn hotspot: docs/screens/ppt/admin-contextual-help.md (top-3 churn in 9-day catch-up window) | open | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-docs-screens-ppt-announcements-md` | Churn hotspot: docs/screens/ppt/announcements.md (top-3 churn in 9-day catch-up window) | open | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-mobile-app-config-icon-test-ts` | Churn hotspot: 124 lines in frontend/apps/mobile/app.config.icon.test.ts (PR #1383 gap-85-2) | done | 2026-06-25 |  |
| 1 | triage | `closed-not-merged-pr-1634` | PR #1634 closed without merging | open | 2026-06-25 |  |
| 1 | triage | `closed-not-merged-pr-1698` | PR #1698 closed without merging | open | 2026-06-25 |  |
| 1 | triage | `closed-not-merged-pr-1720` | PR #1720 closed without merging | open | 2026-06-25 |  |
| 1 | triage | `closed-not-merged-pr-1727` | PR #1727 closed without merging | open | 2026-06-25 |  |
| 1 | triage | `closed-not-merged-pr-1749` | PR #1749 closed without merging | open | 2026-06-25 |  |
| 1 | refactor | `code-review-api-core-osrng-expect` | crypto.rs:127 SysRng.try_fill_bytes(...).expect() panics if OS CSPRNG errors during integration-credential encrypt | done | 2026-06-25 |  |
| 1 | bug | `code-review-mobile-native-kmp-deeplink-token-not-url-decoded` | DeepLinkRouter skips URL-decoding while Android Uri.getQueryParameter decodes — SSO tokens diverge per platform | open | 2026-06-25 |  |
| 1 | bug | `code-review-mobile-native-kmp-search-stale-response-race` | SearchScreen stale-response race — overlapping searches can clobber newer results | open | 2026-06-25 |  |
| 1 | test-gap | `code-review-ppt-web-core-trivial-test-assertions` | AuthContext / useOcrMeterReading tests rely on .toBeDefined() — pass trivially on compile | open | 2026-06-25 |  |
| 1 | refactor | `repeated-churn-backend-servers-api-server-src-routes-forms-rs` | forms.rs repeated-churn — runs_seen=2 (#1337 explicit_auto_deref + #1397 org-scope hardening) | done | 2026-06-25 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new regression test | open | 2026-06-25 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1288-webhook-rls` | Webhook handlers RLS migration (PR #1288, PAP-170) shipped without a new regression test for repo-layer methods | open | 2026-06-25 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression test for the public-connection rou | open | 2026-06-25 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixed in PR #1287 | open | 2026-06-25 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-959-reality-listings-pagination` | Reality-server listings pagination clamp (PR #959) shipped without a regression test for limit=-1 | open | 2026-06-25 |  |
| 1 | test-gap | `test-gap-screen-map-drift-pr-1085-reality` | Screen-map drift: PR #1085 modified reality-web listing detail metadata + page without screen-doc update | open | 2026-06-25 |  |
| 1 | test-gap | `test-gap-screen-map-drift-pr-1100-ppt` | Screen-map drift: PR #1100 modified ppt-web App.tsx (FileDisputePageRoute extraction) without screen-doc update | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1680` | Research dispatcher: cron environment can&#39;t run core pipeline (fire-and-forget implementers die, no DB, git-push + archive-push blocked) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1758` | Follow-up: preflight presence-check misses length floors for JWT_SECRET / ESIGN_TOKEN_SECRET (PR #1753) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1759` | Follow-up: tighten Booking.com listing-push rate/currency validation (ISO-4217 whitelist, mixed-currency, amount bounds) (PR #1743) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1760` | Follow-up: duplicate SQLx migration 00192 broke dev + ID-document PII hardening (PR #1750) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1761` | Follow-up: restore raw principal_kind in tenant-resolution warn logs; carry over #1675 finding-3 (PR #1744) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1762` | Follow-up: portal listing edit silently downgrades sold/rented/archived to draft (PR #1746) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1763` | Follow-up: add integration test for sensor WS non-member 403 rejection (PR #1737) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1764` | Follow-up: Stripe Checkout hardening — session-creation idempotency key + webhook amount cross-check (PR #1726) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1765` | Follow-up: event bus backoff jitter + head-of-line blocking on retry (PR #1716) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1766` | Follow-up: persisted rental booking/guest PII reads (list_bookings/get_booking/get_booking_with_guests/get_guest) not manager-gated (PR #174 | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1767` | Follow-up: offline fault queue ordering/concurrency + offline-edit dedup gaps (PR #1715) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1769` | Follow-up: payment-reminder scheduler can double-send + UTC date boundary + tautological tests (PR #1709) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1770` | Follow-up: bind attachment file_key to the issued upload key + validate MIME on link (PR #1702) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1771` | Follow-up: unread-count ignores per-participant soft-delete/archive (PR #1696) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1772` | Follow-up: OCR endpoints unauthenticated + meter-reminder dedup/doc drift (PR #1703) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1773` | Follow-up: send_message + unread/read model not generalized for N-party group threads (PR #1689) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1776` | Follow-up: N+1 block-check loop in start_thread for N-party conversations (PR #1689) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1777` | Follow-up: meter reminders can be sent twice to a resident with multiple unit meters (PR #1703) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1780` | Follow-up: camelCase wire flip (PR #1768) breaks React Native mobile messaging | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1782` | Follow-up: a third access-token verification copy (JwtService) left unmigrated + log lost token_type field (PR #1744) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1783` | Follow-up: guest ID-document upload/OCR seam — PII audit-logging, content-type sniffing, structured-PII authz parity (PR #1750) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1784` | Follow-up: portal-listings — DB-level status/enum defense-in-depth + IG3 test note (PR #1746) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1785` | Follow-up: Stripe Checkout — multi-currency amount conversion + Stripe idempotency-key + webhook amount cross-check (PR #1726) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1786` | Follow-up: sensor WS handler — add authz regression tests for the surviving DB-checked path (PR #1737) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1787` | Follow-up: align get_booking_conflicts manager gate with canonical DB-backed predicate (PR #1741) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1788` | Follow-up: Booking.com listing-push — currency validation is structural-only, duplicates existing SupportedCurrency allowlist (PR #1743) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1789` | Follow-up: N-party conversations — tests assert snake_case against camelCase wire; start_thread response still 2-party-shaped (PR #1689) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1790` | Follow-up: payment reminders re-fire every ~5 min for the whole due-date window (no persistent dedup) (PR #1709) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1791` | Follow-up: message attachments — link trusts client-supplied file_key (IDOR) + unvalidated content-type (PR #1702) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1792` | Follow-up: event bus retry — blocking per-subscription retry + silent Lagged/buffer-overflow drop defeat at-least-once (PR #1716) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1793` | Follow-up: fault notifications — two transitions (triage, confirm) emit nothing + scattered dispatch logic (PR #1705) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1826` | Follow-up: reality-web auth-callback &#34;e2e&#34; coverage is integration-only + cements a CSRF-skip path (PR #1822) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1827` | Follow-up: 404 mapping left half-done in confirm_match + secret-hiding should use a DTO, not skip_serializing (PR #1809) | open | 2026-06-25 |  |
| 1 | triage | `triage-issue-1828` | Follow-up: accounting-web signup a11y + login link + missing tests/lint-script (PR #1808) | open | 2026-06-25 |  |
...
| 1 | dx | `dx-stalled-review-pr-1179` | PR #1179 (docs(epics) catalog backfill for 37 mounted-but-undocumented backend modules) — stalled at 7d, no reviewDecision | open | 2026-06-16 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-tests-reserve-funds-cross-org-idor-tests-rs` | Churn hotspot: backend/servers/api-server/tests/reserve_funds_cross_org_idor_tests.rs touched 2x since 2026-06-12 (window 2026-06-12→2026-06 | open | 2026-06-13 |  |
| 1 | dx | `dx-stalled-review-pr-988` | Stalled review: PR #988 (Epic: reusable Playwright E2E framework + sitemap FlowRunner) open 10d, no reviewDecision | open | 2026-06-13 |  |
| 1 | triage | `triage-issue-1331` | Issue #1331 (no labels, OPEN): Backend `test` job red/hanging on dev base — blocks the entire backend merge pipeline | open | 2026-06-13 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-reality-portal-rs` | Churn hotspot: backend/crates/db/src/repositories/reality_portal.rs (+59/−28 in PR #1297 PAP-142 IDOR scoping) | open | 2026-06-12 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-api-ecosystem-rs` | Churn hotspot: backend/servers/api-server/src/routes/api_ecosystem.rs (+106/−27 in PR #1293 PAP-171; second touch in 24h) | open | 2026-06-12 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-iot-rs` | Churn hotspot: backend/servers/api-server/src/routes/iot.rs (+278/-403 in PR #1321/#1322 PAP-151 re-land + fmt) | open | 2026-06-12 |  |
| 1 | dx | `closed-not-merged-pr-1274` | PR #1274 (cargo-minor-patch group, /backend, 9 updates) closed unmerged — superseded by #1313 after auto-rebase fix landed | open | 2026-06-12 |  |
...
| 1 | security | `security-pkce-oauth-authcode-pr-908-closed` | PR #908 (fix(security): require PKCE on OAuth authorization-code flow, closes #823) was closed unmerged — verify whether PKCE enforcement st | done | 2026-06-03 |  |
...
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→18:30Z) | dropped | 2026-06-25 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-10 03:05Z→18:30Z) | dropped | 2026-06-25 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-06-10 03:05Z→18:30Z) | dropped | 2026-06-25 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-emergency-rs` | Churn hotspot: 1021 lines changed in backend/servers/api-server/src/routes/emergency.rs (window 2026 | dropped | 2026-06-25 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-enhanced-tenant-screening-rs` | Churn hotspot: 709 lines changed in backend/servers/api-server/src/routes/enhanced_tenant_screening. | dropped | 2026-06-25 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-vendors-rs` | Churn hotspot: 929 lines changed in backend/servers/api-server/src/routes/vendors.rs (window 2026-06 | dropped | 2026-06-25 |  |
| 0 | refactor | `churn-hotspot-mobile-native-listing-detail-kt` | Churn hotspot: ListingDetailScreen.kt — +1279 LOC this run (gap-82-4 reality mobile favorite toggle) | dropped | 2026-06-25 |  |
| 0 | refactor | `churn-hotspot-mobile-native-search-screen-kt` | Churn hotspot: SearchScreen.kt — +1293 LOC this run (gap-82-3 reality mobile search/filters) | dropped | 2026-06-25 |  |
| 0 | refactor | `code-review-mobile-native-kmp-deeplink-android-bypasses-shared-router` | MainActivity reimplements deep-link dispatch instead of calling shared DeepLinkRouter — drift trap | dropped | 2026-06-25 |  |
| 0 | refactor | `refactor-churn-hotspot-mobile-announcements` | Churn hotspot: AnnouncementsScreen.tsx — 4 PRs this run, instability proxy | dropped | 2026-06-25 |  |
| 0 | refactor | `refactor-churn-hotspot-mobile-announcements-test` | Churn hotspot: AnnouncementsScreen.test.ts — 4 PRs this run, instability proxy | dropped | 2026-06-25 |  |
| 0 | refactor | `refactor-churn-hotspot-mobile-documents` | Churn hotspot: DocumentsScreen.tsx — 3 PRs this run | dropped | 2026-06-25 |  |
| 0 | triage | `triage-dispatcher-mcp-push-large-file-issue-1014` | Dispatcher action-list.json corruption when MCP push falls back from blocked git push | dropped | 2026-06-25 |  |
| 0 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despite metric=53 | dropped | 2026-06-25 |  |
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected by deploy-server (s | dropped | 2026-06-25 |  |

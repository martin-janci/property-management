# Backlog of vectors
<sub>Last regenerated: 2026-06-21 14:15 UTC by routine</sub>
...
| 3 | security | `security-unchecked-todo-pr-1606` | PR #1606 merged with unchecked TODO checklist — 1 unchecked checklist item(s) post-merge: `cargo test -p api-server acco | open | 2026-06-21 |  |
| 3 | security | `security-unchecked-todo-pr-1625` | PR #1625 merged with unchecked TODO checklist — 4 unchecked checklist item(s) post-merge: `cargo build -p api-server` cl | open | 2026-06-21 |  |
| 3 | bug | `bug-ci-red-voting-pdf-1645` | Code-review: backend.yml red on dev since 2026-06-20 22:24 UTC (PR #1625, commit 3c63a6d3). p | ready | 2026-06-21 | [plan](plans/bug-ci-red-voting-pdf-1645.md) |
...
| 2 | test-gap | `test-gap-screen-map-drift-pr-1610-ppt` | Screen-map drift: PR #1610 touched routes without doc update | open | 2026-06-21 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1611-ppt` | Screen-map drift: PR #1611 touched routes without doc update | open | 2026-06-21 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1617` | Hotfix without test diff: PR #1617 — Fix PR with no test files in diff: fix(integrations): wire combined OTA availabi | open | 2026-06-21 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1621-ppt` | Screen-map drift: PR #1621 touched routes without doc update | open | 2026-06-21 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1621-reality` | Screen-map drift: PR #1621 touched routes without doc update | open | 2026-06-21 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1630-ppt` | Screen-map drift: PR #1630 touched routes without doc update | open | 2026-06-21 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1639` | Hotfix without test diff: PR #1639 — Fix PR with no test files in diff: fix(api-server): manager-gate Airbnb linked-l | open | 2026-06-21 |  |
| 2 | bug | `bug-unchecked-todo-pr-1641` | PR #1641 merged with unchecked TODO checklist — 5 unchecked checklist item(s) post-merge: `GET /ai/sentiment` renders KP | open | 2026-06-21 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1641-ppt` | Screen-map drift: PR #1641 touched routes without doc update | open | 2026-06-21 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1654-ppt` | Screen-map drift: PR #1654 touched routes without doc update | open | 2026-06-21 |  |
...
| 1 | bug | `code-review-mobile-native-kmp-deeplink-token-not-url-decoded` | DeepLinkRouter skips URL-decoding while Android Uri.getQueryParameter decodes — SSO tokens diverge per platform | open | 2026-06-21 |  |
| 1 | bug | `code-review-mobile-native-kmp-search-stale-response-race` | SearchScreen stale-response race — overlapping searches can clobber newer results | open | 2026-06-21 |  |
| 1 | test-gap | `test-gap-screen-map-drift-pr-1085-reality` | Screen-map drift: PR #1085 modified reality-web listing detail metadata + page without screen-doc update | open | 2026-06-21 |  |
| 1 | test-gap | `test-gap-screen-map-drift-pr-1100-ppt` | Screen-map drift: PR #1100 modified ppt-web App.tsx (FileDisputePageRoute extraction) without screen-doc update | open | 2026-06-21 |  |
| 1 | bug | `bug-risky-churn-pr-963-api-main-rs` | Risky churn: api-server main.rs security-headers wiring shipped without a middleware smoke test | open | 2026-06-21 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-959-reality-listings-pagination` | Reality-server listings pagination clamp (PR #959) shipped without a regression test for limit=-1 | open | 2026-06-21 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→18:30Z) | open | 2026-06-21 |  |
| 1 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs (+404/−29 in PR #1294 Booking.com OTA retry) | open | 2026-06-21 |  |
| 1 | dx | `closed-not-merged-pr-1647` | PR #1647 closed without merging — superseded | open | 2026-06-21 |  |
| 1 | dx | `closed-not-merged-pr-1636` | PR #1636 closed without merging — superseded | open | 2026-06-21 |  |
| 1 | dx | `closed-not-merged-pr-1511` | PR #1511 closed without merging — superseded | open | 2026-06-21 |  |
| 1 | refactor | `repeated-churn-backend-crates-integrations-src-booking-rs` | Repeated churn: backend/crates/integrations/src/booking.rs — runs_seen ≥ 2 | open | 2026-06-21 |  |
| 1 | refactor | `repeated-churn-backend-crates-db-src-repositories-document-rs` | Repeated churn: backend/crates/db/src/repositories/document.rs — runs_seen ≥ 2 | open | 2026-06-21 |  |
...
| 0 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despite metric=53 | dropped | 2026-06-21 |  |
| 0 | refactor | `churn-hotspot-mobile-native-listing-detail-kt` | Churn hotspot: ListingDetailScreen.kt — +1279 LOC this run (gap-82-4 reality mobile favorite toggle) | dropped | 2026-06-21 |  |
| 0 | refactor | `churn-hotspot-mobile-native-search-screen-kt` | Churn hotspot: SearchScreen.kt — +1293 LOC this run (gap-82-3 reality mobile search/filters) | dropped | 2026-06-21 |  |
| 0 | refactor | `code-review-mobile-native-kmp-deeplink-android-bypasses-shared-router` | MainActivity reimplements deep-link dispatch instead of calling shared DeepLinkRouter — drift trap | dropped | 2026-06-21 |  |
| 0 | refactor | `refactor-churn-hotspot-mobile-announcements` | Churn hotspot: AnnouncementsScreen.tsx — 4 PRs this run, instability proxy | dropped | 2026-06-21 |  |
| 0 | refactor | `refactor-churn-hotspot-mobile-announcements-test` | Churn hotspot: AnnouncementsScreen.test.ts — 4 PRs this run, instability proxy | dropped | 2026-06-21 |  |
| 0 | refactor | `refactor-churn-hotspot-mobile-documents` | Churn hotspot: DocumentsScreen.tsx — 3 PRs this run | dropped | 2026-06-21 |  |
| 0 | triage | `triage-dispatcher-mcp-push-large-file-issue-1014` | Dispatcher action-list.json corruption when MCP push falls back from blocked git push | dropped | 2026-06-21 |  |
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected by deploy-server (staging/prod) | dropped | 2026-06-21 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-rental-rs` | Churn hotspot: backend/crates/db/src/repositories/rental.rs — top-3 this run | open | 2026-06-21 |  |

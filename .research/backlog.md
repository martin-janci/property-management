...
| 2 | bug | `follow-up-issue-2759-mobile-tolocale-consolidation` | mobile: bare toLocale* still on 12+ screens (device locale, not app) after PR #2755; missing lint gu | open | 2026-08-14 |  |
...
| 1 | bug | `code-review-reality-web-agency-errorstate-i18n` | reality-web AgencyErrorStates.tsx no-agency empty state hardcoded English on 4-locale portal | open | 2026-08-14 |  |
| 1 | bug | `code-review-reality-web-realtor-mgmt-i18n` | reality-web RealtorManagement.tsx: destructive confirm-remove modal + header subtitle hardcoded Engl | open | 2026-08-14 |  |
| 1 | bug | `code-review-reality-web-comparison-view-i18n` | reality-web ComparisonView.tsx renders hardcoded English on 4-locale portal (sk/cs/de/en) — never im | open | 2026-08-14 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-06-21 00:10 UTC by routine</sub>
...
| 2 | test-gap | `screen-map-drift-pr-1630-ppt` | PR #1630 touched routes without updating docs/screens/ — heuristic | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1621-ppt` | PR #1621 touched routes without updating docs/screens/ — heuristic | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1621-reality` | PR #1621 touched routes without updating docs/screens/ — heuristic | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1611-ppt` | PR #1611 touched routes without updating docs/screens/ — heuristic | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1610-ppt` | PR #1610 touched routes without updating docs/screens/ — heuristic | open | 2026-06-21 |  |
| 2 | test-gap | `hotfix-no-test-pr-1617-booking-channel` | Hotfix without test: PR PR #1617 (booking_channel.rs) | open | 2026-06-21 |  |
...
| 1 | refactor | `repeated-churn-backend/crates/integrations/src/booking.rs` | Repeated churn: backend/crates/integrations/src/booking.rs keeps changing (instability proxy) | open | 2026-06-21 |  |
| 1 | refactor | `repeated-churn-backend/crates/db/src/repositories/document.rs` | Repeated churn: backend/crates/db/src/repositories/document.rs keeps changing (instability proxy) | open | 2026-06-21 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-rental-rs` | Churn hotspot: backend/crates/db/src/repositories/rental.rs (track for instability) | open | 2026-06-21 |  |
...
| 0 | dx | `dispatcher-supersession-cluster-2026-06-21` | Dispatcher supersession cluster 2026-06-21: 19 closed-unmerged dispatcher retries | open | 2026-06-21 |  |

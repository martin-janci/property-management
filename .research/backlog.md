...
| 3 | security | `code-review-api-handlers-hellosign-unbound-envelope` | HelloSign webhook verifier signs only event_time+event_type — envelope_id is unsigned (cross-tenant  | ready | 2026-08-26 | [plan](plans/code-review-api-handlers-hellosign-unbound-envelope.md) |
...
| 2 | perf | `code-review-api-core-workflow-regex-recompile` | workflow_executor recompiles regex per evaluation (DoS amplification) | open | 2026-08-26 |  |
| 2 | bug | `code-review-search-drainer-stub-marks-delivered` | saved-search alert drainer wired with logging-stub transports (alerts marked delivered without being | open | 2026-08-26 |  |
| 2 | bug | `code-review-mobile-native-kmp-profile-edit-drops-fields` | KMP profile edit drops fields on save | open | 2026-08-26 |  |
| 2 | bug | `code-review-mobile-native-kmp-twofactor-orphan-unwired` | KMP two-factor flow orphan (unwired handlers) | open | 2026-08-26 |  |
| 2 | bug | `code-review-mobile-native-kmp-account-screen-dead-rows` | KMP AccountScreen renders dead rows | open | 2026-08-26 |  |
| 2 | security | `code-review-api-handlers-esign-webhook-replay` | esignature_webhook has no timestamp/freshness check for any provider (replay window unbounded) | open | 2026-08-26 |  |
...
| 1 | bug | `code-review-api-core-workflow-notin-fail-open` | workflow_executor In/NotIn operator asymmetry (NotIn fails open) | open | 2026-08-26 |  |
| 1 | bug | `code-review-search-drainer-alert-copy-no-i18n` | saved-search alert drainer hardcodes English copy, ignores AlertNotification.locale | open | 2026-08-26 |  |
| 1 | bug | `code-review-mobile-rn-hardcoded-button-labels` | mobile RN messages/person-months buttons hardcoded English (compose CTA, Save/Cancel) | open | 2026-08-26 |  |
| 1 | bug | `code-review-mobile-rn-faultslist-i18n-gap` | FaultsListScreen: '+ Report' CTA + filter tabs hardcoded English | open | 2026-08-26 |  |
| 1 | bug | `code-review-mobile-rn-raw-status-untranslated` | mobile RN faults/outages/announcement badges print raw enum status untranslated | open | 2026-08-26 |  |

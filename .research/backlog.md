...
| 2 | test-gap | `unchecked-todo-pr-1606` | PR #1606 merged with unchecked TODO: verify CI ran accounting_contacts_authz tests | open | 2026-06-21 |  |
| 2 | bug | `risky-churn-pr-1565-document-rs` | Risky churn: PR #1565 fix touched backend/crates/db/src/repositories/document.rs with no test diff (hotspot) | open | 2026-06-21 |  |
| 2 | bug | `risky-churn-pr-1551-document-rs` | Risky churn: PR #1551 fix touched backend/crates/db/src/repositories/document.rs with no test diff (hotspot) | open | 2026-06-21 |  |
| 2 | bug | `risky-churn-pr-1537-rental-rs` | Risky churn: PR #1537 fix touched backend/crates/db/src/repositories/rental.rs with no test diff (hotspot) | open | 2026-06-21 |  |
| 2 | bug | `risky-churn-pr-1469-document-rs` | Risky churn: PR #1469 fix touched backend/crates/db/src/repositories/document.rs with no test diff (hotspot) | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1641-ppt` | PR #1641 touched routes without updating docs/screens/ppt — heuristic | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1654-ppt` | PR #1654 touched routes without updating docs/screens/ppt — heuristic | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1630-ppt` | PR #1630 touched routes without updating docs/screens/ppt — heuristic | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1621-ppt` | PR #1621 touched routes without updating docs/screens/ppt — heuristic | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1621-reality` | PR #1621 touched routes without updating docs/screens/reality — heuristic | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1611-ppt` | PR #1611 touched routes without updating docs/screens/ppt — heuristic | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1610-ppt` | PR #1610 touched routes without updating docs/screens/ppt — heuristic | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1559-ppt` | PR #1559 touched routes without updating docs/screens/ppt — heuristic | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1555-ppt` | PR #1555 touched routes without updating docs/screens/ppt — heuristic | open | 2026-06-21 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→ | open | 2026-06-21 |  |
| 1 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despit | done | 2026-06-21 |  |
| 1 | refactor | `refactor-churn-hotspot-mobile-announcements` | Churn hotspot: AnnouncementsScreen.tsx — 4 PRs this run, instability proxy | done | 2026-06-21 |  |
| 1 | refactor | `refactor-churn-hotspot-mobile-announcements-test` | Churn hotspot: AnnouncementsScreen.test.ts — 4 PRs this run, instability proxy | done | 2026-06-21 |  |
...
| 1 | triage | `triage-issue-1331` | Issue #1331 (no labels, OPEN): Backend `test` job red/hanging on dev base — blocks the entire backend merge pi | done | 2026-06-21 |  |
| 1 | dx | `dx-stalled-review-pr-988` | Stalled review: PR #988 (Epic: reusable Playwright E2E framework + sitemap FlowRunner) open 10d, no reviewDeci | done | 2026-06-21 |  |
| 1 | dx | `dx-stalled-review-pr-1179` | PR #1179 (docs(epics) catalog backfill for 37 mounted-but-undocumented backend modules) — stalled at 7d, no re | done | 2026-06-21 |  |
| 1 | refactor | `repeated-churn-backend-crates-db-src-repositories-document-rs` | backend/crates/db/src/repositories/document.rs now seen as hotspot in 2 runs (last: 2026-06-10) | open | 2026-06-21 |  |
| 1 | refactor | `repeated-churn-backend-crates-integrations-src-booking-rs` | backend/crates/integrations/src/booking.rs now seen as hotspot in 2 runs (last: 2026-06-12) | open | 2026-06-21 |  |

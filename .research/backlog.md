...
| 3 | security | `code-review-api-core-ssrf-toctou-signatures` | LIVE SSRF DNS-rebinding TOCTOU in signatures.rs::store_signed_document (mounted e-sign webhook) — po | ready | 2026-08-09 | [plan](plans/security-ssrf-toctou-signatures-rebinding.md) |
| 3 | security | `code-review-api-core-ssrf-toctou-webhook` | SSRF DNS-rebinding TOCTOU in integrations/webhook.rs::test_webhook (unmounted; land before Epic-61 m | ready | 2026-08-09 | [plan](plans/security-ssrf-toctou-integrations-webhook.md) |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-integrations-webhook-rs` | Churn hotspot: backend/servers/api-server/src/routes/integrations/webhook.rs (2799 lines this run) | open | 2026-08-09 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-reports-mod-rs` | Churn hotspot: backend/servers/api-server/src/routes/reports/mod.rs (2747 lines this run; PR #2720 e | open | 2026-08-09 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-services-scheduler-mod-rs` | Churn hotspot: backend/servers/api-server/src/services/scheduler/mod.rs (2746 lines this run; PR #27 | open | 2026-08-09 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-07-06 03:15 UTC by routine</sub>
...
| 2 | refactor | `refactor-churn-hotspot-backend-crates-db-src-repositories-rental-rs` | Churn hotspot: backend/crates/db/src/repositories/rental.rs (11 commits in 19-day catch-up) | done | 2026-07-06 |  |
...
| 1 | refactor | `refactor-churn-hotspot-backend-crates-db-src-repositories-rental-oauth-rs` | Churn hotspot: backend/crates/db/src/repositories/rental/oauth.rs (594 lines, from PR #2100 split) | open | 2026-07-06 |  |
| 1 | refactor | `refactor-churn-hotspot-backend-crates-db-src-models-multi-currency-rs` | Churn hotspot: backend/crates/db/src/models/multi_currency.rs (532 lines: enum-sync guard #2098 + fix #2113) | open | 2026-07-06 |  |
| 1 | refactor | `code-review-ppt-web-core-errorhandler-i18n-gap` | Localise ERROR_MESSAGES in ppt-web errorHandler (i18n gap) | open | 2026-07-06 |  |
| 1 | bug | `code-review-ppt-web-core-auth-init-stale-token` | AuthContext initializeAuth skips access-token expiry check | open | 2026-07-06 |  |

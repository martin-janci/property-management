...
| 3 | security | `code-review-mobile-rn-nfc-revoke-silent-fail` | mobile-rn: emergencyRevokeAll swallows server revoke when SecureStore write fails — stolen phone kee | ready | 2026-08-25 | [plan](plans/code-review-mobile-rn-nfc-revoke-silent-fail.md) |
...
| 2 | test-gap | `code-review-mobile-rn-nfc-access-no-tests` | mobile-rn: NFCAccessController (grant/deny + wallet-pass creation) has zero test coverage | open | 2026-08-25 |  |
...
| 1 | refactor | `code-review-mobile-rn-i18n-gaps` | mobile-rn: 3 screens (WidgetSettings/PersonMonths/AnnouncementDetail) hardcode English UI strings | open | 2026-08-25 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-06-20 03:25 UTC by routine</sub>
...
| 3 | bug | `unchecked-todo-pr-1507` | Unchecked TODO in merged PR: fix(tests): restore user_memberships seed + fix platform principal for IDOR test | open | 2026-06-20 |  |
| 3 | bug | `unchecked-todo-pr-1492` | Unchecked TODO in merged PR: fix(db): cast remaining rental enum readers — GUEST/CALENDAR_BLOCK/ICAL_FEED_COL | open | 2026-06-20 |  |
| 3 | test-gap | `unchecked-todo-pr-1501` | Unchecked TODO in merged PR: test(reality-server): handler-level IDOR regression for imports/feeds (GH #1300) | open | 2026-06-20 |  |
| 3 | bug | `unchecked-todo-pr-1460` | Unchecked TODO in merged PR: fix(db): FORCE RLS on developer_oauth_apps/grants/api_key_usage_logs (BIT-76, #1 | open | 2026-06-20 |  |
| 3 | test-gap | `unchecked-todo-pr-1476` | Unchecked TODO in merged PR: chore(api-server): RLS dev-tooling + test-suite cleanup (GH #1340, #1341, #1366) | open | 2026-06-20 |  |
...
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new regression t | open | 2026-06-11 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression test for the p | open | 2026-06-11 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixed in PR #1 | open | 2026-06-11 |  |
...
| 2 | test-gap | `hotfix-no-test-pr-1582` | Hotfix without test: fix(mobile): wire useFolderTree / FOLDER_TREE_QUERY_KEY into document screens (closes #1532) | open | 2026-06-20 |  |
| 2 | test-gap | `hotfix-no-test-pr-1565` | Hotfix without test: fix(db): correct document get-by-id read path (u.name + enum ::text decode) | open | 2026-06-20 |  |
| 2 | test-gap | `hotfix-no-test-pr-1561` | Hotfix without test: fix(reality-server): admit public agencies on imports via PortalPrincipal (closes #1300) | open | 2026-06-20 |  |
| 2 | test-gap | `hotfix-no-test-pr-1551` | Hotfix without test: fix(db): cast document_category in count_accessible_rls filter (closes #1528) | open | 2026-06-20 |  |
| 2 | test-gap | `hotfix-no-test-pr-1545` | Hotfix without test: fix(reality-web): unbreak production build — /accounting QueryClient prerender + favorites pl/hu i1 | open | 2026-06-20 |  |
| 2 | test-gap | `hotfix-no-test-pr-1539` | Hotfix without test: fix(oauth): reject public client supplying a client_secret with invalid_client | open | 2026-06-20 |  |
| 2 | test-gap | `hotfix-no-test-pr-1537` | Hotfix without test: fix(db): cast enum write paths on rental_guests + forms (#1008 encode/decode) | open | 2026-06-20 |  |
| 2 | test-gap | `hotfix-no-test-pr-1536` | Hotfix without test: fix(mobile-native): remove unused import failing spotless on dev (post-#1447) | open | 2026-06-20 |  |
| 2 | test-gap | `hotfix-no-test-pr-1512` | Hotfix without test: fix(api-server): clippy fixes in accounting routes (post-#1454) | open | 2026-06-20 |  |
| 2 | dx | `screen-map-drift-pr-1610-ppt` | Screen-map drift: PR #1610 touched ppt-web routes without docs/screens/ppt/ update — fix(faults): confirm delete + use c | open | 2026-06-20 |  |
| 2 | dx | `screen-map-drift-pr-1611-ppt` | Screen-map drift: PR #1611 touched ppt-web routes without docs/screens/ppt/ update — test(reports): cover ScheduleDetail | open | 2026-06-20 |  |
| 2 | dx | `screen-map-drift-pr-1555-ppt` | Screen-map drift: PR #1555 touched ppt-web routes without docs/screens/ppt/ update — gap-79-1: wire useDeleteFault + use | open | 2026-06-20 |  |
| 2 | dx | `screen-map-drift-pr-1559-ppt` | Screen-map drift: PR #1559 touched ppt-web routes without docs/screens/ppt/ update — feat-announcement-comments-web-thre | open | 2026-06-20 |  |
| 2 | dx | `screen-map-drift-pr-1545-reality` | Screen-map drift: PR #1545 touched reality-web routes without docs/screens/reality/ update — fix(reality-web): unbreak p | open | 2026-06-20 |  |
| 2 | dx | `screen-map-drift-pr-1453-reality` | Screen-map drift: PR #1453 touched reality-web routes without docs/screens/reality/ update — N5 — Bank-statement upload  | open | 2026-06-20 |  |
| 2 | dx | `screen-map-drift-pr-1454-ppt` | Screen-map drift: PR #1454 touched ppt-web routes without docs/screens/ppt/ update — feat: native accounting MVP (N1-N4) | open | 2026-06-20 |  |
...
| 1 | refactor | `churn-hotspot-mobile-native-listing-detail-kt` | Churn hotspot: mobile-native/androidApp/src/main/java/three/two/bit/ppt/reality/ui/listing/ListingDetailScreen.kt | open | 2026-06-06 |  |
| 1 | refactor | `churn-hotspot-mobile-native-search-screen-kt` | Churn hotspot: mobile-native/androidApp/src/main/java/three/two/bit/ppt/reality/ui/search/SearchScreen.kt | open | 2026-06-06 |  |
...
| 1 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despite metric=5 | open | 2026-06-07 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-emergency-rs` | Churn hotspot: backend/servers/api-server/src/routes/emergency.rs | open | 2026-06-10 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-vendors-rs` | Churn hotspot: backend/servers/api-server/src/routes/vendors.rs | open | 2026-06-10 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-enhanced-tenant-screening-rs` | Churn hotspot: backend/servers/api-server/src/routes/enhanced_tenant_screening.rs | open | 2026-06-10 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: backend/crates/db/src/repositories/document.rs | open | 2026-06-10 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: backend/crates/db/src/repositories/subscription.rs | open | 2026-06-10 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: backend/servers/api-server/src/routes/aml_dsa.rs | open | 2026-06-10 |  |
| 1 | dx | `closed-not-merged-pr-1274` | PR #1274 (cargo-minor-patch group, /backend, 9 updates) closed unmerged — superseded by #1313 after auto-rebase fix land | open | 2026-06-12 |  |
| 1 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs | open | 2026-06-12 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-api-ecosystem-rs` | Churn hotspot: backend/servers/api-server/src/routes/api_ecosystem.rs | open | 2026-06-12 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-reality-portal-rs` | Churn hotspot: backend/crates/db/src/repositories/reality_portal.rs | open | 2026-06-12 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-iot-rs` | Churn hotspot: backend/servers/api-server/src/routes/iot.rs | open | 2026-06-12 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-reserve-funds-rs` | Churn hotspot: backend/servers/api-server/src/routes/reserve_funds.rs | open | 2026-06-12 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-sensor-rs` | Churn hotspot: backend/crates/db/src/repositories/sensor.rs | open | 2026-06-12 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-tests-reserve-funds-cross-org-idor-tests-rs` | Churn hotspot: backend/servers/api-server/tests/reserve_funds_cross_org_idor_tests.rs | open | 2026-06-13 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-tests-form-rls-repo-tests-rs` | Churn hotspot: backend/crates/db/tests/form_rls_repo_tests.rs | open | 2026-06-13 |  |
...
| 1 | refactor | `churn-hotspot-frontend-apps-mobile-app-config-icon-test-ts` | Churn hotspot: frontend/apps/mobile/app.config.icon.test.ts | open | 2026-06-15 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-mobile-app-config-ts` | Churn hotspot: frontend/apps/mobile/app.config.ts | open | 2026-06-15 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-form-rs` | Churn hotspot: backend/crates/db/src/repositories/form.rs | open | 2026-06-15 |  |
| 1 | refactor | `code-review-api-core-osrng-expect` | crypto.rs:127 SysRng.try_fill_bytes(...).expect() panics if OS CSPRNG errors during integration-credential encrypt | open | 2026-06-15 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-forms-rs` | Churn hotspot: backend/servers/api-server/src/routes/forms.rs | open | 2026-06-16 |  |
...
| 1 | test-gap | `test-gap-screen-map-drift-pr-1085-reality` | Screen-map drift: PR #1085 modified reality-web listing detail metadata + page without screen-doc update | open | 2026-06-20 |  |
| 1 | test-gap | `test-gap-screen-map-drift-pr-1100-ppt` | Screen-map drift: PR #1100 modified ppt-web App.tsx (FileDisputePageRoute extraction) without screen-doc update | open | 2026-06-20 |  |
| 1 | bug | `bug-risky-churn-pr-963-api-main-rs` | Risky churn: api-server main.rs security-headers wiring shipped without a middleware smoke test | open | 2026-06-20 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-959-reality-listings-pagination` | Reality-server listings pagination clamp (PR #959) shipped without a regression test for limit=-1 | open | 2026-06-20 |  |
| 1 | refactor | `repeated-churn-backend-servers-api-server-src-services-push_fanout-rs` | Churn hotspot: backend/servers/api-server/src/services/push_fanout.rs | open | 2026-06-20 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-tests-accounting_rls_repo_tests-rs` | Churn hotspot: backend/crates/db/tests/accounting_rls_repo_tests.rs | open | 2026-06-20 |  |
| 1 | refactor | `repeated-churn-backend-crates-integrations-src-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs | open | 2026-06-20 |  |
| 1 | triage | `closed-not-merged-pr-1511` | PR #1511 closed without merge | open | 2026-06-20 |  |
| 1 | triage | `closed-not-merged-pr-1505` | PR #1505 closed without merge | open | 2026-06-20 |  |
| 1 | triage | `closed-not-merged-pr-1506` | PR #1506 closed without merge | open | 2026-06-20 |  |
| 1 | triage | `closed-not-merged-pr-1504` | PR #1504 closed without merge | open | 2026-06-20 |  |
| 1 | triage | `closed-not-merged-pr-1503` | PR #1503 closed without merge | open | 2026-06-20 |  |
| 1 | triage | `closed-not-merged-pr-1500` | PR #1500 closed without merge | open | 2026-06-20 |  |
...
| 0 | refactor | `refactor-churn-hotspot-mobile-announcements` | Churn hotspot: AnnouncementsScreen.tsx — 4 PRs this run, instability proxy | dropped | 2026-06-20 |  |
| 0 | refactor | `refactor-churn-hotspot-mobile-announcements-test` | Churn hotspot: AnnouncementsScreen.test.ts — 4 PRs this run, instability proxy | dropped | 2026-06-20 |  |
| 0 | refactor | `refactor-churn-hotspot-mobile-documents` | Churn hotspot: DocumentsScreen.tsx — 3 PRs this run | dropped | 2026-06-20 |  |
| 0 | triage | `triage-dispatcher-mcp-push-large-file-issue-1014` | Dispatcher action-list.json corruption when MCP push falls back from blocked git push | dropped | 2026-06-20 |  |
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected | dropped | 2026-06-20 |  |

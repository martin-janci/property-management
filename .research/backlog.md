# Backlog of vectors
<sub>Last regenerated: 2026-07-12 18:00 UTC by routine</sub>
...
| 3 | security | `code-review-api-handlers-suspended-enum-oracle` | Login handler leaks ACCOUNT_SUSPENDED before password check — account-enumeration oracle | ready | 2026-07-12 | [plan](plans/code-review-api-handlers-suspended-enum-oracle.md) |
| 3 | security | `code-review-reality-server-ssrf-ipv4-mapped-ipv6` | reality-server url_validator bypass — IPv4-mapped IPv6 literal (::ffff:169.254.169.254) reaches metadata IMDS | ready | 2026-07-12 | [plan](plans/code-review-reality-server-ssrf-ipv4-mapped-ipv6.md) |
...
| 2 | bug | `code-review-api-handlers-raw-db-error-leak` | Handlers return raw DB error strings in JSON response — information disclosure | open | 2026-07-12 |  |
...
| 1 | bug | `code-review-mobile-native-kmp-no-http-timeout` | Shared Ktor HttpClient has no HttpTimeout plugin — stalled requests hang UI | open | 2026-07-12 |  |
| 1 | bug | `code-review-ppt-web-ui-sessionspage-unsafe-cast` | SessionsPage `as unknown as SessionRow[]` cast strips type-checking on security control | open | 2026-07-12 |  |
| 1 | bug | `code-review-ppt-web-ui-moderation-prompt-unvalidated` | ContentModerationPage window.prompt inputs cast unchecked to literal unions | open | 2026-07-12 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-07-18 04:18 UTC by routine</sub>
...
| 3 | bug | `code-review-api-core-voice-cmd-fabricated-success` | Voice-assistant handlers action_check_balance/action_report_fault ship as stubs — fabricated success on live webhook path | ready | 2026-07-18 | [plan](plans/code-review-api-core-voice-cmd-fabricated-success.md) |
| 3 | bug | `code-review-reality-web-listings-no-error-branch` | reality-web /listings silently renders empty state on API failure (no error branch destructured from useListings) | ready | 2026-07-18 | [plan](plans/code-review-reality-web-listings-no-error-branch.md) |
...
| 2 | security | `code-review-api-core-api-call-ssrf-hostname` | api_call action validate_external_url guards only literal IPs — hostname resolution bypass (SSRF) | open | 2026-07-18 |  |
| 2 | bug | `code-review-ppt-web-ui-invoicelist-noop-view` | ppt-web AccountingInvoiceList rows appear clickable but do nothing — cursor-pointer with no handler | open | 2026-07-18 |  |
| 2 | bug | `code-review-mobile-rn-offline-queue-silent-dataloss` | mobile RN offline queue drops terminally-failed mutations after 3 retries — silent data loss with no dead-letter store | open | 2026-07-18 |  |
...
| 1 | bug | `code-review-api-core-workflow-cond-fail-open` | workflow_executor evaluate_conditions() fails OPEN on unrecognised condition JSON | open | 2026-07-18 |  |
| 1 | bug | `code-review-ppt-web-ui-dsareports-i18n` | ppt-web DsaReportsPage hardcodes English error strings — bypasses i18n | open | 2026-07-18 |  |
| 1 | bug | `code-review-ppt-web-ui-dispute-evidence-retry` | ppt-web FileDisputePageRoute threads failedEvidence into router state but no retry UI consumes it | open | 2026-07-18 |  |
| 1 | bug | `code-review-reality-web-saved-search-hardcoded-i18n` | reality-web saved-searches page hardcodes For Sale/For Rent/€…-€… — bypasses next-intl | open | 2026-07-18 |  |
| 1 | bug | `code-review-reality-web-profile-hardcoded-locale` | reality-web agency/realtor public profile pages hardcode Slovak text — untranslated on other locales | open | 2026-07-18 |  |

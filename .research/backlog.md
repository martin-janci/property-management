...
| 2 | bug | `code-review-mobile-rn-dashboard-no-err-ui` | DashboardScreen silently shows zeros on API failure — no isError branch or ErrorBoundary | done | 2026-07-14 |  |
| 2 | test-gap | `code-review-mobile-rn-deeplink-mgr-untested` | DeepLinkManager auth-gated routing (pending-link queue, dispatch-after-auth) has no test | open | 2026-07-14 |  |
| 2 | test-gap | `screen-map-drift-pr-2287-reality` | reality-web favorites/alerts new subroute shipped without a screen-map doc | open | 2026-07-14 |  |
| 2 | test-gap | `screen-map-drift-pr-2294-ppt` | ppt-web portal-webhook-status manager surface shipped without a screen-map doc | open | 2026-07-14 |  |
| 2 | test-gap | `screen-map-drift-pr-2292-ppt` | ppt-web reports create-new-schedule flow shipped without a screen-map doc | open | 2026-07-14 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-07-01 18:30 UTC by routine</sub>
...
| 3 | bug | `code-review-backend-financial-payment-race` | allocate_existing_payment fetches payment + invoice outside transaction (949-969); concurrent second allocate can double-allocate by reading stale allocated sum; should FOR UPDATE lock payment row bef | ready | 2026-07-01 | [plan](plans/code-review-backend-financial-payment-race.md) |
...
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1288-webhook-rls` | Webhook handlers RLS migration (PR #1288, PAP-170) shipped without a new regression test for repo-layer methods | done | 2026-07-01 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new regression test | done | 2026-07-01 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixed in PR #1287 | done | 2026-07-01 |  |
| 2 | refactor | `churn-hotspot-backend-crates-db-src-repositories-reality-portal-rs` | Churn hotspot: backend/crates/db/src/repositories/reality_portal.rs (+59/−28 in PR #1297 PAP-142 IDOR scoping) | open | 2026-07-01 |  |
| 2 | bug | `code-review-backend-messaging-race-block-check` | send_message loops over recipients checking is_blocked per recipient (947-968) without atomicity; N+1 pattern; blocked_among_rls batch query exists (line 421, start_thread) as atomic alternative (issu | open | 2026-07-01 |  |
| 2 | bug | `code-review-backend-reality-watermark-ordering` | worker sets org context per-org inside loop (108) but does not isolate enqueue+advance pairs; if org_id=2 enqueue runs between org_id=1 enqueue and advance, org_id=1 advance reads org_id=2 newer water | open | 2026-07-01 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-messaging-rs` | Churn hotspot: backend/servers/api-server/src/routes/messaging.rs — 3 changes in the 15-day catch-up window | open | 2026-07-01 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-messaging-rs` | Churn hotspot: backend/crates/db/src/repositories/messaging.rs — 3 changes in the 15-day catch-up window | open | 2026-07-01 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-financial-rs` | Churn hotspot: backend/crates/db/src/repositories/financial.rs — 3 changes in the 15-day catch-up window | open | 2026-07-01 |  |
| 1 | dx | `dx-stalled-review-pr-1797` | Stalled review: PR #1797 | open | 2026-07-01 |  |
| 1 | dx | `dx-stalled-review-pr-1812` | Stalled review: PR #1812 | open | 2026-07-01 |  |

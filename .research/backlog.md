# Backlog of vectors
<sub>Last regenerated: 2026-07-31 03:15 UTC by routine</sub>
...
| 3 | security | `code-review-reality-server-ssrf-ipv4-mapped-ipv6` | SECURITY: reality-server url_validator IPv6 branch does not reject IPv4-mapped addresses (::ffff:a.b.c.d) — SSRF bypass for RFC1918 targets | ready | 2026-07-31 | [plan](plans/code-review-reality-server-ssrf-ipv4-mapped-ipv6.md) |
| 3 | refactor | `refactor-churn-hotspot-api-server-scheduler-2026-07-30` | Churn hotspot: backend/servers/api-server/src/services/scheduler.rs — 347 lines this window (PRs #2567, #2576) | open | 2026-07-31 |  |
...
| 2 | security | `code-review-reality-server-redirect-backslash-bypass` | SECURITY: reality-server sso.rs check_redirect_uri_allowed treats `/\evil.com` as same-origin — open-redirect variant not caught by `//` guard | open | 2026-07-31 |  |
| 2 | bug | `code-review-reality-server-agent-review-body-unbounded` | SECURITY-LITE: reality-server agent_reviews.rs public create_review binds user-controlled body into INSERT with no length/empty/trim validation | open | 2026-07-31 |  |
| 2 | test-gap | `screen-map-drift-pr-2600-reality` | screen-map drift: PR #2600 touched reality-web/src/app/[locale]/layout.tsx + app/env.js/route.ts w/o docs/screens/reality/ | open | 2026-07-31 |  |
| 2 | test-gap | `test-gap-voice-webhooks-zero-coverage` | test-gap: voice_webhooks.rs (1148 lines, 6 mounted endpoints incl. OAuth token exchange) has no tests at all | done | 2026-07-31 |  |
| 2 | bug | `code-review-api-core-resolved-rs-leaks-db-error` | SECURITY-LITE: layout/resolved.rs err500 handler leaks raw sqlx/serde error text on public GET /layout/resolved/{screen} — 8 sites, no server-side log | open | 2026-07-30 |  |
...
| 1 | refactor | `refactor-churn-hotspot-admin-web-mobile-config-2026-07-31` | Churn hotspot: frontend/apps/admin-web/src/pages/MobileConfigPage.tsx — 365 lines this window (PR #2601 no-op-Save rewrite) | open | 2026-07-31 |  |
| 1 | refactor | `refactor-churn-hotspot-api-server-voice-webhooks-2026-07-31` | Churn hotspot: backend/servers/api-server/src/routes/voice_webhooks.rs — 472 lines this window (test-add churn, healthy) | open | 2026-07-31 |  |
| 1 | bug | `code-review-api-core-scheduler-rs-silent-target-err` | scheduler.rs silently swallows DB errors on notification target lookups at 3 sites — failed dispatches show as empty target sets, no log/metric | done | 2026-07-31 |  |
| 1 | bug | `code-review-api-core-admin-rs-swallowed-serialize` | layout/admin.rs (+ tenant.rs) mutation handlers end with unwrap_or_default() serialize — a failed serialize returns 200 OK / body null instead of 500 | done | 2026-07-31 |  |
| 1 | dx | `dx-stale-todo-security-comments-faults-critical-notifications` | Stale TODO(security) headers in faults.rs / critical_notifications.rs describe a hardcoded-false gate that no longer exists | done | 2026-07-31 |  |

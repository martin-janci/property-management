# Backlog of vectors
<sub>Last regenerated: 2026-06-27 02:23 UTC by routine</sub>
...
| 3 | bug | `bug-revert-pr-1713-delegations` | Revert: delegations frontend (#1690) re-added then reverted (#1713) — reconcile delegation retirement (BIT-213 | open | 2026-06-27 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-reality-server-src-services-saved-search-alerts-rs` | Churn hotspot: reality-server saved_search_alerts.rs — 3 commits in 2026-06-16..2026-06-27 (Epic 16 alert cade | open | 2026-06-27 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-models-reality-portal-rs` | Churn hotspot: db crate reality_portal.rs models — 3 commits this window (saved-search + favorites) | open | 2026-06-27 |  |

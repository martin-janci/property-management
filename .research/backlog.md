# Backlog of vectors
<sub>Last regenerated: 2026-06-18 02:25 UTC by routine</sub>
...
| 2 | test-gap | `hotfix-no-test-pr-1539-oauth-public-client` | PR #1539 fix(oauth): reject public client supplying a client_secret — only touches `oauth.rs` (handler logic); no tes... | open | 2026-06-18 |  |
| 2 | test-gap | `hotfix-no-test-pr-1545-reality-web-build` | PR #1545 fix(reality-web): unbreak production build (`/accounting` QueryClient prerender) — adds `accounting/layout.t... | open | 2026-06-18 |  |
| 2 | test-gap | `hotfix-no-test-pr-1551-document-cast` | PR #1551 fix(db): cast document_category in count_accessible_rls — 1-line cast fix in `document.rs`, no regression te... | open | 2026-06-18 |  |
| 2 | bug | `risky-churn-pr-1551-document-rs` | PR #1551 (fix) modified backend/crates/db/src/repositories/document.rs — a top-3 churn file — with no test diff. | open | 2026-06-18 |  |
| 2 | test-gap | `screen-map-drift-pr-1545-reality` | PR #1545 touched `frontend/apps/reality-web/src/app/accounting/layout.tsx` (added new layout segment) without updatin... | open | 2026-06-18 |  |
| 2 | test-gap | `screen-map-drift-pr-1453-reality` | PR #1453 touched `frontend/apps/reality-web/src/app/accounting/page.tsx` (PAP-210 payment-matching) without updating ... | open | 2026-06-18 |  |
| 2 | test-gap | `screen-map-drift-pr-1454-ppt` | PR #1454 touched `frontend/apps/ppt-web/src/routes/groups/accounting.tsx` (new accounting route group N1-N4) without ... | open | 2026-06-18 |  |
| 2 | bug | `code-review-ppt-web-core-error-messages-not-i18n` | errorHandler.ts:53-141 hard-codes user-facing error messages in English; app supports sk/cs/de/en but non-en users al... | open | 2026-06-18 |  |
| 2 | security | `code-review-ppt-web-core-auth-storage-no-expiry` | AuthContext.tsx:112-192 stores access/refresh tokens in localStorage with no TTL guard or expiry check; tokens persis... | open | 2026-06-18 |  |
...
| 2 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcoded MOCK_* arrays — no API wiring | open | 2026-06-16 |  |
...
| 2 | test-gap | `test-gap-screen-map-drift-pr-1100-ppt` | Screen-map drift: PR #1100 modified ppt-web App.tsx (FileDisputePageRoute extraction) without screen-doc update | open | 2026-06-05 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→18:30Z) | open | 2026-06-18 |  |
| 1 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs (+404/−29 in PR #1294 Booking.com OTA retry) | open | 2026-06-18 |  |
| 1 | refactor | `repeated-churn-backend-crates-integrations-src-booking-rs` | backend/crates/integrations/src/booking.rs hit churn top-3 across runs (runs_seen=2); instability proxy. | open | 2026-06-18 |  |
| 1 | refactor | `repeated-churn-backend-crates-db-src-repositories-document-rs` | backend/crates/db/src/repositories/document.rs hit churn top-3 across runs (runs_seen=2); instability proxy. | open | 2026-06-18 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-rental-rs` | 2961 lines churn in backend/crates/db/src/repositories/rental.rs this window; runs_seen 0→1. | open | 2026-06-18 |  |
| 1 | refactor | `closed-not-merged-pr-1500` | PR #1500 closed unmerged this window — fix(api-server) IDOR on dispute/violation add_evidence (superseded) | open | 2026-06-18 |  |
| 1 | refactor | `closed-not-merged-pr-1503` | PR #1503 closed unmerged this window — fix(tests) seed_membership role arg (superseded by #1517) | open | 2026-06-18 |  |
| 1 | refactor | `closed-not-merged-pr-1504` | PR #1504 closed unmerged this window — fix(db) duplicate migration 00181 rename (superseded by #1505) | open | 2026-06-18 |  |
| 1 | refactor | `closed-not-merged-pr-1505` | PR #1505 closed unmerged this window — fix(db) rental enum text casts (superseded by #1486/#1492) | open | 2026-06-18 |  |
| 1 | refactor | `closed-not-merged-pr-1506` | PR #1506 closed unmerged this window — fix(api-server) booking-oauth seed_membership role (superseded by #1517) | open | 2026-06-18 |  |
| 1 | refactor | `closed-not-merged-pr-1511` | PR #1511 closed unmerged this window — fix(api-server) clippy lints accounting routes (superseded by #1512) | open | 2026-06-18 |  |
| 1 | triage | `untriaged-issue-1538` | Issue #1538 (no labels, OPEN): Backend `test` job is not a required check on `dev` — red-test PRs merge freely | open | 2026-06-18 |  |
| 1 | triage | `untriaged-issue-1535` | Issue #1535 (no labels, OPEN): Follow-up: cover NULL-fee booking create round-trip + dedupe rental_bookings column pr... | open | 2026-06-18 |  |
| 1 | triage | `untriaged-issue-1533` | Issue #1533 (no labels, OPEN): Follow-up: nextPageTriggerFlow in-flight race + missing multi-emission test coverage (... | open | 2026-06-18 |  |
| 1 | triage | `untriaged-issue-1532` | Issue #1532 (no labels, OPEN): Follow-up: wire useFolderTree / FOLDER_TREE_QUERY_KEY into the document screens (PR #1... | open | 2026-06-18 |  |
| 1 | triage | `untriaged-issue-1531` | Issue #1531 (no labels, OPEN): Follow-up: add regression tests for draft flush-on-unmount + watch-subscription cleanu... | open | 2026-06-18 |  |
| 1 | triage | `untriaged-issue-1527` | Issue #1527 (no labels, OPEN): Follow-up: add behavioral cross-user RLS isolation test for developer_oauth_apps / dev... | open | 2026-06-18 |  |
| 1 | triage | `untriaged-issue-1524` | Issue #1524 (no labels, OPEN): Follow-up: strengthen idempotency test to assert preserved first-view timestamp (PR #1... | open | 2026-06-18 |  |
| 1 | triage | `untriaged-issue-1523` | Issue #1523 (no labels, OPEN): Follow-up: rate-limit / lockout on MFA recovery-code verify endpoint (PR #1467) | open | 2026-06-18 |  |
| 1 | triage | `untriaged-issue-1522` | Issue #1522 (no labels, OPEN): Follow-up: accounting UI bypasses shared API auth interceptor after @hey-api migration... | open | 2026-06-18 |  |
| 1 | triage | `untriaged-issue-1521` | Issue #1521 (no labels, OPEN): Follow-up: payment-matching UI shipped in wrong app, with broken auth + no i18n/tests ... | open | 2026-06-18 |  |
| 1 | triage | `untriaged-issue-1520` | Issue #1520 (no labels, OPEN): Follow-up: wire preference-aware push dispatch-target selection to real user preferenc... | open | 2026-06-18 |  |
| 1 | triage | `untriaged-issue-1519` | Issue #1519 (no labels, OPEN): Follow-up: add XXE/DTD regression-guard test + namespace-prefix coverage for inbound O... | open | 2026-06-18 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-sensor-rs` | Churn hotspot: backend/crates/db/src/repositories/sensor.rs (+248/-86 in PR #1321/#1322 PAP-151 re-land + fmt) | open | 2026-06-12 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-10 03:05Z→18:30Z) | open | 2026-06-10 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-06-10 03:05Z→18:30Z) | open | 2026-06-10 |  |
...
| 1 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despite metric=53 | open | 2026-06-07 |  |
...
| 0 | dx | `lag-warning-2026-06-18` | Routine last ran 2026-06-16T03:25:00Z — 46h gap; > 36h threshold. | open | 2026-06-18 |  |

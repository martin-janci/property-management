# Backlog of vectors
<sub>Last regenerated: 2026-08-21 10:41 UTC by routine</sub>
...
| 3 | bug | `code-review-api-core-email-action-stub-drops-mail` | api-core workflow EmailExecutor is a stub — commented-out send, ActionResult:... | ready | 2026-08-21 | [plan](plans/code-review-api-core-email-action-stub-drops-mail.md) |
| 3 | bug | `code-review-api-core-notif-action-stub-noop` | api-core workflow NotificationExecutor is a stub — no NotificationService cal... | ready | 2026-08-21 | [plan](plans/code-review-api-core-notif-action-stub-noop.md) |
...
| 2 | bug | `code-review-api-core-announcement-roles-legacy-membership` | api-core announcement scheduler resolves target roles via legacy organization... | open | 2026-08-21 |  |
| 2 | bug | `code-review-api-core-osrng-expect-panic-auth-paths` | api-core auth/oauth paths .expect() OsRng — process panic under EGD/entropy s... | open | 2026-08-21 |  |
| 2 | bug | `code-review-api-core-syndication-stub-never-called` | api-core syndication process_syndication_job has zero callers + stubbed body ... | open | 2026-08-21 |  |
| 2 | bug | `code-review-api-core-voice-contact-mgr-fake-email` | api-core voice_commands action_contact_manager returns fabricated manager@exa... | open | 2026-08-21 |  |
| 2 | bug | `code-review-api-core-voice-facility-contact-fabricated-success` | api-core voice_commands action_book_facility + contact_manager return success... | open | 2026-08-21 |  |
| 2 | bug | `code-review-api-handlers-financial-error-swallow` | api-handlers financial unit-ledger handler collapses Err(e) into Ok(Json{rece... | open | 2026-08-21 |  |
| 2 | security | `code-review-api-handlers-list-limit-unclamped` | api-handlers: multiple list handlers forward user-controlled `limit` to SQL L... | open | 2026-08-21 |  |
| 2 | bug | `code-review-ppt-web-core-api-401-onunauthorized-unwired` | ppt-web-core api.ts onUnauthorized callback never invoked on 401 — refresh qu... | open | 2026-08-21 |  |
| 2 | bug | `code-review-ppt-web-ui-ai-chat-delete-swallows-err` | ppt-web-ui useAiChat useDeleteSession awaits fetch without response.ok check ... | open | 2026-08-21 |  |
| 2 | bug | `code-review-ppt-web-ui-ai-chat-ocr-fetch-no-auth` | ppt-web-ui useAiChat OCR fetch is a bare fetch() with no auth header — 401 on... | open | 2026-08-21 |  |
| 2 | bug | `code-review-ppt-web-ui-dsa-download-no-onsuccess` | ppt-web-ui DsaReportsPage download mutation has no onSuccess/onError — silent... | open | 2026-08-21 |  |
| 2 | bug | `code-review-ppt-web-ui-moderation-prompt-cast` | ppt-web-ui ContentModerationPage handleTakeAction casts prompt() output witho... | open | 2026-08-21 |  |
| 2 | bug | `code-review-ppt-web-ui-moderation-prompt-cast-unvalidated` | ppt-web-ui ContentModerationPage + AmlDashboardPage prompt() cast without val... | open | 2026-08-21 |  |
| 2 | bug | `code-review-reality-web-import-mutations-silent-fail` | reality-web Epic 46 agency-import mutations fire without onError — every stat... | open | 2026-08-21 |  |
| 2 | security | `code-review-reality-web-sso-callback-error-passthrough` | reality-web SSO callback renders raw searchParams `error_description` — refle... | open | 2026-08-21 |  |
...
| 1 | bug | `code-review-api-core-delay-to-duration-mul-overflow` | api-core workflow delay action: DelayConfig::to_duration u64 * unit factor ca... | open | 2026-08-21 |  |
| 1 | bug | `code-review-mobile-native-kmp-formatprice-minor-unit-contract` | mobile-native-kmp FormatUtils.formatPrice minor-unit contract mismatch — disp... | open | 2026-08-21 |  |
| 1 | bug | `code-review-mobile-native-kmp-ssoinitiation-callback-unencoded` | mobile-native-kmp SSO initiation passes callback URL unencoded — URL injectio... | open | 2026-08-21 |  |
| 1 | bug | `code-review-ppt-web-core-api-default-export-stale-singleton` | ppt-web-core api.ts default export is a stale singleton — mutations against r... | open | 2026-08-21 |  |
| 1 | bug | `code-review-ppt-web-core-refresh-queue-never-invoked` | ppt-web-core AuthContext token-refresh queue never invoked — every concurrent... | open | 2026-08-21 |  |
| 1 | bug | `code-review-ppt-web-ui-ai-chat-querykey-paging` | ppt-web-ui useAiChat queryKey ignores limit/offset — pagination collapses cac... | open | 2026-08-21 |  |
| 1 | refactor | `code-review-ppt-web-ui-compliance-hardcoded-i18n` | ppt-web-ui compliance pages (AML/DSA) hardcode English status/labels — sk/cs/... | open | 2026-08-21 |  |
| 1 | refactor | `code-review-ppt-web-ui-dsa-reports-i18n` | ppt-web-ui DsaReportsPage status strings hardcoded English — sk/cs/de locales... | open | 2026-08-21 |  |
| 1 | refactor | `code-review-ppt-web-ui-registry-confirm-i18n` | ppt-web-ui RegistryPage destructive/approve confirmations hardcoded English —... | open | 2026-08-21 |  |
| 1 | refactor | `code-review-reality-web-listinggrid-empty-i18n` | reality-web ListingGrid empty-state has no i18n — search-results grid always ... | open | 2026-08-21 |  |
| 1 | dx | `stalled-review-pr-2744` | stalled review: PR #2744 fix(dispatcher) un-wedge oversize-archive push (#1162) + close retry-remint | needs-human-judgement | 2026-08-21 |  |

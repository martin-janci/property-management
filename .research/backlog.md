# Backlog of vectors
<sub>Last regenerated: 2026-06-26 04:17 UTC by routine</sub>
...
| 3 | bug | `unchecked-todo-pr-1768` | PR #1768 merged with unchecked TODO checkboxes — follow-up review | open | 2026-06-26 |  |
...
| 2 | test-gap | `unchecked-todo-pr-1703` | PR #1703 merged with unchecked TODO checkboxes — follow-up review | open | 2026-06-26 |  |
| 2 | test-gap | `unchecked-todo-pr-1705` | PR #1705 merged with unchecked TODO checkboxes — follow-up review | open | 2026-06-26 |  |
| 2 | test-gap | `unchecked-todo-pr-1709` | PR #1709 merged with unchecked TODO checkboxes — follow-up review | open | 2026-06-26 |  |
| 2 | dx | `unchecked-todo-pr-1844` | PR #1844 merged with unchecked TODO checkboxes — follow-up review | open | 2026-06-26 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05.. | done | 2026-06-26 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-10 0.. | done | 2026-06-26 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-06-10 03:.. | done | 2026-06-26 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-forms-rs` | Churn hotspot: backend/servers/api-server/src/routes/forms.rs touched 2x since 2026-06-12 (window 2026-06-12.. | done | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-iot-rs` | Churn hotspot: backend/servers/api-server/src/routes/iot.rs (+278/-403 in PR #1321/#1322 PAP-151 re-land + f.. | done | 2026-06-26 |  |

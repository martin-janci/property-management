...
| 3 | bug | `code-review-reality-web-listing-card-locale-loss` | reality-web ListingCard uses next/link, dropping locale prefix on every card click | ready | 2026-08-23 | [plan](plans/code-review-reality-web-listing-card-locale-loss.md) |
...
| 2 | bug | `code-review-reality-server-sso-sessions-unbounded-map` | reality-server PendingSsoSession in-memory map grows unbounded under abandoned SSO flows — DoS pivot | open | 2026-08-23 |  |
| 2 | bug | `code-review-reality-server-drainer-mark-fail-redeliver` | reality-server search_alert_drainer redelivers already-sent alerts when mark_search_alert_notified f | open | 2026-08-23 |  |
| 2 | bug | `code-review-reality-web-language-switcher-hardcoded-aria` | reality-web LanguageSwitcher aria-labels are hardcoded English across all six locales | open | 2026-08-23 |  |
| 2 | bug | `code-review-reality-web-category-cards-missing-key` | reality-web CategoryCards uses missing i18n key browseByTypeSubtitle with fake defaultValue option | open | 2026-08-23 |  |
...
| 1 | bug | `code-review-reality-server-url-validator-cgnat-gap` | reality-server ipv4_forbidden_reason omits CGNAT / TEST-NET / benchmarking ranges — SSRF defense-in- | open | 2026-08-23 |  |
| 1 | bug | `code-review-reality-web-listings-count-plural-loss` | reality-web CategoryCards passes preformatted string to ICU count, breaking Slavic plural + locale-a | open | 2026-08-23 |  |

...
| 2 | bug | `code-review-api-handlers-migration-export-mock-url` | api-handlers: migration export handlers persist hardcoded mock URL as file_path; download returns un | open | 2026-08-13 |  |
...
| 1 | bug | `code-review-reality-web-agency-errorstate-i18n` | frontend/apps/reality-web/src/components/agency/AgencyErrorStates.tsx — file uses useTranslations fo | open | 2026-08-11 |  |
| 1 | bug | `code-review-reality-web-realtor-mgmt-i18n` | frontend/apps/reality-web/src/components/agency/RealtorManagement.tsx — component DOES use useTransl | open | 2026-08-11 |  |
| 1 | bug | `code-review-reality-web-comparison-view-i18n` | frontend/apps/reality-web/src/components/comparison/ComparisonView.tsx — component imports NO useTra | open | 2026-08-11 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-07-01 10:19 UTC by routine</sub>
...
| 2 | refactor | `refactor-integration-merge-pr-1955` | PR #1955 consolidated 22 reviewed/compiling PRs onto one integration branch (~90KB diff) — elevated regression surface | open | 2026-07-01 |  |
| 2 | test-gap | `test-gap-ci-not-running-pr-1993` | PR #1993 (fix messaging unread-count soft-delete) shipped with regression test that never runs in CI (#1998) | open | 2026-07-01 |  |
| 2 | test-gap | `test-gap-coverage-overstated-finance` | Finance test coverage overstated: ignored/500-tolerant tests counted as done (#1997/#2001) | open | 2026-07-01 |  |
...
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new regressio... | open | 2026-06-11 |  |
...
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression test for th... | open | 2026-06-11 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixed in PR... | open | 2026-06-11 |  |
...
| 1 | bug | `code-review-mobile-rn-deeplink-init-unhandled` | useDeepLinkRouting.ts:27-36 — initialize() re-runs on onNavigate identity change + void promise with no .catch → dupl... | open | 2026-06-16 |  |
| 1 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcoded MOCK... | open | 2026-06-16 |  |
| 1 | test-gap | `screen-map-drift-pr-1418-ppt` | PR #1418 touched routes/** (faults.route.test.tsx) without updating docs/screens/ppt/* — heuristic, test-file fix | open | 2026-06-16 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-financial-rs` | Churn hotspot: backend/crates/db/src/repositories/financial.rs (4 commits this window) | open | 2026-07-01 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-messaging-rs` | Churn hotspot: backend/servers/api-server/src/routes/messaging.rs (4 commits this window) | open | 2026-07-01 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-rentals-rs` | Churn hotspot: backend/servers/api-server/src/routes/rentals.rs (3 commits this window) | open | 2026-07-01 |  |
| 1 | dx | `dx-stalled-review-pr-1797` | Stalled review: PR #1797 (fix OCR unauth + rental guest PII manager-gate) — 7d draft, security scope | open | 2026-07-01 |  |
| 1 | dx | `dx-stalled-review-pr-1812` | Stalled review: PR #1812 (churn-hotspot reality_portal.rs module split) — 7d draft, no reviewDecision | open | 2026-07-01 |  |
| 1 | triage | `triage-issue-1997` | Issue #1997 (no labels): follow-up: finance test coverage overstated (from-merged-review) | open | 2026-07-01 |  |
| 1 | triage | `triage-issue-1999` | Issue #1999 (no labels): follow-up: currency serialization bug (from-merged-review) | open | 2026-07-01 |  |
| 1 | triage | `triage-issue-2000` | Issue #2000 (no labels): follow-up: alert drop (from-merged-review) | open | 2026-07-01 |  |
...
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injec... | dropped | 2026-06-03 |  |
...
| 0 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despite metri... | dropped | 2026-06-07 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→18:30Z) | dropped | 2026-06-10 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-10 03:05Z→18:... | dropped | 2026-06-10 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-06-10 03:05Z→18:30Z) | dropped | 2026-06-10 |  |
...
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-sensor-rs` | Churn hotspot: backend/crates/db/src/repositories/sensor.rs (+248/-86 in PR #1321/#1322 PAP-151 re-land + fmt) | dropped | 2026-06-12 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-api-ecosystem-rs` | Churn hotspot: backend/servers/api-server/src/routes/api_ecosystem.rs (+106/−27 in PR #1293 PAP-171; second touch in ... | dropped | 2026-06-12 |  |
...
| 0 | dx | `closed-not-merged-pr-1274` | PR #1274 (cargo-minor-patch group, /backend, 9 updates) closed unmerged — superseded by #1313 after auto-rebase fix l... | dropped | 2026-06-12 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-tests-form-rls-repo-tests-rs` | Churn hotspot: backend/crates/db/tests/form_rls_repo_tests.rs touched 2x since 2026-06-12 (window 2026-06-12→2026-06-13) | dropped | 2026-06-13 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-tests-reserve-funds-cross-org-idor-tests-rs` | Churn hotspot: backend/servers/api-server/tests/reserve_funds_cross_org_idor_tests.rs touched 2x since 2026-06-12 (wi... | dropped | 2026-06-13 |  |
| 0 | dx | `dx-stalled-review-pr-988` | Stalled review: PR #988 (Epic: reusable Playwright E2E framework + sitemap FlowRunner) open 10d, no reviewDecision | dropped | 2026-06-13 |  |
| 0 | triage | `triage-issue-1331` | Issue #1331 (no labels, OPEN): Backend `test` job red/hanging on dev base — blocks the entire backend merge pipeline | dropped | 2026-06-13 |  |
...
| 0 | refactor | `code-review-api-core-osrng-expect` | crypto.rs:127 SysRng.try_fill_bytes(...).expect() panics if OS CSPRNG errors during integration-credential encrypt | dropped | 2026-06-15 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-forms-rs` | Churn hotspot: backend/servers/api-server/src/routes/forms.rs touched 2x since 2026-06-12 (window 2026-06-12→2026-06-13) | dropped | 2026-06-16 |  |
...
| 0 | dx | `dx-stalled-review-pr-1179` | PR #1179 (docs(epics) catalog backfill for 37 mounted-but-undocumented backend modules) — stalled at 7d, no reviewDec... | dropped | 2026-06-16 |  |
...
| 0 | test-gap | `test-gap-screen-map-drift-pr-922-ppt` | Screen-map drift: PR #922 modified ppt-web App.tsx (dev-review rounds 1-5 fixes) without a docs/screens/ppt update | dropped | 2026-06-16 |  |

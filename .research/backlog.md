# Backlog of vectors
<sub>Last regenerated: 2026-06-25 12:30 UTC by routine</sub>
...
| 3 | bug | `code-review-mobile-rn-report-fault-fake-submit` | ReportFaultScreen.tsx handleSubmit() fakes API call with setTimeout(1500) — fault reports never reac | done | 2026-06-25 | [plan](plans/_archive/code-review-mobile-rn-report-fault-fake-submit.md) |
| 3 | bug | `revert-pr-1713` | Revert PR #1713 (rolled back #1690 delegation feature) | open | 2026-06-25 |  |
...
| 3 | bug | `code-review-reality-web-share-comparison-404` | Reality-web ComparisonUrlHandler hits non-existent /api/listings/${id} — every shared comparison URL | ready | 2026-06-14 | [plan](plans/code-review-reality-web-share-comparison-404.md) |
...
| 3 | security | `security-llm-doc-idor` | IDOR: ai.rs LLM-doc handlers publish/list/get any tenant's listing descriptions & photo enhancements | ready | 2026-06-01 | [plan](plans/security-llm-doc-idor.md) |
...
| 2 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) rend | open | 2026-06-25 |  |
| 2 | bug | `unchecked-todo-pr-1705` | Unchecked TODOs in PR #1705 (feat(faults): fire notifications on every fault lifecycle ev) | open | 2026-06-25 |  |
| 2 | bug | `unchecked-todo-pr-1709` | Unchecked TODOs in PR #1709 (feat(scheduler): payment reminders + auto-overdue transition) | open | 2026-06-25 |  |
| 2 | bug | `unchecked-todo-pr-1768` | Unchecked TODOs in PR #1768 (fix(messaging): camelCase wire contract for thread/message/p) | open | 2026-06-25 |  |
| 2 | bug | `unchecked-todo-pr-1703` | Unchecked TODOs in PR #1703 (feat(api-server): gap-sweep Epic 12 — meter reminders + OCR ) | open | 2026-06-25 |  |
| 2 | bug | `unchecked-todo-pr-1717` | Unchecked TODOs in PR #1717 (feat(financial): income statement, balance sheet, cash flow ) | open | 2026-06-25 |  |
| 2 | bug | `unchecked-todo-pr-1685` | Unchecked TODOs in PR #1685 (feat(ppt-web): real-time IoT dashboard via BIT-145 WebSocket) | open | 2026-06-25 |  |
| 2 | bug | `unchecked-todo-pr-1723` | Unchecked TODOs in PR #1723 (fix(financial): rustfmt compliance for financial reports rou) | open | 2026-06-25 |  |
...
| 2 | test-gap | `screen-map-drift-pr-1418-ppt` | PR #1418 touched routes/** (faults.route.test.tsx) without updating docs/screens/ppt/* — heuristic,  | open | 2026-06-16 |  |
| 2 | bug | `code-review-mobile-rn-deeplink-init-unhandled` | useDeepLinkRouting.ts:27-36 — initialize() re-runs on onNavigate identity change + void promise with | open | 2026-06-16 |  |
...
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1288-webhook-rls` | Webhook handlers RLS migration (PR #1288, PAP-170) shipped without a new regression test for repo-la | open | 2026-06-11 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped withou | open | 2026-06-11 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regre | open | 2026-06-11 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and w | open | 2026-06-11 |  |
...
| 1 | bug | `code-review-mobile-native-kmp-deeplink-token-not-url-decoded` | DeepLinkRouter skips URL-decoding while Android Uri.getQueryParameter decodes — SSO tokens diverge p | open | 2026-06-25 |  |
...
| 1 | test-gap | `test-gap-screen-map-drift-pr-1085-reality` | Screen-map drift: PR #1085 modified reality-web listing detail metadata + page without screen-doc up | open | 2026-06-25 |  |
| 1 | test-gap | `test-gap-screen-map-drift-pr-1100-ppt` | Screen-map drift: PR #1100 modified ppt-web App.tsx (FileDisputePageRoute extraction) without screen | open | 2026-06-25 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06- | done | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026 | done | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-0 | done | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs (+404/−29 in PR #1294 Booking.com OTA retr | open | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-iot-rs` | Churn hotspot: backend/servers/api-server/src/routes/iot.rs (+278/-403 in PR #1321/#1322 PAP-151 re- | done | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-reserve-funds-rs` | Churn hotspot: backend/servers/api-server/src/routes/reserve_funds.rs (+228/-255 in PR #1321 PAP-151 | done | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-sensor-rs` | Churn hotspot: backend/crates/db/src/repositories/sensor.rs (+248/-86 in PR #1321/#1322 PAP-151 re-l | done | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-forms-rs` | Churn hotspot: backend/servers/api-server/src/routes/forms.rs touched 2x since 2026-06-12 (window 20 | done | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-tests-form-rls-repo-tests-rs` | Churn hotspot: backend/crates/db/tests/form_rls_repo_tests.rs touched 2x since 2026-06-12 (window 20 | done | 2026-06-25 |  |
...
| 1 | refactor | `code-review-api-core-osrng-expect` | crypto.rs:127 SysRng.try_fill_bytes(...).expect() panics if OS CSPRNG errors during integration-cred | done | 2026-06-25 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-financial-rs` | Churn hotspot — backend/servers/api-server/src/routes/financial.rs (2380 lines this run; candidate f | open | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-buildings-rs` | Churn hotspot — backend/servers/api-server/src/routes/buildings.rs (2347 lines this run; candidate f | open | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-integrations-sync-rs` | Churn hotspot — backend/servers/api-server/src/routes/integrations/sync.rs (2293 lines this run; can | open | 2026-06-25 |  |
| 1 | dx | `closed-not-merged-pr-1720` | PR #1720 closed unmerged — fix(ppt-web): add Leases nav link + home tile (#977) — super | open | 2026-06-25 |  |
| 1 | dx | `closed-not-merged-pr-1749` | PR #1749 closed unmerged — fix(mobile): exclude app.config.icon.test.ts from tsc — supe | open | 2026-06-25 |  |
| 1 | dx | `closed-not-merged-pr-1727` | PR #1727 closed unmerged — fix(ci): unblock backend gate — superseded by #1721 + #1728 | open | 2026-06-25 |  |
| 1 | dx | `closed-not-merged-pr-1698` | PR #1698 closed unmerged — feat(epic-3): story 3.2 - unit management UI (BIT-188) — sup | open | 2026-06-25 |  |
| 1 | dx | `closed-not-merged-pr-1634` | PR #1634 closed unmerged — [PM #1627] saved-search alerts list: signal truncation past  | open | 2026-06-25 |  |
| 1 | test-gap | `test-gap-screen-map-drift-pr-922-ppt` | Screen-map drift: PR #922 modified ppt-web App.tsx (dev-review rounds 1-5 fixes) without a docs/scre | open | 2026-06-16 |  |
...
| 1 | dx | `dx-stalled-review-pr-1179` | PR #1179 (docs(epics) catalog backfill for 37 mounted-but-undocumented backend modules) — stalled at | open | 2026-06-16 |  |
| 1 | triage | `triage-issue-1380` | Issue #1380 (no labels, OPEN): Dispatcher stale gap-scan buffer + Tier-2 escalation endpoint misconf | open | 2026-06-15 |  |
...
| 0 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work  | dropped | 2026-06-25 |  |
...
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK | dropped | 2026-06-25 |  |

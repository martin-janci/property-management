...
| 3 | security | `code-review-api-handlers-share-pw-no-throttle` | SECURITY: public document-share password endpoint has no throttle — attacker with a share token can  | open | 2026-08-16 |  |
...
| 2 | refactor | `code-review-ppt-web-ui-moderation-no-i18n` | ppt-web-ui: ContentModerationPage uses window.prompt/alert with hardcoded English for DSA enforcemen | open | 2026-08-16 |  |
| 2 | bug | `code-review-ppt-web-ui-moderation-fabricated-context` | ppt-web-ui: ContentModerationPage fabricates content_owner.previous_violations=0 + report_source='us | open | 2026-08-16 |  |
| 2 | bug | `code-review-ppt-web-ui-createfault-mock-ai` | ppt-web-ui: CreateFaultPage ships a HARDCODED mock AI suggestion instead of calling useRequestAiSugg | open | 2026-08-16 |  |
| 2 | bug | `code-review-api-handlers-share-log-proxy-ip` | shares.rs audit log records TCP peer (proxy IP) instead of real client — audit trail useless behind  | open | 2026-08-16 |  |
...
| 1 | refactor | `code-review-reality-web-agency-errorstate-i18n` | reality-web: AgencyErrorStates.tsx no-agency empty/error state hardcoded English — inconsistent with | open | 2026-08-16 |  |
| 1 | refactor | `code-review-reality-web-realtor-mgmt-i18n` | reality-web: RealtorManagement.tsx destructive confirm-remove modal + subtitle hardcoded English — n | open | 2026-08-16 |  |
| 1 | refactor | `code-review-reality-web-comparison-view-i18n` | reality-web: ComparisonView.tsx hardcodes English UI + toast strings on a 4-locale portal — Epic 51  | open | 2026-08-16 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-06-28 08:30 UTC by routine</sub>
...
| 3 | security | `unchecked-todo-pr-1861` | Unchecked PR-body checklist on #1861 (regional-compliance endpoints) — followup #1906 confirmed material gaps | ready | 2026-06-28 | [plan](plans/unchecked-todo-pr-1861.md) |
...
| 2 | refactor | `unchecked-todo-pr-1859` | Unchecked PR-body checklist on #1859 (tenant-migration endpoints) — followup #1905 confirmed material gaps | open | 2026-06-28 |  |
...
| 1 | refactor | `churn-hotspot-frontend-packages-sitemap-src-data-api-server-index-ts` | Churn hotspot: frontend/packages/sitemap/src/data/api-server/index.ts (3 touches in 12d) | open | 2026-06-28 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-state-rs` | Churn hotspot: backend/servers/api-server/src/state.rs (3 touches in 12d) | open | 2026-06-28 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-migration-rs` | Churn hotspot: backend/servers/api-server/src/routes/migration.rs (3 touches in 12d) | open | 2026-06-28 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-mod-rs` | Churn hotspot: backend/crates/db/src/repositories/mod.rs (3 touches in 12d) | open | 2026-06-28 |  |
| 1 | triage | `untriaged-issue-1906` | Issue #1906: regional-compliance quorum lookup is dead code + missing role checks (no label) | open | 2026-06-28 |  |
| 1 | triage | `untriaged-issue-1905` | Issue #1905: tenant-migration endpoints duplicate migration number + import/export gaps (no label) | open | 2026-06-28 |  |
| 1 | triage | `untriaged-issue-1791` | Issue #1791: message attachments link trusts client-supplied file_key (IDOR) (no label) | open | 2026-06-28 |  |
| 1 | triage | `untriaged-issue-1764` | Issue #1764: Stripe Checkout hardening — idempotency + webhook gaps (no label) | open | 2026-06-28 |  |
| 1 | triage | `untriaged-issue-1680` | Issue #1680: research dispatcher cron environment can't run core pipeline (no label) | open | 2026-06-28 |  |
...
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1288-webhook-rls` | Webhook handlers RLS migration (PR #1288, PAP-170) shipped without a new regression test for repo-layer method | open | 2026-06-11 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new re | open | 2026-06-11 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression test | open | 2026-06-11 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixe | open | 2026-06-11 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-emergency-rs` | Churn hotspot: 1021 lines changed in backend/servers/api-server/src/routes/emergency.rs (window 2026 | dropped | 2026-06-28 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-enhanced-tenant-screening-rs` | Churn hotspot: 709 lines changed in backend/servers/api-server/src/routes/enhanced_tenant_screening. | dropped | 2026-06-28 |  |
...
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-10 03: | dropped | 2026-06-28 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-06-10 03:05 | dropped | 2026-06-28 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-reserve-funds-rs` | Churn hotspot: backend/servers/api-server/src/routes/reserve_funds.rs (+228/-255 in PR #1321 PAP-151 re-land) | dropped | 2026-06-28 |  |

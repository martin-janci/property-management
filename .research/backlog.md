# Backlog of vectors
<sub>Last regenerated: 2026-07-14 20:15 UTC by routine</sub>
...
| 3 | test-gap | `code-review-mobile-rn-nfc-no-tests` | Mobile RN NFC credential/access modules (security-critical) have zero test coverage | open | 2026-07-14 |  |
| 3 | security | `code-review-api-handlers-news-articles-idor` | Cross-tenant IDOR + data-loss in news_articles handlers (raw pool, no org scope) | deferred | 2026-07-14 |  |
...
| 2 | bug | `code-review-ppt-web-core-dashboard-unguarded` | ppt-web manager/resident dashboards routed without ProtectedRoute — role-gate hole | open | 2026-07-14 |  |
| 2 | bug | `code-review-ppt-web-core-units-fetch-noauth` | ppt-web person-months units fetch missing Bearer token — silent 401 on auth-gated endpoint | open | 2026-07-14 |  |
| 2 | test-gap | `code-review-mobile-rn-deeplink-mgr-untested` | Mobile RN DeeplinkManager (auth-token bridging) untested — critical bridge with zero coverage | open | 2026-07-14 |  |
| 2 | bug | `code-review-mobile-rn-dashboard-no-err-ui` | Mobile RN dashboard silently renders zero data on API errors (no error UI) | open | 2026-07-14 |  |
| 2 | bug | `code-review-mobile-rn-announcements-i18n` | Mobile RN AnnouncementsScreen hardcodes English strings — no i18n on user-facing copy | open | 2026-07-14 |  |
...
| 1 | bug | `code-review-ppt-web-core-sessions-cast` | ppt-web SessionsPage performs redundant double-cast, obscuring type-safety | open | 2026-07-14 |  |
| 1 | bug | `code-review-mobile-rn-onboarding-untested` | Mobile RN onboarding flow untested — first-run experience has zero coverage | open | 2026-07-14 |  |
| 1 | bug | `code-review-mobile-rn-meter-console-error` | Mobile RN meter screen throws unhandled console.error on invalid reading input | open | 2026-07-14 |  |
| 1 | bug | `code-review-mobile-rn-fault-category-i18n` | Mobile RN fault category labels hardcoded English — misses i18n contract | open | 2026-07-14 |  |
| 1 | test-gap | `code-review-mobile-rn-voice-module-no-tests` | Mobile RN voice module has zero tests despite being a mutating user-input surface | open | 2026-07-14 |  |
| 1 | bug | `code-review-mobile-rn-queue-swallow-error` | Mobile RN offline queue swallows errors, silently drops actions on transient failures | open | 2026-07-14 |  |

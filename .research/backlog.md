# Backlog of vectors
<sub>Last regenerated: 2026-06-27 10:30 UTC by routine</sub>
...
| 3 | bug | `revert-pr-1713` | Revert: PR #1713 reverted #1690 (delegation FE re-add) — CEO ruled delegation stays retired per BIT-198/BIT-213; FE was  | done | 2026-06-27 |  |
...
| 2 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcoded MOCK_*  | done | 2026-06-27 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs (+404/−29 in PR #1294 Booking.com OTA retry) | done | 2026-06-27 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-form-rs` | Churn hotspot: 53 lines in backend/crates/db/src/repositories/form.rs (PR #1379 #1332 unblock) | done | 2026-06-27 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-rental-rs` | Churn hotspot: backend/crates/db/src/repositories/rental/rs — top-3 line-churn this run: 2933 lines changed (window 2026 | open | 2026-06-27 |  |
| 1 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-mod-rs` | Churn hotspot: backend/crates/integrations/src/booking/mod/rs — top-3 line-churn this run: 2818 lines changed (window 20 | open | 2026-06-27 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-auth-rs` | Churn hotspot: backend/servers/api/server/src/routes/auth/rs — top-3 line-churn this run: 2648 lines changed (window 202 | open | 2026-06-27 |  |
| 1 | refactor | `repeated-churn-backend-servers-api-server-src-routes-auth-rs` | Repeated churn: backend/servers/api/server/src/routes/auth/rs | open | 2026-06-27 |  |
| 1 | dx | `closed-not-merged-pr-1698` | Closed-not-merged: feat(epic-3): story 3.2 - unit management UI (BIT-188) — closed unmerged 2026-06-22 — likely supersed | open | 2026-06-27 |  |
| 1 | dx | `closed-not-merged-pr-1720` | Closed-not-merged: fix(ppt-web): add Leases nav link + home tile (#977) — closed unmerged 2026-06-23 — review notes both | open | 2026-06-27 |  |
| 1 | dx | `closed-not-merged-pr-1727` | Closed-not-merged: fix(ci): unblock backend gate — organizations fmt + notification_event RLS baseline — closed unmerged | open | 2026-06-27 |  |
| 1 | dx | `closed-not-merged-pr-1749` | Closed-not-merged: fix(mobile): exclude app.config.icon.test.ts from tsc typecheck — closed unmerged 2026-06-23 — supers | open | 2026-06-27 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-tests-reserve-funds-cross-org-idor-tests-rs` | Churn hotspot: backend/servers/api-server/tests/reserve_funds_cross_org_idor_tests.rs touched 2x since 2026-06-12 (windo | dropped | 2026-06-13 |  |

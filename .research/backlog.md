# Backlog of vectors
<sub>Last regenerated: 2026-07-29 03:23 UTC by routine</sub>
...
| 2 | test-gap | `screen-map-drift-pr-2549-reality` | screen-map drift: PR #2549 touched reality-web/app/api/layout-revalidate/route.ts w/o docs/screens/reality/ | open | 2026-07-29 |  |
| 2 | test-gap | `screen-map-drift-pr-2478-reality` | screen-map drift: PR #2478 touched reality-web/app/api/layout-revalidate/route.ts w/o docs/screens/reality/ | open | 2026-07-29 |  |
| 2 | bug | `code-review-ppt-web-core-authctx-init-stale-role` | AuthContext init bypasses refreshTokenInternal → stale role on cold-boot refresh (#574 fix gap) | done | 2026-07-29 |  |
| 2 | security | `code-review-api-handlers-resolved-leaks-internal-errors` | layout/resolved.rs leaks raw sqlx/serde error text to client — hardening sweep skipped this file | ready | 2026-07-29 | [plan](plans/code-review-api-handlers-resolved-leaks-internal-errors.md) |
...
| 1 | refactor | `code-review-api-handlers-resolved-unvalidated-tenant` | layout/resolved.rs uses unvalidated TenantExtractor for org_id + nil-org guard while sibling tenant.rs migrated to rls.tenant_id() | open | 2026-07-29 |  |
| 1 | bug | `code-review-api-handlers-admin-401-coerced-403` | layout/admin.rs coerces extract_super_admin_token 401 into 403 across all 11 handlers — breaks SDK token-refresh | open | 2026-07-29 |  |
| 1 | refactor | `churn-hotspot-layout-webhook-rs-2026-07-29` | Churn hotspot: backend/servers/api-server/src/routes/layout/webhook.rs — 217 lines changed this run (PR #2478 timestamped HMAC + PR #2549 delivery_id) | open | 2026-07-29 |  |
| 1 | refactor | `churn-hotspot-layout-tenant-rs-2026-07-29` | Churn hotspot: backend/servers/api-server/src/routes/layout/tenant.rs — 262 lines changed this run (PR #2478 hardening sweep) | open | 2026-07-29 |  |
| 1 | refactor | `churn-hotspot-layout-admin-rs-2026-07-29` | Churn hotspot: backend/servers/api-server/src/routes/layout/admin.rs — 240 lines changed this run (PR #2478 hardening + PR #2549 delivery_id wiring) | open | 2026-07-29 |  |
...
| 1 | triage | `triage-closed-not-merged-pr-2489` | PR #2489 closed unmerged: dependabot npm-minor-patch (5→4 update group) superseded by #2491 | open | 2026-07-23 |  |

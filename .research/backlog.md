# Backlog of vectors
<sub>Last regenerated: 2026-07-18 03:09 UTC by routine</sub>
...
| 2 | bug | `code-review-mobile-rn-offline-queue-silent-dataloss` | Mobile-rn offline queue silently drops retry-exhausted mutations (5xx/network) with no dead-letter store | open | 2026-07-18 |  |
...
| 1 | refactor | `churn-hotspot-frontend-packages-sitemap-src-json-generate-ts` | Churn hotspot: frontend/packages/sitemap/src/json/generate.ts — 3 commits this run (PR #2395 en-json refactor, #2397 sitemap.json determinism re | open | 2026-07-18 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-services-scheduler-rs` | Churn hotspot: backend/servers/api-server/src/services/scheduler.rs — 2 commits this run (PR #2419 scheduler-RLS migration-number comment fix, #2420 m | open | 2026-07-18 |  |

...
| 3 | bug | `code-review-api-core-email-action-stub-drops-mail` | EmailExecutor logs and returns success without invoking EmailService | ready | 2026-08-21 | [plan](plans/code-review-api-core-email-action-stub-drops-mail.md) |
| 3 | bug | `code-review-api-core-notif-action-stub-noop` | NotificationExecutor never persists in-app notifications (workflow send-notification is a no-op) | open | 2026-08-21 |  |
| 3 | security | `code-review-api-handlers-voice-webhook-rlsconn-unreachable` | voice webhook uses non-RLS pool then wraps in RlsConn, bypassing tenant isolation | ready | 2026-08-21 | [plan](plans/code-review-api-handlers-voice-webhook-rlsconn-unreachable.md) |
...
| 2 | bug | `code-review-api-core-voice-contact-mgr-fake-email` | voice action_contact_manager fabricates a placeholder email address instead of loading manager conta | open | 2026-08-21 |  |
| 2 | bug | `code-review-ppt-web-core-authctx-no-token-expiry-check` | AuthContext trusts stored access token without expiry validation on hydrate | open | 2026-08-21 |  |
...
| 1 | refactor | `churn-hotspot-reality-portal-searches` | reality_portal/searches.rs is a churn hotspot (3 commits in 2 days) | open | 2026-08-21 |  |
| 1 | bug | `code-review-api-handlers-voice-webhook-rls-release-inconsistent` | voice webhook releases the RLS connection on some paths and leaks it on others | open | 2026-08-21 |  |

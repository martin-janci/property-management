# Backlog of vectors
<sub>Last regenerated: 2026-06-27 08:19 UTC by routine</sub>
...
| 3 | bug | `bug-unchecked-todo-pr-1468` | Unchecked TODO in merged PR — PR #1468 | open | 2026-06-27 |  |
| 3 | security | `security-unchecked-todo-pr-1507` | Unchecked TODO in merged PR — PR #1507 | open | 2026-06-27 |  |
| 3 | bug | `bug-unchecked-todo-pr-1492` | Unchecked TODO in merged PR — PR #1492 | open | 2026-06-27 |  |
| 3 | bug | `bug-revert-pr-1713` | Revert investigation: PR #1713 | open | 2026-06-27 |  |
...
| 2 | test-gap | `screen-map-drift-pr-1418-ppt` | PR #1418 touched routes/** (faults.route.test.tsx) without updating docs/screens/ppt/* — heuristic, test-file fix | done | 2026-06-27 |  |
| 2 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcoded MOCK_* arrays — no API wiring | done | 2026-06-27 |  |
| 2 | bug | `code-review-mobile-rn-deeplink-init-unhandled` | useDeepLinkRouting.ts:27-36 — initialize() re-runs on onNavigate identity change + void promise with no .catch → duplicate nav / unhandled rejection | done | 2026-06-27 |  |
| 2 | refactor | `churn-hotspot-backend/crates/db/src/repositories/document.rs` | Churn hotspot: backend/crates/db/src/repositories/document.rs | open | 2026-06-27 |  |
| 2 | refactor | `churn-hotspot-backend/servers/api-server/src/routes/aml_dsa.rs` | Churn hotspot: backend/servers/api-server/src/routes/aml_dsa.rs | open | 2026-06-27 |  |
| 2 | refactor | `churn-hotspot-backend/servers/api-server/src/routes/forms.rs` | Churn hotspot: backend/servers/api-server/src/routes/forms.rs | open | 2026-06-27 |  |
| 2 | dx | `dx-unchecked-todo-pr-1717` | Unchecked TODO in merged PR — PR #1717 | open | 2026-06-27 |  |
| 2 | dx | `dx-unchecked-todo-pr-1642` | Unchecked TODO in merged PR — PR #1642 | open | 2026-06-27 |  |
| 2 | dx | `dx-unchecked-todo-pr-1709` | Unchecked TODO in merged PR — PR #1709 | open | 2026-06-27 |  |
| 2 | dx | `dx-unchecked-todo-pr-1641` | Unchecked TODO in merged PR — PR #1641 | open | 2026-06-27 |  |
| 2 | dx | `dx-unchecked-todo-pr-1471` | Unchecked TODO in merged PR — PR #1471 | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1454-ppt` | Screen-map drift: PR #1454 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1555-ppt` | Screen-map drift: PR #1555 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1559-ppt` | Screen-map drift: PR #1559 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1610-ppt` | Screen-map drift: PR #1610 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1611-ppt` | Screen-map drift: PR #1611 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1621-ppt` | Screen-map drift: PR #1621 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1630-ppt` | Screen-map drift: PR #1630 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1641-ppt` | Screen-map drift: PR #1641 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1654-ppt` | Screen-map drift: PR #1654 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1685-ppt` | Screen-map drift: PR #1685 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1690-ppt` | Screen-map drift: PR #1690 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1694-ppt` | Screen-map drift: PR #1694 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1696-ppt` | Screen-map drift: PR #1696 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1713-ppt` | Screen-map drift: PR #1713 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1733-ppt` | Screen-map drift: PR #1733 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1737-ppt` | Screen-map drift: PR #1737 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1453-reality` | Screen-map drift: PR #1453 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1545-reality` | Screen-map drift: PR #1545 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1621-reality` | Screen-map drift: PR #1621 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1642-reality` | Screen-map drift: PR #1642 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1677-reality` | Screen-map drift: PR #1677 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1746-reality` | Screen-map drift: PR #1746 touched routes without doc update | open | 2026-06-27 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1822-reality` | Screen-map drift: PR #1822 touched routes without doc update | open | 2026-06-27 |  |
...
| 1 | bug | `code-review-mobile-native-kmp-deeplink-token-not-url-decoded` | DeepLinkRouter skips URL-decoding while Android Uri.getQueryParameter decodes — SSO tokens diverge per platform | open | 2026-06-27 |  |
| 1 | bug | `code-review-mobile-native-kmp-search-stale-response-race` | SearchScreen stale-response race — overlapping searches can clobber newer results | open | 2026-06-27 |  |
| 1 | test-gap | `test-gap-screen-map-drift-pr-1085-reality` | Screen-map drift: PR #1085 modified reality-web listing detail metadata + page without screen-doc update | open | 2026-06-27 |  |
| 1 | test-gap | `test-gap-screen-map-drift-pr-1100-ppt` | Screen-map drift: PR #1100 modified ppt-web App.tsx (FileDisputePageRoute extraction) without screen-doc update | open | 2026-06-27 |  |
| 1 | bug | `bug-risky-churn-pr-963-api-main-rs` | Risky churn: api-server main.rs security-headers wiring shipped without a middleware smoke test | open | 2026-06-27 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-959-reality-listings-pagination` | Reality-server listings pagination clamp (PR #959) shipped without a regression test for limit=-1 | open | 2026-06-27 |  |
| 1 | bug | `bug-ios-deeplink-info-plist-missing` | iOS deep-link layer dead at runtime — Info.plist missing CFBundleURLTypes + applinks entitlement | open | 2026-06-27 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1288-webhook-rls` | Webhook handlers RLS migration (PR #1288, PAP-170) shipped without a new regression test for repo-layer methods | open | 2026-06-27 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new regression test | open | 2026-06-27 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression test for the public-connection routing | open | 2026-06-27 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixed in PR #1287 | open | 2026-06-27 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-mobile-app-config-icon-test-ts` | Churn hotspot: 124 lines in frontend/apps/mobile/app.config.icon.test.ts (PR #1383 gap-85-2) | done | 2026-06-27 |  |
| 1 | refactor | `code-review-api-core-osrng-expect` | crypto.rs:127 SysRng.try_fill_bytes(...).expect() panics if OS CSPRNG errors during integration-credential encrypt | done | 2026-06-27 |  |
| 1 | refactor | `repeated-churn-backend-servers-api-server-src-routes-forms-rs` | forms.rs repeated-churn — runs_seen=2 (#1337 explicit_auto_deref + #1397 org-scope hardening) | done | 2026-06-27 |  |
| 1 | triage | `triage-closed-not-merged-pr-1749` | PR closed unmerged: PR #1749 | open | 2026-06-27 |  |
| 1 | triage | `triage-closed-not-merged-pr-1727` | PR closed unmerged: PR #1727 | open | 2026-06-27 |  |
| 1 | triage | `triage-closed-not-merged-pr-1720` | PR closed unmerged: PR #1720 | open | 2026-06-27 |  |
| 1 | triage | `triage-closed-not-merged-pr-1698` | PR closed unmerged: PR #1698 | open | 2026-06-27 |  |
| 1 | triage | `triage-closed-not-merged-pr-1647` | PR closed unmerged: PR #1647 | open | 2026-06-27 |  |
| 1 | triage | `triage-closed-not-merged-pr-1636` | PR closed unmerged: PR #1636 | open | 2026-06-27 |  |
| 1 | triage | `triage-closed-not-merged-pr-1634` | PR closed unmerged: PR #1634 | open | 2026-06-27 |  |
| 1 | triage | `triage-closed-not-merged-pr-1511` | PR closed unmerged: PR #1511 | open | 2026-06-27 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-emergency-rs` | Churn hotspot: 1021 lines changed in backend/servers/api-server/src/routes/emergency.rs (window 2026 | dropped | 2026-06-27 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-vendors-rs` | Churn hotspot: 929 lines changed in backend/servers/api-server/src/routes/vendors.rs (window 2026-06 | dropped | 2026-06-27 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-enhanced-tenant-screening-rs` | Churn hotspot: 709 lines changed in backend/servers/api-server/src/routes/enhanced_tenant_screening. | dropped | 2026-06-27 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→18:30Z) | dropped | 2026-06-27 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-10 03:05Z→18:30Z) | dropped | 2026-06-27 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-06-10 03:05Z→18:30Z) | dropped | 2026-06-27 |  |
| 0 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despite metric=53 | dropped | 2026-06-27 |  |
| 0 | refactor | `churn-hotspot-mobile-native-listing-detail-kt` | Churn hotspot: ListingDetailScreen.kt — +1279 LOC this run (gap-82-4 reality mobile favorite toggle) | dropped | 2026-06-27 |  |
| 0 | refactor | `churn-hotspot-mobile-native-search-screen-kt` | Churn hotspot: SearchScreen.kt — +1293 LOC this run (gap-82-3 reality mobile search/filters) | dropped | 2026-06-27 |  |
| 0 | refactor | `code-review-mobile-native-kmp-deeplink-android-bypasses-shared-router` | MainActivity reimplements deep-link dispatch instead of calling shared DeepLinkRouter — drift trap | dropped | 2026-06-27 |  |
| 0 | refactor | `refactor-churn-hotspot-mobile-announcements` | Churn hotspot: AnnouncementsScreen.tsx — 4 PRs this run, instability proxy | dropped | 2026-06-27 |  |
| 0 | refactor | `refactor-churn-hotspot-mobile-announcements-test` | Churn hotspot: AnnouncementsScreen.test.ts — 4 PRs this run, instability proxy | dropped | 2026-06-27 |  |
| 0 | refactor | `refactor-churn-hotspot-mobile-documents` | Churn hotspot: DocumentsScreen.tsx — 3 PRs this run | dropped | 2026-06-27 |  |
| 0 | triage | `triage-dispatcher-mcp-push-large-file-issue-1014` | Dispatcher action-list.json corruption when MCP push falls back from blocked git push | dropped | 2026-06-27 |  |
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected by deploy-server (staging/prod) | dropped | 2026-06-27 |  |
| 0 | dx | `closed-not-merged-pr-1274` | PR #1274 (cargo-minor-patch group, /backend, 9 updates) closed unmerged — superseded by #1313 after auto-rebase fix landed | dropped | 2026-06-27 |  |
| 0 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs (+404/−29 in PR #1294 Booking.com OTA retry) | dropped | 2026-06-27 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-api-ecosystem-rs` | Churn hotspot: backend/servers/api-server/src/routes/api_ecosystem.rs (+106/−27 in PR #1293 PAP-171; second touch in 24h) | dropped | 2026-06-27 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-reality-portal-rs` | Churn hotspot: backend/crates/db/src/repositories/reality_portal.rs (+59/−28 in PR #1297 PAP-142 IDOR scoping) | dropped | 2026-06-27 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-iot-rs` | Churn hotspot: backend/servers/api-server/src/routes/iot.rs (+278/-403 in PR #1321/#1322 PAP-151 re-land + fmt) | dropped | 2026-06-27 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-reserve-funds-rs` | Churn hotspot: backend/servers/api-server/src/routes/reserve_funds.rs (+228/-255 in PR #1321 PAP-151 re-land) | dropped | 2026-06-27 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-sensor-rs` | Churn hotspot: backend/crates/db/src/repositories/sensor.rs (+248/-86 in PR #1321/#1322 PAP-151 re-land + fmt) | dropped | 2026-06-27 |  |
| 0 | triage | `triage-issue-1331` | Issue #1331 (no labels, OPEN): Backend `test` job red/hanging on dev base — blocks the entire backend merge pipeline | dropped | 2026-06-27 |  |
| 0 | dx | `dx-stalled-review-pr-988` | Stalled review: PR #988 (Epic: reusable Playwright E2E framework + sitemap FlowRunner) open 10d, no reviewDecision | dropped | 2026-06-27 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-tests-reserve-funds-cross-org-idor-tests-rs` | Churn hotspot: backend/servers/api-server/tests/reserve_funds_cross_org_idor_tests.rs touched 2x since 2026-06-12 (window 2026-06-12→2026-06-13) | dropped | 2026-06-27 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-tests-form-rls-repo-tests-rs` | Churn hotspot: backend/crates/db/tests/form_rls_repo_tests.rs touched 2x since 2026-06-12 (window 2026-06-12→2026-06-13) | dropped | 2026-06-27 |  |
| 0 | test-gap | `test-gap-screen-map-drift-pr-1418-ppt` | Screen-map drift: PR #1418 touched routes without doc update | open | 2026-06-27 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-07-02 10:12 UTC by routine</sub>
...
| 3 | security | `security-rustsec-ammonia-4-1-2` | RUSTSEC advisory on ammonia v4.1.2 blocks backend CI (all PRs red on cargo-deny) | open | 2026-07-02 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-messaging-rs` | Churn hotspot: `backend/servers/api-server/src/routes/messaging.rs` (3 commits this run) | open | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-messaging-rs` | Churn hotspot: `backend/crates/db/src/repositories/messaging.rs` (3 commits this run) | open | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-tests-multi-currency-happy-path-tests-rs` | Churn hotspot: `backend/servers/api-server/tests/multi_currency_happy_path_tests.rs` (3 commits this run) | open | 2026-07-02 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-06-28 03:25 UTC by routine</sub>
...
| 3 | bug | `revert-pr-1713` | Revert (delegations): PR #1690 re-wired retired frontend; backend gap audit + UI cleanup test | open | 2026-06-28 |  |
| 3 | bug | `code-review-api-handlers-regional-compliance-stub-minutes` | regional_compliance.rs Slovak/Czech vote-minutes/usneseni handlers return hardcoded stub data as legally-bindi | ready | 2026-06-28 | [plan](plans/code-review-api-handlers-regional-compliance-stub-minutes.md) |
...
| 2 | test-gap | `screen-map-drift-pr-1418-ppt` | PR #1418 touched routes/** (faults.route.test.tsx) without updating docs/screens/ppt/* — heuristic, test-file  | done | 2026-06-28 |  |
| 2 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcod | done | 2026-06-28 |  |
| 2 | bug | `code-review-api-handlers-migration-template-pagination` | migration.rs list_templates fetches all then skips in Rust; page/per_page never reach DB; total wrong | open | 2026-06-28 |  |
| 2 | security | `code-review-api-handlers-migration-fake-download-token` | migration.rs download_template emits fake unsigned token=Uuid::new_v4() with no /file route to validate — masq | ready | 2026-06-28 | [plan](plans/code-review-api-handlers-migration-fake-download-token.md) |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-forms-rs` | Churn hotspot: backend/servers/api-server/src/routes/forms.rs touched 2x since 2026-06-12 (window 2026-06-12→2 | open | 2026-06-28 |  |
...
| 1 | refactor | `code-review-api-core-osrng-expect` | crypto.rs:127 SysRng.try_fill_bytes(...).expect() panics if OS CSPRNG errors during integration-credential enc | done | 2026-06-28 |  |

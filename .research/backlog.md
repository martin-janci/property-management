# Backlog of vectors
<sub>Last regenerated: 2026-06-18 04:10 UTC by routine</sub>
...
| 3 | bug | `bug-ios-searchview-uncompilable` | iOS SearchView.swift does not compile — performSearch/scheduleSearch undefined, resultsGrid corrupted | done | 2026-06-18 | [plan](plans/_archive/bug-ios-searchview-uncompilable.md) |
...
| 2 | bug | `code-review-mobile-native-kmp-deeplink-token-not-url-decoded` | DeepLinkRouter skips URL-decoding while Android Uri.getQueryParameter decodes — SSO tokens diverge per platform | done | 2026-06-18 |  |
| 2 | bug | `code-review-mobile-native-kmp-search-stale-response-race` | SearchScreen stale-response race — overlapping searches can clobber newer results | done | 2026-06-18 |  |
| 2 | bug | `bug-ios-deeplink-info-plist-missing` | iOS deep-link layer dead at runtime — Info.plist missing CFBundleURLTypes + applinks entitlement | done | 2026-06-18 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1288-webhook-rls` | Webhook handlers RLS migration (PR #1288, PAP-170) shipped without a new regression test for repo-layer methods | done | 2026-06-18 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new regression t | done | 2026-06-18 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression test for the p | open | 2026-06-18 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixed in PR #1 | done | 2026-06-18 |  |
| 2 | test-gap | `screen-map-drift-pr-1454-ppt` | PR #1454 (feat: native accounting MVP + @hey-api migration) touched ppt-web routes (App.tsx/AppRoutes.tsx, routes/groups | open | 2026-06-18 |  |
| 2 | test-gap | `screen-map-drift-pr-1454-reality` | PR #1454 touched reality-web app/accounting/ (layout.tsx + page.tsx) without updating docs/screens/reality/*.md — new /a | open | 2026-06-18 |  |
| 2 | test-gap | `screen-map-drift-pr-1453-reality` | PR #1453 (N5 bank-statement upload + payment-matching) touched reality-web app/accounting/page.tsx without updating docs | open | 2026-06-18 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1469-document-form-user-enum-decode` | fix(db) #1469 — document/form/user repo SELECT enum-decode + unit_number column drift; 3 files (db/repositories/{documen | open | 2026-06-18 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1539-oauth-public-client` | fix(oauth) #1539 — reject public client supplying a client_secret with invalid_client; 1 file (routes/oauth.rs), zero te | open | 2026-06-18 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1551-document-category-cast` | fix(db) #1551 — cast document_category enum in count_accessible_rls (closes #1528); 1 file (db/repositories/document.rs) | open | 2026-06-18 |  |
| 2 | bug | `risky-churn-pr-1485-booking-rs` | PR #1485 (fix(integrations): Booking.com OTA push retry — timeout + Retry-After + RateLimited, BIT-110) modified backend | open | 2026-06-18 |  |
...
| 1 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despite metric=5 | done | 2026-06-18 |  |
...
| 1 | triage | `triage-issue-1331` | Issue #1331 (no labels, OPEN): Backend `test` job red/hanging on dev base — blocks the entire backend merge pipeline | done | 2026-06-18 |  |
| 1 | dx | `dx-stalled-review-pr-988` | Stalled review: PR #988 (Epic: reusable Playwright E2E framework + sitemap FlowRunner) open 10d, no reviewDecision | done | 2026-06-18 |  |
| 1 | triage | `triage-issue-1380` | Issue #1380 (no labels, OPEN): Dispatcher stale gap-scan buffer + Tier-2 escalation endpoint misconfigured | done | 2026-06-18 |  |
| 1 | dx | `closed-not-merged-pr-1425` | PR #1425 (GH #1377 document presigned-URL tests) closed unmerged — superseded by merged #1394 | done | 2026-06-18 |  |
| 1 | dx | `dx-stalled-review-pr-1179` | PR #1179 (docs(epics) catalog backfill for 37 mounted-but-undocumented backend modules) — stalled at 7d, no reviewDecisi | done | 2026-06-18 |  |
| 1 | refactor | `repeated-churn-backend-crates-integrations-src-booking-rs` | booking.rs hotspot fires in runs_seen=2 consecutive checks — instability proxy; primary churn drivers PR #1485 (Booking. | open | 2026-06-18 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-tests-document-folder-tests-rs` | 1002 lines changed in tests/document_folder_tests.rs — driven by PR #1316 (rescued orphan test bin + AC happy-path tests | open | 2026-06-18 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-tests-accounting-rls-repo-tests-rs` | 823 lines changed in db/tests/accounting_rls_repo_tests.rs — driven by PR #1453+#1454 (native accounting MVP N1-N5: cont | open | 2026-06-18 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-08-01 04:18 UTC by routine</sub>
...
| 2 | refactor | `refactor-churn-hotspot-integrations-booking-mod-2026-07-31` | Churn hotspot: backend/crates/integrations/src/booking/mod.rs — 3626 lines this window (recently split by PR #2611) | done | 2026-08-01 |  |
...
| 1 | refactor | `refactor-churn-hotspot-api-server-scheduler-mod-2026-08-01` | Churn hotspot: backend/servers/api-server/src/services/scheduler/mod.rs — 398 lines this run (PR #2613 extracted vote-lifecycle to submodule) | open | 2026-08-01 |  |

...
| 2 | security | `code-review-api-handlers-voice-refresh-simulated-token-release` | voice /oauth/refresh mints a simulated access token in RELEASE builds when the platform OAuth client | open | 2026-08-18 |  |
...
| 1 | security | `code-review-api-handlers-voice-oauth-exchange-no-rate-limit` | voice /oauth/exchange makes a live upstream OAuth call (exchange_code) per request with no per-user  | open | 2026-08-18 |  |
| 1 | bug | `code-review-api-handlers-voice-exchange-device-dedup` | voice /oauth/exchange generates a fresh random device_id every call with no upsert on (org,user,plat | open | 2026-08-18 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-documents-shares-rs-2026-08-18` | Churn hotspot: shares.rs — 449 lines this run across #2773 #2784 #2790 (public share endpoints + rat | open | 2026-08-18 |  |
| 1 | test-gap | `churn-hotspot-frontend-apps-mobile-src-nfc-nfccredentialmanager-test-ts-2026-08-18` | Churn hotspot: NFCCredentialManager.test.ts — 379 lines this run across #2775 #2780 #2786 (three NFC | open | 2026-08-18 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-services-voice-commands-rs-2026-08-18` | Churn hotspot: voice_commands.rs — 347 lines this run (PR #2788 fabricated-empty retry1: real announ | open | 2026-08-18 |  |

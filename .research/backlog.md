# Backlog of vectors
<sub>Last regenerated: 2026-06-20 18:11 UTC by routine</sub>
...
| 3 | security | `security-llm-doc-idor` | IDOR: ai.rs LLM-doc handlers publish/list/get any tenant's listing descriptions & photo enhancements unscoped | done | 2026-06-20 | [plan](plans/_archive/security-llm-doc-idor.md) |
...
| 3 | bug | `code-review-mobile-rn-report-fault-fake-submit` | ReportFaultScreen.tsx handleSubmit() fakes API call with setTimeout(1500) — fault reports never reach backend (App.tsx:126 wires | ready | 2026-06-16 | [plan](plans/code-review-mobile-rn-report-fault-fake-submit.md) |
...
| 2 | test-gap | `test-gap-screen-map-drift-pr-1559-ppt` | Screen-map drift: PR #1559 modified ppt-web routes/groups/announcements.tsx (Story 6.3 optimistic add) without doc update | open | 2026-06-20 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1610-ppt` | Screen-map drift: PR #1610 modified ppt-web routes/groups/faults.tsx (delete confirm + stats refresh) without doc update | open | 2026-06-20 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1621-ppt` | Screen-map drift: PR #1621 relocated payment-matching into ppt-web (accounting.tsx + lazyRoutes.tsx) without doc update | open | 2026-06-20 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1621-reality` | Screen-map drift: PR #1621 removed payment-matching from reality-web (accounting layout+page) without doc update | open | 2026-06-20 |  |
...
| 2 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcoded MOCK_* arrays — | open | 2026-06-16 |  |
...
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression test for the public-co | open | 2026-06-11 |  |
...
| 1 | refactor | `refactor-churn-hotspot-mobile-announcements-test` | Churn hotspot: AnnouncementsScreen.test.ts — 4 PRs this run, instability proxy | done | 2026-06-20 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-integrations-src-lib-rs` | Churn hotspot: backend/crates/integrations/src/lib.rs touched 3x in OTA-push epic (Booking.com integration) | open | 2026-06-20 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-ppt-web-src-lib-queryKeys-ts` | Churn hotspot: frontend/apps/ppt-web/src/lib/queryKeys.ts touched 3x (accounting + payment-matching relocate) | open | 2026-06-20 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-tests-reserve-funds-cross-org-idor-tests-rs` | Churn hotspot: backend/servers/api-server/tests/reserve_funds_cross_org_idor_tests.rs touched 2x since 2026-06-12 (window 2026-0 | open | 2026-06-13 |  |
...
| 1 | security | `security-pkce-oauth-authcode-pr-908-closed` | PR #908 (fix(security): require PKCE on OAuth authorization-code flow, closes #823) was closed unmerged — verify whether PKCE en | done | 2026-06-03 |  |
...
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected by depl | dropped | 2026-06-20 |  |

...
| 3 | bug | `code-review-api-handlers-hellosign-unbound-envelope` | SECURITY: verify_hellosign_signature MACs only event_time+event_type — envelope_id forgery enables c | ready | 2026-08-26 | [plan](plans/code-review-api-handlers-hellosign-unbound-envelope.md) |
...
| 2 | bug | `code-review-api-handlers-esign-webhook-replay` | esignature_webhook has no timestamp/freshness check — captured HelloSign/DocuSign/Adobe deliveries r | open | 2026-08-26 |  |
...
| 1 | bug | `code-review-mobile-rn-raw-status-untranslated` | mobile-rn FaultsListScreen renders raw api-server status enum (`fault.status.replace('_',' ')`) — sk | open | 2026-08-26 |  |
| 1 | bug | `code-review-mobile-rn-faultslist-i18n-gap` | mobile-rn FaultsListScreen report-fault CTA is hardcoded English '+ Report' in an otherwise-translat | open | 2026-08-26 |  |
| 1 | bug | `code-review-mobile-rn-hardcoded-button-labels` | mobile-rn MessagesScreen compose CTA hardcoded English '+ New message' in an otherwise-translated sc | open | 2026-08-26 |  |

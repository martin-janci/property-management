# Backlog of vectors
<sub>Last regenerated: 2026-07-12 14:30 UTC by routine</sub>
...
| 3 | security | `security-reality-agency-invitation-no-membership` | reality-server create_invitation lacks agency-membership check — any authed user can mint invitation for any agency | ready | 2026-07-12 | [plan](plans/security-reality-agency-invitation-no-membership.md) |
...
| 2 | security | `security-reality-list-members-unauth` | reality-server list_members has no auth extractor — unauthenticated agency roster enumeration | open | 2026-07-12 |  |
| 2 | bug | `bug-reality-imports-pagination-total-lies` | reality-server imports list handlers return `total = jobs.len()` — pagination lie + unbounded limit | open | 2026-07-12 |  |
...
| 1 | test-gap | `test-gap-oauth-integration-tests-r2` | oauth_integration_tests.rs still churning — new baseline hotspot after 2026-06-16 dropped v1 | open | 2026-07-12 |  |
| 1 | refactor | `refactor-booking-mod-r2` | booking/mod.rs repeated-churn (runs_seen 1→2) after PRs #2230/#2231 landed | open | 2026-07-12 |  |
| 1 | refactor | `refactor-auth-rs-r3` | routes/auth.rs still repeated-churn (runs_seen 2→3) after PR #2250 refresh-token refactor | open | 2026-07-12 |  |
| 1 | security | `closed-not-merged-pr-1797` | PR #1797 (auth on OCR + manager-gate rental PII) closed unmerged — superseded | done | 2026-07-12 |  |

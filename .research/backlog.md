# Backlog of vectors
<sub>Last regenerated: 2026-06-20 12:30 UTC by routine</sub>
...
| 3 | bug | `code-review-mobile-rn-report-fault-fake-submit` | ReportFaultScreen.tsx handleSubmit() fakes API call with setTimeout(1500) — fault reports never reac | ready | 2026-06-16 | [plan](plans/code-review-mobile-rn-report-fault-fake-submit.md) |
...
| 2 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs (+404/−29 in PR #1294 Booking.com OTA retr | open | 2026-06-20 |  |
| 2 | test-gap | `screen-map-drift-pr-1454-ppt` | PR #1454 touched ppt routes (AppRoutes.tsx) without updating docs/screens/ppt/* — heuristic | open | 2026-06-20 |  |
| 2 | test-gap | `screen-map-drift-pr-1555-ppt` | PR #1555 touched ppt routes (faults.route.test.tsx) without updating docs/screens/ppt/* — heuristic | open | 2026-06-20 |  |
| 2 | test-gap | `screen-map-drift-pr-1559-ppt` | PR #1559 touched ppt routes (announcements.tsx) without updating docs/screens/ppt/* — heuristic | open | 2026-06-20 |  |
| 2 | test-gap | `screen-map-drift-pr-1610-ppt` | PR #1610 touched ppt routes (faults.route.test.tsx) without updating docs/screens/ppt/* — heuristic | open | 2026-06-20 |  |
| 2 | test-gap | `screen-map-drift-pr-1611-ppt` | PR #1611 touched ppt routes (reports.download-retry.route.test.tsx) without updating docs/screens/pp | open | 2026-06-20 |  |
| 2 | test-gap | `screen-map-drift-pr-1453-reality` | PR #1453 touched reality routes (page.tsx) without updating docs/screens/reality/* — heuristic | open | 2026-06-20 |  |
| 2 | test-gap | `screen-map-drift-pr-1545-reality` | PR #1545 touched reality routes (layout.tsx) without updating docs/screens/reality/* — heuristic | open | 2026-06-20 |  |
...
| 2 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) rend | open | 2026-06-16 |  |
...
| 1 | bug | `code-review-mobile-native-kmp-deeplink-token-not-url-decoded` | DeepLinkRouter skips URL-decoding while Android Uri.getQueryParameter decodes — SSO tokens diverge p | open | 2026-06-20 |  |
...
| 1 | test-gap | `test-gap-screen-map-drift-pr-1085-reality` | Screen-map drift: PR #1085 modified reality-web listing detail metadata + page without screen-doc up | open | 2026-06-20 |  |
| 1 | test-gap | `test-gap-screen-map-drift-pr-1100-ppt` | Screen-map drift: PR #1100 modified ppt-web App.tsx (FileDisputePageRoute extraction) without screen | open | 2026-06-20 |  |
...
| 1 | refactor | `refactor-churn-hotspot-mobile-announcements` | Churn hotspot: AnnouncementsScreen.tsx — 4 PRs this run, instability proxy | done | 2026-06-20 |  |
...
| 1 | refactor | `churn-hotspot-frontend-apps-mobile-src-screens-documents-move-folder-sheet-tsx` | MoveFolderSheet.tsx churn hotspot — 519 lines in catch-up window (PR #1557 mobile folder rename/move | open | 2026-06-20 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-forms-rs` | Churn hotspot: backend/servers/api-server/src/routes/forms.rs touched 2x since 2026-06-12 (window 20 | open | 2026-06-16 |  |
...
| 1 | refactor | `code-review-api-core-osrng-expect` | crypto.rs:127 SysRng.try_fill_bytes(...).expect() panics if OS CSPRNG errors during integration-cred | open | 2026-06-15 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06- | open | 2026-06-10 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026 | open | 2026-06-10 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-0 | open | 2026-06-10 |  |
...
| 1 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work  | open | 2026-06-07 |  |
...
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK | dropped | 2026-06-20 |  |

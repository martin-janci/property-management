...
| 2 | bug | `code-review-mobile-native-kmp-create-listing-not-wired` | mobile-native-kmp CreateListingScreen onSubmit is a NotImplementedError stub — realtor Create-Listin | open | 2026-08-30 |  |
| 2 | bug | `code-review-reality-server-bytelen-charcount-validation` | reality-server public-write validators (inquiries/articles/agent_reviews/reports) measure BYTES but  | open | 2026-08-30 |  |
...
| 1 | bug | `code-review-reality-server-report-contact-unvalidated` | reality-server submit_report reporter_email/reporter_phone bound into INSERT with NO length or forma | open | 2026-08-30 |  |

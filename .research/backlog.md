# Backlog of vectors
<sub>Last regenerated: 2026-07-01 03:07 UTC by routine</sub>
...
| 3 | security | `security-llm-doc-idor` | IDOR: ai.rs LLM-doc handlers publish/list/get any tenant's listing descriptions & photo enhancements unscoped | done | 2026-07-01 | [plan](plans/_archive/security-llm-doc-idor.md) |
| 3 | bug | `code-review-ppt-web-core-delete-session-no-error-handling` | useAiChat: DELETE session fetch has no response.ok check — silently succeeds on 4xx/5xx and invalidates caches | ready | 2026-07-01 | [plan](plans/code-review-ppt-web-core-delete-session-no-error-handling.md) |
| 3 | bug | `code-review-ppt-web-core-action-queue-faked-api-calls` | useActionQueue: queryFn fakes API call with setTimeout(300) + generateMockData — dashboard queue is mock, never hits /api/v1/action-queue | ready | 2026-07-01 | [plan](plans/code-review-ppt-web-core-action-queue-faked-api-calls.md) |
...
| 2 | security | `code-review-ppt-web-core-iot-websocket-unsafe-window-cast` | useIotWebSocket: unchecked `(window as unknown as Record<string, unknown>)` reads arbitrary __API_BASE_URL__ without URL/protocol validation | open | 2026-07-01 |  |
...
| 1 | bug | `bug-risky-churn-pr-963-api-main-rs` | Risky churn: api-server main.rs security-headers wiring shipped without a middleware smoke test | done | 2026-07-01 |  |
...
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-form-rs` | Churn hotspot: 53 lines in backend/crates/db/src/repositories/form.rs (PR #1379 #1332 unblock) | done | 2026-07-01 |  |
...
| 0 | dx | `dx-stalled-review-pr-1179` | PR #1179 (docs(epics) catalog backfill for 37 mounted-but-undocumented backend modules) — stalled at 7d, no reviewDecision | dropped | 2026-06-16 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-tests-reserve-funds-cross-org-idor-tests-rs` | Churn hotspot: backend/servers/api-server/tests/reserve_funds_cross_org_idor_tests.rs touched 2x since 2026-06-12 (window 2026-06-12→2026-06-13) | dropped | 2026-06-13 |  |
...
| 0 | dx | `closed-not-merged-pr-1274` | PR #1274 (cargo-minor-patch group, /backend, 9 updates) closed unmerged — superseded by #1313 after auto-rebase fix landed | dropped | 2026-06-12 |  |
...
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-10 03:05Z→18:30Z) | dropped | 2026-06-10 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-06-27 04:18 UTC by routine</sub>
...
| 3 | refactor | `refactor-revert-pr-1713` | Revert: PR #1713 removed re-added delegation frontend (#1690) — reconcile with retirement (BIT-213) | open | 2026-06-27 |  |
...
| 2 | refactor | `churn-hotspot-backend-servers-api-server-tests-oauth_integration_tests-rs` | oauth_integration_tests.rs — repeated top-3 churn hotspot (2718 lines, runs_seen 3) | open | 2026-06-27 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-rental-rs` | rental.rs (db repository) — top-1 churn hotspot this 11d window (2933 lines) | open | 2026-06-27 |  |
| 1 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-mod-rs` | booking/mod.rs (Booking.com integration) — top-2 churn hotspot (2818 lines), several fix() PRs landing | open | 2026-06-27 |  |

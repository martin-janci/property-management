...
| 3 | bug | `code-review-ppt-web-ui-authcallback-double-decode` | ppt-web AuthCallbackPage double-decodes error_description → URIError leaves SSO callback stuck on sp | ready | 2026-08-21 | [plan](plans/code-review-ppt-web-ui-authcallback-double-decode.md) |
...
| 2 | bug | `code-review-ppt-web-ui-toast-role-alert-for-all-types` | ppt-web Toast forces role="alert" on every variant, over-interrupting screen readers on success/info | open | 2026-08-21 |  |
| 2 | test-gap | `unchecked-todo-pr-2806` | PR #2806 body has unchecked test-plan checkboxes (Integration tests / Manual testing) after merge | open | 2026-08-21 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-tests-suites-oauth-integration-tests-rs-2026-08-21` | churn-hotspot: backend/servers/api-server/tests/suites/oauth_integration_tests.rs (+3427 lines this  | open | 2026-08-21 |  |
| 1 | bug | `code-review-ppt-web-ui-confirmationdialog-hardcoded-processing` | ppt-web ConfirmationDialog leaks hardcoded English 'Processing...' during in-flight confirm — bypass | open | 2026-08-21 |  |
| 1 | refactor | `repeated-churn-backend/servers/api-server/src/routes/voice_webhooks.rs-2026-08-21` | repeated-churn: backend/servers/api-server/src/routes/voice_webhooks.rs (runs_seen bumped to 3) | open | 2026-08-21 |  |

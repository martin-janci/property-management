...
| 2 | bug | `code-review-reality-server-link-pm-account-noop` | reality-server link_pm_account() returns LinkResult::Success but never persists pm_user_id (silent n | open | 2026-08-05 |  |
| 2 | bug | `code-review-reality-server-pwreset-token-dropped-prod` | reality-server password-reset token minted+stored but neither emailed nor logged in release — featur | open | 2026-08-05 |  |
...
| 1 | bug | `code-review-reality-server-inquiry-detail-empty-msgs` | reality-server inquiry-detail always returns messages: vec![] — realtor thread never fetched | open | 2026-08-05 |  |
| 1 | refactor | `repeated-churn-frontend/apps/mobile/src/screens/messages/ThreadDetailScreen.tsx` | Repeated-churn: ThreadDetailScreen.tsx touched in 2 consecutive runs (runs_seen=2) — instability pro | open | 2026-08-05 |  |

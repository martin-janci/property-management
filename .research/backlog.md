# Backlog of vectors
<sub>Last regenerated: 2026-07-06 12:25 UTC by routine</sub>
...
| 3 | bug | `code-review-api-handlers-compliance-minutes-stubbed` | regional_compliance minutes/usneseni endpoints ship hardcoded stub meeting data (Slovak + Czech legal minutes) | ready | 2026-07-06 | [plan](plans/code-review-api-handlers-compliance-minutes-stubbed.md) |
| 3 | security | `code-review-api-handlers-gdpr-fake-dpo` | regional_compliance GDPR consent status returns a fabricated DPO contact when config missing | ready | 2026-07-06 | [plan](plans/code-review-api-handlers-gdpr-fake-dpo.md) |
...
| 2 | bug | `code-review-api-handlers-vote-validator-fake-defaults` | regional_compliance vote validators invent 75%/80% defaults when eligibles=0 or vote.results unparseable | open | 2026-07-06 |  |
...
| 1 | refactor | `refactor-churn-hotspot-backend-crates-db-src-models-multi-currency-rs` | Churn hotspot: backend/crates/db/src/models/multi_currency.rs (3 touches — enum-sync scaffolding + guard) | open | 2026-07-06 |  |
| 1 | refactor | `refactor-churn-hotspot-backend-crates-db-src-models-regional-compliance-rs` | Churn hotspot: backend/crates/db/src/models/regional_compliance.rs (3 touches — SlovakAccountingExport enforce | open | 2026-07-06 |  |
| 1 | refactor | `refactor-churn-hotspot-backend-servers-api-server-src-routes-regional-compliance-rs` | Churn hotspot: backend/servers/api-server/src/routes/regional_compliance.rs (3 touches + serious quality findi | open | 2026-07-06 |  |

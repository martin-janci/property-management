# Backlog of vectors
<sub>Last regenerated: 2026-06-18 14:15 UTC by routine</sub>
...
| 4 | test-gap | `screen-map-drift-pr-1453-reality` | PR #1453 touched reality routes (frontend/apps/reality-web/src/app/accounting/pa | open | 2026-06-18 |  |
| 3 | bug | `bug-rental-guest-reports-enum-decode-residual` | cast enum columns on rental_guest_reports write paths (extends PR #1537) | open | 2026-06-18 |  |
| 3 | bug | `bug-document-repo-enum-decode-residual` | audit document.rs for SELECT d.* enum-decode residue (post-PR #1565) | ready | 2026-06-18 | [plan](plans/bug-document-repo-enum-decode-residual.md) |
| 3 | bug | `bug-ppt-web-accounting-invoice-page-incomplete` | AccountingInvoiceManagementPage has stub handlers + auth-typing leaks + no error UI | ready | 2026-06-18 | [plan](plans/bug-ppt-web-accounting-invoice-page-incomplete.md) |
...
| 2 | refactor | `refactor-fixme-commit-c75cde482-accounting-payment-matching` | TODO in backend/servers/api-server/src/services/accounting.rs: "Date proximity,  | open | 2026-06-18 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1539-oauth-public-client` | PR #1539 fixed OAuth public-client client_secret rejection (security boundary) — | open | 2026-06-18 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1545-reality-web-prod-build` | PR #1545 fixed reality-web SSG prerender — /accounting QueryClient + favorites p | open | 2026-06-18 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1561-reality-imports-portal-principal` | PR #1561 added PortalPrincipal extractor (auth boundary) + swapped 11 imports.rs | open | 2026-06-18 |  |
| 2 | test-gap | `screen-map-drift-pr-1454-ppt` | PR #1454 touched ppt routes (frontend/apps/ppt-web/src/routes/AppRoutes.tsx, fro | open | 2026-06-18 |  |
| 2 | test-gap | `screen-map-drift-pr-1555-ppt` | PR #1555 touched ppt routes (frontend/apps/ppt-web/src/routes/groups/faults.tsx) | open | 2026-06-18 |  |
| 2 | bug | `code-review-ppt-web-core-auth-init-no-expiry-check` | frontend/apps/ppt-web/src/contexts/AuthContext.tsx:384-387 — initializeAuth trea | open | 2026-06-18 |  |
...
| 1 | bug | `bug-risky-churn-pr-963-api-main-rs` | Risky churn: api-server main.rs security-headers wiring shipped without a middleware smoke test | open | 2026-06-18 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-959-reality-listings-pagination` | Reality-server listings pagination clamp (PR #959) shipped without a regression test for limit=-1 | open | 2026-06-18 |  |
| 1 | refactor | `refactor-churn-hotspot-mobile-announcements` | Churn hotspot: AnnouncementsScreen.tsx — 4 PRs this run, instability proxy | done | 2026-06-18 |  |
| 1 | refactor | `refactor-churn-hotspot-mobile-announcements-test` | Churn hotspot: AnnouncementsScreen.test.ts — 4 PRs this run, instability proxy | done | 2026-06-18 |  |
| 1 | triage | `triage-issue-1520` | issue #1520 created without label: wire preference-aware push dispatch-target se | open | 2026-06-18 |  |
| 1 | triage | `triage-issue-1521` | issue #1521 created without label: payment-matching UI shipped in wrong app, wit | open | 2026-06-18 |  |
| 1 | triage | `triage-issue-1522` | issue #1522 created without label: accounting UI bypasses shared API auth interc | open | 2026-06-18 |  |
| 1 | triage | `triage-issue-1532` | issue #1532 created without label: wire useFolderTree / FOLDER_TREE_QUERY_KEY in | open | 2026-06-18 |  |
| 1 | triage | `triage-issue-1533` | issue #1533 created without label: nextPageTriggerFlow in-flight race + missing  | open | 2026-06-18 |  |
| 1 | triage | `triage-issue-1538` | issue #1538 created without label: Backend test job not required check on dev —  | open | 2026-06-18 |  |
...
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→18:30Z) | dropped | 2026-06-18 |  |
| 0 | triage | `triage-dispatcher-mcp-push-large-file-issue-1014` | Dispatcher action-list.json corruption when MCP push falls back from blocked git push | dropped | 2026-06-18 |  |
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected | dropped | 2026-06-18 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-rental-rs` | rental.rs: 8 changes since 2026-06-16 (enum-cast cascade #1486/#1492/#1507/#1537 | dropped | 2026-06-18 |  |
| 0 | test-gap | `screen-map-drift-pr-1545-reality` | PR #1545 touched reality routes (frontend/apps/reality-web/src/app/accounting/la | dropped | 2026-06-18 |  |
| 0 | refactor | `code-review-ppt-web-core-accounting-auth-headers-cast` | frontend/apps/ppt-web/src/features/accounting/pages/AccountingInvoiceManagementP | dropped | 2026-06-18 |  |

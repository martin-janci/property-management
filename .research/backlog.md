# Backlog of vectors
<sub>Last regenerated: 2026-07-31 10:34 UTC by routine</sub>
...
| 3 | security | `code-review-reality-server-ssrf-ipv4-mapped-ipv6` | SSRF: reality-server url_validator misses IPv4-mapped IPv6 addresses (::ffff:...) — full blocklist bypass on agency-import fetches | ready | 2026-07-31 | [plan](plans/code-review-reality-server-ssrf-ipv4-mapped-ipv6.md) |
...
| 2 | bug | `code-review-reality-server-ss-alert-watermark-swallow` | Silent watermark write failure in saved-search alert worker causes duplicate alerts | open | 2026-07-31 |  |
| 2 | bug | `code-review-reality-server-agent-review-body-unbounded` | Missing input bounds: reality-server create_review accepts arbitrary-length `body` on public write endpoint | open | 2026-07-31 |  |
| 2 | security | `code-review-reality-server-redirect-backslash-bypass` | Open-redirect: reality-server SSO check_redirect_uri_allowed misses backslash form (/\evil.com) | open | 2026-07-31 |  |
...
| 1 | refactor | `refactor-churn-hotspot-api-server-voice-webhooks-2026-07-31` | Churn hotspot: backend/servers/api-server/src/routes/voice_webhooks.rs — 472 lines this window (PR #2604 unit tests) | open | 2026-07-31 |  |
| 1 | refactor | `refactor-churn-hotspot-api-server-reports-schedule-cadence-2026-07-31` | Churn hotspot: backend/servers/api-server/src/routes/reports/schedule_cadence.rs — 889 lines this window (PR #2599 new file) | open | 2026-07-31 |  |
| 1 | refactor | `refactor-churn-hotspot-api-server-reports-mod-2026-07-31` | Churn hotspot: backend/servers/api-server/src/routes/reports/mod.rs — 887 lines this window (PR #2599 extract) | open | 2026-07-31 |  |
| 1 | bug | `code-review-api-core-push-fanout-reqwest-expect` | push_fanout FCM/APNs adapters .expect() on reqwest::Client::builder().build() — server-boot crash path | open | 2026-07-31 |  |

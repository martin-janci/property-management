# Backlog of vectors
<sub>Last regenerated: 2026-07-06 06:11 UTC by routine</sub>
...
| 2 | bug | `code-review-ppt-web-core-ws-reconnect-race` | close superseded WebSocket before overwriting on reconnect | open | 2026-07-06 |  |
| 2 | bug | `code-review-ppt-web-core-api-default-export` | avoid pre-configure default apiClient export in lib/api.ts | open | 2026-07-06 |  |
...
| 1 | dx | `code-review-ppt-web-core-error-msgs-i18n` | route lib/errorHandler.ts titles/messages through i18n | open | 2026-07-06 |  |

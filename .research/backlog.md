# Backlog of vectors
<sub>Last regenerated: 2026-06-18 16:34 UTC by routine</sub>
...
| 3 | bug | `bug-board-meetings-full-name-column` | board_meetings.rs uses nonexistent u.full_name column on list_board_members + list_motions — 500s on member/motion li... | ready | 2026-06-18 | [plan](plans/bug-board-meetings-full-name-column.md) |
| 3 | security | `security-mfa-recovery-limiter-leak` | MFA recovery rate-limiter grows without bound (DoS) + denial reuses MfaBackupCodeUsed audit action (mislabel) | ready | 2026-06-18 | [plan](plans/security-mfa-recovery-limiter-leak.md) |
...
| 2 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→18:30Z) | open | 2026-06-18 |  |
| 2 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs (+404/−29 in PR #1294 Booking.com OTA retry) | open | 2026-06-18 |  |
| 2 | security | `security-portal-principal-agency-id-mismatch` | PortalPrincipal bypasses reality_agency_members membership check + rides on agency_id=user_id mismatch (PR #1561) | open | 2026-06-18 |  |
| 2 | security | `security-ota-manager-gate-stringly-typed-role-set` | OTA manager-gate hand-rolls role string-set instead of TenantRole::is_manager — silent-drift authz hazard (PR #1552) | open | 2026-06-18 |  |
| 2 | test-gap | `test-gap-download-retry-harness-divergence` | Download/retry test harness diverges from real route container — error + toast wiring untested (PR #1548) | open | 2026-06-18 |  |
| 2 | bug | `bug-faults-page-delete-stats-wiring` | Harden fault delete + stats wiring on FaultsPage (PR #1555) | open | 2026-06-18 |  |
| 2 | bug | `bug-mobile-movefolder-root-no-op` | Mobile MoveFolderSheet "Root (top level)" silently no-ops + flatten util duplication (PR #1557) | open | 2026-06-18 |  |
| 2 | test-gap | `test-gap-pin-test-asserts-constant` | pin-test asserts the constant instead of the wiring; stale test comment (PR #1582) | open | 2026-06-18 |  |
| 2 | test-gap | `test-gap-xxe-regression-guards-vacuous` | XXE/entity regression guards are vacuous-pass — assertions never fail on the unfixed code (PR #1562) | open | 2026-06-18 |  |
| 2 | dx | `dx-rustfmt-not-blocking-on-dev` | rustfmt lint job is not a blocking pre-merge gate on dev — fmt-red PRs merge freely (PR #1581) | open | 2026-06-18 |  |
| 2 | test-gap | `test-gap-mark-invitation-viewed-timing` | mark_invitation_viewed COALESCE-regression test catch is timing-dependent, not deterministic (PR #1564) | open | 2026-06-18 |  |
| 2 | test-gap | `test-gap-rls-write-path-developer-oauth` | Add write-path (INSERT/UPDATE/DELETE) RLS assertions for developer OAuth/usage tables (PR #1563) | open | 2026-06-18 |  |
...
| 2 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcoded MOCK... | open | 2026-06-16 |  |
...
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new regressio... | open | 2026-06-11 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression test for th... | open | 2026-06-11 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixed in PR... | open | 2026-06-11 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-rental-rs` | Churn hotspot: backend/crates/db/src/repositories/rental.rs | open | 2026-06-18 |  |
...
| 1 | dx | `dx-stalled-review-pr-1179` | PR #1179 (docs(epics) catalog backfill for 37 mounted-but-undocumented backend modules) — stalled at 7d, no reviewDec... | open | 2026-06-16 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-tests-reserve-funds-cross-org-idor-tests-rs` | Churn hotspot: backend/servers/api-server/tests/reserve_funds_cross_org_idor_tests.rs touched 2x since 2026-06-12 (wi... | open | 2026-06-13 |  |
...
| 1 | dx | `closed-not-merged-pr-1274` | PR #1274 (cargo-minor-patch group, /backend, 9 updates) closed unmerged — superseded by #1313 after auto-rebase fix l... | open | 2026-06-12 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-api-ecosystem-rs` | Churn hotspot: backend/servers/api-server/src/routes/api_ecosystem.rs (+106/−27 in PR #1293 PAP-171; second touch in ... | open | 2026-06-12 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-10 03:05Z→18:... | open | 2026-06-10 |  |
...
| 1 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despite metri... | open | 2026-06-07 |  |
...
| 0 | triage | `lag-warning-2026-06-18` | Routine lag: 60h (2d 12h) since last run on 2026-06-16T03:25Z — likely cron miss or buffer-low backfill | open | 2026-06-18 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-07-16 14:15 UTC by routine</sub>
...
| 3 | bug | `code-review-api-handlers-missing-authz-article` | news_articles handlers missing authz: publish/archive/restore/pin/delete/media open to any tenant member | ready | 2026-07-16 | [plan](plans/code-review-api-handlers-missing-authz-article.md) |
| 3 | bug | `code-review-mobile-native-kmp-navigation-create-listing-stub` | Android CreateListing wired to NotImplementedError — realtor Publish silently blocked | ready | 2026-07-16 | [plan](plans/code-review-mobile-native-kmp-navigation-create-listing-stub.md) |
...
| 2 | bug | `code-review-api-handlers-unenforced-toggle-flags` | api-handlers: toggle/feature flags read but never enforced on gated paths | open | 2026-07-16 |  |
| 2 | bug | `code-review-ppt-web-core-auth-stale-token-init` | ppt-web auth init reads stale refresh token — race with silent-refresh handshake | open | 2026-07-16 |  |
| 2 | bug | `code-review-ppt-web-core-iot-ws-unbounded-reconnect` | ppt-web IoT WebSocket: unbounded reconnect loop — battery/network drain, no backoff cap | open | 2026-07-16 |  |
| 2 | bug | `code-review-ppt-web-ui-paymatch-mut-noerr` | ppt-web PaymentsMatch mutation has no error branch — silent failure on POST/PATCH | open | 2026-07-16 |  |
| 2 | bug | `code-review-ppt-web-ui-invoice-mut-noerr` | ppt-web Invoice mutation has no error branch — silent failure on POST/PATCH | open | 2026-07-16 |  |
| 2 | bug | `code-review-ppt-web-ui-portfolio-dash-mock` | ppt-web portfolio dashboard still renders hardcoded mock data — no backend wire | open | 2026-07-16 |  |
| 2 | bug | `code-review-reality-web-pricealert-mut-noerr` | reality-web PriceAlert mutation has no error branch — silent failure on subscribe/unsubscribe | open | 2026-07-16 |  |
...
| 1 | bug | `code-review-api-core-scheduler-mutex-poison` | api-core scheduler: Mutex poison never recovered — silent freeze on panic | open | 2026-07-16 |  |
| 1 | bug | `code-review-api-handlers-rng-expect-panic` | api-handlers: rng().expect() panics on RNG failure — should map to 500 not process crash | open | 2026-07-16 |  |
| 1 | bug | `code-review-ppt-web-core-nav-aria-no-i18n` | ppt-web nav: hard-coded English aria-labels — screen-reader users get untranslated nav | open | 2026-07-16 |  |
| 1 | bug | `code-review-reality-server-view-no-visibility-gate` | reality-server view route: no visibility gate — private listings observable via direct URL | open | 2026-07-16 |  |
| 1 | bug | `code-review-reality-web-sso-callback-i18n` | reality-web SSO callback: error strings hard-coded English across 4 locales | open | 2026-07-16 |  |
| 1 | test-gap | `code-review-mobile-native-kmp-listingrepo-partial` | ListingRepository: 5 of 6 network methods have no coverage (search/featured/recent/suggestions/nearby) | open | 2026-07-16 |  |

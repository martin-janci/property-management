# Backlog of vectors
<sub>Last regenerated: 2026-06-27 20:30 UTC by routine</sub>
...
| 1 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected | done | 2026-06-27 |  |
...
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new regression t | open | 2026-06-27 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression test for the p | open | 2026-06-27 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixed in PR #1 | open | 2026-06-27 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-iot-rs` | Churn hotspot: backend/servers/api-server/src/routes/iot.rs (+278/-403 in PR #1321/#1322 PAP-151 re-land + fmt) | done | 2026-06-27 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-reserve-funds-rs` | Churn hotspot: backend/servers/api-server/src/routes/reserve_funds.rs (+228/-255 in PR #1321 PAP-151 re-land) | done | 2026-06-27 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-sensor-rs` | Churn hotspot: backend/crates/db/src/repositories/sensor.rs (+248/-86 in PR #1321/#1322 PAP-151 re-land + fmt) | done | 2026-06-27 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-forms-rs` | Churn hotspot: backend/servers/api-server/src/routes/forms.rs touched 2x since 2026-06-12 (window 2026-06-12→2026-06-13) | done | 2026-06-27 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-tests-form-rls-repo-tests-rs` | Churn hotspot: backend/crates/db/tests/form_rls_repo_tests.rs touched 2x since 2026-06-12 (window 2026-06-12→2026-06-13) | done | 2026-06-27 |  |
...
| 1 | dx | `closed-not-merged-pr-1698` | PR #1698 closed unmerged — feat(epic-3): story 3.2 - unit management UI (BIT-188) | open | 2026-06-27 |  |
| 1 | dx | `closed-not-merged-pr-1720` | PR #1720 closed unmerged — fix(ppt-web): add Leases nav link + home tile (#977) | open | 2026-06-27 |  |
| 1 | dx | `closed-not-merged-pr-1727` | PR #1727 closed unmerged — fix(ci): unblock backend gate — organizations fmt + notification_event | open | 2026-06-27 |  |
| 1 | dx | `closed-not-merged-pr-1749` | PR #1749 closed unmerged — fix(mobile): exclude app.config.icon.test.ts from tsc typecheck (unblo | open | 2026-06-27 |  |
| 1 | dx | `closed-not-merged-pr-1858` | PR #1858 closed unmerged — chore(api-server): remove 59 unmounted ROADMAP routers + orphaned publ | open | 2026-06-27 |  |
| 1 | refactor | `churn-hotspot-backend-servers-reality-server-src-services-saved-search-alerts-rs` | Churn: backend/servers/reality-server/src/services/saved_search_alerts.rs (3 PRs in 11d for BIT-139/140 feature) | open | 2026-06-27 |  |
...
| 0 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despite metric=5 | dropped | 2026-06-27 |  |
...
| 0 | dx | `closed-not-merged-pr-1274` | PR #1274 (cargo-minor-patch group, /backend, 9 updates) closed unmerged — superseded by #1313 after auto-rebase fix land | dropped | 2026-06-27 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-tests-reserve-funds-cross-org-idor-tests-rs` | Churn hotspot: backend/servers/api-server/tests/reserve_funds_cross_org_idor_tests.rs touched 2x since 2026-06-12 (windo | dropped | 2026-06-27 |  |
| 0 | dx | `lag-warning-2026-06-27` | Routine lag: previous run was 2026-06-16 — 11d gap (stale routine alert) | open | 2026-06-27 |  |

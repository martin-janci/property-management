# Backlog of vectors
<sub>Last regenerated: 2026-08-08 04:31 UTC by routine</sub>
...
| 2 | bug | `code-review-mobile-native-kmp-httpclient-no-timeouts` | mobile-native-kmp: shared Ktor HttpClient has no HttpTimeout — every mobile API call can hang indefi | open | 2026-08-08 |  |
| 2 | bug | `code-review-api-handlers-reports-unwrap-or-default-silent-zero` | api-handlers: four report handlers swallow DB errors with unwrap_or_default(), serve HTTP 200 with s | open | 2026-08-08 |  |
...
| 1 | perf | `code-review-mobile-native-kmp-profile-stats-serial-fetch` | mobile-native-kmp: ProfileStats.load() serializes three independent GETs, tripling Account screen op | open | 2026-08-08 |  |

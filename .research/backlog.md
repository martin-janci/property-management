# Backlog of vectors
<sub>Last regenerated: 2026-06-21 16:00 UTC by routine</sub>
...
| 1 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despite metric=5 | done | 2026-06-21 |  |
| 1 | triage | `triage-issue-1331` | Issue #1331 (no labels, OPEN): Backend `test` job red/hanging on dev base — blocks the entire backend merge pipeline | done | 2026-06-21 |  |
...
| 1 | dx | `closed-not-merged-pr-1647` | PR #1647 (feat(iot): sensor register + edit + standalone list [BIT-147]) closed  | open | 2026-06-21 |  |

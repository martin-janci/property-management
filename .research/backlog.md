...
| 3 | bug | `code-review-mobile-native-kmp-inquiries-response-contract` | mobile-native-kmp InquiriesResponse required page_size mismatches reality-server `limit` — MissingFi | ready | 2026-08-18 | [plan](plans/code-review-mobile-native-kmp-inquiries-response-contract.md) |
...
| 2 | security | `code-review-reality-server-sso-reqwest-no-timeout` | reality-server: SSO reqwest calls have no timeout — anonymous DoS amplification on auth endpoints | ready | 2026-08-18 | [plan](plans/code-review-reality-server-sso-reqwest-no-timeout.md) |
| 2 | bug | `code-review-reality-server-imports-pagination-total-and-unclamped-limit` | reality-server: imports list endpoints lie about total and accept unclamped limit (silent data loss  | open | 2026-08-18 |  |

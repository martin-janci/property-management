# Backlog of vectors
<sub>Last regenerated: 2026-06-26 03:26 UTC by routine</sub>
...
| 3 | bug | `code-review-mobile-rn-report-fault-fake-submit` | ReportFaultScreen.tsx handleSubmit() fakes API call with setTimeout(1500) — fault reports never reach backend (App.tsx:1 | done | 2026-06-26 | [plan](plans/_archive/code-review-mobile-rn-report-fault-fake-submit.md) |
| 3 | bug | `revert-pr-1713` | Reverted: delegations frontend (PR #1713 reverts #1690) | open | 2026-06-26 |  |
| 3 | security | `code-review-ppt-web-core-accounting-cache-leak-on-logout` | frontend/apps/ppt-web/src/lib/queryKeys.ts:347-368 — AUTHED_QUERY_KEY_ROOTS list omits 'accounting' even though queryKey | ready | 2026-06-26 | [plan](plans/code-review-ppt-web-core-accounting-cache-leak-on-logout.md) |
...
| 2 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcoded MOCK_*  | done | 2026-06-26 |  |
| 2 | bug | `risky-churn-pr-1565-document-rs` | Risky churn: fix-PR touches backend/crates/db/src/repositories/document.rs with no test diff | open | 2026-06-26 |  |
| 2 | bug | `risky-churn-pr-1551-document-rs` | Risky churn: fix-PR touches backend/crates/db/src/repositories/document.rs with no test diff | open | 2026-06-26 |  |
| 2 | bug | `risky-churn-pr-1537-rental-rs` | Risky churn: fix-PR touches backend/crates/db/src/repositories/rental.rs with no test diff | open | 2026-06-26 |  |
| 2 | bug | `risky-churn-pr-1469-document-rs` | Risky churn: fix-PR touches backend/crates/db/src/repositories/document.rs with no test diff | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1822-reality` | PR #1822 (79-2-authentication-flow: reality-web SSO callback e2e coverage (gap-7) touched reality-we | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1746-reality` | PR #1746 (fix(portal-listings): validate enums/status + ownership IDOR tests + F) touched reality-we | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1737-ppt` | PR #1737 (fix(iot): remove duplicate JWT-trusting sensor WS channel, converge on) touched ppt-web ro | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1696-ppt` | PR #1696 (feat(messaging): per-participant thread archive + soft-delete (BIT-182) touched ppt-web ro | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1733-ppt` | PR #1733 (fix(ppt-web): add loading state + double-click guard to invoice PDF do) touched ppt-web ro | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1713-ppt` | PR #1713 (revert(delegations): remove re-added delegation frontend (#1690) (#171) touched ppt-web ro | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1690-ppt` | PR #1690 (feat(delegations): wire delegation feature into ppt-web (Story 3.4) (#) touched ppt-web ro | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1694-ppt` | PR #1694 (feat(ppt-web): add Leases sidebar nav link (closes #977 gap 2) (#1694)) touched ppt-web ro | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1685-ppt` | PR #1685 (feat(ppt-web): real-time IoT dashboard via BIT-145 WS channel (Epic 14) touched ppt-web ro | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1677-reality` | PR #1677 (fix(reality-web): defend listing detail JSON-LD against partial SSR bo) touched reality-we | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1642-reality` | PR #1642 (feat(epic-15): portal-user listing CRUD — owner/realtor edit (#986) (#) touched reality-we | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1641-ppt` | PR #1641 (feat(ppt-web): Sentiment & Predictive Maintenance dashboards (Epic 13,) touched ppt-web ro | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1654-ppt` | PR #1654 (feat(ppt-web): invoice "PDF" download button (#975.6) (#1654)) touched ppt-web routes with | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1630-ppt` | PR #1630 (feat(ppt-web): wire Payment Management page to the org-wide endpoints ) touched ppt-web ro | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1621-reality` | PR #1621 (fix(ppt-web): relocate payment-matching to ppt-web with correct api-se) touched reality-we | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1621-ppt` | PR #1621 (fix(ppt-web): relocate payment-matching to ppt-web with correct api-se) touched ppt-web ro | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1611-ppt` | PR #1611 (test(reports): cover ScheduleDetailPageRoute download/retry toast wiri) touched ppt-web ro | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1610-ppt` | PR #1610 (fix(faults): confirm delete + use closed_count + refresh stats on dele) touched ppt-web ro | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1559-ppt` | PR #1559 (feat(UC-06): optimistic add for announcement comments (Story 6.3) (#15) touched ppt-web ro | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1555-ppt` | PR #1555 (feat(UC-03): wire useDeleteFault + useFaultStatistics into FaultsPage ) touched ppt-web ro | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1545-reality` | PR #1545 (fix(reality-web): unbreak production build — /accounting QueryClient p) touched reality-we | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1453-reality` | PR #1453 (N5 — Bank-statement upload + payment-matching + match-review (PAP-210)) touched reality-we | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1454-ppt` | PR #1454 (feat: native accounting MVP (N1-N4) + @hey-api migration (#1454)) touched ppt-web routes w | open | 2026-06-26 |  |
| 2 | bug | `code-review-ppt-web-core-payment-match-no-onerror` | frontend/apps/ppt-web/src/features/accounting/pages/PaymentMatchingPage.tsx:61-73 — confirmMutation and rejectMutation d | open | 2026-06-26 |  |
...
| 2 | bug | `code-review-mobile-rn-deeplink-init-unhandled` | useDeepLinkRouting.ts:27-36 — initialize() re-runs on onNavigate identity change + void promise with no .catch → duplica | open | 2026-06-16 |  |
...
| 2 | refactor | `refactor-announcements-rs-module-split` | announcements.rs (2,722 LOC) — explicit module-split into routes/announcements/{crud,targeting,delivery,reactions,mod}.r | done | 2026-06-06 |  |
...
| 2 | test-gap | `test-gap-screen-map-drift-pr-1033-ppt` | Screen-map drift: PR #1033 wired error/retry into AnnouncementsPage+FaultsPage via App.tsx without a docs/screens/ppt up | done | 2026-06-06 |  |
...
| 2 | bug | `bug-report-schedule-update-no-sql` | ReportSchedule.update_schedule stores cron in `time` workaround; documented UPDATE never runs (missing cron_expression c | done | 2026-05-30 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-emergency-rs` | Churn hotspot: 1021 lines changed in backend/servers/api-server/src/routes/emergency.rs (window 2026 | done | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-enhanced-tenant-screening-rs` | Churn hotspot: 709 lines changed in backend/servers/api-server/src/routes/enhanced_tenant_screening. | done | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→18:30Z) | done | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-10 03:05Z→18:30Z | done | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-06-10 03:05Z→18:30Z) | done | 2026-06-26 |  |
| 1 | refactor | `refactor-churn-hotspot-mobile-announcements` | Churn hotspot: AnnouncementsScreen.tsx — 4 PRs this run, instability proxy | done | 2026-06-26 |  |
| 1 | refactor | `refactor-churn-hotspot-mobile-announcements-test` | Churn hotspot: AnnouncementsScreen.test.ts — 4 PRs this run, instability proxy | done | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs (+404/−29 in PR #1294 Booking.com OTA retry) | done | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-reserve-funds-rs` | Churn hotspot: backend/servers/api-server/src/routes/reserve_funds.rs (+228/-255 in PR #1321 PAP-151 re-land) | done | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-sensor-rs` | Churn hotspot: backend/crates/db/src/repositories/sensor.rs (+248/-86 in PR #1321/#1322 PAP-151 re-land + fmt) | done | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-tests-form-rls-repo-tests-rs` | Churn hotspot: backend/crates/db/tests/form_rls_repo_tests.rs touched 2x since 2026-06-12 (window 2026-06-12→2026-06-13) | done | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-mobile-app-config-icon-test-ts` | Churn hotspot: 124 lines in frontend/apps/mobile/app.config.icon.test.ts (PR #1383 gap-85-2) | done | 2026-06-26 |  |
| 1 | refactor | `code-review-api-core-osrng-expect` | crypto.rs:127 SysRng.try_fill_bytes(...).expect() panics if OS CSPRNG errors during integration-credential encrypt | done | 2026-06-26 |  |
| 1 | refactor | `repeated-churn-backend-servers-api-server-src-routes-forms-rs` | forms.rs repeated-churn — runs_seen=2 (#1337 explicit_auto_deref + #1397 org-scope hardening) | done | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-ppt-web-src-routes-lazyroutes-tsx` | Churn hotspot: frontend/apps/ppt-web/src/routes/lazyRoutes.tsx | open | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-rental-rs` | Churn hotspot: backend/crates/db/src/repositories/rental.rs | open | 2026-06-26 |  |
| 1 | refactor | `repeated-churn-backend-crates-db-src-repositories-document-rs` | Repeated churn: backend/crates/db/src/repositories/document.rs (runs_seen ≥ 2) | open | 2026-06-26 |  |
| 1 | refactor | `code-review-ppt-web-core-sessions-double-cast` | frontend/apps/ppt-web/src/features/settings/pages/SessionsPage.tsx:84 — `(sessionsQuery.data?.sessions ?? []) as unknown | open | 2026-06-26 |  |
...
| 1 | dx | `dx-stalled-review-pr-1179` | PR #1179 (docs(epics) catalog backfill for 37 mounted-but-undocumented backend modules) — stalled at 7d, no reviewDecisi | open | 2026-06-16 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-tests-reserve-funds-cross-org-idor-tests-rs` | Churn hotspot: backend/servers/api-server/tests/reserve_funds_cross_org_idor_tests.rs touched 2x since 2026-06-12 (windo | open | 2026-06-13 |  |
...
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1288-webhook-rls` | Webhook handlers RLS migration (PR #1288, PAP-170) shipped without a new regression test for repo-layer methods | open | 2026-06-11 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new regression t | open | 2026-06-11 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression test for the p | open | 2026-06-11 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixed in PR #1 | open | 2026-06-11 |  |
...
| 1 | bug | `code-review-mobile-native-kmp-deeplink-token-not-url-decoded` | DeepLinkRouter skips URL-decoding while Android Uri.getQueryParameter decodes — SSO tokens diverge per platform | open | 2026-06-06 |  |
...
| 1 | test-gap | `test-gap-screen-map-drift-pr-1100-ppt` | Screen-map drift: PR #1100 modified ppt-web App.tsx (FileDisputePageRoute extraction) without screen-doc update | open | 2026-06-05 |  |
...
| 1 | security | `security-pkce-oauth-authcode-pr-908-closed` | PR #908 (fix(security): require PKCE on OAuth authorization-code flow, closes #823) was closed unmerged — verify whether | done | 2026-06-03 |  |
...
| 1 | triage | `triage-issue-859` | Issue #859 (no labels, OPEN): sqlx 0.9 breaks runtime decode of Postgres enum columns into Rust String (SELECT * reads 5 | done | 2026-06-01 |  |
...
| 0 | dx | `closed-not-merged-pr-1274` | PR #1274 (cargo-minor-patch group, /backend, 9 updates) closed unmerged — superseded by #1313 after auto-rebase fix land | dropped | 2026-06-12 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-api-ecosystem-rs` | Churn hotspot: backend/servers/api-server/src/routes/api_ecosystem.rs (+106/−27 in PR #1293 PAP-171; second touch in 24h | dropped | 2026-06-12 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-iot-rs` | Churn hotspot: backend/servers/api-server/src/routes/iot.rs (+278/-403 in PR #1321/#1322 PAP-151 re-land + fmt) | dropped | 2026-06-12 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-vendors-rs` | Churn hotspot: 929 lines changed in backend/servers/api-server/src/routes/vendors.rs (window 2026-06 | dropped | 2026-06-10 |  |
| 0 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despite metric=5 | dropped | 2026-06-07 |  |
...
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected | dropped | 2026-06-03 |  |

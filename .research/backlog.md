...
| 3 | security | `code-review-api-handlers-hellosign-unbound-envelope` | api-handlers: HelloSign e-signature webhook MAC covers only event_time+event_type — envelope_id is u | ready | 2026-08-26 | [plan](plans/code-review-api-handlers-hellosign-unbound-envelope.md) |
...
| 2 | security | `code-review-api-handlers-esign-webhook-replay` | api-handlers: esignature_webhook has no timestamp/freshness check for any provider — captured delive | open | 2026-08-26 |  |
| 2 | bug | `code-review-reality-web-realtor-api-missing-bearer-header` | reality-web: lib/realtor-api.ts request() sends only credentials:'include' and never merges getAuthH | open | 2026-08-26 |  |
| 2 | bug | `code-review-reality-web-realtor-account-pages-no-i18n` | reality-web: 11 realtor+account page shells (realtor/*, account/*) ship English-only in a 4-locale a | open | 2026-08-26 |  |
...
| 1 | bug | `code-review-mobile-rn-raw-status-untranslated` | mobile-rn: FaultsListScreen/OutagesScreen/AnnouncementDetailScreen render raw enum status strings un | open | 2026-08-26 |  |
| 1 | bug | `code-review-mobile-rn-faultslist-i18n-gap` | mobile-rn: FaultsListScreen hardcodes '+ Report' CTA and capitalizes raw filter option keys — Englis | open | 2026-08-26 |  |
| 1 | bug | `code-review-mobile-rn-hardcoded-button-labels` | mobile-rn: MessagesScreen/PersonMonthsScreen hardcode English button labels ('+ New message'/'Save'/ | open | 2026-08-26 |  |
| 1 | bug | `code-review-reality-web-shared-state-primitives-no-i18n` | reality-web: components/states/ErrorState.tsx and EmptyState.tsx hardcode English defaults (currentl | open | 2026-08-26 |  |

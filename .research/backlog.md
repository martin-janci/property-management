# Backlog of vectors
<sub>Last regenerated: 2026-07-05 02:30 UTC by routine</sub>
...
| 2 | bug | `code-review-ppt-web-core-action-queue-mock-data` | useActionQueue.ts (ppt-web dashboard) renders mock data — queryFn + executeAction never hit the API | open | 2026-07-05 |  |
...
| 1 | dx | `stalled-review-pr-1812` | PR #1812 stalled 9d — churn-hotspot-backend-crates-db-src-repositories-reality-portal-rs split (draft, no revi | open | 2026-07-05 |  |
| 1 | dx | `stalled-review-pr-1797` | PR #1797 stalled 11d — auth on OCR endpoints + manager-gate rental guest PII reads (security fix, draft) | open | 2026-07-05 |  |

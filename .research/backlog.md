# Backlog of vectors
<sub>Last regenerated: 2026-06-18 03:19 UTC by routine</sub>
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-tests-document-folder-tests-rs` | Churn hotspot: document_folder_tests.rs — 1046 lines this run (PR #1454 + folder org work) | open | 2026-06-18 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-tests-accounting-rls-repo-tests-rs` | Churn hotspot: accounting_rls_repo_tests.rs — 823 lines NEW this run (PR #1454 accounting MVP) | open | 2026-06-18 |  |
| 1 | refactor | `repeated-churn-backend-crates-integrations-src-booking-rs` | Repeated-churn: backend/crates/integrations/src/booking.rs — 2nd hotspot run (instability proxy) | open | 2026-06-18 |  |
| 1 | dx | `closed-not-merged-pr-1503` | PR #1503 (fix(tests): seed_membership role arg) closed unmerged — superseded by merged #1507 | open | 2026-06-18 |  |
| 1 | dx | `closed-not-merged-pr-1504` | PR #1504 (fix(db): resolve duplicate migration 00181) closed unmerged | open | 2026-06-18 |  |
| 1 | dx | `closed-not-merged-pr-1505` | PR #1505 (fix(db): cast rental enum columns) closed unmerged — superseded by #1492 | open | 2026-06-18 |  |
| 1 | dx | `closed-not-merged-pr-1506` | PR #1506 (fix(api-server): seed_membership role arg booking-oauth non-manager) closed unmerged — superseded by | open | 2026-06-18 |  |
| 1 | dx | `closed-not-merged-pr-1511` | PR #1511 (fix(api-server): clippy lints accounting routes) closed unmerged — superseded by #1512 | open | 2026-06-18 |  |
...
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET no | dropped | 2026-06-18 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-08-09 00:20 UTC by routine</sub>
...
| 5 | security | `code-review-api-core-dead-middleware-cleanup` | api-core exports 3 dead-but-dangerous middleware layers (rls_context, authorization, tenant_filter)  | ready | 2026-08-09 | [plan](plans/code-review-api-core-dead-middleware-cleanup.md) |
...
| 4 | bug | `code-review-reality-server-sso-oauth-helpers-harden` | reality-server SSO OAuth helpers: no request timeout on reqwest client + 60s negative-cache on trans | ready | 2026-08-09 | [plan](plans/code-review-reality-server-sso-oauth-helpers-harden.md) |
...
| 2 | bug | `code-review-api-core-delay-duration-overflow-before-cap` | workflow delay action multiplies duration before 7-day cap — silent overflow in release, panic in de | open | 2026-08-09 |  |
| 2 | bug | `code-review-api-core-accounting-line-multimatch` | accounting payment matcher accepts the first ambiguous invoice-line hit — silently allocates payment | open | 2026-08-09 |  |
| 2 | bug | `code-review-api-core-vote-reminders-no-cross-tick-dedup` | vote reminders scheduler has no cross-tick dedup — restarts and slow ticks fan out duplicate reminde | open | 2026-08-09 |  |
| 2 | bug | `code-review-api-handlers-reports-unwrap-or-default-silent-zero` | reports handler uses unwrap_or_default on Result — DB failures reported as valid empty/zero payloads | open | 2026-08-09 |  |
| 2 | bug | `code-review-mobile-native-kmp-create-listing-submit-stub` | realtor Create Listing screen's onSubmit hardcoded to failure — shipped broken user flow | open | 2026-08-09 |  |
| 2 | bug | `code-review-ppt-web-core-errorhandler-network-misclassify` | parseApiError runs isNetworkError() first and substring-sniffs any message — structured errors are s | open | 2026-08-09 |  |
...
| 1 | bug | `code-review-api-core-quiet-hours-db-error-fail-open` | notification quiet-hours check fails open on DB error — silent delivery outside quiet window | open | 2026-08-09 |  |
| 1 | bug | `code-review-api-core-accounting-vs-only-amount-ignored` | accounting VS-only match branch ignores amount — variable-symbol collisions allocate incorrect payme | open | 2026-08-09 |  |
| 1 | test-gap | `code-review-api-core-accounting-no-tests` | payment matcher in accounting.rs has zero tests — regressions ship silently | open | 2026-08-09 |  |
| 1 | refactor | `code-review-mobile-native-kmp-apiclient-dead-code-healthcheck-bug` | mobile-native ApiClient is never instantiated — ~100 lines of dead duplicate API logic | open | 2026-08-09 |  |
| 1 | bug | `code-review-ppt-web-core-usewebsocket-handler-dep-gap` | useWebSocket subscribe effect omits handler from deps — stale-handler closures can silently drop ear | open | 2026-08-09 |  |

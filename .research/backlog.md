# Backlog of vectors
<sub>Last regenerated: 2026-06-18 12:35 UTC by routine</sub>

| Score | Vector | ID | Title | Status | Updated | Plan |
|-------|--------|----|----|--------|---------|------|
| 8 | test-gap | `test-gap-document-rs-regression-tests-pr-1551-1565` | Regression tests for document.rs fix PRs #1551 + #1565 (cast/decode bugs on top-churn repo) | open | 2026-06-18 | [plan](plans/test-gap-document-rs-regression-tests-pr-1551-1565.md) |
...
| 4 | test-gap | `test-gap-rental-rs-enum-cast-regression-pr-1537` | Regression tests for rental.rs PR #1537 enum-cast write-paths on rental_guests + forms (#1008) | open | 2026-06-18 | [plan](plans/test-gap-rental-rs-enum-cast-regression-pr-1537.md) |
...
| 2 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→ | open | 2026-06-18 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1561-reality-imports-public-agency` | Regression test gap: PR #1561 admitted public agencies on imports via PortalPrincipal — no test (closes #1300) | open | 2026-06-18 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1539-oauth-public-client` | Regression test gap: PR #1539 rejects public OAuth client with client_secret (invalid_client) — no test | open | 2026-06-18 |  |
| 2 | test-gap | `screen-map-drift-pr-1545-reality` | Screen-map drift: PR #1545 touched reality-web /accounting/layout.tsx with no docs/screens/reality update | open | 2026-06-18 |  |
...
| 1 | refactor | `churn-hotspot-frontend-apps-reality-web-src-app-accounting-layout-tsx` | Churn hotspot: frontend/apps/reality-web/src/app/accounting/layout.tsx — 2 PRs in 48h (build + biome fixes pos | open | 2026-06-18 |  |

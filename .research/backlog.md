...
| 3 | bug | `code-review-mobile-native-kmp-notification-repository-dead-endpoints` | mobile-native-kmp NotificationRepository targets /api/v1/notifications on reality-server — no such r | ready | 2026-08-23 | [plan](plans/code-review-mobile-native-kmp-notification-repository-dead-endpoints.md) |
| 3 | bug | `code-review-mobile-native-kmp-inquiry-viewing-endpoints-wrong-path` | mobile-native-kmp InquiryRepository viewing+create+reply URLs don't match reality-server routes → se | ready | 2026-08-23 | [plan](plans/code-review-mobile-native-kmp-inquiry-viewing-endpoints-wrong-path.md) |
...
| 2 | bug | `code-review-reality-server-drainer-mark-fail-redeliver` | reality-server: search_alert_drainer.mark_notified failure re-drains → duplicate email+push fan-out  | open | 2026-08-23 |  |
| 2 | bug | `code-review-reality-server-sso-sessions-unbounded-map` | reality-server: PendingSsoSession map is unbounded — no background sweep of expired entries → memory | open | 2026-08-23 |  |
...
| 1 | bug | `code-review-reality-server-url-validator-cgnat-gap` | reality-server url_validator omits CGNAT/TEST-NET/benchmark ranges from ipv4_forbidden_reason — SSRF | open | 2026-08-23 |  |

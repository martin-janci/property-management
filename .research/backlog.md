...
| 3 | security | `code-review-api-handlers-voice-webhook-broken-auth` | SECURITY: voice webhook receiver ignores OAuth access token — authenticate_voice_user() returns any  | open | 2026-08-04 |  |

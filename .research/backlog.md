# Backlog of vectors
<sub>Last regenerated: 2026-06-21 18:17 UTC by routine</sub>
...
| 1 | refactor | `churn-hotspot-frontend-apps-ppt-web-src-routes-lazyroutes-tsx` | Churn hotspot: frontend/apps/ppt-web/src/routes/lazyRoutes.tsx (6 changes — IoT/Sentiment/Payment lazy-route r | open | 2026-06-21 |  |
| 1 | refactor | `churn-hotspot-frontend-packages-api-client-src-financial-api-ts` | Churn hotspot: frontend/packages/api-client/src/financial/api.ts (5 changes — financial/payment-matching API c | open | 2026-06-21 |  |
| 1 | refactor | `repeated-churn-backend-crates-db-src-repositories-reality-portal-rs` | Repeated-churn: backend/crates/db/src/repositories/reality_portal.rs (runs_seen=2 — keeps being patched for au | open | 2026-06-21 |  |
| 1 | dx | `closed-not-merged-pr-1647` | PR #1647 closed unmerged — author split IoT mega-PR into #1646/#1652/#1653 (clean split, no regression) | open | 2026-06-21 |  |
| 1 | dx | `closed-not-merged-pr-1636` | PR #1636 closed unmerged — superseded by #1638 + #1632 (#1584 findings 1,4) | open | 2026-06-21 |  |

...
| 2 | bug | `code-review-api-core-payment-matcher-multi-suggest` | payment_matcher: break after first suggestion + decrement remaining | open | 2026-08-17 |  |
| 2 | security | `code-review-api-handlers-share-pw-no-throttle` | Throttle unauthenticated share-password endpoint (brute-force gap) | open | 2026-08-17 |  |
| 2 | bug | `code-review-ppt-web-ui-createfault-mock-ai` | Wire CreateFaultPage photo AI suggestion to real endpoint (drop mock) | open | 2026-08-17 |  |
| 2 | bug | `code-review-ppt-web-ui-moderation-fabricated-context` | Stop fabricating prev_violations/report_source in moderation queue | open | 2026-08-17 |  |
...
| 1 | bug | `code-review-api-core-payment-matcher-vs-only-threshold` | payment_matcher: raise auto-suggest threshold above VS-only match | open | 2026-08-17 |  |
| 1 | bug | `code-review-api-handlers-share-log-proxy-ip` | Log real client IP (not proxy) on share-access audit trail | open | 2026-08-17 |  |
| 1 | bug | `code-review-ppt-web-core-errorhandler-i18n-gap` | i18n client-side errorHandler catalogue (English-only error toasts) | open | 2026-08-17 |  |
| 1 | bug | `code-review-ppt-web-ui-moderation-no-i18n` | Replace ContentModerationPage window.prompt/alert with i18n modals | open | 2026-08-17 |  |
| 1 | bug | `code-review-reality-web-agency-errorstate-i18n` | i18n no-agency empty state in AgencyErrorStates.tsx | open | 2026-08-17 |  |
| 1 | bug | `code-review-reality-web-comparison-view-i18n` | i18n ComparisonView.tsx — full component hardcoded English | open | 2026-08-17 |  |
| 1 | bug | `code-review-reality-web-realtor-mgmt-i18n` | i18n RealtorManagement remove-confirm modal + subtitle | open | 2026-08-17 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-06-26 16:30 UTC by routine</sub>
...
| 2 | bug | `code-review-ppt-web-core-unsafe-api-response-cast` | SessionsPage.tsx unsafe `as unknown as SessionRow[]` cast — API shape drift silently passes through | open | 2026-06-26 |  |
| 2 | test-gap | `screen-map-drift-pr-1822-reality` | PR #1822 touched reality-web auth/callback page.test.tsx without updating docs/screens/reality/* — heuristic, test-file fix | open | 2026-06-26 |  |
| 2 | dx | `unchecked-todo-pr-1844-yaml-verify` | PR #1844 merged with 2 unchecked post-merge verification checkboxes (sprint-status yaml-parse + scope-check scripts) | open | 2026-06-26 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-vendors-rs` | Churn hotspot: 929 lines changed in backend/servers/api-server/src/routes/vendors.rs (window 2026-06 | done | 2026-06-26 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-iot-rs` | Churn hotspot: backend/servers/api-server/src/routes/iot.rs (+278/-403 in PR #1321/#1322 PAP-151 re-land + fmt) | done | 2026-06-26 |  |
...
| 1 | refactor | `code-review-ppt-web-core-console-in-production` | ppt-web websocket.ts ships 9 unconditional console.warn/error calls to prod (api.ts is correctly DEV-gated) | open | 2026-06-26 |  |
| 1 | test-gap | `code-review-ppt-web-core-unhandled-query-errors` | useActionQueue hook returns isError/error but documents no error-boundary contract; silent failures possible | open | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-messaging-rs` | messaging.rs route changed in 6 commits this window (BIT-244, BIT-206, UC-05.9 attachments) — review surface growing | open | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-models-mod-rs` | db models/mod.rs changed in 5 commits this window — model surface expanded for group threads | open | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-models-messaging-rs` | messaging db model churned 5x this window — N-party group threads, full participant list, camelCase serde fixes | open | 2026-06-26 |  |
| 1 | dx | `closed-not-merged-pr-1720` | PR #1720 (fix(ppt-web): add Leases nav link + home tile) closed unmerged 2026-06-23 — verify root issue stayed closed | open | 2026-06-26 |  |
| 1 | dx | `closed-not-merged-pr-1749` | PR #1749 (fix(mobile): exclude app.config.icon.test.ts from tsc typecheck) closed unmerged — superseded by #1748 | open | 2026-06-26 |  |
| 1 | dx | `closed-not-merged-pr-1727` | PR #1727 (fix(ci): unblock backend gate — fmt + RLS baseline) closed unmerged — superseded by other CI fix series | open | 2026-06-26 |  |
| 1 | dx | `closed-not-merged-pr-1698` | PR #1698 (feat(epic-3): story 3.2 unit management UI BIT-188) closed unmerged 2026-06-22 — confirm follow-up exists | open | 2026-06-26 |  |

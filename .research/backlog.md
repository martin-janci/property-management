# Backlog of vectors
<sub>Last regenerated: 2026-08-12 12:32 UTC by routine</sub>
...
| 3 | test-gap | `code-review-api-core-quiet-hours-drain-untested` | api-core: QuietHoursDrainWorker.drain_due() lacks DB-integration coverage — partial-channel-failure ... | ready | 2026-08-12 | [plan](plans/code-review-api-core-quiet-hours-drain-untested.md) |
| 3 | security | `code-review-security-csv-injection-audit-repowide` | api-handlers: PR #2731 fixed CSV formula-injection for vote titles only — GDPR export, reports, mark... | ready | 2026-08-12 | [plan](plans/code-review-security-csv-injection-audit-repowide.md) |
| 3 | bug | `gap-84-2-document-sign-page-ppt-web` | epic-84 story 84-2: signer-facing document-sign page missing in ppt-web — backend signing URL + invi... | open | 2026-08-12 |  |
| 3 | bug | `gap-84-1-s3-direct-upload-frontend-wire` | epic-84 story 84-1: ppt-web upload flow still server-proxied — POST /documents/upload-url (SigV4 pre... | open | 2026-08-12 |  |
...
| 2 | bug | `code-review-ppt-web-core-perfmetrics-listener-leak` | usePerformanceMetrics never removes its visibilitychange/load listeners on cleanup — event-listener ... | open | 2026-08-12 |  |
| 2 | test-gap | `screen-map-drift-pr-2735-ppt` | screen-map drift: PR #2735 modified frontend/apps/ppt-web/src/routes/groups/rentals.tsx (regression ... | open | 2026-08-12 |  |
| 2 | test-gap | `code-review-ppt-web-core-authed-query-keys-structural-guard` | ppt-web: AUTHED_QUERY_KEY_ROOTS logout allowlist has missed a query root 3× in a row — needs structu... | open | 2026-08-12 |  |
...
| 1 | refactor | `churn-hotspot-backend/servers/api-server/src/routes/integrations/webhook.rs` | churn-hotspot: backend/servers/api-server/src/routes/integrations/webhook.rs — 2799 lines churned th... | open | 2026-08-12 |  |
| 1 | refactor | `churn-hotspot-backend/servers/api-server/src/services/scheduler/mod.rs` | churn-hotspot: backend/servers/api-server/src/services/scheduler/mod.rs — 2532 lines churned this ru... | open | 2026-08-12 |  |
| 1 | refactor | `churn-hotspot-backend/servers/api-server/src/routes/financial.rs` | churn-hotspot: backend/servers/api-server/src/routes/financial.rs — 2411 lines churned this run | open | 2026-08-12 |  |
| 1 | refactor | `code-review-reality-web-inquiries-i18n` | reality-web /inquiries page has no next-intl wiring — badges, empty-state, pagination all English on... | open | 2026-08-12 |  |
| 1 | refactor | `code-review-reality-web-saved-searches-i18n` | reality-web /saved-searches page hardcodes English throughout — labels, delete-prompt, empty-state, ... | open | 2026-08-12 |  |
| 1 | refactor | `code-review-reality-web-agency-slug-i18n` | reality-web /agency/[slug] public SEO page hardcodes Slovak on all locales — /en /de /cs render Slov... | open | 2026-08-12 |  |

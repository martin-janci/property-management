# Backlog of vectors
<sub>Last regenerated: 2026-06-20 08:31 UTC by routine</sub>
...
| 2 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs (+404/−29 in PR #1294 Booking.com OTA retry) | open | 2026-06-20 |  |
| 2 | test-gap | `screen-map-drift-pr-1555-ppt` | PR #1555 wired useDeleteFault + useFaultStatistics into FaultsPage (gap-79-1) without updating docs/screens/pp | open | 2026-06-20 |  |
| 2 | test-gap | `screen-map-drift-pr-1559-ppt` | PR #1559 touched routes/groups/announcements.tsx (UC-06 Story 6.3 comments optimistic add) without updating do | open | 2026-06-20 |  |
| 2 | test-gap | `screen-map-drift-pr-1610-ppt` | PR #1610 touched routes/groups/faults.tsx (confirm-delete + closed_count UX) without updating docs/screens/ppt | open | 2026-06-20 |  |
| 2 | test-gap | `screen-map-drift-pr-1611-ppt` | PR #1611 touched routes/** (reports.download-retry.route.test.tsx) without updating docs/screens/ppt/* — test- | open | 2026-06-20 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-rental-rs` | rental.rs repository churned 2x with enum-cast fixes — pattern suggests missing platform_enum::text helper | open | 2026-06-20 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-mfa-rs` | MFA route file churned 3x in one window (security hardening burst — verify RLS + rate-limit + audit-action evi | open | 2026-06-20 |  |
| 1 | bug | `code-review-mobile-native-kmp-deeplink-token-not-url-decoded` | DeepLinkRouter skips URL-decoding while Android Uri.getQueryParameter decodes — SSO tokens diverge per platfor | open | 2026-06-20 |  |
...
| 0 | refactor | `refactor-churn-hotspot-mobile-announcements-test` | Churn hotspot: AnnouncementsScreen.test.ts — 4 PRs this run, instability proxy | done | 2026-06-20 |  |

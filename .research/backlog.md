...
| 3 | bug | `code-review-mobile-native-kmp-inquiries-response-contract` | mobile-native-kmp InquiriesResponse required page_size mismatches reality-server `limit` — MissingFi | ready | 2026-08-16 | [plan](plans/code-review-mobile-native-kmp-inquiries-response-contract.md) |
...
| 1 | refactor | `churn-hotspot-quiet-hours-drain-rs` | churn hotspot: backend/servers/api-server/src/services/quiet_hours_drain.rs — 3 touches in 48h (noti | open | 2026-08-24 |  |
| 1 | refactor | `churn-hotspot-notification-pipeline-rs` | churn hotspot: backend/servers/api-server/src/services/notification_pipeline.rs — 3 touches in 48h | open | 2026-08-24 |  |
| 1 | refactor | `churn-hotspot-granular-notification-repository-rs` | churn hotspot: backend/crates/db/src/repositories/granular_notification.rs — 3 touches in 48h | open | 2026-08-24 |  |

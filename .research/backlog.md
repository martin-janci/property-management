# Backlog of vectors
<sub>Last regenerated: 2026-06-25 16:35 UTC by routine</sub>
...
| 3 | refactor | `refactor-revert-pr-1713` | revert(delegations) — deliberate BIT-213 retirement, not a bug | open | 2026-06-25 |  |
...
| 2 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs (+404/−29 in PR #1294 Booking.com OTA retry) | done | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1630-ppt` | screen-map drift: PR #1630 ppt-web routes (Payment Management wiring) | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1641-ppt` | screen-map drift: PR #1641 ppt-web routes (Sentiment + Predictive Maintenance routes (new group)) | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1654-ppt` | screen-map drift: PR #1654 ppt-web routes (invoice PDF button) | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1685-ppt` | screen-map drift: PR #1685 ppt-web routes (real-time IoT WebSocket) | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1690-ppt` | screen-map drift: PR #1690 ppt-web routes (Delegations feature (REVERTED by #1713 — see revert signal)) | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1694-ppt` | screen-map drift: PR #1694 ppt-web routes (Leases sidebar nav link) | open | 2026-06-25 |  |
...
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new regression t | open | 2026-06-25 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression test for the p | open | 2026-06-25 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixed in PR #1 | open | 2026-06-25 |  |
...
| 1 | refactor | `churn-hotspot-backend/servers/api-server/tests/oauth_integration_tests.rs` | Churn hotspot: backend/servers/api-server/tests/oauth_integration_tests.rs | open | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend/servers/api-server/src/routes/auth.rs` | Churn hotspot: backend/servers/api-server/src/routes/auth.rs | open | 2026-06-25 |  |
| 1 | dx | `dx-closed-not-merged-pr-1720` | PR #1720 closed unmerged: fix(ppt-web): add Leases nav link + home tile (#977) | open | 2026-06-25 |  |
| 1 | dx | `dx-closed-not-merged-pr-1749` | PR #1749 closed unmerged: fix(mobile): exclude app.config.icon.test.ts from tsc typecheck (unblock dev fro | open | 2026-06-25 |  |
| 1 | dx | `dx-closed-not-merged-pr-1727` | PR #1727 closed unmerged: fix(ci): unblock backend gate — organizations fmt + notification_event RLS basel | open | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-mod-rs` | Churn hotspot: backend/crates/integrations/src/booking/mod.rs (2818 lines window 2026-06-16→2026-06-25) | open | 2026-06-25 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-tests-form-rls-repo-tests-rs` | Churn hotspot: backend/crates/db/tests/form_rls_repo_tests.rs touched 2x since 2026-06-12 (window 2026-06-12→2026-06-13) | open | 2026-06-13 |  |
...
| 0 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despite metric=5 | dropped | 2026-06-25 |  |
...
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected | dropped | 2026-06-25 |  |
| 0 | dx | `dx-lag-warning-2026-06-25` | routine has not run in 9d 9h — cloud cron likely paused; dispatcher loop still | open | 2026-06-25 |  |

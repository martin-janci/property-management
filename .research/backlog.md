# Backlog of vectors
<sub>Last regenerated: 2026-07-30 22:28 UTC by routine</sub>

| Score | Vector | ID | Title | Status | Updated | Plan |
|-------|--------|----|----|--------|---------|------|
| 6 | bug | `code-review-reality-server-ssrf-ipv4-mapped-ipv6` | backend/servers/reality-server/src/util/url_validator.rs:150 — the Host::Ipv6 arm of validate_fetch_url() only rejects i | ready | 2026-07-30 | [plan](plans/code-review-reality-server-ssrf-ipv4-mapped-ipv6.md) |
...
| 4 | bug | `code-review-api-core-resolved-rs-leaks-db-error` | SECURITY-LITE: layout/resolved.rs err500 handler leaks raw sqlx/serde error text on public GET /layout/resolved/{screen} — 8 sites, no server-side log | open | 2026-07-30 |  |
| 3 | security | `code-review-reality-server-users-login-no-rate-limit` | backend/servers/reality-server/src/routes/users.rs:45-47 register the PUBLIC UNAUTHENTICATED auth endpoints POST /api/v1 | ready | 2026-07-30 | [plan](plans/code-review-reality-server-users-login-no-rate-limit.md) |
...
| 2 | bug | `code-review-api-handlers-reports-csv-injection` | backend/servers/api-server/src/routes/reports/mod.rs:363-397 (generate_sync_csv_report, faults branch) — writes user-con | open | 2026-07-30 |  |
| 2 | bug | `code-review-reality-server-raw-db-error-leak-multi` | Multiple internet-facing reality-server handlers return the RAW underlying sqlx/anyhow error string as the Axum (StatusC | open | 2026-07-30 |  |
| 2 | bug | `code-review-reality-server-pwreset-email-not-wired` | backend/servers/reality-server/src/routes/users.rs:453-486 — request_password_reset's success branch (PasswordResetReque | open | 2026-07-30 |  |
| 2 | bug | `code-review-reality-server-sso-redirect-backslash-openredirect` | backend/servers/reality-server/src/routes/sso.rs:147 — check_redirect_uri_allowed() treats any value that starts_with('/ | open | 2026-07-30 |  |
| 2 | bug | `code-review-reality-server-branding-color-unvalidated` | backend/servers/reality-server/src/routes/agency_branding.rs:116-131,324-325 — UpdateBrandingRequest.primary_color / sec | open | 2026-07-30 |  |
| 2 | bug | `code-review-reality-server-imports-raw-error-leak` | backend/servers/reality-server/src/routes/imports.rs:134-138 (list_import_jobs) and siblings at :167-170 (get_import_job | open | 2026-07-30 |  |
...
| 1 | bug | `code-review-api-core-admin-rs-swallowed-serialize` | layout/admin.rs (+ tenant.rs) mutation handlers end with unwrap_or_default() serialize — a failed serialize returns 200 OK / body null instead of 500 | open | 2026-07-30 |  |
| 1 | bug | `code-review-api-core-scheduler-rs-silent-target-err` | scheduler.rs silently swallows DB errors on notification target lookups at 3 sites — failed dispatches show as empty target sets, no log/metric | open | 2026-07-30 |  |
| 1 | bug | `code-review-ppt-web-ui-movefolder-i18n` | frontend/apps/ppt-web/src/features/documents/components/MoveFolderDialog.tsx (802 lines, a Phase-1 churn hotspot) render | open | 2026-07-30 |  |
| 1 | bug | `code-review-ppt-web-ui-sharepanel-i18n` | frontend/apps/ppt-web/src/features/documents/components/DocumentSharePanel.tsx has 0 useTranslation/t() calls and render | open | 2026-07-30 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-admin-web-src-pages-MobileConfigPage-tsx` | Churn hotspot: frontend/apps/admin-web/src/pages/MobileConfigPage.tsx — 365 lines this window (PR #2601 no-op-save fix). | open | 2026-07-30 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-admin-web-src-pages-platform-tsx` | Churn hotspot: frontend/apps/admin-web/src/pages/platform.tsx — 235 lines this window (PR #2601 no-op-save fix). | open | 2026-07-30 |  |

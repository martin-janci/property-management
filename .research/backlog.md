# Backlog of vectors
<sub>Last regenerated: 2026-06-24 20:30 UTC by routine</sub>
...
| 3 | refactor | `refactor-revert-pr-1713` | PR #1713 reverts delegation frontend re-add (#1690) — reconciles with retirement | open | 2026-06-24 |  |
...
| 2 | dx | `dx-unchecked-todo-pr-1606` | PR body has unchecked `- [ ] cargo test -p api-server accounting_contacts` after | open | 2026-06-24 |  |
| 2 | dx | `dx-unchecked-todo-pr-1723` | PR body has unchecked CI checkboxes (`- [ ] cargo fmt --all -- --check` etc) aft | open | 2026-06-24 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-messaging-rs` | Touched by PRs #1750 (epic-18 guest-ID-doc OCR seam), #1756 (camelCase wire cont | open | 2026-06-24 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-models-messaging-rs` | Touched by PRs #1750, #1756, #1768 — all messaging-domain wire-contract / model  | open | 2026-06-24 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-tests-messaging-attachments-authz-tests-rs` | Touched by PRs #1750, #1755 (migration dup-version fix), #1756 — test churn trac | open | 2026-06-24 |  |
| 1 | dx | `dx-closed-not-merged-pr-1720` | PR #1720 closed without merge — 'fix(ppt-web): add Leases nav link + home tile ( | open | 2026-06-24 |  |
| 1 | dx | `dx-closed-not-merged-pr-1749` | PR #1749 closed without merge — 'fix(mobile): exclude app.config.icon.test.ts fr | open | 2026-06-24 |  |
| 1 | dx | `dx-closed-not-merged-pr-1727` | PR #1727 closed without merge — 'fix(ci): unblock backend gate — organizations f | open | 2026-06-24 |  |
| 1 | dx | `dx-closed-not-merged-pr-1698` | PR #1698 closed without merge — 'feat(epic-3): story 3.2 - unit management UI (B | open | 2026-06-24 |  |
| 1 | dx | `dx-closed-not-merged-pr-1634` | PR #1634 closed without merge — '[PM #1627] saved-search alerts list: signal tru | open | 2026-06-24 |  |
| 1 | dx | `dx-closed-not-merged-pr-1647` | PR #1647 closed without merge — 'feat(iot): sensor register + edit + standalone  | open | 2026-06-24 |  |
| 1 | dx | `dx-closed-not-merged-pr-1636` | PR #1636 closed without merge — 'fix(reality-server): reconcile portal import au | open | 2026-06-24 |  |

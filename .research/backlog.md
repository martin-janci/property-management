# Backlog of vectors
<sub>Last regenerated: 2026-06-21 20:28 UTC by routine</sub>
...
| 3 | bug | `unchecked-todo-pr-1625` | PR #1625 (voting PDF generation + archive PAP-288) merged with unchecked TODOs — also broke dev backend CI (#1 | open | 2026-06-21 |  |
| 3 | security | `unchecked-todo-pr-1606` | PR #1606 (accounting list_contacts manager-only role gate PAP-281) merged with unchecked TODOs | open | 2026-06-21 |  |
...
| 2 | test-gap | `screen-map-drift-pr-1642-reality` | Screen-map drift: #1642 touched reality routes without updating docs/screens/reality/*.md | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1641-ppt` | Screen-map drift: #1641 touched ppt routes without updating docs/screens/ppt/*.md | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1654-ppt` | Screen-map drift: #1654 touched ppt routes without updating docs/screens/ppt/*.md | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1630-ppt` | Screen-map drift: #1630 touched ppt routes without updating docs/screens/ppt/*.md | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1621-ppt` | Screen-map drift: #1621 touched ppt routes without updating docs/screens/ppt/*.md | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1621-reality` | Screen-map drift: #1621 touched reality routes without updating docs/screens/reality/*.md | open | 2026-06-21 |  |
| 2 | test-gap | `unchecked-todo-pr-1642` | PR #1642 (portal-user listing CRUD owner/realtor edit) merged with unchecked TODOs in body | open | 2026-06-21 |  |
| 2 | test-gap | `unchecked-todo-pr-1641` | PR #1641 (Sentiment & Predictive Maintenance dashboards Epic 13) merged with unchecked TODOs | open | 2026-06-21 |  |
| 2 | test-gap | `hotfix-no-test-pr-1639` | PR #1639 (fix airbnb manager-gate config reads, closes #1626) merged without test diff | open | 2026-06-21 |  |
| 2 | test-gap | `hotfix-no-test-pr-1658` | PR #1658 (fix mobile API_BASE_URL through Constants single source UC-85) merged without test diff | open | 2026-06-21 |  |
...
| 1 | refactor | `churn-hotspot-docs-functional-requirements-md` | Churn hotspot: docs/functional-requirements.md — 7116 line-changes since 2026-06-16 | open | 2026-06-21 |  |
| 1 | refactor | `churn-hotspot-_bmad-output-epics-md` | Churn hotspot: _bmad-output/epics.md — 5514 line-changes since 2026-06-16 | open | 2026-06-21 |  |

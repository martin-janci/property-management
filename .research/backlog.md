# Backlog of vectors
<sub>Last regenerated: 2026-08-06 16:43 UTC by routine</sub>
...
| 3 | bug | `code-review-ppt-web-core-ws-pong-timeout-drop` | ppt-web notification WS force-closes every ~40s — client app-level ping has no server counterpart | ready | 2026-08-06 | [plan](plans/code-review-ppt-web-core-ws-pong-timeout-drop.md) |
...
| 2 | dx | `fixme-pr-2664-portfolio-dashboard-page-nav-todo` | resolve TODO in portfolio dashboard navigation stub (PR #2664) | open | 2026-08-06 |  |
| 2 | test-gap | `hotfix-no-test-pr-2664` | add regression tests for fix(UC-144): wire portfolio dashboard to real API, remove mock data (# | open | 2026-08-06 |  |
| 2 | test-gap | `hotfix-no-test-pr-2666` | add regression tests for fix(api-server): persist voice-reported faults instead of returning a  | open | 2026-08-06 |  |
| 2 | test-gap | `hotfix-no-test-pr-2668` | add regression tests for fix(reality-server): reject IPv4-mapped IPv6 in SSRF URL guard (#2668) | open | 2026-08-06 |  |
| 2 | test-gap | `hotfix-no-test-pr-2670` | add regression tests for fix(api-server): source Slovak/Czech vote-minutes documents from persi | open | 2026-08-06 |  |
| 2 | test-gap | `hotfix-no-test-pr-2672` | add regression tests for fix(api-server): verify Alexa voice webhook request signatures (#2672) | open | 2026-08-06 |  |
| 2 | test-gap | `hotfix-no-test-pr-2677` | add regression tests for fix(common): validate resolved IPs to close DNS-hostname SSRF bypass ( | open | 2026-08-06 |  |
| 2 | test-gap | `hotfix-no-test-pr-2678` | add regression tests for fix(api-server): propagate announcement target-resolution errors inste | open | 2026-08-06 |  |
| 2 | test-gap | `hotfix-no-test-pr-2679` | add regression tests for fix(api-server): stop fabricating success on voice check-balance (#267 | open | 2026-08-06 |  |
| 2 | bug | `risky-churn-pr-2664-PortfolioDashboardPage-tsx` | reduce risky-churn on PortfolioDashboardPage-tsx (fix PR #2664 landed without tests) | open | 2026-08-06 |  |
| 2 | bug | `risky-churn-pr-2666-voice_webhooks-rs` | reduce risky-churn on voice_webhooks-rs (fix PR #2666 landed without tests) | open | 2026-08-06 |  |
| 2 | bug | `risky-churn-pr-2672-voice_webhooks-rs` | reduce risky-churn on voice_webhooks-rs (fix PR #2672 landed without tests) | open | 2026-08-06 |  |
| 2 | bug | `code-review-acc-qr-endpoint-missing-status-guard` | PR #2559 get_invoice_qr has no cancelled/draft status guard — emits payment QR for voided invoices | open | 2026-08-06 |  |
| 2 | bug | `code-review-reality-server-inquiries-no-ratelimit` | reality-server inquiry-create endpoint has no rate limiting (spam / abuse vector) | open | 2026-08-06 |  |
| 2 | bug | `code-review-reality-server-listing-viewcount-hardcoded-zero` | reality-server listing view_count hardcoded to 0 — analytics + trending endpoint useless | open | 2026-08-06 |  |
| 2 | bug | `code-review-ppt-web-core-ws-giveup-no-resume` | ppt-web WS reconnect never resumes after online/offline transition or 10-attempt give-up | open | 2026-08-06 |  |
| 2 | bug | `code-review-api-handlers-enhanced-chat-stub` | api-server enhanced-chat handler is a stub — feature not implemented | open | 2026-08-06 |  |
| 2 | bug | `code-review-mobile-rn-auth-restore-stale-token` | mobile-rn AuthContext restores expired access token on cold start (no expiry check) | open | 2026-08-06 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-auth-mod-rs` | stabilise churn hotspot backend/servers/api-server/src/routes/auth/mod.rs | open | 2026-08-06 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-voice-webhooks-rs` | stabilise churn hotspot backend/servers/api-server/src/routes/voice_webhooks.rs | open | 2026-08-06 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-ppt-web-src-features-portfolio-performance-pages-PortfolioDashboardPage-tsx` | stabilise churn hotspot frontend/apps/ppt-web/src/features/portfolio-performance/pages/PortfolioDash | open | 2026-08-06 |  |
| 1 | dx | `stalled-review-pr-2555` | unstick PR #2555 — stalled without reviewDecision | open | 2026-08-06 |  |
| 1 | dx | `stalled-review-pr-2558` | unstick PR #2558 — stalled without reviewDecision | open | 2026-08-06 |  |
| 1 | dx | `stalled-review-pr-2559` | unstick PR #2559 — stalled without reviewDecision | open | 2026-08-06 |  |
| 1 | bug | `code-review-reality-server-inquiry-email-stub` | reality-server inquiry email notification is a stub — realtors never receive inquiry emails | open | 2026-08-06 |  |
| 1 | bug | `code-review-reality-server-orphan-listinghandler-stub-detail` | reality-server orphan listing-detail handler returns stub payload | open | 2026-08-06 |  |
| 1 | bug | `code-review-reality-server-orphan-schedule-viewing-stub` | reality-server schedule-viewing handler is an orphan stub | open | 2026-08-06 |  |
| 1 | security | `code-review-api-handlers-ai-upstream-error-leak` | api-server AI handler leaks upstream provider error strings to client (information disclosure) | open | 2026-08-06 |  |
| 1 | bug | `code-review-mobile-rn-biometric-prompt-i18n` | mobile-rn enableBiometric prompt strings hardcoded English (bypasses i18n) | open | 2026-08-06 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-06-22 20:30 UTC by routine</sub>
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→18:30Z) | open | 2026-06-22 |  |
...
| 1 | refactor | `refactor-churn-hotspot-mobile-announcements` | Churn hotspot: AnnouncementsScreen.tsx — 4 PRs this run, instability proxy | done | 2026-06-22 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-rental-rs` | Churn hotspot: 2893 lines changed in backend/crates/db/src/repositories/rental.rs | open | 2026-06-22 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-tests-oauth_integration_tests-rs` | Churn hotspot: 2718 lines changed in backend/servers/api-server/tests/oauth_integration_tests.rs | open | 2026-06-22 |  |

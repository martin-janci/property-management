...
| 3 | security | `code-review-reality-server-invitation-authz-escalation` | SECURITY: reality-server create_invitation lacks agency-membership check — any authenticated user jo | ready | 2026-08-05 | [plan](plans/code-review-reality-server-invitation-authz-escalation.md) |
...
| 2 | bug | `code-review-reality-server-my-reports-total-page-length` | reality-server list_my_reports returns page length as `total` — pagination broken (client cannot com | open | 2026-08-05 |  |
...
| 1 | refactor | `churn-hotspot-backend/servers/api-server/src/routes/voice_webhooks.rs` | Churn hotspot: voice_webhooks.rs — 223-line security fix landed via PR #2660 (broken-auth in authent | open | 2026-08-05 |  |
| 1 | refactor | `repeated-churn-frontend/apps/mobile/src/screens/messages/ThreadDetailScreen.tsx` | Repeated churn: ThreadDetailScreen.tsx — hardened across runs_seen=2 consecutive runs (i18n + timest | open | 2026-08-05 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-07-18 02:19 UTC by routine</sub>
...
| 2 | test-gap | `screen-map-drift-pr-2411-ppt` | Screen-map drift: PR #2411 changed ppt-web reports.tsx without updating docs/screens/ppt/reports.md | open | 2026-07-18 |  |
| 2 | test-gap | `screen-map-drift-pr-2384-ppt` | Screen-map drift: PR #2384 changed ppt-web reports.tsx without updating docs/screens/ppt/reports.md | open | 2026-07-18 |  |
| 2 | test-gap | `screen-map-drift-pr-2373-reality` | Screen-map drift: PR #2373 changed reality-web listing-detail helpers without updating docs/screens/reality/listing-detail.md | open | 2026-07-18 |  |
| 2 | security | `code-review-api-core-ssrf-validator-drift` | Workflow ApiCallExecutor uses a local SSRF validator that drifts from common::url_validation — accepts http:// in prod, no multicast/redirect guard | ready | 2026-07-18 | [plan](plans/code-review-api-core-ssrf-validator-drift.md) |
...
| 1 | refactor | `repeated-churn-backend/servers/api-server/src/routes/reports.rs` | Repeated-churn: backend/servers/api-server/src/routes/reports.rs (runs_seen=3 this run, +3361 lines from PR #2340 + follow-ups) | open | 2026-07-18 |  |

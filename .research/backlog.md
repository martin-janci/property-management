# Backlog of vectors
<sub>Last regenerated: 2026-08-01 03:13 UTC by routine</sub>
...
| 3 | bug | `code-review-api-core-scheduler-dev-email-baked` | SECURITY-LITE: Scheduler EmailService baked to development() at construction — scheduler-triggered email notifications silently no-op in prod (announcements, votes, payment-due) | ready | 2026-08-01 | [plan](plans/code-review-api-core-scheduler-dev-email-baked.md) |
...
| 2 | bug | `code-review-api-core-votes-reminder-spam` | Bug: send_vote_reminders has no persistent per-tick dedup — every ~60s scheduler tick re-fires notify_vote_reminder for every non-voter within the reminder window | open | 2026-08-01 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-2600-reality` | Screen-map drift: reality-web layout changed without docs/screens/reality/ update (PR #2600) | done | 2026-08-01 |  |
...
| 1 | refactor | `refactor-churn-hotspot-admin-web-tenant-lifecycle-page-2026-08-01` | Churn hotspot: frontend/apps/admin-web/src/pages/TenantLifecyclePage.tsx — 117 lines this window (PR #2616 @ppt/ui-kit primitive migration) | open | 2026-08-01 |  |

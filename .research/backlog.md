# Backlog of vectors
<sub>Last regenerated: 2026-06-28 03:35 UTC by routine</sub>
...
| 1 | bug | `code-review-mobile-native-kmp-deeplink-token-not-url-decoded` | DeepLinkRouter skips URL-decoding while Android Uri.getQueryParameter decodes — SSO tokens diverge per platfor | open | 2026-06-28 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→ | done | 2026-06-28 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-migration-rs` | Churn hotspot: backend/servers/api-server/src/routes/migration.rs — 2921 lines changed (+2338/-583) since 2026 | open | 2026-06-28 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-messaging-rs` | Churn hotspot: backend/servers/api-server/src/routes/messaging.rs — 2228 lines changed (+2141/-87) since 2026- | open | 2026-06-28 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-data_residency-rs` | Churn hotspot: backend/servers/api-server/src/routes/data_residency.rs — 2050 lines changed (+1554/-496) since | open | 2026-06-28 |  |
| 1 | triage | `untriaged-issue-issue-1904` | Follow-up issue #1904: harden migration-version collision guard — add a test + auto-discover dirs | open | 2026-06-28 |  |
| 1 | triage | `untriaged-issue-issue-1905` | Follow-up issue #1905: tenant-migration endpoints — duplicate migration number + import/export still stubbed | open | 2026-06-28 |  |
| 1 | triage | `untriaged-issue-issue-1906` | Follow-up issue #1906: regional-compliance quorum lookup is dead code + missing role checks/test gaps | open | 2026-06-28 |  |
| 1 | triage | `untriaged-issue-issue-1851` | Follow-up issue #1851: harden PlatformAdminRepository against runtime-only SQL typos (use compile-time sqlx) | open | 2026-06-28 |  |
| 1 | triage | `untriaged-issue-issue-1852` | Follow-up issue #1852: favorite alert worker — use checked sqlx macros, batch per-org scans, tighten aborts | open | 2026-06-28 |  |
...
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET no | dropped | 2026-06-28 |  |
...
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-sensor-rs` | Churn hotspot: backend/crates/db/src/repositories/sensor.rs (+248/-86 in PR #1321/#1322 PAP-151 re-land + fmt) | dropped | 2026-06-28 |  |
...
| 0 | dx | `dx-stalled-review-pr-988` | Stalled review: PR #988 (Epic: reusable Playwright E2E framework + sitemap FlowRunner) open 10d, no reviewDeci | dropped | 2026-06-28 |  |
...
| 0 | refactor | `churn-hotspot-backend-crates-db-tests-form-rls-repo-tests-rs` | Churn hotspot: backend/crates/db/tests/form_rls_repo_tests.rs touched 2x since 2026-06-12 (window 2026-06-12→2 | dropped | 2026-06-28 |  |

...
| 3 | security | `code-review-reality-server-sso-pending-sessions-unbounded` | reality-server: /api/v1/sso/login grows sso_sessions HashMap unboundedly — memory DoS | ready | 2026-08-10 | [plan](plans/code-review-reality-server-sso-pending-sessions-unbounded.md) |
...
| 2 | security | `code-review-reality-server-sso-upstream-no-timeout` | reality-server: SSO upstream reqwest clients have no timeout — slow PM OAuth pins handler tasks | ready | 2026-08-10 | [plan](plans/code-review-reality-server-sso-upstream-no-timeout.md) |
...
| 1 | bug | `code-review-reality-server-import-jobs-total-is-page-length` | reality-server: GET /api/v1/imports/jobs `total` is jobs.len() — silently caps at page size | open | 2026-08-10 |  |
| 1 | refactor | `churn-hotspot-backend-servers-reality-server-src-state-rs` | hotspot: backend/servers/reality-server/src/state.rs (1201 lines churned across 3 commits) | open | 2026-08-10 |  |
| 1 | refactor | `churn-hotspot-backend-servers-reality-server-src-routes-agencies-rs` | hotspot: backend/servers/reality-server/src/routes/agencies.rs (624 lines churned across 3 commits) | open | 2026-08-10 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-07-07 12:15 UTC by routine</sub>
...
| 1 | refactor | `refactor-churn-hotspot-backend-crates-integrations-src-booking-mod-rs` | Churn hotspot: backend/crates/integrations/src/booking/mod.rs (2818 lines-churn this run) | open | 2026-07-07 |  |
| 1 | refactor | `refactor-churn-hotspot-backend-servers-api-server-tests-oauth-integration-tests-rs` | Churn hotspot: backend/servers/api-server/tests/oauth_integration_tests.rs (2719 lines-churn; runs_seen=3) | open | 2026-07-07 |  |
...
| 0 | refactor | `refactor-churn-hotspot-backend-servers-api-server-src-routes-auth-rs` | Churn hotspot: backend/servers/api-server/src/routes/auth.rs (2648 lines-churn this run) | open | 2026-07-07 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-07-11 03:10 UTC by routine</sub>
...
| 3 | security | `code-review-mobile-native-kmp-android-sso-missing-csrf-state` | Android SSO deep-link handler skips CSRF state check — session-fixation via reality://sso?token=... (iOS enforces state) | ready | 2026-07-11 | [plan](plans/security-android-sso-missing-csrf-state.md) |
...
| 2 | bug | `code-review-mobile-native-kmp-android-no-session-persistence` | Android app has no token persistence — SSO session lost on every cold start (iOS uses Keychain) | open | 2026-07-11 |  |
...
| 1 | dx | `dx-stalled-review-pr-2018` | PR #2018 (chore(deps): bump aes-gcm 0.10.3 → 0.11.0) — dependabot PR stalled at 8d, no reviewDecision | open | 2026-07-11 |  |

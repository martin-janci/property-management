# Backlog of vectors
<sub>Last regenerated: 2026-07-18 18:20 UTC by routine</sub>
...
| 2 | test-gap | `screen-map-drift-pr-2411-ppt` | PR #2411 touched frontend/apps/ppt-web/src/routes/groups/reports.tsx + features/reports/components/ScheduleForm.tsx without updating docs/screens/ppt/reports.md | open | 2026-07-18 |  |
| 2 | test-gap | `screen-map-drift-pr-2384-ppt` | PR #2384 touched frontend/apps/ppt-web/src/routes/groups/reports.tsx + features/reports/components/ScheduleForm.tsx without updating docs/screens/ppt/reports.md | open | 2026-07-18 |  |
| 2 | test-gap | `screen-map-drift-pr-2373-reality` | PR #2373 refactored reality-web listing-detail page/schema/metadata without updating docs/screens/reality/listing-detail.md | open | 2026-07-18 |  |
| 2 | security | `code-review-ppt-web-ui-marketplace-website-href-xss` | Provider-controlled website URL rendered as <a href={provider.website}> with no scheme allow-list — stored-XSS via javascript: URI on ProviderDetailPage | ready | 2026-07-18 | [plan](plans/code-review-ppt-web-ui-marketplace-website-href-xss.md) |
| 2 | refactor | `code-review-ppt-web-ui-marketplace-i18n-regression` | Marketplace + advanced-notifications slices ship with 0 useTranslation calls — hardcoded English regressing PR #2411 localization convention | open | 2026-07-18 |  |
...
| 1 | refactor | `churn-hotspot-frontend-packages-sitemap-src-json-generate-ts` | Churn hotspot: frontend/packages/sitemap/src/json/generate.ts — 2 touches this run (PR #2397 determinism, PR #2407 drift-guard) | open | 2026-07-18 |  |
| 1 | refactor | `churn-hotspot-frontend-packages-screen-map-src-init-write-ts` | Churn hotspot: frontend/packages/screen-map/src/init-write.ts — 2 touches this run (validation hardening) | open | 2026-07-18 |  |
| 1 | refactor | `churn-hotspot-frontend-packages-reality-api-client-src-favorites-hooks-ts` | Churn hotspot: frontend/packages/reality-api-client/src/favorites/hooks.ts — 2 touches this run (AC-5 price-alert + DTO reconcile) | open | 2026-07-18 |  |
| 1 | test-gap | `code-review-ppt-web-ui-marketplace-notifications-untested` | Marketplace + advanced-notifications slices ship without any sibling *.test.* files — 0 tests for non-trivial view-state / filter-reducer / mutation-error logic | open | 2026-07-18 |  |

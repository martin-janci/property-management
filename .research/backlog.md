# Backlog of vectors
<sub>Last regenerated: 2026-06-19 14:13 UTC by routine</sub>
...
| 3 | security | `code-review-api-handlers-disable-mfa-no-ratelimit` | Rate-limit recovery-code path in disable_mfa (mirrors verify_recovery_code throttle) | ready | 2026-06-19 | [plan](plans/security-disable-mfa-recovery-no-ratelimit.md) |
| 3 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs (+404/−29 in PR #1294 Booking.com OTA retry) | open | 2026-06-19 |  |
...
| 2 | security | `code-review-api-handlers-totp-verify-no-throttle` | Add brute-force throttle to /mfa/verify and /backup-codes/regenerate TOTP paths | ready | 2026-06-19 | [plan](plans/security-mfa-totp-verify-no-throttle.md) |
| 2 | test-gap | `screen-map-drift-pr-1545-reality` | screen-map-drift-pr-1545-reality | open | 2026-06-19 |  |
| 2 | test-gap | `screen-map-drift-pr-1555-ppt` | screen-map-drift-pr-1555-ppt | open | 2026-06-19 |  |
| 2 | test-gap | `screen-map-drift-pr-1559-ppt` | screen-map-drift-pr-1559-ppt | open | 2026-06-19 |  |
...
| 1 | bug | `code-review-api-handlers-db-error-masked` | Stop swallowing DB errors with unwrap_or_default in disable_mfa recovery-code path | open | 2026-06-19 |  |
| 1 | triage | `triage-issue-1604` | Issue #1604 (needs-human-review, OPEN): Dispatcher backlog exhausted — coverage.json (2026-06-16) stale, producing only already-shipped no-op tasks | open | 2026-06-19 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-tests-api_ecosystem_developer_force_rls_tests-rs` | churn-hotspot-backend-crates-db-tests-api_ecosystem_developer_force_rls_tests-rs | open | 2026-06-19 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-mfa-rs` | churn-hotspot-backend-servers-api-server-src-routes-mfa-rs | open | 2026-06-19 |  |
...
| 0 | refactor | `refactor-churn-hotspot-mobile-announcements-test` | Churn hotspot: AnnouncementsScreen.test.ts — 4 PRs this run, instability proxy | done | 2026-06-19 |  |

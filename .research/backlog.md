...
| 3 | bug | `code-review-mobile-native-kmp-android-session-not-persisted` | mobile-native-kmp Android: SsoService scoped to MainActivity + no session token store — rotation / c | ready | 2026-08-24 | [plan](plans/code-review-mobile-native-kmp-android-session-not-persisted.md) |
...
| 2 | bug | `code-review-mobile-native-kmp-create-listing-stub-submit` | mobile-native-kmp Android CreateListingScreen Publish button is a hard NotImplementedError stub — re | open | 2026-08-24 |  |
| 2 | bug | `code-review-mobile-native-kmp-agency-hub-fabricated-metrics` | mobile-native-kmp Android AgencyHubScreen renders hardcoded '42 active / 18 new / 2.4h avg' stats an | open | 2026-08-24 |  |
...
| 1 | dx | `stalled-review-pr-2744` | stalled review: PR #2744 dispatcher un-wedge (11d open as DRAFT, CI green, dispatcher-reviewer verdi | needs-human-judgement | 2026-08-24 |  |

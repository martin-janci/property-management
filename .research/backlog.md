# Backlog of vectors
<sub>Last regenerated: 2026-06-18 20:30 UTC by routine</sub>
...
| 3 | dx | `dx-pm-coverage-stale-2026-06-18` | Refresh coverage.json — dispatcher buffer empty (claimable=0) | open | 2026-06-18 |  |
...
| 2 | test-gap | `test-gap-screen-map-drift-pr-1545-reality` | PR #1545 touched reality-web app (frontend/apps/reality-web/src/app/accounting | open | 2026-06-18 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1555-ppt` | PR #1555 touched ppt-web routes (frontend/apps/ppt-web/src/routes/groups/fault | open | 2026-06-18 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1559-ppt` | PR #1559 touched ppt-web routes (frontend/apps/ppt-web/src/routes/groups/annou | open | 2026-06-18 |  |
...
| 2 | test-gap | `screen-map-drift-pr-1418-ppt` | PR #1418 touched routes/** (faults.route.test.tsx) without updating docs/screens/ppt/* — heuristic, test-fil | open | 2026-06-16 |  |
| 2 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardc | open | 2026-06-16 |  |
| 2 | bug | `code-review-mobile-rn-deeplink-init-unhandled` | useDeepLinkRouting.ts:27-36 — initialize() re-runs on onNavigate identity change + void promise with no .cat | open | 2026-06-16 |  |
...
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1288-webhook-rls` | Webhook handlers RLS migration (PR #1288, PAP-170) shipped without a new regression test for repo-layer meth | open | 2026-06-11 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new  | open | 2026-06-11 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression te | open | 2026-06-11 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfi | open | 2026-06-11 |  |
...
| 2 | bug | `code-review-mobile-native-kmp-deeplink-token-not-url-decoded` | DeepLinkRouter skips URL-decoding while Android Uri.getQueryParameter decodes — SSO tokens diverge per platf | open | 2026-06-06 |  |
...
| 2 | test-gap | `test-gap-screen-map-drift-pr-1100-ppt` | Screen-map drift: PR #1100 modified ppt-web App.tsx (FileDisputePageRoute extraction) without screen-doc upd | open | 2026-06-05 |  |
...
| 1 | triage | `triage-dispatcher-mcp-push-large-file-issue-1014` | Dispatcher action-list.json corruption when MCP push falls back from blocked git push | dropped | 2026-06-18 |  |
| 1 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET  | dropped | 2026-06-18 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-tests-api-ecosystem-developer-force-rls-tests-rs` | backend/crates/db/tests/api_ecosystem_developer_force_rls_tests.rs touched in  | open | 2026-06-18 |  |
| 1 | refactor | `repeated-churn-backend-crates-integrations-src-booking-rs` | backend/crates/integrations/src/booking.rs hot across multiple runs (last_seen | open | 2026-06-18 |  |
| 1 | refactor | `churn-hotspot-backend-Cargo-toml` | backend/Cargo.toml touched in 2 commits this run | open | 2026-06-18 |  |
| 1 | test-gap | `test-gap-screen-map-drift-pr-922-ppt` | Screen-map drift: PR #922 modified ppt-web App.tsx (dev-review rounds 1-5 fixes) without a docs/screens/ppt  | open | 2026-06-16 |  |
...
| 1 | dx | `dx-stalled-review-pr-1179` | PR #1179 (docs(epics) catalog backfill for 37 mounted-but-undocumented backend modules) — stalled at 7d, no  | open | 2026-06-16 |  |
...
| 1 | refactor | `code-review-api-core-osrng-expect` | crypto.rs:127 SysRng.try_fill_bytes(...).expect() panics if OS CSPRNG errors during integration-credential e | open | 2026-06-15 |  |
| 1 | triage | `triage-issue-1331` | Issue #1331 (no labels, OPEN): Backend `test` job red/hanging on dev base — blocks the entire backend merge  | open | 2026-06-13 |  |
| 1 | dx | `dx-stalled-review-pr-988` | Stalled review: PR #988 (Epic: reusable Playwright E2E framework + sitemap FlowRunner) open 10d, no reviewDe | open | 2026-06-13 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-tests-reserve-funds-cross-org-idor-tests-rs` | Churn hotspot: backend/servers/api-server/tests/reserve_funds_cross_org_idor_tests.rs touched 2x since 2026- | open | 2026-06-13 |  |
...
| 1 | dx | `closed-not-merged-pr-1274` | PR #1274 (cargo-minor-patch group, /backend, 9 updates) closed unmerged — superseded by #1313 after auto-reb | open | 2026-06-12 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-api-ecosystem-rs` | Churn hotspot: backend/servers/api-server/src/routes/api_ecosystem.rs (+106/−27 in PR #1293 PAP-171; second  | open | 2026-06-12 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-iot-rs` | Churn hotspot: backend/servers/api-server/src/routes/iot.rs (+278/-403 in PR #1321/#1322 PAP-151 re-land + f | open | 2026-06-12 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05 | open | 2026-06-10 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-10 0 | open | 2026-06-10 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-06-10 03: | open | 2026-06-10 |  |
...
| 1 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 desp | open | 2026-06-07 |  |

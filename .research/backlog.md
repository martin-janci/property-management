# Backlog of vectors
<sub>Last regenerated: 2026-06-25 03:30 UTC by routine</sub>
...
| 3 | bug | `code-review-reality-web-share-comparison-404` | Reality-web ComparisonUrlHandler hits non-existent /api/listings/${id} — every shared comparison URL 404s | done | 2026-06-25 | [plan](plans/code-review-reality-web-share-comparison-404.md) |
| 3 | bug | `code-review-reality-web-listing-page-ssr-crash` | Reality-web listing detail SSR crashes on partial 200 body — JSON-LD build deref of undefined fields | done | 2026-06-25 | [plan](plans/code-review-reality-web-listing-page-ssr-crash.md) |
| 3 | bug | `code-review-reality-web-realtor-mgmt-untranslated` | Reality-web RealtorManagement.tsx hardcoded English strings — agency flow not localized to sk/cs/de | done | 2026-06-25 | [plan](plans/code-review-reality-web-realtor-mgmt-untranslated.md) |
| 3 | bug | `code-review-mobile-rn-report-fault-fake-submit` | ReportFaultScreen.tsx handleSubmit() fakes API call with setTimeout(1500) — fault reports never reach backend (App.tsx:126 wires this) | done | 2026-06-25 | [plan](plans/code-review-mobile-rn-report-fault-fake-submit.md) |
| 3 | dx | `dx-revert-pr-1713` | Revert delegations FE landed 16min before CEO retirement ruling (#1713) | open | 2026-06-25 |  |
...
| 2 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcoded MOCK_* arrays — no API wiring | done | 2026-06-25 |  |
| 2 | bug | `code-review-mobile-rn-deeplink-init-unhandled` | useDeepLinkRouting.ts:27-36 — initialize() re-runs on onNavigate identity change + void promise with no .catch → duplicate nav / unhandled rejection | done | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1668-ppt` | Screen-map drift: PR #1668 touched ppt-web routes w/o screen docs | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1696-ppt` | Screen-map drift: PR #1696 touched ppt-web routes w/o screen docs | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1673-ppt` | Screen-map drift: PR #1673 touched ppt-web routes w/o screen docs | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1690-ppt` | Screen-map drift: PR #1690 touched ppt-web routes w/o screen docs | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1694-ppt` | Screen-map drift: PR #1694 touched ppt-web routes w/o screen docs | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1685-ppt` | Screen-map drift: PR #1685 touched ppt-web routes w/o screen docs | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1641-ppt` | Screen-map drift: PR #1641 touched ppt-web routes w/o screen docs | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1654-ppt` | Screen-map drift: PR #1654 touched ppt-web routes w/o screen docs | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1630-ppt` | Screen-map drift: PR #1630 touched ppt-web routes w/o screen docs | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1621-ppt` | Screen-map drift: PR #1621 touched ppt-web routes w/o screen docs | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1611-ppt` | Screen-map drift: PR #1611 touched ppt-web routes w/o screen docs | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1610-ppt` | Screen-map drift: PR #1610 touched ppt-web routes w/o screen docs | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1559-ppt` | Screen-map drift: PR #1559 touched ppt-web routes w/o screen docs | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1555-ppt` | Screen-map drift: PR #1555 touched ppt-web routes w/o screen docs | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1454-ppt` | Screen-map drift: PR #1454 touched ppt-web routes w/o screen docs | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1822-reality` | Screen-map drift: PR #1822 touched reality-web routes w/o screen docs | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1671-reality` | Screen-map drift: PR #1671 touched reality-web routes w/o screen docs | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1677-reality` | Screen-map drift: PR #1677 touched reality-web routes w/o screen docs | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-986-reality` | Screen-map drift: PR #986 touched reality-web routes w/o screen docs | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1545-reality` | Screen-map drift: PR #1545 touched reality-web routes w/o screen docs | open | 2026-06-25 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1453-reality` | Screen-map drift: PR #1453 touched reality-web routes w/o screen docs | open | 2026-06-25 |  |
...
| 2 | bug | `bug-ios-deeplink-info-plist-missing` | iOS deep-link layer dead at runtime — Info.plist missing CFBundleURLTypes + applinks entitlement | open | 2026-06-11 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1288-webhook-rls` | Webhook handlers RLS migration (PR #1288, PAP-170) shipped without a new regression test for repo-layer methods | open | 2026-06-11 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new regression test | open | 2026-06-11 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression test for the public-connection routing | open | 2026-06-11 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixed in PR #1287 | open | 2026-06-11 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-emergency-rs` | Churn hotspot: 1021 lines changed in backend/servers/api-server/src/routes/emergency.rs (window 2026 | done | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-vendors-rs` | Churn hotspot: 929 lines changed in backend/servers/api-server/src/routes/vendors.rs (window 2026-06 | done | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-enhanced-tenant-screening-rs` | Churn hotspot: 709 lines changed in backend/servers/api-server/src/routes/enhanced_tenant_screening. | done | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→18:30Z) | done | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-10 03:05Z→18:30Z) | done | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-06-10 03:05Z→18:30Z) | done | 2026-06-25 |  |
| 1 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected by deploy-server (staging/prod) | done | 2026-06-25 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-iot-rs` | Churn hotspot: backend/servers/api-server/src/routes/iot.rs (+278/-403 in PR #1321/#1322 PAP-151 re-land + fmt) | done | 2026-06-25 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-forms-rs` | Churn hotspot: backend/servers/api-server/src/routes/forms.rs touched 2x since 2026-06-12 (window 2026-06-12→2026-06-13) | done | 2026-06-25 |  |
...
| 1 | refactor | `churn-hotspot-frontend-apps-ppt-web-src-routes-lazyRoutes-tsx` | Hotspot: ppt-web lazyRoutes.tsx (13 commits/9d) | open | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-rental-rs` | Hotspot: db crate rental.rs repo (10 commits/9d) | open | 2026-06-25 |  |
| 1 | dx | `dx-closed-not-merged-pr-1749` | Closed without merge: PR #1749 | open | 2026-06-25 |  |
| 1 | dx | `dx-closed-not-merged-pr-1727` | Closed without merge: PR #1727 | open | 2026-06-25 |  |
| 1 | dx | `dx-closed-not-merged-pr-1720` | Closed without merge: PR #1720 | open | 2026-06-25 |  |
| 1 | dx | `dx-closed-not-merged-pr-1698` | Closed without merge: PR #1698 | open | 2026-06-25 |  |
| 1 | dx | `dx-closed-not-merged-pr-1647` | Closed without merge: PR #1647 | open | 2026-06-25 |  |
| 1 | dx | `dx-closed-not-merged-pr-1636` | Closed without merge: PR #1636 | open | 2026-06-25 |  |
| 1 | dx | `dx-closed-not-merged-pr-1634` | Closed without merge: PR #1634 | open | 2026-06-25 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-tests-reserve-funds-cross-org-idor-tests-rs` | Churn hotspot: backend/servers/api-server/tests/reserve_funds_cross_org_idor_tests.rs touched 2x since 2026-06-12 (window 2026-06-12→2026-06-13) | open | 2026-06-13 |  |

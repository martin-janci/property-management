# Backlog of vectors
<sub>Last regenerated: 2026-06-20 00:25 UTC by routine</sub>
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-mfa-rs` | MFA route churn-hot: 4 commits this run (rate-limit + stale-entry fixes across #1580/#1602) | open | 2026-06-20 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-ppt-web-src-features-faults-pages-FaultsPage-tsx` | ppt-web FaultsPage churn-hot: 3 commits this run (gap-79-1 wire + #1588 hardening) | open | 2026-06-20 |  |

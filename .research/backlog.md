...
| 3 | bug | `code-review-mobile-native-kmp-create-listing-not-implemented` | mobile-native-kmp-create-listing-not-implemented: the Screen.CreateListing composable wires `onSubmi | ready | 2026-08-26 | [plan](plans/code-review-mobile-native-kmp-create-listing-not-implemented.md) |
...
| 2 | bug | `code-review-mobile-native-kmp-compose-notnull-assertions` | mobile-native-kmp-compose-notnull-assertions: Systemic `!!` non-null assertions on nullable UI-state | open | 2026-08-26 |  |
| 2 | bug | `code-review-ppt-web-ui-bookfacility-silent-availability` | ppt-web-ui-bookfacility-silent-availability: the checkAvailability fetch effect swallows failures wi | open | 2026-08-26 |  |
| 2 | bug | `code-review-ppt-web-ui-facilities-silent-load-errors` | ppt-web-ui-facilities-silent-load-errors: the listFacilities fetch catch block only calls console.er | open | 2026-08-26 |  |
| 2 | bug | `code-review-reality-server-sso-http-no-timeout` | reality-server-sso-http-no-timeout: , :711, :748 — the three PM-OAuth helper fns exchange_pm_token ( | open | 2026-08-26 |  |
| 2 | bug | `code-review-reality-web-agency-slug-i18n` | reality-web-agency-slug-i18n: frontend/apps/reality-web/src/app/[locale]/agency/[slug]/page.tsx — th | open | 2026-08-26 |  |
| 2 | bug | `code-review-reality-web-checksession-5xx-logout` | reality-web-checksession-5xx-logout: checkSession() (runs on every mount) treats ANY non-ok /api/v1/ | open | 2026-08-26 |  |
| 2 | bug | `code-review-api-core-workflow-regex-recompile` | api-core-workflow-regex-recompile: the `Matches` comparison operator calls `regex::Regex::new(patter | open | 2026-08-26 |  |
| 2 | bug | `code-review-mobile-native-kmp-account-screen-dead-rows` | mobile-native-kmp-account-screen-dead-rows: ,465,474 — three chevron-decorated SectionRow items ('Co | open | 2026-08-26 |  |
| 2 | bug | `code-review-mobile-native-kmp-twofactor-orphan-unwired` | mobile-native-kmp-twofactor-orphan-unwired: ,349-354 — Screen.TwoFactor ('auth/two-factor') is decla | open | 2026-08-26 |  |
| 2 | bug | `code-review-mobile-native-kmp-profile-edit-drops-fields` | mobile-native-kmp-profile-edit-drops-fields: ,261-292 — the screen exposes editable OutlinedTextFiel | open | 2026-08-26 |  |
| 2 | bug | `code-review-search-drainer-stub-marks-delivered` | search-drainer-stub-marks-delivered: production wiring constructs the saved-search alert drainer via | open | 2026-08-26 |  |
| 2 | bug | `code-review-reality-web-account-edit-wrong-locale-strings` | reality-web-account-edit-wrong-locale-strings: frontend/apps/reality-web/src/app/[locale]/account/li | open | 2026-08-26 |  |
...
| 1 | bug | `code-review-mobile-rn-list-search-placeholders-i18n` | mobile-rn-list-search-placeholders-i18n: frontend/apps/mobile/src/screens/messages/MessagesScreen.ts | open | 2026-08-26 |  |
| 1 | refactor | `code-review-ppt-web-ui-facilities-hardcoded-i18n` | ppt-web-ui-facilities-hardcoded-i18n: ,101,112,118 — user-facing fallback strings 'Facility not foun | open | 2026-08-26 |  |
| 1 | bug | `code-review-reality-web-inquiry-cancel-no-error` | reality-web-inquiry-cancel-no-error: frontend/apps/reality-web/src/app/[locale]/inquiries/page.tsx:4 | open | 2026-08-26 |  |
| 1 | bug | `code-review-api-core-workflow-notin-fail-open` | api-core-workflow-notin-fail-open: `ComparisonOperator::In` returns `Ok(false)` when `compare_value. | open | 2026-08-26 |  |
| 1 | refactor | `code-review-mobile-rn-faults-screen-no-i18n` | mobile-rn-faults-screen-no-i18n: active screen (Epic 4: Fault Reporting & Resolution, UC-03) has NO  | open | 2026-08-26 |  |
| 1 | refactor | `code-review-mobile-rn-widget-settings-alerts-i18n` | mobile-rn-widget-settings-alerts-i18n: frontend/apps/mobile/src/screens/settings/WidgetSettingsScree | open | 2026-08-26 |  |
| 1 | refactor | `code-review-mobile-rn-person-months-hardcoded-i18n` | mobile-rn-person-months-hardcoded-i18n: frontend/apps/mobile/src/screens/person-months/PersonMonthsS | open | 2026-08-26 |  |
| 1 | bug | `code-review-search-drainer-alert-copy-no-i18n` | search-drainer-alert-copy-no-i18n: the alert `subject` and `body` are built from hard-coded English  | open | 2026-08-26 |  |
| 1 | refactor | `code-review-reality-web-realtor-section-no-i18n` | reality-web-realtor-section-no-i18n: frontend/apps/reality-web/src/app/[locale]/realtor/** — the ent | open | 2026-08-26 |  |
| 1 | bug | `code-review-reality-web-realtor-dashboard-total-mislabel` | reality-web-realtor-dashboard-total-mislabel: frontend/apps/reality-web/src/app/[locale]/realtor/pag | open | 2026-08-26 |  |

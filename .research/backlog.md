# Backlog of vectors
<sub>Last regenerated: 2026-07-07 08:16 UTC by routine</sub>
...
| 3 | security | `security-llm-doc-idor` | IDOR: ai.rs LLM-doc handlers publish/list/get any tenant's listing descriptions & photo enhancements unscoped | done | 2026-07-07 | [plan](plans/_archive/security-llm-doc-idor.md) |
...
| 1 | refactor | `refactor-churn-hotspot-backend-crates-db-src-models-multi-currency-rs` | Churn hotspot: backend/crates/db/src/models/multi_currency.rs (2 PRs in 2-day window) | open | 2026-07-07 |  |
| 1 | refactor | `refactor-churn-hotspot-backend-crates-db-src-models-regional-compliance-rs` | Churn hotspot: backend/crates/db/src/models/regional_compliance.rs (2 PRs in 2-day window) | open | 2026-07-07 |  |
| 1 | refactor | `refactor-churn-hotspot-backend-servers-api-server-src-routes-regional-compliance-rs` | Churn hotspot: backend/servers/api-server/src/routes/regional_compliance.rs (2 PRs in 2-day window) | open | 2026-07-07 |  |
| 1 | triage | `triage-closed-not-merged-pr-2140` | Closed unmerged: PR #2140 test(api-server): enlarge tie group in include_system pagination test | open | 2026-07-07 |  |
| 1 | triage | `triage-closed-not-merged-pr-2145` | Closed unmerged: PR #2145 test(api-server): non-manager 403 deny test for outage mutations | open | 2026-07-07 |  |
...
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new regression test | open | 2026-07-05 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression test for the public-connection routing | open | 2026-07-05 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixed in PR #1287 | open | 2026-07-05 |  |
...
| 1 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcoded MOCK_* arrays — no API wiring | open | 2026-07-05 |  |
| 1 | bug | `code-review-mobile-rn-deeplink-init-unhandled` | useDeepLinkRouting.ts:27-36 — initialize() re-runs on onNavigate identity change + void promise with no .catch → duplicate nav / unhandled rejection | open | 2026-07-05 |  |

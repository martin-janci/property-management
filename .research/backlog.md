# Backlog of vectors
<sub>Last regenerated: 2026-07-02 18:40 UTC by routine</sub>
...
| 3 | bug | `reverted-pr-1690` | Prevent gap-sweep from re-admitting board-retired surfaces (delegation revert #1713→BIT-213) | ready | 2026-07-02 | [plan](plans/bug-retired-scaffolds-guard-registry.md) |
| 3 | bug | `code-review-ppt-web-core-person-months-fetch-missing-auth` | person-months.tsx: raw fetch bypasses auth wiring (no Bearer, no X-Tenant-ID) | ready | 2026-07-02 | [plan](plans/code-review-ppt-web-core-person-months-fetch-missing-auth.md) |
...
| 2 | bug | `code-review-ppt-web-core-rentals-mutations-silent-failure` | rentals.tsx: 4 mutations lack onError — silent failure on Connect/Sync/CheckIn/CheckOut | open | 2026-07-02 |  |
...
| 1 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcoded MOCK_* arrays — no API wiring | done | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-.github/workflows/backend.yml` | Churn hotspot: .github/workflows/backend.yml — high change velocity this window | open | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-frontend/apps/ppt-web/messages/en.json` | Churn hotspot: frontend/apps/ppt-web/messages/en.json — high change velocity this window | open | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-frontend/apps/ppt-web/messages/sk.json` | Churn hotspot: frontend/apps/ppt-web/messages/sk.json — high change velocity this window | open | 2026-07-02 |  |
| 1 | refactor | `code-review-ppt-web-core-person-months-hardcoded-strings` | person-months.tsx: 6 hardcoded UI strings — i18n gap vs sibling financial.tsx | open | 2026-07-02 |  |
...
| 1 | bug | `code-review-mobile-rn-deeplink-init-unhandled` | useDeepLinkRouting.ts:27-36 — initialize() re-runs on onNavigate identity change + void promise with no .catch → duplicate nav / unhandled rejection | open | 2026-06-16 |  |

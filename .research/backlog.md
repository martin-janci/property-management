...
| 2 | refactor | `refactor-churn-hotspot-backend-servers-api-server-tests-oauth-integration-tests-rs` | Churn hotspot: backend/servers/api-server/tests/oauth_integration_tests.rs — 2719 lines this run | open | 2026-07-08 |  |
...
| 1 | refactor | `refactor-churn-hotspot-backend-crates-integrations-src-booking-mod-rs` | Churn hotspot: backend/crates/integrations/src/booking/mod.rs — 2818 lines this run (Booking.com OTA | open | 2026-07-08 |  |
| 1 | refactor | `refactor-churn-hotspot-backend-servers-api-server-src-routes-auth-rs` | Churn hotspot: backend/servers/api-server/src/routes/auth.rs — 2648 lines this run (MFA rate-limit h | open | 2026-07-08 |  |
| 1 | dx | `dx-stalled-review-pr-1797` | Stalled review: PR #1797 (fix(api-server) OCR auth + rental PII manager-gate) — open 15d, draft, no  | open | 2026-07-08 |  |

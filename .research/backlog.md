# Backlog of vectors
<sub>Last regenerated: 2026-07-07 02:39 UTC by routine</sub>
...
| 3 | security | `code-review-ppt-web-core-authed-query-roots-drift` | PPT-web AUTHED_QUERY_KEY_ROOTS drift — accounting/sentiment/notification-analytics/predictive-maintenance not  | ready | 2026-07-07 | [plan](plans/code-review-ppt-web-core-authed-query-roots-drift.md) |
...
| 2 | bug | `code-review-ppt-web-core-retry-non-idempotent-post` | PPT-web axios retry interceptor retries non-idempotent POST/PUT on network failure — duplicate acks/prediction | open | 2026-07-07 |  |
...
| 1 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcod | done | 2026-07-07 |  |
| 1 | refactor | `refactor-churn-hotspot-backend-crates-db-src-repositories-rental-rs` | Churn hotspot: backend/crates/db/src/repositories/rental.rs (11 commits in 19-day catch-up) | done | 2026-07-07 |  |
| 1 | bug | `code-review-ppt-web-core-init-auth-no-expiry-check` | PPT-web initializeAuth() sets user from storage without JWT exp check — authed UI flicker + 401 flap on expire | open | 2026-07-07 |  |
| 1 | refactor | `refactor-churn-hotspot-backend-crates-db-src-repositories-rental-oauth-rs` | Churn hotspot: backend/crates/db/src/repositories/rental/oauth.rs (594 lines this run — new sub-module from PR | open | 2026-07-07 |  |
| 1 | refactor | `refactor-churn-hotspot-backend-crates-db-src-models-multi-currency-rs` | Churn hotspot: backend/crates/db/src/models/multi_currency.rs (532 lines across PRs #2098 + #2113) | open | 2026-07-07 |  |
...
| 1 | test-gap | `test-gap-screen-map-drift-pr-1100-ppt` | Screen-map drift: PR #1100 modified ppt-web App.tsx (FileDisputePageRoute extraction) without screen-doc updat | open | 2026-07-05 |  |
...
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1288-webhook-rls` | Webhook handlers RLS migration (PR #1288, PAP-170) shipped without a new regression test for repo-layer method | open | 2026-07-05 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new re | open | 2026-07-05 |  |

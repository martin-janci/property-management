# Backlog of vectors
<sub>Last regenerated: 2026-07-02 20:00 UTC by routine</sub>
...
| 3 | bug | `code-review-mobile-rn-report-fault-fake-submit` | ReportFaultScreen.tsx handleSubmit() fakes API call with setTimeout(1500) — fault reports never reach backend (App.tsx:126 wires t | ready | 2026-06-16 | [plan](plans/code-review-mobile-rn-report-fault-fake-submit.md) |
...
| 2 | bug | `bug-risky-churn-pr-963-api-main-rs` | Risky churn: api-server main.rs security-headers wiring shipped without a middleware smoke test | done | 2026-07-02 |  |
| 2 | test-gap | `screen-map-drift-pr-1685-ppt` | Screen-map drift: PR #1685 touched frontend/apps/ppt-web/src/routes/groups/iot.tsx without updating docs/screens/ppt/*.md — Story: | open | 2026-07-02 |  |
| 2 | test-gap | `screen-map-drift-pr-1641-ppt` | Screen-map drift: PR #1641 touched frontend/apps/ppt-web/src/routes/groups/ai-dashboards.tsx without updating docs/screens/ppt/*.m | open | 2026-07-02 |  |
| 2 | test-gap | `screen-map-drift-pr-1697-ppt` | Screen-map drift: PR #1697 touched frontend/apps/ppt-web/src/routes/groups/documents.tsx without updating docs/screens/ppt/*.md —  | open | 2026-07-02 |  |
| 2 | test-gap | `screen-map-drift-pr-1707-ppt` | Screen-map drift: PR #1707 touched frontend/apps/ppt-web/src/routes/groups/documents.tsx without updating docs/screens/ppt/*.md —  | open | 2026-07-02 |  |
| 2 | test-gap | `screen-map-drift-pr-1701-ppt` | Screen-map drift: PR #1701 touched frontend/apps/ppt-web/src/routes/groups/units.tsx without updating docs/screens/ppt/*.md — Stor | open | 2026-07-02 |  |
| 2 | test-gap | `screen-map-drift-pr-1695-ppt` | Screen-map drift: PR #1695 touched frontend/apps/ppt-web/src/routes/groups/buildings.tsx without updating docs/screens/ppt/*.md —  | open | 2026-07-02 |  |
| 2 | test-gap | `screen-map-drift-pr-1987-reality` | Screen-map drift: PR #1987 touched frontend/apps/reality-web/src/app/[locale]/auth/callback/page.tsx without updating docs/screens | open | 2026-07-02 |  |
| 2 | test-gap | `screen-map-drift-pr-1677-reality` | Screen-map drift: PR #1677 touched frontend/apps/reality-web/src/app/[locale]/listings/[slug]/page.tsx without updating docs/scree | open | 2026-07-02 |  |
| 2 | test-gap | `screen-map-drift-pr-1746-reality` | Screen-map drift: PR #1746 touched frontend/apps/reality-web/src/app/[locale]/account/listings/[id]/edit/page.tsx without updating | open | 2026-07-02 |  |
| 2 | test-gap | `screen-map-drift-pr-1621-ppt` | Screen-map drift: PR #1621 touched frontend/apps/ppt-web/src/routes/groups/accounting.tsx without updating docs/screens/ppt/*.md — | open | 2026-07-02 |  |
| 2 | test-gap | `screen-map-drift-pr-1621-reality` | Screen-map drift: PR #1621 touched frontend/apps/reality-web/src/app/[locale]/accounting/page.tsx without updating docs/screens/re | open | 2026-07-02 |  |
...
| 1 | bug | `code-review-mobile-native-kmp-deeplink-token-not-url-decoded` | DeepLinkRouter skips URL-decoding while Android Uri.getQueryParameter decodes — SSO tokens diverge per platform | open | 2026-07-02 |  |
...
| 1 | test-gap | `test-gap-screen-map-drift-pr-1100-ppt` | Screen-map drift: PR #1100 modified ppt-web App.tsx (FileDisputePageRoute extraction) without screen-doc update | open | 2026-07-02 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-emergency-rs` | Churn hotspot: 1021 lines changed in backend/servers/api-server/src/routes/emergency.rs (window 2026 | done | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-vendors-rs` | Churn hotspot: 929 lines changed in backend/servers/api-server/src/routes/vendors.rs (window 2026-06 | done | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-enhanced-tenant-screening-rs` | Churn hotspot: 709 lines changed in backend/servers/api-server/src/routes/enhanced_tenant_screening. | done | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→18:30Z) | done | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-10 03:05Z→18:30Z) | done | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-06-10 03:05Z→18:30Z) | done | 2026-07-02 |  |
...
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1288-webhook-rls` | Webhook handlers RLS migration (PR #1288, PAP-170) shipped without a new regression test for repo-layer methods | open | 2026-07-02 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new regression test | open | 2026-07-02 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression test for the public-conn | open | 2026-07-02 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixed in PR #1287 | open | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs (+404/−29 in PR #1294 Booking.com OTA retry) | done | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-iot-rs` | Churn hotspot: backend/servers/api-server/src/routes/iot.rs (+278/-403 in PR #1321/#1322 PAP-151 re-land + fmt) | done | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-reserve-funds-rs` | Churn hotspot: backend/servers/api-server/src/routes/reserve_funds.rs (+228/-255 in PR #1321 PAP-151 re-land) | done | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-sensor-rs` | Churn hotspot: backend/crates/db/src/repositories/sensor.rs (+248/-86 in PR #1321/#1322 PAP-151 re-land + fmt) | done | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-forms-rs` | Churn hotspot: backend/servers/api-server/src/routes/forms.rs touched 2x since 2026-06-12 (window 2026-06-12→2026-06-13) | done | 2026-07-02 |  |
| 1 | refactor | `repeated-churn-backend-servers-api-server-src-routes-forms-rs` | forms.rs repeated-churn — runs_seen=2 (#1337 explicit_auto_deref + #1397 org-scope hardening) | done | 2026-07-02 |  |
| 1 | test-gap | `screen-map-drift-pr-1418-ppt` | PR #1418 touched routes/** (faults.route.test.tsx) without updating docs/screens/ppt/* — heuristic, test-file fix | open | 2026-07-02 |  |
| 1 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcoded MOCK_* arrays — n | open | 2026-07-02 |  |
| 1 | bug | `code-review-mobile-rn-deeplink-init-unhandled` | useDeepLinkRouting.ts:27-36 — initialize() re-runs on onNavigate identity change + void promise with no .catch → duplicate nav / u | open | 2026-07-02 |  |
| 1 | dx | `stalled-review-pr-1797` | PR #1797 (fix(api-server): auth on OCR endpoints + manager-gate rental guest PII reads) — draft, opened 2026-06-23 (9d), no review | open | 2026-07-02 |  |
| 1 | dx | `stalled-review-pr-1812` | PR #1812 (churn-hotspot: split reality-portal.rs repository) — draft, opened 2026-06-24 (8d), no reviewDecision | open | 2026-07-02 |  |
...
| 1 | security | `security-pkce-oauth-authcode-pr-908-closed` | PR #908 (fix(security): require PKCE on OAuth authorization-code flow, closes #823) was closed unmerged — verify whether PKCE enfo | done | 2026-06-03 |  |
...
| 0 | test-gap | `test-gap-screen-map-drift-pr-922-ppt` | Screen-map drift: PR #922 modified ppt-web App.tsx (dev-review rounds 1-5 fixes) without a docs/screens/ppt update | dropped | 2026-07-02 |  |
| 0 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despite metric=53 | dropped | 2026-07-02 |  |
...
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected by deploy | dropped | 2026-07-02 |  |
| 0 | dx | `closed-not-merged-pr-1274` | PR #1274 (cargo-minor-patch group, /backend, 9 updates) closed unmerged — superseded by #1313 after auto-rebase fix landed | dropped | 2026-07-02 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-api-ecosystem-rs` | Churn hotspot: backend/servers/api-server/src/routes/api_ecosystem.rs (+106/−27 in PR #1293 PAP-171; second touch in 24h) | dropped | 2026-07-02 |  |
...
| 0 | triage | `triage-issue-1331` | Issue #1331 (no labels, OPEN): Backend `test` job red/hanging on dev base — blocks the entire backend merge pipeline | dropped | 2026-07-02 |  |
| 0 | dx | `dx-stalled-review-pr-988` | Stalled review: PR #988 (Epic: reusable Playwright E2E framework + sitemap FlowRunner) open 10d, no reviewDecision | dropped | 2026-07-02 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-tests-reserve-funds-cross-org-idor-tests-rs` | Churn hotspot: backend/servers/api-server/tests/reserve_funds_cross_org_idor_tests.rs touched 2x since 2026-06-12 (window 2026-06- | dropped | 2026-07-02 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-tests-form-rls-repo-tests-rs` | Churn hotspot: backend/crates/db/tests/form_rls_repo_tests.rs touched 2x since 2026-06-12 (window 2026-06-12→2026-06-13) | dropped | 2026-07-02 |  |
...
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-form-rs` | Churn hotspot: 53 lines in backend/crates/db/src/repositories/form.rs (PR #1379 #1332 unblock) | dropped | 2026-07-02 |  |
| 0 | refactor | `code-review-api-core-osrng-expect` | crypto.rs:127 SysRng.try_fill_bytes(...).expect() panics if OS CSPRNG errors during integration-credential encrypt | dropped | 2026-07-02 |  |
...
| 0 | dx | `dx-stalled-review-pr-1179` | PR #1179 (docs(epics) catalog backfill for 37 mounted-but-undocumented backend modules) — stalled at 7d, no reviewDecision | dropped | 2026-07-02 |  |

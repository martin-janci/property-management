# Backlog of vectors
<sub>Last regenerated: 2026-06-26 10:00 UTC by routine</sub>
...
| 3 | bug | `revert-pr-1713` | Revert: PR #1713 revert(delegations): remove re-added delegation frontend (#1690) — reco | done | 2026-06-26 |  |
...
| 2 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcod | done | 2026-06-26 |  |
| 2 | bug | `unchecked-todo-pr-1723` | Unchecked TODO in PR #1723 | open | 2026-06-26 |  |
...
| 1 | bug | `code-review-mobile-native-kmp-deeplink-token-not-url-decoded` | DeepLinkRouter skips URL-decoding while Android Uri.getQueryParameter decodes — SSO tokens diverge per platfor | open | 2026-06-26 |  |
...
| 1 | test-gap | `test-gap-screen-map-drift-pr-1100-ppt` | Screen-map drift: PR #1100 modified ppt-web App.tsx (FileDisputePageRoute extraction) without screen-doc updat | open | 2026-06-26 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→ | done | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-10 03: | done | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-06-10 03:05 | done | 2026-06-26 |  |
...
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1288-webhook-rls` | Webhook handlers RLS migration (PR #1288, PAP-170) shipped without a new regression test for repo-layer method | open | 2026-06-26 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new re | open | 2026-06-26 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression test | open | 2026-06-26 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixe | open | 2026-06-26 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-tests-form-rls-repo-tests-rs` | Churn hotspot: backend/crates/db/tests/form_rls_repo_tests.rs touched 2x since 2026-06-12 (window 2026-06-12→2 | done | 2026-06-26 |  |
...
| 1 | triage | `closed-not-merged-pr-1720` | PR closed unmerged: PR #1720 fix(ppt-web): add Leases nav link + home tile (#977) closed unmerged on 2026-06-2 | open | 2026-06-26 |  |
| 1 | triage | `closed-not-merged-pr-1749` | PR closed unmerged: PR #1749 fix(mobile): exclude app.config.icon.test.ts from tsc typecheck (unblock dev fron | open | 2026-06-26 |  |
| 1 | triage | `closed-not-merged-pr-1727` | PR closed unmerged: PR #1727 fix(ci): unblock backend gate — organizations fmt + notification_event RLS baseli | open | 2026-06-26 |  |
| 1 | triage | `closed-not-merged-pr-1698` | PR closed unmerged: PR #1698 feat(epic-3): story 3.2 - unit management UI (BIT-188) closed unmerged on 2026-06 | open | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-models-mod-rs` | Churn hotspot: backend/crates/db/src/models/mod.rs | open | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-models-reality-portal-rs` | Churn hotspot: backend/crates/db/src/models/reality_portal.rs | open | 2026-06-26 |  |
...
| 0 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despit | dropped | 2026-06-26 |  |
...
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET no | dropped | 2026-06-26 |  |
| 0 | dx | `closed-not-merged-pr-1274` | PR #1274 (cargo-minor-patch group, /backend, 9 updates) closed unmerged — superseded by #1313 after auto-rebas | dropped | 2026-06-26 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-api-ecosystem-rs` | Churn hotspot: backend/servers/api-server/src/routes/api_ecosystem.rs (+106/−27 in PR #1293 PAP-171; second to | dropped | 2026-06-26 |  |

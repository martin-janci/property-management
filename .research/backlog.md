# Backlog of vectors
<sub>Last regenerated: 2026-08-31 02:40 UTC by routine</sub>
...
| 2 | bug | `code-review-reality-server-agent-review-self-review` | reality-server create_review lets realtors self-review — public avg_rating self-inflation via missin | open | 2026-08-31 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-2889-ppt` | Screen-map drift: PR #2889 wired realtime WS invalidation in ppt-web App.tsx without a docs/screens/ | open | 2026-08-31 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-2890-reality` | Screen-map drift: PR #2890 surfaced mutation errors on reality-web favorites/inquiries/saved-searche | open | 2026-08-31 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-2894-reality` | Screen-map drift: PR #2894 i18n'd reality-web saved-searches page without a docs/screens/reality upd | open | 2026-08-31 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-2895-reality` | Screen-map drift: PR #2895 i18n'd reality-web inquiries page without a docs/screens/reality update | open | 2026-08-31 |  |
...
| 2 | bug | `code-review-ppt-web-core-ws-event-name-mismatch` | WebSocketContext eventToQueryKeys keys on `entity:*` but api-server emits `domain.action` — realtime | done | 2026-08-30 |  |
| 2 | bug | `code-review-reality-server-bytelen-charcount-validation` | Reality Portal length validators measure bytes but errors say characters — over-rejects sk/cs/de acc | done | 2026-08-30 |  |
| 2 | bug | `code-review-reality-server-sso-introspect-negcache-poison` | SSO introspect_pm_token caches active=false on PM 5xx — 60s spurious session denials during PM intro | done | 2026-08-30 |  |
| 2 | bug | `code-review-reality-web-mutation-no-onerror` | Mutations on favorites/saved-searches/inquiries silently swallow errors (no onError, no isError surf | done | 2026-08-30 |  |
...
| 1 | bug | `code-review-reality-server-pagination-offset-overflow` | reality-server article/inquiry pagination computes offset as unchecked i64 mul — page=i64::MAX panic | open | 2026-08-31 |  |
| 1 | bug | `code-review-reality-server-saved-search-error-string-status` | reality-server saved-search create/update map DB errors to HTTP status by substring-matching Display | open | 2026-08-31 |  |
| 1 | refactor | `refactor-repeated-churn-ContentModerationPage-tsx-2026-08-31` | ppt-web ContentModerationPage.tsx repeated-churn — 3 touches / 585 lines over 14d (2nd cross-run hit | open | 2026-08-31 |  |
| 1 | refactor | `refactor-repeated-churn-auth-policy-rs-2026-08-31` | api-server auth_policy.rs repeated-churn — 3 touches / 640 lines over 14d (2nd cross-run hit) | open | 2026-08-31 |  |
| 1 | refactor | `refactor-repeated-churn-moderation-rs-2026-08-31` | aml_dsa/moderation.rs repeated-churn — 4 touches / 1150 lines over 14d (2nd cross-run hit) | open | 2026-08-31 |  |
| 1 | bug | `code-review-api-handlers-compliance-superadmin-exact-match` | compliance handlers gate on exact SuperAdmin match — locks out PlatformAdmin (breaks platform-tier h | done | 2026-08-30 |  |
...
| 1 | bug | `code-review-ppt-web-core-api-onunauthorized-unwired` | lib/api.ts onUnauthorized callback never wired — 401 branch dead, getApiClient consumers stuck on to | done | 2026-08-30 |  |
| 1 | bug | `code-review-reality-server-alert-drainer-i18n-english-only` | SearchAlertDrainer composes English-only subject+body despite carrying recipient locale — latent not | done | 2026-08-30 |  |
| 1 | bug | `code-review-reality-server-report-contact-unvalidated` | submit_report reporter_email/reporter_phone bound into INSERT with no length or format validation | done | 2026-08-30 |  |
...
| 1 | bug | `code-review-reality-web-inquiries-i18n` | Inquiries page renders hardcoded English status labels and chrome in a 4-language app | done | 2026-08-30 |  |
| 1 | bug | `code-review-reality-web-saved-searches-i18n` | Saved Searches page + SavedSearchCard render hardcoded English strings in a 4-language app | done | 2026-08-30 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-08-01 02:15 UTC by routine</sub>
...
| 2 | dx | `dx-fixme-admin-web-ui-kit-primitives-missing` | @ppt/ui-kit missing primitives (Stepper, FileUpload, RadioCards, StatusPill) — admin-web ships inline duplicates | done | 2026-08-01 |  |
| 2 | dx | `dx-fixme-api-client-generator-typescript-error-types` | openapi-ts generator wrapper swallows errors and emits weak error types | open | 2026-08-01 |  |
...
| 1 | refactor | `refactor-churn-hotspot-scheduler-mod-rs-2026-08-01` | Churn hotspot: backend/servers/api-server/src/services/scheduler/mod.rs — 398 lines this run (intentional split by PR #2613) | done | 2026-08-01 |  |
| 1 | refactor | `refactor-churn-hotspot-tenant-lifecycle-page-2026-08-01` | Churn hotspot: frontend/apps/admin-web/src/pages/TenantLifecyclePage.tsx — 117 lines this run (ui-kit consolidation, PR #2616) | done | 2026-08-01 |  |
| 1 | refactor | `refactor-churn-hotspot-api-validation-yml-2026-08-01` | Churn hotspot: .github/workflows/api-validation.yml — 47 lines this run (CI wrapper hardening, PR #2615) | done | 2026-08-01 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-06-24 00:30 UTC by routine</sub>
...
| 3 | bug | `bug-revert-pr-1713-delegations` | investigate delegations revert PR #1713: why was the surface re-added then reverted | open | 2026-06-24 |  |
...
| 2 | dx | `dx-unchecked-todo-pr-1723-financial` | follow up on unchecked TODO in PR #1723 financial reports rustfmt | open | 2026-06-24 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1737-ppt` | screen-map drift: PR #1737 touched ppt-web iot route without docs/screens/ppt update | open | 2026-06-24 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1746-reality` | screen-map drift: PR #1746 touched reality-web listing-edit route without docs/screens/reality update | open | 2026-06-24 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-emergency-rs` | Churn hotspot: 1021 lines changed in backend/servers/api-server/src/routes/emergency.rs (window 2026 | dropped | 2026-06-24 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-enhanced-tenant-screening-rs` | Churn hotspot: 709 lines changed in backend/servers/api-server/src/routes/enhanced_tenant_screening. | dropped | 2026-06-24 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→ | dropped | 2026-06-24 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-10 03: | dropped | 2026-06-24 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-06-10 03:05 | dropped | 2026-06-24 |  |

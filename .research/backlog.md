# Backlog of vectors
<sub>Last regenerated: 2026-07-05 08:43 UTC by routine</sub>
...
| 3 | bug | `bug-ios-searchview-uncompilable` | iOS SearchView.swift does not compile — performSearch/scheduleSearch undefined, resultsGrid corrupted | done | 2026-07-05 | [plan](plans/_archive/bug-ios-searchview-uncompilable.md) |
| 3 | bug | `code-review-mobile-rn-report-fault-fake-submit` | ReportFaultScreen.tsx handleSubmit() fakes API call with setTimeout(1500) — fault reports never reach bac... | done | 2026-07-05 | [plan](plans/_archive/code-review-mobile-rn-report-fault-fake-submit.md) |
| 3 | security | `code-review-ppt-web-core-dashboard-route-unprotected` | routes/groups/core.tsx:144-150 comment claims 'ProtectedRoute handles auth' but  | ready | 2026-07-05 | [plan](plans/code-review-ppt-web-core-dashboard-route-unprotected.md) |
| 3 | bug | `code-review-reality-web-listing-page-ssr-crash` | Reality-web listing detail SSR crashes on partial 200 body — JSON-LD build deref of undefined fields | done | 2026-07-05 | [plan](plans/_archive/code-review-reality-web-listing-page-ssr-crash.md) |
| 3 | bug | `code-review-reality-web-realtor-mgmt-untranslated` | Reality-web RealtorManagement.tsx hardcoded English strings — agency flow not localized to sk/cs/de | open | 2026-07-05 |  |
| 3 | bug | `code-review-reality-web-share-comparison-404` | Reality-web ComparisonUrlHandler hits non-existent /api/listings/${id} — every shared comparison URL 404s | done | 2026-07-05 | [plan](plans/_archive/code-review-reality-web-share-comparison-404.md) |
| 3 | security | `security-llm-doc-idor` | IDOR: ai.rs LLM-doc handlers publish/list/get any tenant's listing descriptions & photo enhancements unsc... | done | 2026-07-05 | [plan](plans/_archive/security-llm-doc-idor.md) |
| 3 | security | `unchecked-todo-pr-1862` | test(BIT-265) platform-admin authz regression — 25 endpoints partial→done merged | open | 2026-07-05 |  |
...
| 2 | bug | `code-review-ppt-web-core-api-retry-non-idempotent` | api.ts:76,184-211 retries on 408/429/500/502/503/504 via instance.request(config | open | 2026-07-05 |  |
| 2 | bug | `code-review-ppt-web-core-perf-metrics-listener-leak` | usePerformanceMetrics.ts:142/153 addEventListener('load'/'visibilitychange') ins | open | 2026-07-05 |  |
| 2 | bug | `unchecked-todo-pr-1859` | fix(api-server) 23 tenant-migration endpoints (BIT-260) merged with unchecked TO | open | 2026-07-05 |  |
| 2 | bug | `unchecked-todo-pr-1861` | fix(api-server) implement 19 regional-compliance endpoints (Epic 72) merged with | open | 2026-07-05 |  |
| 2 | bug | `unchecked-todo-pr-2037` | recent merged PR has unchecked `- [ ]` in body — unfinished follow-up scope | open | 2026-07-05 |  |
| 2 | bug | `code-review-api-core-vote-partial-cmp-panic` | vote.rs:1765 calculate_question_result() uses partial_cmp().unwrap() on f64 — NaN/Inf weights panic /vote... | done | 2026-06-16 |  |
...
| 2 | refactor | `refactor-announcements-rs-module-split` | announcements.rs (2,722 LOC) — explicit module-split into routes/announcements/{crud,targeting,delivery,r... | done | 2026-06-06 |  |
...
| 2 | refactor | `refactor-platform-admin-rs-module-split` | platform_admin.rs (2,762 LOC) — explicit module-split into routes/platform_admin/{tenants,features,billin... | done | 2026-06-06 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1033-ppt` | Screen-map drift: PR #1033 wired error/retry into AnnouncementsPage+FaultsPage via App.tsx without a docs... | done | 2026-06-06 |  |
...
| 2 | test-gap | `test-gap-hotfix-no-test-pr-874-portal-webhooks` | Portal webhook fail-closed fix (PR #874) shipped without a regression test for unverified-signature rejec... | done | 2026-06-05 |  |
...
| 2 | test-gap | `test-gap-hotfix-no-test-pr-990-frontend-gap-sweep` | Frontend gap-sweep (PR #990, 34 files across Epics 1/6/7B/9/10B/11/15/17/18) shipped without a regression... | done | 2026-06-05 |  |
...
| 2 | test-gap | `test-gap-router-set-parity-tests` | api-server main.rs vs lib.rs::create_router diverge silently (5 routes unreachable in prod, no test asser... | done | 2026-06-01 |  |
| 2 | bug | `bug-report-schedule-update-no-sql` | ReportSchedule.update_schedule stores cron in `time` workaround; documented UPDATE never runs (missing cr... | done | 2026-05-30 |  |
...
| 1 | bug | `bug-ios-deeplink-info-plist-missing` | iOS deep-link layer dead at runtime — Info.plist missing CFBundleURLTypes + applinks entitlement | open | 2026-07-05 |  |
...
| 1 | bug | `churn-hotspot-backend-crates-db-src-repositories-lease-rs` | 3 PRs pin schema drift on units.designation join; #2060 fixed 42703 500 in list_ | open | 2026-07-05 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-accounting-rs` | accounting.rs touched by ~8 fix PRs across 19d window (state-machine, secret-ser | open | 2026-07-05 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-messaging-rs` | messaging/thread routes touched by 6+ fix PRs (unread soft-delete leak, N-party  | open | 2026-07-05 |  |
| 1 | bug | `closed-not-merged-pr-1802` | fix(messaging) N-party delivery/block/unhide superseded by merged #1789/#1993 —  | open | 2026-07-05 |  |
| 1 | bug | `closed-not-merged-pr-1804` | fix(scheduler) persistent payment-reminder dedup abandoned — need to verify whet | open | 2026-07-05 |  |
| 1 | bug | `closed-not-merged-pr-1919` | bug-risky-churn-pr-963-api-main-rs (security-headers wiring) closed unmerged — t | open | 2026-07-05 |  |
| 1 | test-gap | `closed-not-merged-pr-1958` | test(BIT-360) bulk re-enable 718 BIT-351-quarantined tests (146 files) closed un | open | 2026-07-05 |  |
| 1 | bug | `code-review-mobile-native-kmp-deeplink-token-not-url-decoded` | DeepLinkRouter skips URL-decoding while Android Uri.getQueryParameter decodes — SSO tokens diverge per pl... | open | 2026-07-05 |  |
...
| 1 | bug | `code-review-mobile-rn-deeplink-init-unhandled` | useDeepLinkRouting.ts:27-36 — initialize() re-runs on onNavigate identity change + void promise with no .... | open | 2026-07-05 |  |
| 1 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render ha... | open | 2026-07-05 |  |
| 1 | test-gap | `screen-map-drift-pr-1418-ppt` | PR #1418 touched routes/** (faults.route.test.tsx) without updating docs/screens/ppt/* — heuristic, test-... | open | 2026-07-05 |  |
| 1 | security | `stalled-review-pr-1797` | fix(api-server) auth OCR + rental guest PII manager-gate — draft 12d, last updat | open | 2026-07-05 |  |
| 1 | refactor | `stalled-review-pr-1812` | churn-hotspot reality_portal.rs split — draft 11d, needs-human-review label, +19 | open | 2026-07-05 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a n... | open | 2026-07-05 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1288-webhook-rls` | Webhook handlers RLS migration (PR #1288, PAP-170) shipped without a new regression test for repo-layer m... | open | 2026-07-05 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression... | open | 2026-07-05 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was ho... | open | 2026-07-05 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-959-reality-listings-pagination` | Reality-server listings pagination clamp (PR #959) shipped without a regression test for limit=-1 | open | 2026-07-05 |  |
...
| 1 | test-gap | `test-gap-screen-map-drift-pr-1100-ppt` | Screen-map drift: PR #1100 modified ppt-web App.tsx (FileDisputePageRoute extraction) without screen-doc ... | open | 2026-07-05 |  |
| 1 | refactor | `refactor-closed-not-merged-pr-1378` | PR #1378 closed without merge — DROP-OWNED-BY teardown theory for #1332 was wrong root cause, superseded ... | done | 2026-06-15 |  |
...
| 1 | triage | `triage-issue-950` | Issue #950 (no labels, OPEN): CI: trigger-deploy 403 marks all dev image builds red and blocks staging au... | done | 2026-06-07 |  |
| 1 | triage | `triage-issue-952` | Issue #952 (no labels, OPEN): [staging] Reality SSO login dead-ends: redirect_uri callback 404s on realit... | done | 2026-06-07 |  |
...
| 1 | security | `security-pkce-oauth-authcode-pr-908-closed` | PR #908 (fix(security): require PKCE on OAuth authorization-code flow, closes #823) was closed unmerged —... | done | 2026-06-03 |  |
...
| 1 | triage | `triage-issue-848` | Issue #848 (no labels, OPEN): Code review: Epics 78+134 — Vendor portal stubs & Predictive maintenance ga... | done | 2026-06-01 |  |
| 1 | triage | `triage-issue-850` | Issue #850 (no labels, OPEN): Code review: Epics 61+146+42 — Multi-currency, Data residency, Violations (... | done | 2026-06-01 |  |
| 1 | triage | `triage-issue-851` | Issue #851 (no labels, OPEN): Code review: Epics 15+105+69 — Listings/syndication & Developer API stubs (... | done | 2026-06-01 |  |
| 1 | triage | `triage-issue-859` | Issue #859 (no labels, OPEN): sqlx 0.9 breaks runtime decode of Postgres enum columns into Rust String (S... | done | 2026-06-01 |  |
| 1 | triage | `triage-issue-867` | Issue #867 (no labels, OPEN): Tech debt: api-server main.rs duplicates lib.rs::create_router — routers di... | done | 2026-06-01 |  |
...
| 1 | triage | `triage-issue-849` | Issue #849 (no labels, OPEN): Code review: Epic 10B+143 — Admin impersonation, Help, Board meetings auth ... | done | 2026-05-31 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03... | dropped | 2026-07-05 |  |
...
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-reality-portal-rs` | Churn hotspot: backend/crates/db/src/repositories/reality_portal.rs (+59/−28 in PR #1297 PAP-142 IDOR sco... | dropped | 2026-07-05 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-sensor-rs` | Churn hotspot: backend/crates/db/src/repositories/sensor.rs (+248/-86 in PR #1321/#1322 PAP-151 re-land +... | dropped | 2026-07-05 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-1... | dropped | 2026-07-05 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-tests-form-rls-repo-tests-rs` | Churn hotspot: backend/crates/db/tests/form_rls_repo_tests.rs touched 2x since 2026-06-12 (window 2026-06... | dropped | 2026-07-05 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-06-10 ... | dropped | 2026-07-05 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-api-ecosystem-rs` | Churn hotspot: backend/servers/api-server/src/routes/api_ecosystem.rs (+106/−27 in PR #1293 PAP-171; seco... | dropped | 2026-07-05 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-forms-rs` | Churn hotspot: backend/servers/api-server/src/routes/forms.rs touched 2x since 2026-06-12 (window 2026-06... | dropped | 2026-07-05 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-iot-rs` | Churn hotspot: backend/servers/api-server/src/routes/iot.rs (+278/-403 in PR #1321/#1322 PAP-151 re-land ... | dropped | 2026-07-05 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-reserve-funds-rs` | Churn hotspot: backend/servers/api-server/src/routes/reserve_funds.rs (+228/-255 in PR #1321 PAP-151 re-l... | dropped | 2026-07-05 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-tests-reserve-funds-cross-org-idor-tests-rs` | Churn hotspot: backend/servers/api-server/tests/reserve_funds_cross_org_idor_tests.rs touched 2x since 20... | dropped | 2026-07-05 |  |
...
| 0 | refactor | `churn-hotspot-mobile-native-listing-detail-kt` | Churn hotspot: ListingDetailScreen.kt — +1279 LOC this run (gap-82-4 reality mobile favorite toggle) | dropped | 2026-07-05 |  |
...
| 0 | dx | `closed-not-merged-pr-1274` | PR #1274 (cargo-minor-patch group, /backend, 9 updates) closed unmerged — superseded by #1313 after auto-... | dropped | 2026-07-05 |  |
...
| 0 | refactor | `code-review-api-core-osrng-expect` | crypto.rs:127 SysRng.try_fill_bytes(...).expect() panics if OS CSPRNG errors during integration-credentia... | dropped | 2026-07-05 |  |
...
| 0 | dx | `dx-stalled-review-pr-1179` | PR #1179 (docs(epics) catalog backfill for 37 mounted-but-undocumented backend modules) — stalled at 7d, ... | dropped | 2026-07-05 |  |
| 0 | dx | `dx-stalled-review-pr-988` | Stalled review: PR #988 (Epic: reusable Playwright E2E framework + sitemap FlowRunner) open 10d, no revie... | dropped | 2026-07-05 |  |
...
| 0 | refactor | `refactor-churn-hotspot-mobile-documents` | Churn hotspot: DocumentsScreen.tsx — 3 PRs this run | dropped | 2026-07-05 |  |
...
| 0 | test-gap | `test-gap-screen-map-drift-pr-922-ppt` | Screen-map drift: PR #922 modified ppt-web App.tsx (dev-review rounds 1-5 fixes) without a docs/screens/p... | dropped | 2026-07-05 |  |
...
| 0 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 d... | dropped | 2026-07-05 |  |
| 0 | triage | `triage-issue-1331` | Issue #1331 (no labels, OPEN): Backend `test` job red/hanging on dev base — blocks the entire backend mer... | dropped | 2026-07-05 |  |
...
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECR... | dropped | 2026-07-05 |  |

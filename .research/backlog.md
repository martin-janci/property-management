# Backlog of vectors
<sub>Last regenerated: 2026-06-23 08:30 UTC by routine</sub>
...
| 3 | refactor | `refactor-revert-pr-1713-delegations-retirement` | Revert PR #1713: delegations frontend retirement cleanup (BIT-213) | open | 2026-06-23 |  |
...
| 2 | test-gap | `test-gap-screen-map-drift-pr-1746-reality` | Screen-map drift: PR #1746 touched reality-web routes without docs/screens/reality/*.md update | open | 2026-06-23 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1737-ppt` | Screen-map drift: PR #1737 touched ppt-web routes without docs/screens/ppt/*.md update | open | 2026-06-23 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1733-ppt` | Screen-map drift: PR #1733 touched ppt-web routes without docs/screens/ppt/*.md update | open | 2026-06-23 |  |
...
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1485-booking-timeout-retry` | Hotfix without test: PR #pr (1485 booking timeout retry) | open | 2026-06-23 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-06-10 03:05 | open | 2026-06-23 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-forms-rs` | Churn hotspot: backend/servers/api-server/src/routes/forms.rs touched 2x since 2026-06-12 (window 2026-06-12→2 | open | 2026-06-23 |  |
| 1 | refactor | `repeated-churn-backend-servers-api-server-src-routes-forms-rs` | forms.rs repeated-churn — runs_seen=2 (#1337 explicit_auto_deref + #1397 org-scope hardening) | open | 2026-06-23 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-financial-rs` | Churn hotspot: backend/servers/api-server/src/routes/financial.rs | open | 2026-06-23 |  |
| 1 | triage | `closed-not-merged-pr-1749` | Closed-not-merged PR #1749: fix(mobile): exclude app.config.icon.test.ts from  | open | 2026-06-23 |  |
| 1 | triage | `closed-not-merged-pr-1727` | Closed-not-merged PR #1727: fix(ci): unblock backend gate — organizations fmt  | open | 2026-06-23 |  |
| 1 | triage | `closed-not-merged-pr-1698` | Closed-not-merged PR #1698: feat(epic-3): story 3.2 - unit management UI (BIT- | open | 2026-06-23 |  |

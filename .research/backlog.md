# Backlog of vectors
<sub>Last regenerated: 2026-07-14 12:24 UTC by routine</sub>
...
| 3 | test-gap | `code-review-mobile-rn-nfc-no-tests` | NFCCredentialManager + NFCAccessController + NFC index have no tests — building-access credentials & tap-validation are security-critical and uncovered | ready | 2026-07-14 | [plan](plans/code-review-mobile-rn-nfc-no-tests.md) |
...
| 2 | test-gap | `screen-map-drift-pr-2292-ppt` | Screen-map drift: PR #2292 wired Create-Schedule UI into ppt-web routes without a docs/screens/ppt update | open | 2026-07-14 |  |
| 2 | test-gap | `screen-map-drift-pr-2294-ppt` | Screen-map drift: PR #2294 added portal-webhook-status route via App.tsx without a docs/screens/ppt update | open | 2026-07-14 |  |
| 2 | test-gap | `screen-map-drift-pr-2287-reality` | Screen-map drift: PR #2287 wired reality-web /favorites/alerts route without a docs/screens/reality update | open | 2026-07-14 |  |
| 2 | bug | `code-review-mobile-rn-dashboard-no-err-ui` | Mobile DashboardScreen fires four useApiQuery calls and never reads .isError — silent all-zero render on any API failure | done | 2026-07-14 |  |
| 2 | test-gap | `code-review-mobile-rn-deeplink-mgr-untested` | DeepLinkManager auth-gated routing (pending-link queue, dispatch-after-auth, handler subscription) has no test | open | 2026-07-14 |  |
| 2 | bug | `code-review-ppt-web-core-units-fetch-noauth` | person-months useBuildingUnits calls raw fetch('/api/v1/units?...') with no Authorization header — protected endpoint 401s + error is swallowed → zero units rendered | open | 2026-07-14 |  |
| 2 | bug | `code-review-ppt-web-core-dashboard-unguarded` | ppt-web /dashboard/manager + /dashboard/resident wired without <ProtectedRoute> — guard fails open, unauthenticated user sees dashboard shell | open | 2026-07-14 |  |
...
| 1 | refactor | `churn-hotspot-frontend/apps/reality-web/messages/cs.json` | Churn hotspot: frontend/apps/reality-web/messages/cs.json — 3 PRs this run (i18n additions for price alerts + notif triggers) | open | 2026-07-14 |  |
| 1 | refactor | `churn-hotspot-frontend/apps/reality-web/messages/de.json` | Churn hotspot: frontend/apps/reality-web/messages/de.json — 3 PRs this run (i18n additions for price alerts + notif triggers) | open | 2026-07-14 |  |
| 1 | refactor | `churn-hotspot-frontend/apps/reality-web/messages/en.json` | Churn hotspot: frontend/apps/reality-web/messages/en.json — 3 PRs this run (i18n additions for price alerts + notif triggers) | open | 2026-07-14 |  |
| 1 | bug | `code-review-ppt-web-core-sessions-cast` | SessionsPage double-casts API session payload (as unknown as SessionRow[]) — defeats type checking; is_current vs isCurrent divergence would silently break revoke-all | open | 2026-07-14 |  |

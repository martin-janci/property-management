# Backlog of vectors
<sub>Last regenerated: 2026-08-06 06:24 UTC by routine</sub>
...
| 3 | bug | `code-review-reality-server-listings-viewcount` | GET /listings/{id} hardcodes view_count:0 while track_view persists to listing_analytics | ready | 2026-08-06 | [plan](plans/code-review-reality-server-listings-viewcount.md) |
...
| 2 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-auth-rs` | churn hotspot: backend/servers/api-server/src/routes/auth.rs (2950 lines, runs_seen=6) | open | 2026-08-06 |  |
| 2 | refactor | `code-review-reality-server-orphaned-get-listing` | handlers/listings/mod.rs get_listing returns stubbed data with no call sites (dead) | open | 2026-08-06 |  |
| 2 | refactor | `code-review-reality-server-orphaned-schedule-viewing` | handlers/inquiries/mod.rs schedule_viewing always returns not-yet-implemented (dead stub) | open | 2026-08-06 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-integrations-webhook-rs` | churn hotspot: backend/servers/api-server/src/routes/integrations/webhook.rs (2799 lines) | open | 2026-08-06 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-reports-mod-rs` | churn hotspot: backend/servers/api-server/src/routes/reports/mod.rs (2460 lines) | open | 2026-08-06 |  |

...
| 2 | security | `code-review-reality-server-sso-error-leak` | reality-server SSO handlers leak raw internal errors (DB/crypto/JWT/reqwest) via SsoError::new(&e.to | open | 2026-08-18 |  |
| 2 | bug | `code-review-reality-server-sso-http-no-timeout` | reality-server sso.rs builds bare reqwest::Client::new() with NO timeout — hung PM OAuth upstream bl | open | 2026-08-18 |  |
| 2 | bug | `code-review-reality-web-inquiry-cancel-silent-fail` | reality-web inquiries page: cancelInquiry mutation has no onError + no isError render — cancellation | open | 2026-08-18 |  |
| 2 | bug | `code-review-reality-web-profile-mock-data-shipped` | reality-web /[locale]/profile ships MOCK_PROFILE + MOCK_LISTINGS to production users — authenticated | open | 2026-08-18 |  |
...
| 1 | bug | `code-review-mobile-native-kmp-portfolio-analytics-caps-100` | mobile-native-kmp: getPortfolioAnalytics() truncates realtor portfolio at 100 listings — dashboard u | open | 2026-08-18 |  |
...
| 1 | refactor | `code-review-reality-web-inquiries-page-no-i18n` | reality-web inquiries page renders raw English in every non-English locale (no useTranslations impor | open | 2026-08-18 |  |
| 1 | refactor | `code-review-reality-web-savedsearches-no-i18n` | reality-web saved-searches page: hardcoded English filter/toggle strings across sk/cs/de/en (no next | open | 2026-08-18 |  |
| 1 | bug | `code-review-reality-web-comparison-fetch-unvalidated-cast` | reality-web ComparisonUrlHandler fetches shared-comparison payload with unvalidated JSON cast (as Fo | open | 2026-08-18 |  |
| 1 | bug | `code-review-reality-web-comparison-localstorage-unvalidated` | reality-web comparison-context reads localStorage `pinnedListings` and JSON.parses it into state wit | open | 2026-08-18 |  |
| 1 | refactor | `churn-hotspot-frontend-mobile-nfc-credential-manager` | mobile/nfc/NFCCredentialManager.ts churn hotspot — 4 touches this run (offline-persist bugfix + Secu | open | 2026-08-18 |  |
| 1 | refactor | `churn-hotspot-backend-api-server-documents-shares` | api-server routes/documents/shares.rs churn hotspot — 3 touches this run (password throttle #2773 +  | open | 2026-08-18 |  |

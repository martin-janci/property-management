...
| 3 | bug | `code-review-mobile-native-kmp-create-listing-not-implemented` | [mobile-native-kmp] create listing not implemented | ready | 2026-08-25 | [plan](plans/code-review-mobile-native-kmp-create-listing-not-implemented.md) |
...
| 2 | bug | `code-review-mobile-native-kmp-account-screen-dead-rows` | [mobile-native-kmp] account screen dead rows | open | 2026-08-25 |  |
| 2 | bug | `code-review-mobile-native-kmp-compose-notnull-assertions` | [mobile-native-kmp] compose notnull assertions | open | 2026-08-25 |  |
| 2 | bug | `code-review-mobile-native-kmp-profile-edit-drops-fields` | [mobile-native-kmp] profile edit drops fields | open | 2026-08-25 |  |
| 2 | bug | `code-review-mobile-native-kmp-twofactor-orphan-unwired` | [mobile-native-kmp] twofactor orphan unwired | open | 2026-08-25 |  |
| 2 | bug | `code-review-ppt-web-ui-bookfacility-silent-availability` | [ppt-web-ui] bookfacility silent availability | open | 2026-08-25 |  |
...
| 2 | bug | `code-review-ppt-web-ui-facilities-silent-load-errors` | [ppt-web-ui] facilities silent load errors | open | 2026-08-25 |  |
| 2 | bug | `code-review-ppt-web-ui-invoice-empty-items` | [ppt-web-ui] invoice empty items | open | 2026-08-25 |  |
| 2 | bug | `code-review-ppt-web-ui-mediation-sessions-swallowed-error` | [ppt-web-ui] mediation sessions swallowed error | open | 2026-08-25 |  |
| 2 | bug | `code-review-reality-server-sso-http-no-timeout` | [reality-server] sso http no timeout | open | 2026-08-25 |  |
| 2 | bug | `code-review-reality-web-account-edit-wrong-locale-strings` | [reality-web] account edit wrong locale strings | open | 2026-08-25 |  |
| 2 | bug | `code-review-reality-web-agency-slug-i18n` | [reality-web] agency slug i18n | open | 2026-08-25 |  |
| 2 | bug | `code-review-reality-web-checksession-5xx-logout` | [reality-web] checksession 5xx logout | open | 2026-08-25 |  |
| 2 | bug | `code-review-search-drainer-stub-marks-delivered` | [reality-server] search drainer stub marks delivered | open | 2026-08-25 |  |
...
| 1 | refactor | `code-review-mobile-rn-faults-screen-no-i18n` | [mobile-rn] faults screen no i18n | open | 2026-08-25 |  |
| 1 | bug | `code-review-mobile-rn-list-search-placeholders-i18n` | [mobile-rn] list search placeholders i18n | open | 2026-08-25 |  |
| 1 | refactor | `code-review-mobile-rn-person-months-hardcoded-i18n` | [mobile-rn] person months hardcoded i18n | open | 2026-08-25 |  |
| 1 | refactor | `code-review-mobile-rn-widget-settings-alerts-i18n` | [mobile-rn] widget settings alerts i18n | open | 2026-08-25 |  |
| 1 | bug | `code-review-ppt-web-ui-date-number-formatters-no-locale` | [ppt-web-ui] date number formatters no locale | open | 2026-08-25 |  |
| 1 | bug | `code-review-ppt-web-ui-document-hooks-hardcoded-sk` | [ppt-web-ui] document hooks hardcoded sk | open | 2026-08-25 |  |
...
| 1 | i18n | `code-review-ppt-web-ui-facilities-hardcoded-i18n` | [ppt-web-ui] facilities hardcoded i18n | open | 2026-08-25 |  |
| 1 | bug | `code-review-ppt-web-ui-invoice-vat-table-drift` | [ppt-web-ui] invoice vat table drift | open | 2026-08-25 |  |
| 1 | i18n | `code-review-ppt-web-ui-native-confirm-dialogs` | [ppt-web-ui] native confirm dialogs | open | 2026-08-25 |  |
| 1 | bug | `code-review-reality-web-inquiry-cancel-no-error` | [reality-web] inquiry cancel no error | open | 2026-08-25 |  |
| 1 | bug | `code-review-reality-web-realtor-dashboard-total-mislabel` | [reality-web] realtor dashboard total mislabel | open | 2026-08-25 |  |
| 1 | refactor | `code-review-reality-web-realtor-section-no-i18n` | [reality-web] realtor section no i18n | open | 2026-08-25 |  |
| 1 | bug | `code-review-search-drainer-alert-copy-no-i18n` | [reality-server] search drainer alert copy no i18n | open | 2026-08-25 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-07-02 06:15 UTC by routine</sub>
...
| 3 | security | `security-cargo-deny-ammonia-advisory-2009` | Repo-wide blocker: cargo-deny RUSTSEC advisory on ammonia v4.1.2 red — all backend PR merges blocked (#2009) | ready | 2026-07-02 | [plan](plans/security-cargo-deny-ammonia-advisory-bump.md) |
| 3 | bug | `code-review-mobile-rn-report-fault-fake-submit` | ReportFaultScreen.tsx handleSubmit() fakes API call with setTimeout(1500) — fault reports never reach backen | ready | 2026-06-16 | [plan](plans/code-review-mobile-rn-report-fault-fake-submit.md) |
...
| 3 | security | `security-llm-doc-idor` | IDOR: ai.rs LLM-doc handlers publish/list/get any tenant's listing descriptions & photo enhancements unscope | ready | 2026-06-01 | [plan](plans/security-llm-doc-idor.md) |
...
| 2 | test-gap | `screen-map-drift-pr-1987-reality` | Screen-map drift: PR #1987 added SSO callback CSRF fix without docs/screens/reality/auth-callback.md | open | 2026-07-02 |  |
| 2 | test-gap | `screen-map-drift-pr-1977-ppt` | Screen-map drift: PR #1977 changed messaging unread semantics without docs/screens/ppt/messaging-* update | open | 2026-07-02 |  |
| 2 | test-gap | `screen-map-drift-pr-1993-ppt` | Screen-map drift: PR #1993 changed messaging unread/block semantics without docs/screens/ppt/messaging-* upd | open | 2026-07-02 |  |
| 2 | test-gap | `test-gap-bit-440-fragile-test-gate` | Backend test gate fragile — 9 suites quarantined without hardening test (BIT-440 PRs #1984 + #1985) | open | 2026-07-02 |  |
| 2 | bug | `code-review-api-core-vote-partial-cmp-panic` | vote.rs:1765 calculate_question_result() uses partial_cmp().unwrap() on f64 — NaN/Inf weights panic /votes/{ | done | 2026-06-16 |  |
...
| 2 | refactor | `refactor-announcements-rs-module-split` | announcements.rs (2,722 LOC) — explicit module-split into routes/announcements/{crud,targeting,delivery,reac | done | 2026-06-06 |  |
...
| 2 | refactor | `refactor-platform-admin-rs-module-split` | platform_admin.rs (2,762 LOC) — explicit module-split into routes/platform_admin/{tenants,features,billing,a | done | 2026-06-06 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1033-ppt` | Screen-map drift: PR #1033 wired error/retry into AnnouncementsPage+FaultsPage via App.tsx without a docs/sc | done | 2026-06-06 |  |
...
| 2 | test-gap | `test-gap-hotfix-no-test-pr-874-portal-webhooks` | Portal webhook fail-closed fix (PR #874) shipped without a regression test for unverified-signature rejectio | done | 2026-06-05 |  |
...
| 2 | test-gap | `test-gap-hotfix-no-test-pr-990-frontend-gap-sweep` | Frontend gap-sweep (PR #990, 34 files across Epics 1/6/7B/9/10B/11/15/17/18) shipped without a regression te | done | 2026-06-05 |  |
...
| 2 | test-gap | `test-gap-router-set-parity-tests` | api-server main.rs vs lib.rs::create_router diverge silently (5 routes unreachable in prod, no test asserts  | done | 2026-06-01 |  |
| 2 | bug | `bug-report-schedule-update-no-sql` | ReportSchedule.update_schedule stores cron in `time` workaround; documented UPDATE never runs (missing cron_ | done | 2026-05-30 |  |
...
| 1 | dx | `stalled-review-pr-1797` | PR #1797 (auth on OCR + manager-gate rental PII) — stalled at 8d, draft, no reviewDecision | open | 2026-07-02 |  |
| 1 | dx | `closed-not-merged-pr-1958` | PR #1958 (bulk re-enable 718 BIT-351 tests) closed unmerged — superseded by incremental batches | open | 2026-07-02 |  |
| 1 | dx | `closed-not-merged-pr-1982` | PR #1982 (finance happy-path un-quarantine BIT-417) closed unmerged — superseded by #1991 | open | 2026-07-02 |  |
| 1 | dx | `closed-not-merged-pr-1802` | PR #1802 (N-party messaging delivery/block/unhide) closed unmerged — superseded by #1977/#1993/#1990 | open | 2026-07-02 |  |
| 1 | dx | `closed-not-merged-pr-1956` | PR #1956 (documents-forms happy-path Wave 7) closed unmerged — rolled into #1963/#1980 | open | 2026-07-02 |  |
| 1 | dx | `closed-not-merged-pr-1795` | PR #1795 closed unmerged in 2026-06-29 batch — superseded by later security/hardening wave | open | 2026-07-02 |  |
| 1 | dx | `closed-not-merged-pr-1799` | PR #1799 closed unmerged in 2026-06-29 batch — superseded by later security/hardening wave | open | 2026-07-02 |  |
| 1 | dx | `closed-not-merged-pr-1804` | PR #1804 closed unmerged in 2026-06-29 batch — superseded by later security/hardening wave | open | 2026-07-02 |  |
| 1 | dx | `closed-not-merged-pr-1814` | PR #1814 closed unmerged in 2026-06-29 batch — superseded by later security/hardening wave | open | 2026-07-02 |  |
| 1 | dx | `closed-not-merged-pr-1823` | PR #1823 closed unmerged in 2026-06-29 batch — superseded by later security/hardening wave | open | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-messaging-rs` | Churn hotspot: messaging.rs (routes) — 3 PRs in 3 days (#1977 unread watermark, #1993 soft-delete + block, # | open | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-messaging-rs` | Churn hotspot: messaging.rs (repository) — 2 PRs, migration 00208 + soft-delete predicate | open | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-regional-compliance-rs` | Churn hotspot: regional_compliance.rs — 77 lines (PR #1976: live quorum + 5 manager-gates + org-id fix) | open | 2026-07-02 |  |
| 1 | dx | `dx-followup-issue-growth-2026-07-02` | Follow-up backlog growth: 5 new post-merge review issues filed in one day (#1997-2001) | open | 2026-07-02 |  |
| 1 | test-gap | `screen-map-drift-pr-1418-ppt` | PR #1418 touched routes/** (faults.route.test.tsx) without updating docs/screens/ppt/* — heuristic, test-fil | open | 2026-06-16 |  |
| 1 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardc | open | 2026-06-16 |  |
| 1 | bug | `code-review-mobile-rn-deeplink-init-unhandled` | useDeepLinkRouting.ts:27-36 — initialize() re-runs on onNavigate identity change + void promise with no .cat | open | 2026-06-16 |  |
...
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1288-webhook-rls` | Webhook handlers RLS migration (PR #1288, PAP-170) shipped without a new regression test for repo-layer meth | open | 2026-06-11 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new  | open | 2026-06-11 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression te | open | 2026-06-11 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfi | open | 2026-06-11 |  |
...
| 1 | triage | `triage-issue-950` | Issue #950 (no labels, OPEN): CI: trigger-deploy 403 marks all dev image builds red and blocks staging auto- | done | 2026-06-07 |  |
| 1 | triage | `triage-issue-952` | Issue #952 (no labels, OPEN): [staging] Reality SSO login dead-ends: redirect_uri callback 404s on reality a | done | 2026-06-07 |  |
...
| 1 | bug | `code-review-mobile-native-kmp-deeplink-token-not-url-decoded` | DeepLinkRouter skips URL-decoding while Android Uri.getQueryParameter decodes — SSO tokens diverge per platf | open | 2026-06-06 |  |
...
| 1 | test-gap | `test-gap-screen-map-drift-pr-1100-ppt` | Screen-map drift: PR #1100 modified ppt-web App.tsx (FileDisputePageRoute extraction) without screen-doc upd | open | 2026-06-05 |  |
...
| 1 | security | `security-pkce-oauth-authcode-pr-908-closed` | PR #908 (fix(security): require PKCE on OAuth authorization-code flow, closes #823) was closed unmerged — ve | done | 2026-06-03 |  |
...
| 1 | triage | `triage-issue-850` | Issue #850 (no labels, OPEN): Code review: Epics 61+146+42 — Multi-currency, Data residency, Violations (ori | done | 2026-06-01 |  |
| 1 | triage | `triage-issue-851` | Issue #851 (no labels, OPEN): Code review: Epics 15+105+69 — Listings/syndication & Developer API stubs (ori | done | 2026-06-01 |  |
| 1 | triage | `triage-issue-859` | Issue #859 (no labels, OPEN): sqlx 0.9 breaks runtime decode of Postgres enum columns into Rust String (SELE | done | 2026-06-01 |  |
| 1 | triage | `triage-issue-867` | Issue #867 (no labels, OPEN): Tech debt: api-server main.rs duplicates lib.rs::create_router — routers diver | done | 2026-06-01 |  |
...
| 1 | triage | `triage-issue-849` | Issue #849 (no labels, OPEN): Code review: Epic 10B+143 — Admin impersonation, Help, Board meetings auth (or | done | 2026-05-31 |  |
| 0 | test-gap | `test-gap-screen-map-drift-pr-922-ppt` | Screen-map drift: PR #922 modified ppt-web App.tsx (dev-review rounds 1-5 fixes) without a docs/screens/ppt  | dropped | 2026-06-16 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-forms-rs` | Churn hotspot: backend/servers/api-server/src/routes/forms.rs touched 2x since 2026-06-12 (window 2026-06-12 | dropped | 2026-06-16 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-tests-booking-oauth-csrf-tests-rs` | booking_oauth_csrf_tests.rs hotspot — 484-line NEW test file (PR #1393 #1424 OAuth CSRF coverage) | dropped | 2026-06-16 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-tests-booking-oauth-routes-tests-rs` | booking_oauth_routes_tests.rs hotspot — 381-line NEW test file (PR #1393 OAuth routes coverage) | dropped | 2026-06-16 |  |
| 0 | refactor | `repeated-churn-backend-servers-api-server-src-routes-forms-rs` | forms.rs repeated-churn — runs_seen=2 (#1337 explicit_auto_deref + #1397 org-scope hardening) | dropped | 2026-06-16 |  |
| 0 | dx | `closed-not-merged-pr-1425` | PR #1425 (GH #1377 document presigned-URL tests) closed unmerged — superseded by merged #1394 | dropped | 2026-06-16 |  |
| 0 | dx | `dx-stalled-review-pr-1179` | PR #1179 (docs(epics) catalog backfill for 37 mounted-but-undocumented backend modules) — stalled at 7d, no  | dropped | 2026-06-16 |  |
| 0 | triage | `triage-issue-1380` | Issue #1380 (no labels, OPEN): Dispatcher stale gap-scan buffer + Tier-2 escalation endpoint misconfigured | dropped | 2026-06-15 |  |
| 0 | refactor | `churn-hotspot-frontend-apps-mobile-app-config-icon-test-ts` | Churn hotspot: 124 lines in frontend/apps/mobile/app.config.icon.test.ts (PR #1383 gap-85-2) | dropped | 2026-06-15 |  |
| 0 | refactor | `churn-hotspot-frontend-apps-mobile-app-config-ts` | Churn hotspot: 94 lines in frontend/apps/mobile/app.config.ts (PR #1383 gap-85-2) | dropped | 2026-06-15 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-form-rs` | Churn hotspot: 53 lines in backend/crates/db/src/repositories/form.rs (PR #1379 #1332 unblock) | dropped | 2026-06-15 |  |
| 0 | refactor | `code-review-api-core-osrng-expect` | crypto.rs:127 SysRng.try_fill_bytes(...).expect() panics if OS CSPRNG errors during integration-credential e | dropped | 2026-06-15 |  |
...
| 0 | triage | `triage-issue-1331` | Issue #1331 (no labels, OPEN): Backend `test` job red/hanging on dev base — blocks the entire backend merge  | dropped | 2026-06-13 |  |
| 0 | dx | `dx-stalled-review-pr-988` | Stalled review: PR #988 (Epic: reusable Playwright E2E framework + sitemap FlowRunner) open 10d, no reviewDe | dropped | 2026-06-13 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-tests-reserve-funds-cross-org-idor-tests-rs` | Churn hotspot: backend/servers/api-server/tests/reserve_funds_cross_org_idor_tests.rs touched 2x since 2026- | dropped | 2026-06-13 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-tests-form-rls-repo-tests-rs` | Churn hotspot: backend/crates/db/tests/form_rls_repo_tests.rs touched 2x since 2026-06-12 (window 2026-06-12 | dropped | 2026-06-13 |  |
| 0 | dx | `closed-not-merged-pr-1274` | PR #1274 (cargo-minor-patch group, /backend, 9 updates) closed unmerged — superseded by #1313 after auto-reb | dropped | 2026-06-12 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-api-ecosystem-rs` | Churn hotspot: backend/servers/api-server/src/routes/api_ecosystem.rs (+106/−27 in PR #1293 PAP-171; second  | dropped | 2026-06-12 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-reality-portal-rs` | Churn hotspot: backend/crates/db/src/repositories/reality_portal.rs (+59/−28 in PR #1297 PAP-142 IDOR scopin | dropped | 2026-06-12 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-iot-rs` | Churn hotspot: backend/servers/api-server/src/routes/iot.rs (+278/-403 in PR #1321/#1322 PAP-151 re-land + f | dropped | 2026-06-12 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-reserve-funds-rs` | Churn hotspot: backend/servers/api-server/src/routes/reserve_funds.rs (+228/-255 in PR #1321 PAP-151 re-land | dropped | 2026-06-12 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-sensor-rs` | Churn hotspot: backend/crates/db/src/repositories/sensor.rs (+248/-86 in PR #1321/#1322 PAP-151 re-land + fm | dropped | 2026-06-12 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-emergency-rs` | Churn hotspot: 1021 lines changed in backend/servers/api-server/src/routes/emergency.rs (window 2026 | dropped | 2026-06-10 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-enhanced-tenant-screening-rs` | Churn hotspot: 709 lines changed in backend/servers/api-server/src/routes/enhanced_tenant_screening. | dropped | 2026-06-10 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05 | dropped | 2026-06-10 |  |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-10 0 | dropped | 2026-06-10 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-06-10 03: | dropped | 2026-06-10 |  |
| 0 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 desp | dropped | 2026-06-07 |  |
...
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET  | dropped | 2026-06-03 |  |

...
| 2 | bug | `code-review-api-handlers-reports-csv-injection` | Reports CSV export writes user-authored vote titles unescaped — spreadsheet formula injection (bypas | done | 2026-08-11 |  |
| 2 | bug | `risky-churn-pr-2730-notification_pipeline-rs` | Risky churn (PR #2730): fix-without-tests touched top-3 churn file | open | 2026-08-11 |  |
| 2 | bug | `risky-churn-pr-2728-voice_commands-rs` | Risky churn (PR #2728): fix-without-tests touched top-3 churn file | open | 2026-08-11 |  |
...
| 1 | refactor | `refactor-churn-hotspot-backend-servers-reality-server-src-services-email-rs` | Churn hotspot: backend/servers/reality-server/src/services/email.rs — top-3 churn: 368 adds+dels acr | open | 2026-08-11 |  |
| 1 | refactor | `refactor-churn-hotspot-backend-servers-api-server-src-services-notification_pipeline-rs` | Churn hotspot: backend/servers/api-server/src/services/notification_pipeline.rs — top-3 churn: 181 a | open | 2026-08-11 |  |
| 1 | refactor | `refactor-churn-hotspot-backend-servers-api-server-src-services-voice_commands-rs` | Churn hotspot: backend/servers/api-server/src/services/voice_commands.rs — top-3 churn: 134 adds+del | open | 2026-08-11 |  |
| 1 | triage | `stalled-review-pr-2555` | Stalled review: PR #2555 | open | 2026-08-11 |  |
| 1 | triage | `stalled-review-pr-2558` | Stalled review: PR #2558 | open | 2026-08-11 |  |
| 1 | triage | `stalled-review-pr-2559` | Stalled review: PR #2559 | open | 2026-08-11 |  |
| 1 | dx | `closed-not-merged-pr-2705` | Closed-not-merged: PR #2705 (rust-toolchain bump retry) | open | 2026-08-11 |  |

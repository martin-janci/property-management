...
| 2 | security | `code-review-api-handlers-share-pw-no-throttle` | SECURITY: public share-password endpoint has no brute-force throttle | ready | 2026-08-14 | [plan](plans/code-review-api-handlers-share-pw-no-throttle.md) |
...
| 1 | bug | `code-review-api-handlers-share-log-proxy-ip` | share access audit log records proxy IP, not real client IP | open | 2026-08-14 |  |
| 1 | bug | `code-review-reality-web-agency-errorstate-i18n` | i18n: AgencyErrorStates.tsx "No Agency Found" state hardcoded English | open | 2026-08-14 |  |
| 1 | bug | `code-review-reality-web-realtor-mgmt-i18n` | i18n: RealtorManagement.tsx delete-confirm modal + subtitle hardcoded | open | 2026-08-14 |  |
| 1 | bug | `code-review-reality-web-comparison-view-i18n` | i18n: ComparisonView.tsx hardcoded English on 4-locale portal | open | 2026-08-14 |  |

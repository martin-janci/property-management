...
| 2 | test-gap | `screen-map-drift-pr-1418-ppt` | PR #1418 touched routes/** (faults.route.test.tsx) without updating docs/screens/ppt/* — heuristic, test-file fix | done | 2026-06-23 |  |
...
| 2 | bug | `code-review-mobile-rn-deeplink-init-unhandled` | useDeepLinkRouting.ts:27-36 — initialize() re-runs on onNavigate identity change + void promise with no .catch → duplicate nav / unhandled rejection | done | 2026-06-23 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→18:30Z) | open | 2026-06-23 |  |
...
| 1 | refactor | `repeated-churn-backend-crates-db-src-repositories-document-rs` | Repeated churn: backend/crates/db/src/repositories/document.rs — instability proxy | open | 2026-06-23 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-rental-rs` | Churn hotspot: backend/crates/db/src/repositories/rental.rs — 2026-06-23 churn: 2939 lines | open | 2026-06-23 |  |
| 1 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-mod-rs` | Churn hotspot: backend/crates/integrations/src/booking/mod.rs — 2026-06-23 churn: 2818 lines | open | 2026-06-23 |  |
| 1 | dx | `closed-not-merged-pr-1749` | PR #1749 closed unmerged 2026-06-23T06:14:41Z: fix(mobile): exclude app.config.icon.test.ts from tsc typecheck (unblock dev fro | open | 2026-06-23 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-06-21 22:07 UTC by routine</sub>
...
| 2 | refactor | `churn-hotspot-backend-crates-db-src-repositories-reality-portal-rs` | Churn hotspot: backend/crates/db/src/repositories/reality_portal.rs (+59/−28 in PR #1297 PAP-142 IDOR scoping) | open | 2026-06-21 |  |
| 2 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs (+404/−29 in PR #1294 Booking.com OTA retry) | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1559-ppt` | Screen-map drift: PR #1559 modified ppt-web announcements route (Story 6.3 optimistic add) with no docs/screen | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1610-ppt` | Screen-map drift: PR #1610 modified ppt-web faults route (confirm-delete + stats refresh) with no docs/screens | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1621-ppt` | Screen-map drift: PR #1621 relocated payment-matching to ppt-web with no docs/screens/ppt/accounting update | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1621-reality` | Screen-map drift: PR #1621 removed payment-matching from reality-web with no docs/screens/reality update | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1630-ppt` | Screen-map drift: PR #1630 wired Payment Management page to org-wide endpoints with no docs/screens/ppt update | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1641-ppt` | Screen-map drift: PR #1641 added Sentiment & Predictive Maintenance dashboards (new route group) with no docs/ | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1642-reality` | Screen-map drift: PR #1642 added portal-user listing CRUD edit pages (account + realtor) with no docs/screens/ | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1654-ppt` | Screen-map drift: PR #1654 added invoice PDF download button to financial route with no docs/screens/ppt updat | open | 2026-06-21 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-api-core-src-extractors-principal-rs` | Churn hotspot: api-core principal extractor — 2 PRs, dedup landing in this window | open | 2026-06-21 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-tests-voting_tests-rs` | Churn hotspot: voting_tests.rs — 7 PRs this window, root of red dev trunk (#1645/#1656) | open | 2026-06-21 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-ppt-web-src-routes-lazyRoutes-tsx` | Churn hotspot: ppt-web lazyRoutes.tsx — 5 PRs in 5 days, central route registry | open | 2026-06-21 |  |
| 1 | refactor | `churn-hotspot-frontend-packages-api-client-src-financial-api-ts` | Churn hotspot: generated financial/api.ts — 4 PRs touching the @hey-api generated client | open | 2026-06-21 |  |
| 1 | dx | `closed-not-merged-pr-1636` | PR #1636 (fix(reality-server) portal authz + principal dedup) closed unmerged — landed via #1632 + #1638 | open | 2026-06-21 |  |
| 1 | refactor | `closed-not-merged-pr-1647` | PR #1647 (feat(iot) sensor register+edit BIT-147) closed unmerged — investigate why iteration didn't land | open | 2026-06-21 |  |
| 1 | bug | `code-review-mobile-native-kmp-deeplink-token-not-url-decoded` | DeepLinkRouter skips URL-decoding while Android Uri.getQueryParameter decodes — SSO tokens diverge per platfor | open | 2026-06-21 |  |
...
| 1 | test-gap | `test-gap-screen-map-drift-pr-1100-ppt` | Screen-map drift: PR #1100 modified ppt-web App.tsx (FileDisputePageRoute extraction) without screen-doc updat | open | 2026-06-21 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→ | open | 2026-06-10 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-10 03: | open | 2026-06-10 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-06-10 03:05 | open | 2026-06-10 |  |
...
| 0 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despit | dropped | 2026-06-21 |  |
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET no | dropped | 2026-06-21 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-07-31 04:25 UTC by routine</sub>
...
| 3 | security | `code-review-reality-server-sso-sessions-unbounded-dos` | SECURITY: reality-server sso_sessions HashMap unbounded — /api/v1/sso/login memory-DoS on abandoned flows (no reaper, no cap) | ready | 2026-07-31 | [plan](plans/code-review-reality-server-sso-sessions-unbounded-dos.md) |
...
| 2 | bug | `code-review-api-core-resolved-rs-leaks-db-error` | SECURITY-LITE: layout/resolved.rs err500 handler leaks raw sqlx/serde error text on public GET /layout/resolved/{screen} — 8 sites, no server-side log | done | 2026-07-31 |  |
...
| 1 | refactor | `refactor-churn-hotspot-api-server-reports-schedule-cadence-2026-07-31` | Churn hotspot: backend/servers/api-server/src/routes/reports/schedule_cadence.rs — 889 lines this window (PR #2599 refactor split) | open | 2026-07-31 |  |
| 1 | refactor | `refactor-churn-hotspot-api-server-reports-mod-2026-07-31` | Churn hotspot: backend/servers/api-server/src/routes/reports/mod.rs — 887 lines this window (PR #2599 refactor split) | open | 2026-07-31 |  |
| 1 | refactor | `refactor-churn-hotspot-api-server-voice-webhooks-2026-07-31` | Churn hotspot: backend/servers/api-server/src/routes/voice_webhooks.rs — 472 lines this window (PR #2604 test-gap fix) | open | 2026-07-31 |  |
| 1 | security | `code-review-reality-server-record-view-unauth-noverify` | reality-server record_view (POST /listings/{id}/view) unauth + swallows track_view errors — analytics abuse surface | open | 2026-07-31 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-06-27 14:25 UTC by routine</sub>
...
| 3 | bug | `revert-pr-1713` | PR #1713 'revert(delegations): remove re-added delegation frontend (#1690) | open | 2026-06-27 |  |
| 3 | bug | `code-review-reality-server-drainer-no-row-reservation` | search_alert_drainer.rs:244-326 | ready | 2026-06-27 | [plan](plans/code-review-reality-server-drainer-no-row-reservation.md) |
| 3 | bug | `code-review-reality-server-saved-search-enqueue-non-tx` | saved_search_alerts.rs:216-240 | ready | 2026-06-27 | [plan](plans/code-review-reality-server-saved-search-enqueue-non-tx.md) |
...
| 2 | bug | `code-review-reality-server-drainer-no-backoff-rate-limit` | search_alert_drainer.rs:122-174 | open | 2026-06-27 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→ | done | 2026-06-27 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-06-10 03:05 | done | 2026-06-27 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-tests-form-rls-repo-tests-rs` | Churn hotspot: backend/crates/db/tests/form_rls_repo_tests.rs touched 2x since 2026-06-12 (window 2026-06-12→2 | done | 2026-06-27 |  |
...
| 1 | dx | `closed-not-merged-pr-1720` | PR #1720 'Leases nav link' closed unmerged | open | 2026-06-27 |  |
| 1 | dx | `closed-not-merged-pr-1749` | PR #1749 'mobile tsc typecheck exclusion' closed unmerged | open | 2026-06-27 |  |
| 1 | dx | `closed-not-merged-pr-1727` | PR #1727 'backend gate unblock for organizations/notification_event' closed unmerged | open | 2026-06-27 |  |
| 1 | dx | `closed-not-merged-pr-1698` | PR #1698 'Epic 3 story 3.2 unit management UI' closed unmerged | open | 2026-06-27 |  |
| 1 | refactor | `churn-hotspot-backend-servers-reality-server-src-services-saved-search-alerts-rs` | backend/servers/reality-server/src/services/saved_search_alerts.rs touched 3x in PRs #1847/#1849/#18 | open | 2026-06-27 |  |
| 1 | refactor | `repeated-churn-backend-crates-db-src-repositories-reality-portal-rs` | reality_portal.rs hit runs_seen=2 (last_seen 2026-06-12 → 2026-06-27). Saved-search-alerts feature w | open | 2026-06-27 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-models-reality-portal-rs` | backend/crates/db/src/models/reality_portal.rs touched 3x in PRs #1847/#1849/#1850 (Epic 16 model ad | open | 2026-06-27 |  |

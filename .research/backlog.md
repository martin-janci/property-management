# Backlog of vectors
<sub>Last regenerated: 2026-07-13 14:19 UTC by routine</sub>
...
| 3 | bug | `code-review-api-core-sync-calevent-create-idor` | IDOR: create_calendar_event handler in api-server ignores path id + skips verify_org_access — cross-org calendar-event write via body connection_id | ready | 2026-07-13 | [plan](plans/security-calevent-create-idor.md) |
...
| 2 | bug | `code-review-api-core-sync-calevent-list-idor` | IDOR (read): list_calendar_events in api-server passes path id to repo without verify_org_access — inconsistent authz, potential cross-org read | open | 2026-07-13 |  |

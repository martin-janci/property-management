...
| 3 | security | `code-review-api-handlers-voice-webhook-default-secret` | SECURITY: verify_hmac_signature falls back to hardcoded "default_secret" when VOICE_WEBHOOK_SECRET u | ready | 2026-08-04 | [plan](plans/code-review-api-handlers-voice-webhook-default-secret.md) |
| 3 | security | `code-review-api-handlers-voice-webhook-timing-cmp` | SECURITY: verify_hmac_signature uses non-constant-time == compare — timing sidechannel on /verify | open | 2026-08-04 |  |
| 3 | security | `code-review-api-handlers-voice-webhook-token-authbypass` | SECURITY: authenticate_voice_user ignores the OAuth access token — Alexa/Google webhook impersonatio | ready | 2026-08-04 | [plan](plans/code-review-api-handlers-voice-webhook-token-authbypass.md) |

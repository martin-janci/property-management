# Backlog of vectors
<sub>Last regenerated: 2026-06-19 02:15 UTC by routine</sub>
...
| 3 | bug | `bug-ios-searchview-uncompilable` | iOS SearchView.swift does not compile — performSearch/scheduleSearch undefined, resultsGrid corrupted | done | 2026-06-19 | [plan](plans/_archive/bug-ios-searchview-uncompilable.md) |
...
| 2 | bug | `bug-ios-deeplink-info-plist-missing` | iOS deep-link layer dead at runtime — Info.plist missing CFBundleURLTypes + applinks entitlement | done | 2026-06-19 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1288-webhook-rls` | Webhook handlers RLS migration (PR #1288, PAP-170) shipped without a new regression test for repo-layer methods | done | 2026-06-19 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new regression test | done | 2026-06-19 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixed in PR #1287 | done | 2026-06-19 |  |
| 2 | bug | `risky-churn-pr-1565-document-rs` | PR #1565 fix(db) document.rs get-by-id without test coverage — risky churn on top-3 hotspot file | open | 2026-06-19 |  |
| 2 | test-gap | `screen-map-drift-pr-1559-ppt` | PR #1559 (announcement comments optimistic add) touched ppt-web/src/routes/groups/announcements.tsx without updating docs/screens/ppt/announcements.md | open | 2026-06-19 |  |
| 2 | test-gap | `screen-map-drift-pr-1555-ppt` | PR #1555 (gap-79-1 wire useDeleteFault + useFaultStatistics into FaultsPage) touched routes/groups/faults.tsx without updating docs/screens/ppt/faults-list.md | open | 2026-06-19 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→18:30Z) | open | 2026-06-19 |  |
| 1 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs (+404/−29 in PR #1294 Booking.com OTA retry) | open | 2026-06-19 |  |
| 1 | refactor | `repeated-churn-backend-crates-integrations-src-booking-rs` | booking.rs repeated-churn — runs_seen 1→2 (5 commits this run from PRs #1485/#1560/#1562/#1577/#1599) | open | 2026-06-19 |  |
| 1 | refactor | `repeated-churn-backend-crates-db-src-repositories-document-rs` | document.rs repeated-churn — runs_seen 1→2 (PR #1565 fix without test diff stacks on prior churn) | open | 2026-06-19 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-rental-rs` | rental.rs churn-hotspot — 2853 lines across 2 commits this run (PR #1578 enum-cast + dedupe BOOKING_COLUMNS) | open | 2026-06-19 |  |
| 1 | triage | `triage-issue-1520` | Issue #1520 (no labels, OPEN): Follow-up: wire preference-aware push dispatch-target selection to real user preference (PR #1450) | open | 2026-06-19 |  |
| 1 | triage | `triage-issue-1521` | Issue #1521 (no labels, OPEN): Follow-up: payment-matching UI shipped in wrong app, with broken auth + no i18n/translations (PR #1453) | open | 2026-06-19 |  |
| 1 | triage | `triage-issue-1522` | Issue #1522 (no labels, OPEN): Follow-up: accounting UI bypasses shared API auth interceptor after @hey-api migration (PR #1454) | open | 2026-06-19 |  |
| 1 | triage | `triage-issue-1533` | Issue #1533 (no labels, OPEN): Follow-up: nextPageTriggerFlow in-flight race + missing multi-emission test coverage (PR #1447) | open | 2026-06-19 |  |
| 1 | triage | `triage-issue-1538` | Issue #1538 (no labels, OPEN): Backend `test` job is not a required check on `dev` — red-test PRs merge freely | open | 2026-06-19 |  |
| 1 | triage | `triage-issue-1584` | Issue #1584 (no labels, OPEN): Follow-up: PortalPrincipal bypasses reality_agency_members and rides on agency_id param (PR #1561) | open | 2026-06-19 |  |
| 1 | triage | `triage-issue-1587` | Issue #1587 (no labels, OPEN): Follow-up: download/retry test harness diverges from real route container — error mode untested (PR #1548) | open | 2026-06-19 |  |
| 1 | triage | `triage-issue-1588` | Issue #1588 (no labels, OPEN): Follow-up: harden fault delete + stats wiring on FaultsPage (PR #1555) | open | 2026-06-19 |  |
| 1 | triage | `triage-issue-1589` | Issue #1589 (no labels, OPEN): Follow-up: mobile MoveFolderSheet 'Root (top level)' is a silent no-op + missing optimistic update | open | 2026-06-19 |  |
| 1 | triage | `triage-issue-1590` | Issue #1590 (no labels, OPEN): Follow-up: pin-test asserts the constant, not the wiring; stale test comment (PR #1446) | open | 2026-06-19 |  |
| 1 | triage | `triage-issue-1592` | Issue #1592 (no labels, OPEN): Follow-up: rustfmt `lint` job is not a blocking pre-merge gate on `dev` (PR #1581) | open | 2026-06-19 |  |
| 1 | triage | `triage-issue-1593` | Issue #1593 (no labels, OPEN): Follow-up: make mark_invitation_viewed COALESCE-regression catch deterministic (PR #1564) | open | 2026-06-19 |  |
...
| 0 | refactor | `refactor-churn-hotspot-mobile-announcements` | Churn hotspot: AnnouncementsScreen.tsx — 4 PRs this run, instability proxy | dropped | 2026-06-19 |  |
| 0 | refactor | `refactor-churn-hotspot-mobile-announcements-test` | Churn hotspot: AnnouncementsScreen.test.ts — 4 PRs this run, instability proxy | dropped | 2026-06-19 |  |
| 0 | refactor | `refactor-churn-hotspot-mobile-documents` | Churn hotspot: DocumentsScreen.tsx — 3 PRs this run | dropped | 2026-06-19 |  |
| 0 | triage | `triage-dispatcher-mcp-push-large-file-issue-1014` | Dispatcher action-list.json corruption when MCP push falls back from blocked git push | dropped | 2026-06-19 |  |
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected by deploy-server (staging/prod) | dropped | 2026-06-19 |  |

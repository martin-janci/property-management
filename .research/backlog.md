# Backlog of vectors
<sub>Last regenerated: 2026-07-18 04:00 UTC by routine</sub>
...
| 2 | security | `security-rag-migrate-rls-vacuous-test` | rag/migrate cross-org RLS test passes vacuously (runs as superuser) — switch to NOBYPASSRLS role (Follow-up to PR #2335) | open | 2026-07-18 |  |
...
| 1 | bug | `bug-scheduler-rls-migration-doc-numbers` | scheduler-RLS doc + test comments cite wrong migration number 00216→00218 (Follow-up to PR #2340) | open | 2026-07-18 |  |
| 1 | refactor | `refactor-churn-hotspots-reports-rs-2026-07-18` | Churn hotspot: routes/reports.rs (3329 lines this run, runs_seen: 3) — instability proxy fires | open | 2026-07-18 |  |
| 1 | refactor | `refactor-churn-hotspots-booking-mod-2026-07-18` | Churn hotspot: backend/crates/integrations/src/booking/mod.rs (3185 lines this run, runs_seen: 2) | open | 2026-07-18 |  |

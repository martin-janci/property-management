# Backlog of vectors
<sub>Last regenerated: 2026-06-23 03:25 UTC by routine</sub>
...
| 3 | bug | `revert-pr-1713` | PR #1713 reverted PR #1690 (delegations frontend) — feature retired (BIT-213) | open | 2026-06-23 |  |
...
| 2 | test-gap | `screen-map-drift-pr-1737-ppt` | Screen-map drift: PR #1737 touched ppt routes without updating docs/screens/ppt/* — fix(iot): remove duplicate JWT-trusting sensor WS channel (# | open | 2026-06-23 |  |
| 2 | test-gap | `screen-map-drift-pr-1696-ppt` | Screen-map drift: PR #1696 touched ppt routes without updating docs/screens/ppt/* — feat(messaging): per-participant thread archive + soft-delet | open | 2026-06-23 |  |
| 2 | test-gap | `screen-map-drift-pr-1733-ppt` | Screen-map drift: PR #1733 touched ppt routes without updating docs/screens/ppt/* — fix(ppt-web): invoice PDF loading state + double-click guard | open | 2026-06-23 |  |
| 2 | test-gap | `screen-map-drift-pr-1690-ppt` | Screen-map drift: PR #1690 touched ppt routes without updating docs/screens/ppt/* — feat(delegations): wire delegation feature into ppt-web (Sto | open | 2026-06-23 |  |
...
| 1 | refactor | `churn-hotspot-frontend-apps-ppt-web-messages-en-json` | Churn hotspot: frontend/apps/ppt-web/messages/en.json (3688 lines this run; i18n catalogue grows w/ features) | open | 2026-06-23 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-rental-rs` | Churn hotspot: backend/crates/db/src/repositories/rental.rs (2837 lines this run; volatile rental repo) | open | 2026-06-23 |  |
...
| 0 | dx | `lag-warning-2026-06-23` | Routine lag: 7d since last run (2026-06-16 → 2026-06-23) — scheduled cron may be paused | open | 2026-06-23 |  |

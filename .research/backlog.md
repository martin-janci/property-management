...
| 3 | bug | `code-review-mobile-native-kmp-inquiries-response-contract` | mobile-native-kmp InquiriesResponse required page_size mismatches reality-server `limit` — MissingFi | ready | 2026-08-21 | [plan](plans/code-review-mobile-native-kmp-inquiries-response-contract.md) |
| 3 | bug | `code-review-api-core-email-action-stub-drops-mail` | api-core EmailExecutor::execute() logs and returns success without invoking EmailService — every wor | ready | 2026-08-21 | [plan](plans/code-review-api-core-email-action-stub-drops-mail.md) |
| 3 | bug | `code-review-api-core-notif-action-stub-noop` | api-core NotificationExecutor::execute() is a no-op stub and resolve_target() returns placeholder st | ready | 2026-08-21 | [plan](plans/code-review-api-core-notif-action-stub-noop.md) |
...
| 2 | bug | `code-review-api-core-voice-contact-mgr-fake-email` | api-core action_contact_manager() returns hardcoded manager@example.com / spravca@example.com — voic | open | 2026-08-21 |  |

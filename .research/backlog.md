# Backlog of vectors
<sub>Last regenerated: 2026-06-26 14:33 UTC by routine</sub>
...
| 3 | refactor | `refactor-revert-delegations-pr-1713` | PR #1713 revert of delegations re-add — surfaces spec/impl drift in epic retirement | open | 2026-06-26 |   |
...
| 2 | bug | `bug-ios-deeplink-info-plist-missing` | iOS deep-link layer dead at runtime — Info.plist missing CFBundleURLTypes + applinks entitlement | done | 2026-06-26 |   |
| 2 | bug | `code-review-mobile-native-kmp-search-stale-response-race` | SearchScreen stale-response race — overlapping searches can clobber newer results | done | 2026-06-26 |   |
| 2 | bug | `code-review-mobile-rn-deeplink-init-unhandled` | useDeepLinkRouting.ts:27-36 — initialize() re-runs on onNavigate identity change + void promise with no .catch | done | 2026-06-26 |   |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixe | done | 2026-06-26 |   |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1602-mfa-recovery-limiter` | MFA recovery limiter eviction (PR #1602) shipped without rate-limit test | open | 2026-06-26 |   |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1632-portal-import-scope` | Reality-server portal import scope per-agency (PR #1632) shipped without regression test | open | 2026-06-26 |   |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1737-iot-ws-dedup` | Sensor WS dedup (PR #1737) shipped without regression test — security-critical auth scope refactor | open | 2026-06-26 |   |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1743-booking-listing-push` | Booking.com listing-push currency validation (PR #1743) shipped without test | open | 2026-06-26 |   |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→ | open | 2026-06-26 |   |
| 1 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs (+404/−29 in PR #1294 Booking.com OTA retry) | open | 2026-06-26 |   |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-financial-rs` | Churn hotspot: backend/servers/api-server/src/routes/financial.rs | open | 2026-06-26 |   |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-forms-rs` | Churn hotspot: backend/servers/api-server/src/routes/forms.rs touched 2x since 2026-06-12 (window 2026-06-12→2 | open | 2026-06-26 |   |
| 1 | refactor | `code-review-api-core-osrng-expect` | crypto.rs:127 SysRng.try_fill_bytes(...).expect() panics if OS CSPRNG errors during integration-credential enc | done | 2026-06-26 |   |
| 1 | refactor | `repeated-churn-backend-servers-api-server-src-routes-forms-rs` | forms.rs repeated-churn — runs_seen=2 (#1337 explicit_auto_deref + #1397 org-scope hardening) | open | 2026-06-26 |   |
| 1 | triage | `triage-closed-not-merged-batch-2026-06-26` | 26 PRs closed unmerged 2026-06-16..2026-06-26 — author self-supersede pattern | open | 2026-06-26 |   |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-api-ecosystem-rs` | Churn hotspot: backend/servers/api-server/src/routes/api_ecosystem.rs (+106/−27 in PR #1293 PAP-171; second to | dropped | 2026-06-12 |   |
...
| 0 | dx | `closed-not-merged-pr-1274` | PR #1274 (cargo-minor-patch group, /backend, 9 updates) closed unmerged — superseded by #1313 after auto-rebas | dropped | 2026-06-12 |   |
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-10 03: | dropped | 2026-06-10 |   |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-06-10 03:05 | dropped | 2026-06-10 |   |

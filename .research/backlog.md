# Backlog of vectors
<sub>Last regenerated: 2026-08-09 19:00 UTC by routine</sub>
...
| 4 | bug | `code-review-mobile-native-kmp-create-listing-submit-stub` | mobile-native-kmp: create listing submit stub | ready | 2026-08-09 | [plan](plans/code-review-mobile-native-kmp-create-listing-submit-stub.md) |
| 3 | security | `code-review-api-handlers-community-unauthenticated-reads` | SECURITY: community.rs get_group/list_posts/get_item run unauthenticated — anonymous cross-tenant read | done | 2026-08-09 | [plan](plans/_archive/code-review-api-handlers-community-unauthenticated-reads.md) |
| 3 | security | `code-review-reality-server-sso-session-invalidate-swallowed` | reality-server sync_session swallows invalidate_session error — portal session survives after PM token goes inactive | done | 2026-08-09 | [plan](plans/_archive/code-review-reality-server-sso-session-invalidate-swallowed.md) |
| 3 | bug | `bug-scheduler-notifications-fire-once` | Scheduler notifications fire-once: transient target-resolution or dispatch error permanently drops announcement / vote notifications | done | 2026-08-09 | [plan](plans/_archive/bug-scheduler-notifications-fire-once.md) |
| 3 | bug | `code-review-mobile-native-kmp-portfolio-analytics-caps-100` | mobile-native-kmp: getPortfolioAnalytics() truncates realtor portfolio at 100 listings — dashboard under-reports on large portfolios | open | 2026-08-09 |  |
| 3 | bug | `code-review-api-core-rls-context-pool-not-conn` | api-core: rls context pool not conn | ready | 2026-08-09 | [plan](plans/code-review-api-core-rls-context-pool-not-conn.md) |
...
| 2 | security | `code-review-reality-server-db-error-leak-to-client` | reality-server leaks raw sqlx::Error strings to internet-facing clients, bypassing util::errors::db_error | done | 2026-08-09 | [plan](plans/_archive/code-review-reality-server-db-error-leak-to-client.md) |
| 2 | bug | `code-review-api-core-fcm-malformed-token-never-evicted` | api-core: fcm malformed token never evicted | open | 2026-08-09 |  |
| 2 | bug | `code-review-api-core-delay-duration-overflow-before-cap` | api-core: delay duration overflow before cap | open | 2026-08-09 |  |
| 2 | bug | `code-review-api-core-accounting-line-multimatch` | api-core: accounting line multimatch | open | 2026-08-09 |  |
| 2 | bug | `code-review-api-core-vote-reminders-no-cross-tick-dedup` | api-core: vote reminders no cross tick dedup | open | 2026-08-09 |  |
| 2 | security | `code-review-api-core-rls-context-deprecated-exported` | api-core: rls context deprecated exported | open | 2026-08-09 |  |
| 2 | security | `code-review-api-core-authz-mw-guest-fail-open` | api-core: authz mw guest fail open | open | 2026-08-09 |  |
| 2 | bug | `code-review-api-handlers-reports-unwrap-or-default-silent-zero` | api-handlers: reports unwrap or default silent zero | open | 2026-08-09 |  |
| 2 | bug | `code-review-ppt-web-core-errorhandler-network-misclassify` | ppt-web-core: errorhandler network misclassify | open | 2026-08-09 |  |
| 2 | bug | `code-review-sso-rs-negcache-transient-fail` | reality-server (sso): negcache transient fail | open | 2026-08-09 |  |
| 2 | bug | `code-review-sso-rs-client-no-timeout-pool` | reality-server (sso): client no timeout pool | open | 2026-08-09 |  |
| 2 | bug | `code-review-api-core-voice-meter-fake-success` | api-core: voice meter fake success | open | 2026-08-09 |  |
| 2 | bug | `code-review-api-core-require-auth-guest-default` | api-core: require auth guest default | open | 2026-08-09 |  |
| 2 | bug | `code-review-api-core-idempotency-tx-across-handler` | api-core: idempotency tx across handler | open | 2026-08-09 |  |
| 2 | bug | `code-review-api-core-announce-roles-legacy-membership-table` | api-core: announce roles legacy membership table | open | 2026-08-09 |  |
| 2 | bug | `code-review-api-handlers-listings-detail-photos-swallow` | api-handlers: listings detail photos swallow | open | 2026-08-09 |  |
| 2 | bug | `code-review-api-handlers-workflow-import-partial-silent` | api-handlers: workflow import partial silent | open | 2026-08-09 |  |
| 2 | bug | `code-review-api-handlers-doc-summary-not-persisted` | api-handlers: doc summary not persisted | open | 2026-08-09 |  |
| 2 | bug | `code-review-mobile-native-kmp-cancellationexception-swallowed-repos` | mobile-native-kmp: cancellationexception swallowed repos | open | 2026-08-09 |  |
| 2 | bug | `code-review-mobile-native-kmp-createlisting-notimpl-stub` | mobile-native-kmp: createlisting notimpl stub | dropped | 2026-08-09 |  |
| 2 | bug | `code-review-mobile-native-kmp-nav-onfailure-empty-swallow` | mobile-native-kmp: nav onfailure empty swallow | open | 2026-08-09 |  |
| 2 | bug | `code-review-ppt-web-ui-automationrules-mutation-no-catch` | ppt-web-ui: automationrules mutation no catch | open | 2026-08-09 |  |
| 2 | bug | `code-review-ppt-web-ui-conditionbuilder-number-coerce-zero` | ppt-web-ui: conditionbuilder number coerce zero | open | 2026-08-09 |  |
| 2 | security | `code-review-reality-server-sso-token-cache-ignores-exp` | reality-server: sso token cache ignores exp | open | 2026-08-09 |  |
| 2 | bug | `code-review-reality-server-sso-http-client-no-timeout` | reality-server: sso http client no timeout | open | 2026-08-09 |  |
| 2 | bug | `code-review-reality-server-sso-introspect-5xx-neg-cache` | reality-server: sso introspect 5xx neg cache | open | 2026-08-09 |  |
| 2 | test-gap | `code-review-reality-web-journal-mock-content-shipped` | reality-web: journal mock content shipped | open | 2026-08-09 |  |
...
| 1 | bug | `code-review-api-core-push-client-build-expect-panic` | api-core: push client build expect panic | open | 2026-08-09 |  |
| 1 | security | `code-review-api-core-pkce-nonconstant-time-compare` | api-core: pkce nonconstant time compare | open | 2026-08-09 |  |
| 1 | bug | `code-review-api-core-quiet-hours-db-error-fail-open` | api-core: quiet hours db error fail open | open | 2026-08-09 |  |
| 1 | bug | `code-review-api-core-accounting-vs-only-amount-ignored` | api-core: accounting vs only amount ignored | open | 2026-08-09 |  |
| 1 | test-gap | `code-review-api-core-accounting-no-tests` | api-core: accounting no tests | open | 2026-08-09 |  |
| 1 | security | `code-review-api-core-tenant-filter-noop-isolation` | api-core: tenant filter noop isolation | open | 2026-08-09 |  |
| 1 | refactor | `code-review-mobile-native-kmp-apiclient-dead-code-healthcheck-bug` | mobile-native-kmp: apiclient dead code healthcheck bug | open | 2026-08-09 |  |
| 1 | bug | `code-review-ppt-web-core-usewebsocket-handler-dep-gap` | ppt-web-core: usewebsocket handler dep gap | open | 2026-08-09 |  |
| 1 | bug | `code-review-api-core-voice-announce-fake-success` | api-core: voice announce fake success | open | 2026-08-09 |  |
| 1 | bug | `code-review-api-core-syndication-fake-synced` | api-core: syndication fake synced | open | 2026-08-09 |  |
| 1 | refactor | `code-review-mobile-native-kmp-layoutrepo-println-logging` | mobile-native-kmp: layoutrepo println logging | open | 2026-08-09 |  |
| 1 | refactor | `code-review-mobile-native-kmp-compose-state-bang-bang` | mobile-native-kmp: compose state bang bang | open | 2026-08-09 |  |
| 1 | bug | `code-review-mobile-native-kmp-portfolio-unbounded-fanout` | mobile-native-kmp: portfolio unbounded fanout | dropped | 2026-08-09 |  |
| 1 | refactor | `code-review-ppt-web-ui-workflow-automation-i18n-gap` | ppt-web-ui: workflow automation i18n gap | open | 2026-08-09 |  |
| 1 | bug | `code-review-reality-web-layout-section-boundary-swallows-errors` | reality-web: layout section boundary swallows errors | open | 2026-08-09 |  |

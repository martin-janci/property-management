# Backlog of vectors
<sub>Last regenerated: 2026-06-23 16:00 UTC by routine</sub>
...
| 3 | bug | `code-review-mobile-rn-report-fault-fake-submit` | ReportFaultScreen.tsx handleSubmit() fakes API call with setTimeout(1500) — fault reports never reach backend  | done | 2026-06-23 | [plan](plans/_archive/code-review-mobile-rn-report-fault-fake-submit.md) |
| 3 | refactor | `refactor-revert-pr-1713` | Revert: PR #1713 — delegation frontend re-added and rolled back (reconcile with retirement BIT-213) | open | 2026-06-23 |  |
...
| 2 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcod | done | 2026-06-23 |  |
...
| 2 | test-gap | `screen-map-drift-pr-1737-ppt` | Screen-map drift: PR #1737 touched ppt-web routes without docs/screens/ppt/* update (heuristic) | open | 2026-06-23 |  |
| 2 | test-gap | `screen-map-drift-pr-1733-ppt` | Screen-map drift: PR #1733 touched ppt-web routes without docs/screens/ppt/* update (heuristic) | open | 2026-06-23 |  |
| 2 | test-gap | `screen-map-drift-pr-1713-ppt` | Screen-map drift: PR #1713 revert touched ppt-web routes without docs/screens/ppt/* update (heuristic) | open | 2026-06-23 |  |
| 2 | test-gap | `screen-map-drift-pr-1746-reality` | Screen-map drift: PR #1746 touched reality-web routes without docs/screens/reality/* update (heuristic) | open | 2026-06-23 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→ | open | 2026-06-23 |  |
...
| 1 | refactor | `refactor-churn-hotspot-mobile-announcements` | Churn hotspot: AnnouncementsScreen.tsx — 4 PRs this run, instability proxy | done | 2026-06-23 |  |
| 1 | refactor | `refactor-churn-hotspot-mobile-announcements-test` | Churn hotspot: AnnouncementsScreen.test.ts — 4 PRs this run, instability proxy | done | 2026-06-23 |  |
...
| 1 | refactor | `refactor-churn-hotspot-frontend-apps-ppt-web-src-routes-lazyroutes-tsx` | Churn hotspot: frontend/apps/ppt-web/src/routes/lazyRoutes.tsx — 13 touches in 7-day catch-up window (route ag | open | 2026-06-23 |  |
| 1 | refactor | `refactor-churn-hotspot-backend-crates-db-src-repositories-rental-rs` | Churn hotspot: backend/crates/db/src/repositories/rental.rs — 10 touches this run (rental/booking repo) | open | 2026-06-23 |  |
| 1 | refactor | `refactor-churn-hotspot-backend-crates-db-src-models-mod-rs` | Churn hotspot: backend/crates/db/src/models/mod.rs — 10 touches this run (model aggregator) | open | 2026-06-23 |  |

...
| 2 | bug | `code-review-api-core-voice-actions-fabricated-empty` | Voice check-announcements & check-meter fabricate success with empty data — residents told 'no new a | done | 2026-08-10 |  |
| 2 | bug | `code-review-api-core-quiet-drain-drops-failed-delivery` | Quiet-hours drain marks held push released even when delivery failed (sent=0) — held notification pe | done | 2026-08-10 |  |
...
| 1 | bug | `code-review-api-core-quiet-schedule-err-failopen` | Notification pipeline swallows quiet-hours schedule DB error and fails open — push delivered during  | open | 2026-08-10 |  |

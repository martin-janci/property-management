# Backlog of vectors
<sub>Last regenerated: 2026-06-27 03:25 UTC by routine</sub>
...
| 3 | bug | `revert-pr-1713` | Revert: PR #1713 reverts #1690 delegation feature re-add (BIT-213) | open | 2026-06-27 |  |
...
| 1 | dx | `dx-stalled-review-pr-988` | Stalled review: PR #988 (Epic: reusable Playwright E2E framework + sitemap FlowRunner) open 10d, no reviewDecision | done | 2026-06-27 |  |
...
| 1 | dx | `dx-stalled-review-pr-1179` | PR #1179 (docs(epics) catalog backfill for 37 mounted-but-undocumented backend modules) — stalled at 7d, no reviewDecision | done | 2026-06-27 |  |
| 1 | dx | `closed-not-merged-pr-1698` | PR #1698 (epic-3 story 3.2 unit-management UI BIT-188) closed unmerged — superseded by #1695 | open | 2026-06-27 |  |
| 1 | dx | `closed-not-merged-pr-1720` | PR #1720 (fix(ppt-web) Leases nav link #977) closed unmerged | open | 2026-06-27 |  |
| 1 | dx | `closed-not-merged-pr-1727` | PR #1727 (fix(ci) backend gate organizations fmt + RLS baseline) closed unmerged — superseded | open | 2026-06-27 |  |
| 1 | dx | `closed-not-merged-pr-1749` | PR #1749 (fix(mobile) exclude icon test) closed unmerged — superseded by #1748 | open | 2026-06-27 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-ppt-web-src-routes-lazyroutes-tsx` | Churn hotspot: frontend/apps/ppt-web/src/routes/lazyRoutes.tsx — 13 commits in 11d (multi-feature wirings) | open | 2026-06-27 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-rental-rs` | Churn hotspot: backend/crates/db/src/repositories/rental.rs — 10 commits in 11d (PII + OCR + Airbnb work) | open | 2026-06-27 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-models-mod-rs` | Churn hotspot: backend/crates/db/src/models/mod.rs — 10 commits in 11d (model exports churn from repo splits + N-party + Stripe) | open | 2026-06-27 |  |

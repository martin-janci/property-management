# Backlog of vectors
<sub>Last regenerated: 2026-07-04 04:00 UTC by routine</sub>
...
| 2 | test-gap | `test-gap-hotfix-no-test-pr-2060` | PR #2060 fix without regression test — units u.name→u.designation schema drift in lease.rs | open | 2026-07-04 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-2047` | PR #2047 fix without regression test — Slovak accounting totals in regional_compliance | open | 2026-07-04 |  |
...
| 1 | test-gap | `screen-map-drift-pr-1418-ppt` | PR #1418 touched routes/** (faults.route.test.tsx) without updating docs/screens/ppt/* — heuristic, test-file  | done | 2026-07-04 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-faults-rs` | Churn hotspot: backend/servers/api-server/src/routes/faults.rs — 3 PRs, 1984 lines (routine catch-up window) | open | 2026-07-04 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-regional-compliance-rs` | Churn hotspot: backend/servers/api-server/src/routes/regional_compliance.rs — 3 PRs, 1030 lines | open | 2026-07-04 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-models-regional-compliance-rs` | Churn hotspot: backend/crates/db/src/models/regional_compliance.rs — 3 PRs, 792 lines | open | 2026-07-04 |  |
...
| 0 | dx | `dx-stalled-review-pr-1179` | PR #1179 (docs(epics) catalog backfill for 37 mounted-but-undocumented backend modules) — stalled at 7d, no re | dropped | 2026-07-04 |  |

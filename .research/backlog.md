# Backlog of vectors
<sub>Last regenerated: 2026-06-21 02:09 UTC by routine</sub>
...
| 3 | bug | `code-review-ppt-web-core-rentals-mutations-no-error` | rentals.tsx mutations have no onError handler — silent failures on connect/sync | ready | 2026-06-21 | [plan](plans/code-review-ppt-web-core-rentals-mutations-no-error.md) |
...
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1617` | hotfix without tests: PR #1617 wires OTA push into route | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1630-ppt` | screen-map drift: PR #1630 changed ppt-web Payment Management route without docs/screens/ppt/ update | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1621-ppt` | screen-map drift: PR #1621 relocated payment-matching to ppt-web without screen-map update | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1621-reality` | screen-map drift: PR #1621 removed reality-web accounting page without screen-map update | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1611-ppt` | screen-map drift (heuristic): PR #1611 test-only route file under ppt-web routes/ | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1610-ppt` | screen-map drift: PR #1610 FaultsPage delete/stats fix without faults-list.md update | open | 2026-06-21 |  |
| 2 | refactor | `code-review-ppt-web-core-rentals-financial-querykeys-bypass` | rentals.tsx + financial.tsx bypass queryKeys factory; tenant scope dropped on invalidate | open | 2026-06-21 |  |
...
| 1 | refactor | `churn-hotspot-backend/crates/integrations/src/booking.rs` | churn hotspot: integrations/src/booking.rs (~4365 lines this window) | open | 2026-06-21 |  |
| 1 | refactor | `churn-hotspot-backend/crates/db/src/repositories/document.rs` | churn hotspot: db/repositories/document.rs (~3077 lines this window) | open | 2026-06-21 |  |
| 1 | refactor | `churn-hotspot-backend/crates/db/src/repositories/rental.rs` | churn hotspot: db/repositories/rental.rs (~2837 lines this window) | open | 2026-06-21 |  |
| 1 | refactor | `code-review-ppt-web-core-sessions-api-cast` | SessionsPage uses double-cast `as unknown as` at API boundary | open | 2026-06-21 |  |

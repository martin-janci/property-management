# Backlog of vectors
<sub>Last regenerated: 2026-07-13 16:30 UTC by routine</sub>
...
| 3 | security | `code-review-api-core-apicall-ssrf-redirect` | SSRF: api_call.rs reqwest client follows redirects w/o re-validation — 3xx bypass to internal 169.254/10.x hosts | ready | 2026-07-13 | [plan](plans/code-review-api-core-apicall-ssrf-redirect.md) |
| 3 | bug | `code-review-api-core-sync-calevent-create-idor` | IDOR: create_calendar_event handler skips verify_org_access — cross-org write via body connection_id | ready | 2026-07-13 | [plan](plans/code-review-api-core-sync-calevent-create-idor.md) |
| 3 | bug | `code-review-reality-web-listing-detail-content-crash` | reality-web ListingDetailContent unguarded address/features deref — partial 200 crashes public SSR | open | 2026-07-13 |  |
...
| 2 | bug | `code-review-api-core-sync-calevent-list-idor` | IDOR: list_calendar_events skips verify_org_access, relies solely on RlsConnection — inconsistent authz | open | 2026-07-13 |  |
| 2 | bug | `code-review-reality-web-agency-dashboard-no-error-branch` | reality-web AgencyDashboard ignores isError — API failures render misleading 'No Agency Found' to owners | open | 2026-07-13 |  |
...
| 1 | refactor | `code-review-ppt-web-ui-protectedroute-hardcoded-strings` | ppt-web ProtectedRoute.tsx hardcoded English strings (loading + access-denied) — no i18n for sk/cs/de | open | 2026-07-13 |  |
| 1 | refactor | `code-review-ppt-web-ui-offlineindicator-no-i18n` | ppt-web OfflineIndicator.tsx hardcoded English banner strings — screen readers announce untranslated to sk/cs/de | open | 2026-07-13 |  |
| 1 | refactor | `code-review-ppt-web-ui-access-denied-dead-end` | ppt-web ProtectedRoute access-denied branch has no navigation affordance — user dead-ended | open | 2026-07-13 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-08-15 02:39 UTC by routine</sub>
...
| 3 | bug | `code-review-reality-server-imports-feed-url-ssrf` | reality-server: create_feed / :399 update_feed / :436 sync_feed persist and later trigger a fetch of | ready | 2026-08-15 | [plan](plans/code-review-reality-server-imports-feed-url-ssrf.md) |
| 3 | bug | `code-review-reality-server-sso-introspect-negcache-poison` | reality-server: -762 — introspect_pm_token() conflates 'the PM token is genuinely inactive' with 'th | ready | 2026-08-15 | [plan](plans/code-review-reality-server-sso-introspect-negcache-poison.md) |
...
| 2 | bug | `code-review-api-handlers-share-pw-no-throttle` | api-handlers: access_protected_share -- public, unauthenticated endpoint (mounted via shares::public | open | 2026-08-15 |  |
| 2 | bug | `code-review-api-core-oauth-refresh-race-drops-revoke-guard` | api-core: -597 — `refresh_tokens` reads the refresh row with `find_refresh_token_by_hash_including_r | open | 2026-08-15 |  |
| 2 | bug | `code-review-api-handlers-ai-list-unclamped-limit` | api-handlers: Multiple AI list endpoints forward a caller-controlled `?limit=` straight into a SQL ` | open | 2026-08-15 |  |
| 2 | bug | `code-review-reality-server-sso-reqwest-no-timeout` | reality-server: , 706, 743 — the three outbound SSO/OAuth helpers exchange_code_for_token(), get_use | open | 2026-08-15 |  |
| 2 | bug | `code-review-api-core-accounting-cross-currency-match` | api-core: -174 (run_payment_matcher) scores a bank-statement line against each open invoice using ON | open | 2026-08-15 |  |
| 2 | bug | `code-review-api-core-accounting-confirm-no-tx` | api-core: -257 (confirm_match) performs three separate money-mutating writes in sequence with no tra | open | 2026-08-15 |  |
| 2 | bug | `code-review-api-handlers-financial-f64-money` | api-handlers: ,1828,1894 (XLSX renderers render_income_statement_xlsx / render_balance_sheet_xlsx) a | open | 2026-08-15 |  |
| 2 | bug | `code-review-api-handlers-ai-pagination-no-cap` | api-handlers: list_sessions passes query.limit.unwrap_or(50) straight through to the repo. Paginatio | open | 2026-08-15 |  |
| 2 | bug | `code-review-api-handlers-marketplace-limit-no-cap` | api-handlers: -289 — search_providers reads `query.limit.unwrap_or(20)` / `query.offset.unwrap_or(0) | open | 2026-08-15 |  |
| 2 | bug | `code-review-mobile-rn-useapi-401-no-refresh` | mobile-rn: frontend/apps/mobile/src/hooks/useApi.ts:83-92 — the central online client `apiRequest()` | open | 2026-08-15 |  |
| 2 | bug | `code-review-ppt-web-core-rentals-mutation-swallow-err` | ppt-web-core: ,323,417,427 — all four rentals mutations (createConnection, syncPlatforms, checkIn, c | open | 2026-08-15 |  |
| 2 | bug | `code-review-ppt-web-core-rentals-noop-actions` | ppt-web-core: -383 — BookingsPageRoute wires onCancelBooking, onCheckIn and onCheckOut to `() => {}` | open | 2026-08-15 |  |
| 2 | bug | `code-review-ppt-web-ui-autorules-mutate-unhandled` | ppt-web-ui: frontend/apps/ppt-web/src/features/workflow-automation/pages/AutomationRulesPage.tsx:56- | open | 2026-08-15 |  |
| 2 | bug | `code-review-ppt-web-ui-execmonitor-retry-unhandled` | ppt-web-ui: frontend/apps/ppt-web/src/features/workflow-automation/pages/ExecutionMonitoringPage.tsx | open | 2026-08-15 |  |
| 2 | bug | `code-review-reality-server-review-body-no-cap` | reality-server: -266 (create_review) validates only `data.rating` (1..=5 at :196) and then binds the | open | 2026-08-15 |  |
...
| 1 | bug | `code-review-reality-web-comparison-view-i18n` | reality-web: frontend/apps/reality-web/src/components/comparison/ComparisonView.tsx — component impo | open | 2026-08-15 |  |
| 1 | bug | `code-review-reality-web-realtor-mgmt-i18n` | reality-web: frontend/apps/reality-web/src/components/agency/RealtorManagement.tsx — component DOES  | open | 2026-08-15 |  |
| 1 | bug | `code-review-reality-web-agency-errorstate-i18n` | reality-web: frontend/apps/reality-web/src/components/agency/AgencyErrorStates.tsx — file uses useTr | open | 2026-08-15 |  |
| 1 | bug | `code-review-api-handlers-share-log-proxy-ip` | api-handlers: & :574 -- both public share handlers derive the audit ip_address from axum ConnectInfo | open | 2026-08-15 |  |
| 1 | bug | `code-review-api-core-oauth-refresh-revoke-before-issue-lockout` | api-core: -630 — `refresh_tokens` revokes the presented refresh token (`self.repo.revoke_refresh_tok | open | 2026-08-15 |  |
| 1 | bug | `code-review-api-handlers-auth-inactive-revoke-swallowed` | api-handlers: in the refresh-token path, when a user is found but `user.status != "active"`, the def | open | 2026-08-15 |  |
| 1 | refactor | `code-review-reality-server-dup-url-validators` | reality-server: fn validate_image_or_link_url and backend/servers/reality-server/src/routes/agency_b | open | 2026-08-15 |  |
| 1 | test-gap | `code-review-mobile-rn-nfc-untested` | mobile-rn: frontend/apps/mobile/src/nfc/ — the NFC access-credential subsystem has ZERO test coverag | open | 2026-08-15 |  |
| 1 | bug | `code-review-mobile-rn-auth-unvalidated-token-body` | mobile-rn: frontend/apps/mobile/src/contexts/AuthContext.tsx:97-107 (login) and :194-200 (refreshTok | open | 2026-08-15 |  |
| 1 | bug | `code-review-ppt-web-core-person-months-toast-i18n` | ppt-web-core: success toast uses raw English literals: `showToast({ type: 'success', title: 'Saved', | open | 2026-08-15 |  |
| 1 | refactor | `code-review-ppt-web-ui-workflow-pages-i18n-gap` | ppt-web-ui: All five workflow-automation page files hardcode user-facing English and import no useTr | open | 2026-08-15 |  |
| 1 | refactor | `code-review-reality-server-url-validator-dup` | reality-server: and backend/servers/reality-server/src/routes/users.rs:28 each define a byte-for-byt | open | 2026-08-15 |  |
| 1 | bug | `code-review-reality-web-realtormgmt-i18n-gap` | reality-web: frontend/apps/reality-web/src/components/agency/RealtorManagement.tsx — inconsistent i1 | open | 2026-08-15 |  |
| 1 | bug | `code-review-reality-web-comparison-unvalidated-cast` | reality-web: frontend/apps/reality-web/src/components/comparison/ComparisonUrlHandler.tsx:43-47 — `f | open | 2026-08-15 |  |

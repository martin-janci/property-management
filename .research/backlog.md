...
| 1 | refactor | `churn-hotspot-backend/servers/api-server/src/routes/documents/shares.rs` | churn-hotspot: backend/servers/api-server/src/routes/documents/shares.rs (PRs #2773,#2784,#2790) | open | 2026-08-19 |  |
...
| 1 | dx | `stalled-review-pr-2583` | Stalled review: PR #2583 (chore(deps): bump rust_xlsxwriter 0.96→0.97) open 19d, no reviewDecision | needs-human-judgement | 2026-08-19 |  |
| 1 | dx | `stalled-review-pr-2584` | Stalled review: PR #2584 (chore(deps): bump sentry 0.48.5→0.49.0) open 19d, no reviewDecision | needs-human-judgement | 2026-08-19 |  |
| 1 | dx | `stalled-review-pr-2585` | Stalled review: PR #2585 (chore(deps): bump base64 0.22.1→0.23.0) open 19d, no reviewDecision | needs-human-judgement | 2026-08-19 |  |
| 1 | dx | `stalled-review-pr-2586` | Stalled review: PR #2586 (chore(deps): bump validator 0.20.0→0.21.0) open 19d, no reviewDecision | needs-human-judgement | 2026-08-19 |  |
| 1 | dx | `stalled-review-pr-2588` | Stalled review: PR #2588 (chore(deps): bump expo-status-bar 56.0.4→57.0.1) open 19d, no reviewDecisi | needs-human-judgement | 2026-08-19 |  |
| 1 | dx | `stalled-review-pr-2589` | Stalled review: PR #2589 (chore(deps-dev): bump @testing-library/react-native 13.3.3→14.x) open 19d, | needs-human-judgement | 2026-08-19 |  |
| 1 | dx | `stalled-review-pr-2590` | Stalled review: PR #2590 (chore(deps): bump expo-device 56.0.4→57.0.1) open 19d, no reviewDecision | needs-human-judgement | 2026-08-19 |  |
| 1 | dx | `stalled-review-pr-2591` | Stalled review: PR #2591 (chore(deps): bump expo-secure-store 56.0.4→57.0.1) open 19d, no reviewDeci | needs-human-judgement | 2026-08-19 |  |
| 1 | dx | `stalled-review-pr-2673` | Stalled review: PR #2673 (chore(deps): bump the ktor group across 1 directory with 7 updates) open 1 | needs-human-judgement | 2026-08-19 |  |

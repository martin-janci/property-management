# Backlog of vectors
<sub>Last regenerated: 2026-07-02 00:30 UTC by routine</sub>
...
| 2 | test-gap | `screen-map-drift-pr-1418-ppt` | PR #1418 touched routes/** (faults.route.test.tsx) without updating docs/screens/ppt/* — heuristic, test-file fix | done | 2026-07-02 |  |
| 2 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcoded MOCK_* arrays — no API wiring | done | 2026-07-02 |  |
| 2 | bug | `risky-churn-pr-1966-preflight-rs` | PR #1966 (fix: preflight length floors) modified a churn hotspot without a test diff | open | 2026-07-02 |  |
| 2 | test-gap | `screen-map-drift-pr-1987-reality` | Screen-map drift: PR #1987 tightened SSO callback CSRF guard without updating docs/screens/reality/oauth-callback.md | open | 2026-07-02 |  |
| 2 | bug | `code-review-api-core-scheduler-metrics-lock-poison` | api-server scheduler.rs — 13x metrics.lock().unwrap() on std::sync::Mutex can cascade a panic across scheduled jobs | open | 2026-07-02 |  |
...
| 1 | refactor | `refactor-churn-hotspot-mobile-announcements` | Churn hotspot: AnnouncementsScreen.tsx — 4 PRs this run, instability proxy | done | 2026-07-02 |  |
| 1 | refactor | `refactor-churn-hotspot-mobile-announcements-test` | Churn hotspot: AnnouncementsScreen.test.ts — 4 PRs this run, instability proxy | done | 2026-07-02 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-tests-form-rls-repo-tests-rs` | Churn hotspot: backend/crates/db/tests/form_rls_repo_tests.rs touched 2x since 2026-06-12 (window 2026-06-12→2026-06-13) | done | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-mobile-app-config-icon-test-ts` | Churn hotspot: 124 lines in frontend/apps/mobile/app.config.icon.test.ts (PR #1383 gap-85-2) | done | 2026-07-02 |  |
| 1 | refactor | `code-review-api-core-osrng-expect` | crypto.rs:127 SysRng.try_fill_bytes(...).expect() panics if OS CSPRNG errors during integration-credential encrypt | done | 2026-07-02 |  |
...
| 1 | refactor | `churn-hotspot-docs-endpoint-checklist-groups-finance-md` | Churn hotspot: docs/endpoint-checklist/groups/finance.md — 382 lines changed across 2 commits | open | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-preflight-rs` | Churn hotspot: api-server preflight.rs — 148 lines changed since last routine run | open | 2026-07-02 |  |

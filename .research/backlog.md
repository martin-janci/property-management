...
| 4 | bug | `code-review-reality-web-inquiry-cancel-no-error` | reality-web InquiryCard cancel is fire-and-forget with no error surface | ready | 2026-08-18 | [plan](plans/code-review-reality-web-inquiry-cancel-no-error.md) |
...
| 2 | bug | `code-review-api-handlers-install-swallowed-db-error` | Booking.com sync silently drops reservations on transient DB errors | open | 2026-08-18 |  |
| 2 | bug | `code-review-api-handlers-platform-admin-audit-swallow` | platform_admin audit handlers show DB failures as empty memberships/sessions | open | 2026-08-18 |  |
| 2 | bug | `code-review-reality-server-saved-search-alert-cap-dataloss` | Saved-search alert watermark advances past capped scan — matches lost | open | 2026-08-18 |  |
| 2 | security | `code-review-reality-server-sso-error-leak` | reality-server SSO surfaces raw internal errors to unauthenticated clients | ready | 2026-08-18 | [plan](plans/code-review-reality-server-sso-error-leak.md) |
| 2 | bug | `code-review-reality-server-sso-http-no-timeout` | reality-server SSO uses reqwest::Client::new() with no request timeout on OAuth calls | open | 2026-08-18 |  |
...
| 1 | refactor | `code-review-reality-web-locale-pages-hardcoded-i18n` | reality-web account/realtor/inquiries/saved-searches pages ship hardcoded copy on the 4-locale porta | open | 2026-08-18 |  |
| 1 | refactor | `churn-hotspot-frontend/apps/mobile/src/nfc/NFCCredentialManager.ts` | NFCCredentialManager.ts under-covered — three hardening rounds this run | open | 2026-08-18 |  |
| 1 | refactor | `churn-hotspot-backend/servers/api-server/src/routes/documents/shares.rs` | documents/shares.rs under sustained hardening — three PRs this run | open | 2026-08-18 |  |

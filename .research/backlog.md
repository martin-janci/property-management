# Backlog of vectors
<sub>Last regenerated: 2026-07-06 14:07 UTC by routine</sub>
...
| 3 | bug | `code-review-ppt-web-core-perf-listener-leak` | usePerformanceMetrics.ts:153 leaks window listeners on hook re-run — stale onReport closures fire i… | ready | 2026-07-06 | [plan](plans/code-review-ppt-web-core-perf-listener-leak.md) |
| 3 | security | `security-jwt-role-vs-db-role-mismatch-mutating-handlers` | JWT-role/DB-role mismatch (#2107 pattern) still gates ~22 mutating handlers across Epic 6/7A — real… | ready | 2026-07-06 | [plan](plans/security-jwt-role-vs-db-role-mismatch-mutating-handlers.md) |
| 3 | bug | `code-review-mobile-rn-report-fault-fake-submit` | ReportFaultScreen.tsx handleSubmit() fakes API call with setTimeout(1500) — fault reports never rea… | ready | 2026-06-16 | [plan](plans/code-review-mobile-rn-report-fault-fake-submit.md) |
...
| 3 | bug | `code-review-reality-web-share-comparison-404` | Reality-web ComparisonUrlHandler hits non-existent /api/listings/${id} — every shared comparison UR… | ready | 2026-06-14 | [plan](plans/code-review-reality-web-share-comparison-404.md) |
...
| 3 | bug | `bug-ios-searchview-uncompilable` | iOS SearchView.swift does not compile — performSearch/scheduleSearch undefined, resultsGrid corrupt… | ready | 2026-06-11 | [plan](plans/bug-ios-searchview-uncompilable.md) |
...
| 3 | security | `security-llm-doc-idor` | IDOR: ai.rs LLM-doc handlers publish/list/get any tenant's listing descriptions & photo enhancement… | ready | 2026-06-01 | [plan](plans/security-llm-doc-idor.md) |
...
| 2 | security | `code-review-ppt-web-core-tokens-in-localstorage` | AuthContext persists access/refresh tokens in localStorage — XSS yields full session takeover (comm… | open | 2026-07-06 |  |
| 2 | bug | `code-review-ppt-web-core-focustrap-stale-onescape` | useFocusTrap useEffect deps=[] freezes onEscape at mount — inline arrow callers get stale state on … | open | 2026-07-06 |  |
...
| 1 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) ren… | done | 2026-07-06 |  |
...
| 1 | refactor | `refactor-churn-hotspot-backend-crates-integrations-src-booking-mod-rs` | Churn hotspot: backend/crates/integrations/src/booking/mod.rs (top-3 churn 2026-07-06, 2818 line de… | open | 2026-07-06 |  |
| 1 | refactor | `refactor-repeated-churn-oauth-integration-tests-rs` | Repeated churn: oauth_integration_tests.rs seen 3 runs (instability proxy for OAuth test suite) | open | 2026-07-06 |  |
| 1 | bug | `code-review-mobile-native-kmp-deeplink-token-not-url-decoded` | DeepLinkRouter skips URL-decoding while Android Uri.getQueryParameter decodes — SSO tokens diverge … | open | 2026-07-05 |  |
...
| 1 | test-gap | `test-gap-screen-map-drift-pr-1085-reality` | Screen-map drift: PR #1085 modified reality-web listing detail metadata + page without screen-doc u… | open | 2026-07-05 |  |
| 1 | test-gap | `test-gap-screen-map-drift-pr-1100-ppt` | Screen-map drift: PR #1100 modified ppt-web App.tsx (FileDisputePageRoute extraction) without scree… | open | 2026-07-05 |  |
...
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1288-webhook-rls` | Webhook handlers RLS migration (PR #1288, PAP-170) shipped without a new regression test for repo-l… | open | 2026-07-05 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped witho… | open | 2026-07-05 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regr… | open | 2026-07-05 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and … | open | 2026-07-05 |  |
...
| 1 | bug | `code-review-mobile-rn-deeplink-init-unhandled` | useDeepLinkRouting.ts:27-36 — initialize() re-runs on onNavigate identity change + void promise wit… | open | 2026-07-05 |  |

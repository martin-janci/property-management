# Backlog of vectors
<sub>Last regenerated: 2026-07-01 16:07 UTC by routine</sub>
...
| 3 | bug | `bug-country-currency-rename-all-screaming-snake` | CountryCode/SupportedCurrency rename_all=SCREAMING_SNAKE_CASE breaks wire ('S_K'/'E_U_R') and DB enum encode — should be UPPERCASE (issue #2000) | ready | 2026-07-01 | [plan](plans/bug-country-currency-rename-all-screaming-snake.md) |
...
| 2 | bug | `bug-favorite-alert-worker-nontransactional-drop` | FavoriteAlertWorker.run_once enqueue+advance non-transactional — can drop a price alert on concurrent write (issue #1999) | open | 2026-07-01 |  |
| 2 | perf | `perf-migration-list-templates-index-tiebreak` | migration list_templates ORDER BY updated_at DESC lacks (org, updated_at DESC) index + total-sort tiebreak + tests (issue #1997) | open | 2026-07-01 |  |
| 2 | test-gap | `test-gap-count-unread-rls-soft-delete-quarantined` | count_unread_rls #1771 regression test is [ignore]'d — SQL-string guard needed or BIT-352 unquarantine (issue #1998) | open | 2026-07-01 |  |
...
| 1 | bug | `bug-tenant-migration-import-export-facade` | Tenant-migration import/export is a DB-backed facade — no S3 upload, hardcoded validate output, no worker, fake export URL (issue #1995) | open | 2026-07-01 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-messaging-rs` | Churn hotspot: backend/crates/db/src/repositories/messaging.rs — 3 PRs (soft-delete leak + set-based block + participant watermark) | open | 2026-07-01 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-sensor-rs` | Churn hotspot: backend/crates/db/src/repositories/sensor.rs (+248/-86 in PR #1321/#1322 PAP-151 re-land + fmt) | done | 2026-07-01 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-10 03:05Z→18:30Z) | done | 2026-07-01 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-emergency-rs` | Churn hotspot: 1021 lines changed in backend/servers/api-server/src/routes/emergency.rs (window 2026 | done | 2026-07-01 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-enhanced-tenant-screening-rs` | Churn hotspot: 709 lines changed in backend/servers/api-server/src/routes/enhanced_tenant_screening. | done | 2026-07-01 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-messaging-rs` | Churn hotspot: backend/servers/api-server/src/routes/messaging.rs — 3 PRs since 2026-06-16 (#1977 participant watermark, #1993 unread soft-delete leak) | open | 2026-07-01 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-reserve-funds-rs` | Churn hotspot: backend/servers/api-server/src/routes/reserve_funds.rs (+228/-255 in PR #1321 PAP-151 re-land) | done | 2026-07-01 |  |
...
| 1 | test-gap | `test-gap-finance-endpoint-checklist-inflated` | finance.md marks ~59 endpoints done citing [ignore]'d tests; person_months accepts 500 as OK — coverage/CI-reality drift (issue #2001) | open | 2026-07-01 |  |

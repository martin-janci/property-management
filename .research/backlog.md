# Backlog of vectors
<sub>Last regenerated: 2026-07-01 04:00 UTC by routine</sub>
...
| 2 | test-gap | `test-gap-screen-map-drift-pr-1955-reality` | Screen-map drift: PR #1955 integration merge touched reality-web account listings edit without a reality screen-doc update | open | 2026-07-01 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1987-reality` | Screen-map drift: PR #1987 modified reality-web SSO callback route without a screen-doc update | open | 2026-07-01 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1807-meter-reminders` | PR #1807 (meter-reminder per-resident dedup) shipped without a regression test | open | 2026-07-01 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1825-booking-currency` | PR #1825 (Booking.com currency ISO-4217 allowlist) shipped without a regression test | open | 2026-07-01 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1972-delegation-scopes` | PR #1972 (delegation scopes enum-array SQL cast fix) shipped without a regression test | open | 2026-07-01 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1966-preflight-env` | PR #1966 (preflight env length-floor check) shipped without a regression test | open | 2026-07-01 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1967-jwt-access-gate` | PR #1967 (JwtService access-gate pin + structured token_type logs) shipped without a regression test | open | 2026-07-01 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1989-accounting-confirm-match` | PR #1989 (accounting confirm_match 404 symmetry + secret-model ToSchema drop) shipped without a regression test | open | 2026-07-01 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1994-migration` | PR #1994 (migration pagination fix) shipped without a regression test | open | 2026-07-01 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-mod-rs` | Churn hotspot: 2818 lines added to backend/crates/integrations/src/booking/mod.rs (14d) | open | 2026-07-01 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-ppt-web-messages-en-json` | Churn hotspot: 3752 lines added to frontend/apps/ppt-web/messages/en.json (14d) | open | 2026-07-01 |  |
| 1 | bug | `code-review-mobile-rn-deeplink-init-unhandled` | useDeepLinkRouting.ts:27-36 — initialize() re-runs on onNavigate identity change + void promise with no .catch → duplicate nav / unhandled rejection | open | 2026-07-01 |  |
| 1 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcoded MOCK_* arrays — no API wiring | open | 2026-07-01 |  |
...
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression test for the public-connection routing | open | 2026-07-01 |  |
...
| 0 | refactor | `churn-hotspot-backend-servers-api-server-tests-reserve-funds-cross-org-idor-tests-rs` | Churn hotspot: backend/servers/api-server/tests/reserve_funds_cross_org_idor_tests.rs touched 2x since 2026-06-12 (window 2026-06-12→2026-06-13) | dropped | 2026-07-01 |  |
...
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected by deploy-server (staging/prod) | dropped | 2026-07-01 |  |

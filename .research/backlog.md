...
| 3 | security | `code-review-api-handlers-buildings-role-gate-gap` | buildings.rs — unit + owner mutation handlers (6 routes) missing Manager role gate | ready | 2026-08-10 | [plan](plans/code-review-api-handlers-buildings-role-gate-gap.md) |
...
| 2 | test-gap | `qa-rag-partial-batch-handler-regression-2026-08-10` | Add handler-level regression test for RAG partial-embedding-batch fail-closed guard (PR #2706) | open | 2026-08-10 |  |

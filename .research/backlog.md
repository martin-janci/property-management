...
| 3 | bug | `bug-api-core-email-notif-actions-noop` | Workflow send_email / send_notification actions are silent no-ops in production — WorkflowExecutor m | ready | 2026-08-08 | [plan](plans/bug-api-core-email-notif-actions-noop.md) |
...
| 2 | bug | `bug-api-core-delay-rs-duration-overflow` | Workflow delay action: DelayConfig::to_duration overflow defeats the 7-day cap — `duration * 86400`  | open | 2026-08-08 |  |
...
| 1 | dx | `dx-stalled-review-pr-2559` | Stalled review: PR #2559 (feat(acc): PAY by square QR endpoint UC-ACC-05.8) — 8+ days open, no revie | open | 2026-08-08 |  |
| 1 | dx | `dx-stalled-review-pr-2558` | Stalled review: PR #2558 (feat(acc): invoice PDF render endpoint UC-ACC-05.9) — 8+ days open, no rev | open | 2026-08-08 |  |
| 1 | dx | `dx-stalled-review-pr-2555` | Stalled review: PR #2555 (feat(acc): wire sent/cancelled invoice lifecycle UC-ACC-05.17) — 8+ days o | open | 2026-08-08 |  |
| 1 | refactor | `refactor-churn-hotspot-api-server-services-actions-api_call-rs` | Churn hotspot: services/actions/api_call.rs — 139 lines added in a single PR (#2707 DoS response-bod | open | 2026-08-08 |  |
| 1 | refactor | `refactor-churn-hotspot-reality-web-listingform-tsx` | Churn hotspot: reality-web components/realtor/ListingForm.tsx — 77 lines (PR #2709 next-intl i18n re | open | 2026-08-08 |  |
| 1 | refactor | `refactor-repeated-churn-workflow_executor-rs-2026-08-08` | Repeated churn: services/workflow_executor.rs runs_seen=2 — PR #2685 refactor (457 lines) + PR #2708 | open | 2026-08-08 |  |

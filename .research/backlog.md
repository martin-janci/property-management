# Backlog of vectors
<sub>Last regenerated: 2026-06-21 06:20 UTC by routine</sub>
...
| 3 | dx | `ops-research-dispatcher-stalled` | Research dispatcher stalled — stale coverage.json + 14 quarantined rows blocking new task claims (Issue #1607) | open | 2026-06-21 |  |
| 3 | bug | `bug-ios-searchview-uncompilable` | iOS SearchView.swift does not compile — performSearch/scheduleSearch undefined, resultsGrid corrupted | done | 2026-06-21 | [plan](plans/_archive/bug-ios-searchview-uncompilable.md) |
...
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1539-oauth-public-client` | OAuth public-client secret-rejection fix (PR #1539) shipped without a regression test for `client_secret` on p | open | 2026-06-21 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1621-reality` | Screen-map drift: PR #1621 reshaped reality-web /accounting layout without updating docs/screens/reality/* (he | open | 2026-06-21 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1621-ppt` | Screen-map drift: PR #1621 relocated payment-matching to ppt-web accounting route without updating docs/screen | open | 2026-06-21 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1630-ppt` | Screen-map drift: PR #1630 wired Payment Management page on financial route without updating docs/screens/ppt/ | open | 2026-06-21 |  |
| 2 | test-gap | `test-gap-voting-pdf-pr-1625` | Voting PDF generation (PR #1625) shipped with unchecked test-plan items — cargo build/clippy/test + JSON-fallb | open | 2026-06-21 |  |
| 2 | bug | `bug-payment-matching-todo-iban-proximity` | Payment matching service has a TODO for date proximity + IBAN match — matching scoring is incomplete (accounti | open | 2026-06-21 |  |
| 2 | bug | `risky-churn-pr-1485-booking` | Risky churn: booking.rs Retry-After/RateLimited fix (PR #1485) shipped without a regression test for 429 + Ret | open | 2026-06-21 |  |
| 2 | bug | `bug-ios-deeplink-info-plist-missing` | iOS deep-link layer dead at runtime — Info.plist missing CFBundleURLTypes + applinks entitlement | done | 2026-06-21 |  |
| 2 | bug | `code-review-mobile-native-kmp-search-stale-response-race` | SearchScreen stale-response race — overlapping searches can clobber newer results | done | 2026-06-21 |  |

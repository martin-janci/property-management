# Backlog of vectors
<sub>Last regenerated: 2026-06-26 04:00 UTC by routine</sub>
...
| 1 | refactor | `churn-hotspot-backend-servers-reality-server-src-services-saved-search-alerts-rs` | Churn hotspot: backend/servers/reality-server/src/services/saved_search_alerts.rs | open | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-frontend-packages-api-client-src-messaging-types-ts` | Churn hotspot: frontend/packages/api-client/src/messaging/types.ts | open | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-ppt-web-src-features-messaging-hooks-useMessaging-ts` | Churn hotspot: frontend/apps/ppt-web/src/features/messaging/hooks/useMessaging.ts | open | 2026-06-26 |  |

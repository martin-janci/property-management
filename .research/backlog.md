# Backlog of vectors
<sub>Last regenerated: 2026-08-14 22:25 UTC by routine</sub>
...
| 3 | bug | `code-review-reality-server-sso-introspect-negcache-poison` | reality-server: introspect_pm_token neg-caches HTTP failures as 'token inactive… | ready | 2026-08-14 | [plan](plans/code-review-reality-server-sso-introspect-negcache-poison.md) |
...
| 2 | security | `code-review-api-handlers-share-pw-no-throttle` | api-handlers: access_protected_share has NO brute-force throttle — public token… | open | 2026-08-14 |  |
| 2 | security | `code-review-api-core-oauth-refresh-race-drops-revoke-guard` | api-core: oauth refresh_tokens race — is_revoked check + revoke() are non-atomi… | open | 2026-08-14 |  |
| 2 | bug | `code-review-reality-server-sso-reqwest-no-timeout` | reality-server: 3 SSO outbound helpers build reqwest::Client with no .timeout()… | open | 2026-08-14 |  |
| 2 | bug | `code-review-api-core-accounting-cross-currency-match` | api-core: run_payment_matcher scores across currencies — EUR bank line matches … | open | 2026-08-14 |  |
| 2 | bug | `code-review-api-core-accounting-confirm-no-tx` | api-core: confirm_match performs 3 money-mutating writes without a transaction … | open | 2026-08-14 |  |
| 2 | bug | `code-review-api-handlers-financial-f64-money` | api-handlers: financial XLSX/PDF renderers convert Decimal→f64 for money — roun… | open | 2026-08-14 |  |
| 2 | security | `code-review-api-handlers-ai-pagination-no-cap` | api-handlers: AI list_sessions unclamped limit (unwrap_or 50, no cap) — attacke… | open | 2026-08-14 |  |
| 2 | security | `code-review-api-handlers-marketplace-limit-no-cap` | api-handlers: marketplace search_providers limit/offset unclamped — DoS via unb… | open | 2026-08-14 |  |
| 2 | bug | `code-review-ppt-web-core-rentals-mutation-swallow-err` | ppt-web-core: rentals.tsx 4 mutations share onError that swallows the error — u… | open | 2026-08-14 |  |
| 2 | bug | `code-review-ppt-web-core-rentals-noop-actions` | ppt-web-core: BookingsPageRoute wires onCancel/onCheckIn/onCheckOut to no-op — … | open | 2026-08-14 |  |
| 2 | bug | `code-review-reality-server-review-body-no-cap` | reality-server: agent_reviews create_review does not bound review body length —… | open | 2026-08-14 |  |
...
| 1 | bug | `code-review-reality-web-comparison-view-i18n` | reality-web ComparisonView.tsx hardcoded English strings — no useTranslations, … | open | 2026-08-14 |  |
| 1 | bug | `code-review-reality-web-realtor-mgmt-i18n` | reality-web RealtorManagement — subtitle + remove-confirm modal hardcoded Engli… | open | 2026-08-14 |  |
| 1 | bug | `code-review-reality-web-agency-errorstate-i18n` | reality-web AgencyErrorStates 'No Agency Found' state hardcoded English on 4-lo… | open | 2026-08-14 |  |
| 1 | bug | `code-review-api-handlers-share-log-proxy-ip` | api-handlers: shares.rs audit log records proxy IP (ConnectInfo peer), not real… | open | 2026-08-14 |  |
| 1 | bug | `code-review-api-core-oauth-refresh-revoke-before-issue-lockout` | api-core: refresh_tokens revokes presented token BEFORE issuing new one — issue… | open | 2026-08-14 |  |
| 1 | bug | `code-review-ppt-web-core-person-months-toast-i18n` | ppt-web-core: person-months.tsx success toast uses raw English literals — not r… | open | 2026-08-14 |  |
| 1 | refactor | `code-review-reality-server-url-validator-dup` | reality-server: validate_image_or_link_url duplicated byte-for-byte in reports.… | open | 2026-08-14 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-services-actions-api_call-rs` | churn hotspot: backend/servers/api-server/src/services/actions/api_call.rs — 10… | open | 2026-08-14 |  |
| 1 | refactor | `repeated-churn-frontend-apps-ppt-web-src-lib-websocket-ts` | repeated churn: frontend/apps/ppt-web/src/lib/websocket.ts — 39 lines this run | open | 2026-08-14 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-organizations-mod-rs` | churn hotspot: backend/servers/api-server/src/routes/organizations/mod.rs — 38 … | open | 2026-08-14 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-08-29 18:35 UTC by routine</sub>
...
| 3 | bug | `code-review-api-core-client-ip-cf-spoof` | backend/servers/api-server/src/client_ip.rs:236-252 — resolve_client_ip trusts CF-Connecting-IP when | ready | 2026-08-29 | [plan](plans/code-review-api-core-client-ip-cf-spoof.md) |
| 3 | bug | `code-review-api-core-fcm-oauth-token-stale` | push_fanout.rs:233 — FcmConfig.oauth_token is populated once with std::env::var("FCM_OAUTH_TOKEN").o | ready | 2026-08-29 | [plan](plans/code-review-api-core-fcm-oauth-token-stale.md) |
...
| 2 | bug | `code-review-api-core-docgen-summarize-char-boundary-panic` | backend/servers/api-server/src/services/document_generation.rs:496-502 — in summarize_document's ver | open | 2026-08-29 |  |
| 2 | bug | `code-review-api-core-idempotency-commit-swallow` | backend/crates/api-core/src/middleware/idempotency.rs:177 — the terminal `let _ = tx.commit().await; | open | 2026-08-29 |  |
| 2 | refactor | `code-review-api-core-rental-dead-unscoped-idor` | The #804/#887 cross-org IDOR remediation added org-scoped `*_for_org` variants across the rental rep | open | 2026-08-29 |  |
| 2 | bug | `code-review-api-core-scheduler-no-panic-isolation` | scheduler/mod.rs:262-282 — the entire background scheduler is a single tokio::spawn (:264) running ` | open | 2026-08-29 |  |
| 2 | bug | `code-review-api-core-workflow-eq-type-strict-no-coercion` | backend/servers/api-server/src/services/workflow_executor.rs:611-652 — the workflow condition compar | open | 2026-08-29 |  |
| 2 | bug | `code-review-ppt-web-core-init-no-exp-check` | contexts/AuthContext.tsx:412-421 cold-boot init trusts a stored access token with NO expiry validati | open | 2026-08-29 |  |
| 2 | bug | `code-review-ppt-web-core-no-runtime-token-refresh` | There is NO runtime silent-refresh: once the short-lived access token expires mid-session, every sub | open | 2026-08-29 |  |
| 2 | bug | `code-review-ppt-web-core-raw-fetch-bypasses-jwt-interceptor` | frontend/apps/ppt-web/src/routes/groups/person-months.tsx:77-91 — `useBuildingUnits` runs `await fet | open | 2026-08-29 |  |
| 2 | bug | `code-review-ppt-web-core-refresh-token-localstorage` | frontend/apps/ppt-web/src/contexts/AuthContext.tsx:116,136-150 — the auth REFRESH token (and access  | open | 2026-08-29 |  |
| 2 | bug | `code-review-ppt-web-ui-create-dispute-page-stub-submit` | frontend/apps/ppt-web/src/features/disputes/pages/CreateDisputePage.tsx:29-42 — handleSubmit collect | open | 2026-08-29 |  |
| 2 | bug | `code-review-reality-server-sso-reqwest-no-timeout` | backend/servers/reality-server/src/routes/sso.rs:687 — `exchange_code_for_tokens()` does `let client | open | 2026-08-29 |  |
| 2 | bug | `code-review-reality-server-sso-sessions-unbounded` | backend/servers/reality-server/src/state.rs:855 — `sso_sessions: Arc<Mutex<HashMap<String, PendingSs | open | 2026-08-29 |  |
...
| 1 | test-gap | `code-review-api-core-rental-idor-test-gap` | The #804/#887 rental IDOR fix added org-scoped `delete_connection_for_org`, `delete_ical_feed_for_or | open | 2026-08-29 |  |
| 1 | bug | `code-review-api-core-rls-context-pool-not-conn` | backend/crates/api-core/src/middleware/rls_context.rs:232 and :248 — require_rls_context (and its si | open | 2026-08-29 |  |
| 1 | bug | `code-review-mobile-rn-deeplink-url-listener-leak` | frontend/apps/mobile/src/qrcode/DeepLinkHandler.ts:215-217 — DeepLinkManager.initialize() calls `Lin | open | 2026-08-29 |  |
| 1 | bug | `code-review-ppt-web-core-iot-sensor-delete-confirm-hardcoded` | frontend/apps/ppt-web/src/routes/groups/iot.tsx:180-184 — the sensor-delete confirmation is a HARDCO | open | 2026-08-29 |  |
| 1 | bug | `code-review-ppt-web-core-retry-ignores-retry-after` | lib/api.ts auto-retries 429 (and 503) but ignores the server's Retry-After header. The retry loop (l | open | 2026-08-29 |  |
| 1 | bug | `code-review-ppt-web-core-ws-jwt-in-url` | frontend/apps/ppt-web/src/lib/websocket.ts:94-100 — buildWebSocketUrl appends the JWT as a URL query | open | 2026-08-29 |  |
| 1 | bug | `code-review-ppt-web-ui-authcallback-decodeuri-throw` | frontend/apps/ppt-web/src/pages/AuthCallbackPage.tsx:93,99-100 — the SSO callback reads `error_descr | open | 2026-08-29 |  |
| 1 | bug | `code-review-ppt-web-ui-dispute-list-no-i18n` | frontend/apps/ppt-web/src/features/disputes/components/DisputeList.tsx has ZERO useTranslation usage | open | 2026-08-29 |  |
| 1 | bug | `code-review-ppt-web-ui-errorboundary-raw-message-prod` | frontend/apps/ppt-web/src/components/ErrorBoundary.tsx:167-168 — the global error boundary renders t | open | 2026-08-29 |  |
| 1 | bug | `code-review-ppt-web-ui-file-dispute-page-partial-i18n` | frontend/apps/ppt-web/src/features/disputes/pages/FileDisputePage.tsx imports and uses useTranslatio | open | 2026-08-29 |  |
| 1 | i18n | `code-review-reality-web-i18n-error-state-gap` | reality-web is a PUBLIC, SEO-indexed portal that serves four locales (sk/cs/de/en via next-intl, mes | open | 2026-08-29 |  |
| 1 | refactor | `code-review-reality-web-listing-grid-empty-dup` | components/states/EmptyState.tsx is the repo's shared, prop-driven empty-placeholder component (Empt | open | 2026-08-29 |  |

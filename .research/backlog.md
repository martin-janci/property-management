# Backlog of vectors
<sub>Last regenerated: 2026-06-22 22:30 UTC by routine</sub>
...
| 2 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcoded MOCK_* arrays — no API wiring | done | 2026-06-22 |  |
| 2 | bug | `code-review-mobile-rn-deeplink-init-unhandled` | useDeepLinkRouting.ts:27-36 — initialize() re-runs on onNavigate identity change + void promise with no .catch → duplicate nav / unhandled rejection | done | 2026-06-22 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-06-10 03:05Z→18:30Z) | done | 2026-06-22 |  |
| 1 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs (+404/−29 in PR #1294 Booking.com OTA retry) | done | 2026-06-22 |  |
| 1 | refactor | `code-review-api-core-osrng-expect` | crypto.rs:127 SysRng.try_fill_bytes(...).expect() panics if OS CSPRNG errors during integration-credential encrypt | done | 2026-06-22 |  |
| 1 | refactor | `repeated-churn-backend-servers-api-server-src-routes-forms-rs` | forms.rs repeated-churn — runs_seen=2 (#1337 explicit_auto_deref + #1397 org-scope hardening) | done | 2026-06-22 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-ppt-web-src-routes-lazyRoutes-tsx` | Churn hotspot: frontend/apps/ppt-web/src/routes/lazyRoutes.tsx — 354 lines across 6 PRs (window 2026-06-16 → 2026-06-22). Structural — every new route/feature touches the route aggregat | open | 2026-06-22 |  |
| 1 | refactor | `churn-hotspot-frontend-packages-api-client-src-index-ts` | Churn hotspot: frontend/packages/api-client/src/index.ts — 73 lines across 5 PRs (window 2026-06-16 → 2026-06-22). Structural — every new route/feature touches the route aggregato | open | 2026-06-22 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-ppt-web-src-routes-AppRoutes-tsx` | Churn hotspot: frontend/apps/ppt-web/src/routes/AppRoutes.tsx — 73 lines across 5 PRs (window 2026-06-16 → 2026-06-22). Structural — every new route/feature touches the route aggregato | open | 2026-06-22 |  |
| 1 | refactor | `repeated-churn-frontend-apps-ppt-web-src-App-tsx` | Churn hotspot: frontend/apps/ppt-web/src/App.tsx — 238 lines across 5 PRs (window 2026-06-16 → 2026-06-22); hotspot_history.runs_seen=3 prior. Same structural pattern as t | open | 2026-06-22 |  |
| 1 | triage | `triage-buffer-low-2026-06-22` | Dispatcher buffer-low fire payload (2026-06-22): claimable=34/72 floor=36 — needs fresh candidate stories | open | 2026-06-22 |  |

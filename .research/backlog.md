# Backlog of vectors
<sub>Last regenerated: 2026-08-27 18:38 UTC by routine</sub>
...
| 3 | bug | `code-review-ppt-web-core-personmonths-raw-fetch-noauth` | frontend/apps/ppt-web/src/routes/groups/person-months.tsx:75-91 — useBuildingUnits() calls a hand-ro... | ready | 2026-08-27 | [plan](plans/code-review-ppt-web-core-personmonths-raw-fetch-noauth.md) |
...
| 3 | security | `security-realtors-mark-inquiry-read-idor` | IDOR: reality-server realtors mark_inquiry_read flips any realtor's inquiry by ID with no owner scop... | done | 2026-05-26 | [plan](plans/security-realtors-mark-inquiry-read-idor.md) |
...
| 2 | bug | `code-review-api-core-fault-report-csv-injection` | backend/servers/api-server/src/routes/reports/helpers.rs:188 — the fault-report CSV branch of genera... | open | 2026-08-27 |  |
| 2 | bug | `code-review-ppt-web-core-financial-dash-no-error-state` | frontend/apps/ppt-web/src/routes/groups/financial.tsx:70-86 — FinancialDashboardPageRoute runs three... | open | 2026-08-27 |  |
| 2 | bug | `code-review-reality-server-sso-rs-reqwest-no-timeout` | backend/servers/reality-server/src/routes/sso.rs:687 — exchange_code_for_tokens() builds `reqwest::C... | open | 2026-08-27 |  |
| 2 | bug | `code-review-reality-web-feedimport-create-no-error` | frontend/apps/reality-web/src/components/import/FeedImport.tsx:480-489 handleCreate() does `await cr... | open | 2026-08-27 |  |
| 2 | bug | `code-review-reality-web-crmconn-create-no-error` | frontend/apps/reality-web/src/components/import/CrmConnection.tsx:389-404 handleCreate() does `await... | open | 2026-08-27 |  |
| 2 | bug | `code-review-reality-web-listings-url-nan-query` | frontend/apps/reality-web/src/app/[locale]/listings/page.tsx:112-124 — getFiltersFromUrl parses five... | open | 2026-08-27 |  |
| 2 | bug | `code-review-reality-web-listings-no-error-state` | frontend/apps/reality-web/src/app/[locale]/listings/page.tsx:145 — `const { data, isLoading } = useL... | open | 2026-08-27 |  |
| 2 | bug | `code-review-ppt-web-ui-content-moderation-assign-alert` | frontend/apps/ppt-web/src/features/compliance/pages/ContentModerationPage.tsx:143 — handleAssign bai... | open | 2026-08-27 |  |
| 2 | dx | `code-review-ppt-web-ui-dsa-transparency-report-card-i18n` | frontend/apps/ppt-web/src/features/compliance/components/DsaTransparencyReportCard.tsx:1-268 has no ... | open | 2026-08-27 |  |
...
| 1 | bug | `code-review-api-core-market-pricing-db-error-swallow` | backend/servers/api-server/src/routes/market_pricing.rs:459 — `list_regions(org_id).await.unwrap_or_... | open | 2026-08-27 |  |
| 1 | bug | `code-review-ppt-web-core-orgprovider-unmemoized-value` | frontend/apps/ppt-web/src/contexts/OrganizationProvider.tsx:8-12 — the context value is built as a f... | open | 2026-08-27 |  |
| 1 | bug | `code-review-reality-web-import-delete-toggle-unhandled` | frontend/apps/reality-web/src/components/import/FeedImport.tsx:154-158 handleTogglePause() and :160-... | open | 2026-08-27 |  |
| 1 | bug | `code-review-reality-web-listing-edit-slovak-i18n` | frontend/apps/reality-web/src/app/[locale]/account/listings/[id]/edit/page.tsx (930 lines) is a [loc... | open | 2026-08-27 |  |
| 1 | bug | `code-review-reality-web-account-routes-i18n` | Systemic i18n gap across the signed-in account/realtor route cluster: multiple [locale]-scoped pages... | open | 2026-08-27 |  |

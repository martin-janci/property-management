# Backlog of vectors
<sub>Last regenerated: 2026-08-02 18:14 UTC by routine</sub>
...
| 2 | bug | `code-review-ppt-web-ui-auth-callback-double-decode` | AuthCallbackPage double-decodes error_description — URIError on any '%' throws before setErrorMessage, breaking SSO error UI | open | 2026-08-02 |  |
| 2 | refactor | `code-review-ppt-web-ui-untranslated-shared-components` | ppt-web shared components (OfflineIndicator/ProtectedRoute/ConfirmationDialog) render hardcoded English strings — no useTranslation, no i18n keys | open | 2026-08-02 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-06-18 06:18 UTC by routine</sub>
...
| 2 | test-gap | `test-gap-screen-map-drift-pr-1545-reality` | Screen-map drift: PR #1545 touched reality-web/src/app/accounting/layout.tsx without docs/screens/reality update | open | 2026-06-18 |  |
...
| 1 | refactor | `refactor-churn-hotspot-rental-rs` | Churn hotspot: backend/crates/db/src/repositories/rental.rs — 7 PRs in one run (enum casts + RLS + OAuth upsert + IDOR t | open | 2026-06-18 |  |
| 1 | refactor | `refactor-churn-hotspot-db-models-mod-rs` | Churn hotspot: backend/crates/db/src/models/mod.rs — 4 PRs (-942 lines retired) + Booking.com client | open | 2026-06-18 |  |
| 1 | triage | `triage-coverage-buffer-exhausted-2026-06-18` | Coverage buffer exhausted: claimable=4/72, coverage.json stale (49 stories, 29 done / 20 partial, 0 todo) — needs local  | needs-human-judgement | 2026-06-18 |  |

...
| 2 | security | `code-review-api-handlers-share-pw-no-throttle` | SECURITY: public share password endpoint has no throttle — brute-force viable via anonymous POST | ready | 2026-08-15 | [plan](plans/code-review-api-handlers-share-pw-no-throttle.md) |
...
| 2 | bug | `code-review-api-core-delay-duration-overflow` | api-core: DelayConfig::to_duration multiplies user-supplied u64 before MAX_DELAY_SECONDS check — pan | open | 2026-08-15 |  |
| 2 | bug | `code-review-mobile-native-kmp-decimal-serializer-throws-malformed` | mobile-native-kmp: DecimalStringSerializers throws on malformed backend Decimal — crashes network de | open | 2026-08-15 |  |
| 2 | bug | `code-review-ppt-web-core-ws-event-name-mismatch` | ppt-web WebSocketContext subscribes to `entity:*` events but backend emits with dot separator — real | open | 2026-08-15 |  |
| 2 | bug | `code-review-ppt-web-core-api-client-no-onunauthorized` | ppt-web AuthProvider wires configureApiClient without onUnauthorized — 401 from feature hooks doesn' | open | 2026-08-15 |  |
| 2 | bug | `code-review-ppt-web-ui-createdispute-fake-submit` | ppt-web CreateDisputePage.handleSubmit fakes API call — dispute forms 'succeed' without hitting back | open | 2026-08-15 |  |
| 2 | bug | `code-review-ppt-web-ui-mediation-panels-no-iserror` | ppt-web mediation panels drop isError from useQuery — network failures render as empty state, not er | open | 2026-08-15 |  |
| 2 | bug | `code-review-reality-web-journal-newsletter-fake-submit` | reality-web journal newsletter subscribe fakes success — no backend POST, subscribers silently dropp | open | 2026-08-15 |  |
| 2 | bug | `code-review-reality-web-inquiry-cancel-no-error` | reality-web inquiries page handleCancel fires mutation without error surface — network failures leav | open | 2026-08-15 |  |
...
| 1 | bug | `code-review-reality-web-comparison-view-i18n` | reality-web ComparisonView.tsx hardcoded English on 4-locale portal — sk/cs/de visitors see EN copy  | open | 2026-08-15 |  |
| 1 | bug | `code-review-reality-web-realtor-mgmt-i18n` | reality-web RealtorManagement.tsx partial i18n — realtor-removal confirm modal + subtitle stay Engli | open | 2026-08-15 |  |
| 1 | bug | `code-review-reality-web-agency-errorstate-i18n` | reality-web AgencyErrorStates.tsx no-agency empty state hardcoded English on 4-locale portal | open | 2026-08-15 |  |
| 1 | bug | `code-review-api-handlers-share-log-proxy-ip` | share-access audit log records reverse-proxy IP, not client IP — audit trail loses attribution | open | 2026-08-15 |  |
...
| 1 | bug | `code-review-api-core-docgen-empty-llm-ok` | api-core: document_generation collapses empty LLM `choices[]` to Ok with empty summary — provider bl | open | 2026-08-15 |  |
| 1 | bug | `code-review-ppt-web-core-unverified-jwt-role` | ppt-web decodeJwtPayload unverified base64 decode of JWT — role/tenant reads trust untampered client | open | 2026-08-15 |  |
| 1 | bug | `code-review-ppt-web-ui-compliance-alert-i18n` | ppt-web compliance/ pages use window.alert() with hardcoded English — inaccessible on 6 locale bundl | open | 2026-08-15 |  |
| 1 | bug | `code-review-reality-web-pricemap-hardcoded-locale` | reality-web PriceMap hardcoded to 'sk' locale — cs/de/en visitors see Slovak number formatting | open | 2026-08-15 |  |
| 1 | refactor | `churn-hotspot-voice-webhooks-rs` | churn-hotspot: voice_webhooks.rs — 3 successive security fixes in one window (+556 lines) suggests d | open | 2026-08-15 |  |
| 1 | test-gap | `churn-hotspot-voice-oauth-refresh-auth-tests` | churn-hotspot: voice_oauth_refresh_auth_tests.rs — new 270-line regression suite (monitor for furthe | open | 2026-08-15 |  |
| 1 | refactor | `churn-hotspot-workflow-executor-rs` | repeated-churn: workflow_executor.rs — runs_seen=2 (2026-08-07 + 2026-08-15) touched again by PR #27 | open | 2026-08-15 |  |

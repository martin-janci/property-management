# Backlog of vectors
<sub>Last regenerated: 2026-07-06 00:17 UTC by routine</sub>
...
| 1 | refactor | `refactor-churn-hotspot-backend-crates-db-src-models-multi-currency-rs` | Churn hotspot: backend/crates/db/src/models/multi_currency.rs (enum sync guard rework, PR #2098) | open | 2026-07-06 |  |
| 1 | refactor | `refactor-churn-hotspot-backend-servers-api-server-tests-outages-happy-path-tests-rs` | Churn hotspot: outages_happy_path_tests.rs (auth fix, PR #1979) | open | 2026-07-06 |  |
| 1 | refactor | `refactor-churn-hotspot-backend-servers-api-server-src-routes-faults-rs` | Churn hotspot: faults.rs (assign_fault recipient extract, PR #2095) | open | 2026-07-06 |  |
| 1 | refactor | `code-review-api-handlers-faults-stale-security-todo` | faults.rs:133 TODO(security) stale — is_manager branches now use MembershipRepository lookup, not hard-coded false | open | 2026-07-06 |  |

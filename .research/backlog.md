# Backlog of vectors
<sub>Last regenerated: 2026-07-14 08:14 UTC by routine</sub>
...
| 2 | bug | `merged-review-finding-issue-2303` | report_schedules next_run_at still write-only (no due-work consumer / post-fire advance) + dual cadence model (issue #2303) | open | 2026-07-14 |   |
| 2 | refactor | `merged-review-finding-issue-2302` | screen-map epic extractor cannot represent letter-suffixed epics (10A/10B/7B) — PR #2297 canonical form will fail future drift scan (issue #2302) | open | 2026-07-14 |   |
| 2 | bug | `merged-review-finding-issue-2301` | Harden gap-84-4 push wiring: pipeline regression guard doesnt pin the fix + iOS-only honest-metrics edge (issue #2301) | open | 2026-07-14 |   |
| 2 | bug | `merged-review-finding-issue-2300` | pgvector back-fill copies vectors without provenance; can pull null-provenance rows into filtered search (issue #2300) | open | 2026-07-14 |   |

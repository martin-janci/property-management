...
| 3 | bug | `code-review-mobile-rn-messages-format-relative-invalid-date` | mobile-rn: MessagesScreen.tsx formatRelative renders literal Invalid Date when lastMessage.createdAt | ready | 2026-08-05 | [plan](plans/code-review-mobile-rn-messages-format-relative-invalid-date.md) |
...
| 2 | bug | `code-review-mobile-rn-offline-tempid-mapping-not-persisted` | mobile-rn: useOfflineSupport tempIdToServerId mapping lost across app restart — dependent actions si | open | 2026-08-05 |  |
| 2 | bug | `code-review-mobile-rn-thread-detail-i18n-bypass` | mobile-rn: ThreadDetailScreen still ships hardcoded English literals after #2656 i18n sweep — bypass | open | 2026-08-05 |  |
| 2 | test-gap | `screen-map-drift-pr-2649-ppt` | screen-map drift: PR #2649 touched ppt-web rentals + financial routes (onError toasts) without updat | done | 2026-08-05 |  |
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-voice_webhooks-rs` | Churn hotspot: voice_webhooks.rs (+195 lines this run — security fix) | open | 2026-08-05 |  |
| 1 | refactor | `repeated-churn-frontend-apps-mobile-src-screens-messages-ThreadDetailScreen-tsx` | Repeated churn: ThreadDetailScreen.tsx modified in 2 consecutive routine runs — screen keeps drawing | open | 2026-08-05 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-06-21 04:20 UTC by routine</sub>
...
| 3 | bug | `unchecked-todo-pr-1606-list-contacts` | PR #1606 (accounting list_contacts manager-only gate) merged with unchecked checkboxes | open | 2026-06-21 |  |
...
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1561-portal-principal` | PR #1561 (reality-server PortalPrincipal admits public agencies) shipped without a regression test | open | 2026-06-21 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1565-document-get-by-id` | PR #1565 (document get-by-id u.name + enum decode) shipped without a regression test | open | 2026-06-21 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1582-folder-tree-mobile` | PR #1582 (mobile wire useFolderTree consumers) shipped without test (test added later in #1618) | open | 2026-06-21 |  |
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1617-ota-push-wire` | PR #1617 (wire combined OTA availability+rate push) shipped without /tests/ path in diff | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1621-ppt` | Screen-map drift: PR #1621 relocated payment-matching to ppt-web without screen-doc update | open | 2026-06-21 |  |
| 2 | test-gap | `unchecked-todo-pr-1625-voting-pdf` | PR #1625 (voting PDF generation + archive PAP-288) merged with unchecked checkboxes | open | 2026-06-21 |  |
...
| 1 | refactor | `churn-hotspot-frontend-apps-mobile-src-screens-documents-movefoldersheet-tsx` | Churn hotspot: frontend/apps/mobile/src/screens/documents/MoveFolderSheet.tsx (519 lines this run) | open | 2026-06-21 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-voting-rs` | Churn hotspot: backend/servers/api-server/src/routes/voting.rs (436 lines this run) | open | 2026-06-21 |  |
| 1 | refactor | `repeated-churn-backend-crates-integrations-src-booking-rs` | Repeated-churn hotspot: backend/crates/integrations/src/booking.rs (runs_seen=2) | open | 2026-06-21 |  |

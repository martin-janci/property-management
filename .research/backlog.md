# Backlog of vectors
<sub>Last regenerated: 2026-06-25 22:13 UTC by routine</sub>
...
| 3 | refactor | `revert-pr-1713` | Process: gap-sweep re-admitted board-retired delegation surface (PR #1690 → revert #1713) | open | 2026-06-25 |  |
...
| 2 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcoded MOCK_*  | done | 2026-06-25 |  |
| 2 | dx | `unchecked-todo-pr-1723` | PR #1723 merged with unchecked test-plan boxes (rustfmt fix-up) | open | 2026-06-25 |  |
...
| 1 | refactor | `churn-hotspot-backend/servers/api-server/src/routes/emergency.rs` | Churn hotspot (post-split): backend/servers/api-server/src/routes/emergency.rs — 3362 lines/9d | open | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend/crates/db/src/repositories/rental.rs` | Churn hotspot: backend/crates/db/src/repositories/rental.rs — 2933 lines/9d | open | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend/crates/integrations/src/booking/mod.rs` | Churn hotspot (post-split): backend/crates/integrations/src/booking/mod.rs — 2818 lines/9d | open | 2026-06-25 |  |
| 1 | dx | `closed-not-merged-pr-1720` | PR #1720 closed unmerged (Leases nav link — duplicate of #1694) | open | 2026-06-25 |  |
| 1 | dx | `closed-not-merged-pr-1749` | PR #1749 closed unmerged (icon test exclude — superseded by #1748 typecheck fix) | open | 2026-06-25 |  |
| 1 | dx | `closed-not-merged-pr-1727` | PR #1727 closed unmerged (RLS baseline — superseded by #1728/#1729) | open | 2026-06-25 |  |
| 1 | dx | `closed-not-merged-pr-1698` | PR #1698 closed unmerged (Story 3.2 unit mgmt UI — superseded by #1695) | open | 2026-06-25 |  |
| 1 | security | `code-review-api-handlers-broadcast-counts-missing-org-filter` | emergency.rs update_broadcast_counts() missing org_id filter — cross-tenant write risk | open | 2026-06-25 |  |

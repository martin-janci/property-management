# Backlog of vectors
<sub>Last regenerated: 2026-07-02 14:08 UTC by routine</sub>
...
| 3 | bug | `code-review-ppt-web-core-iot-ws-relative-url` | ppt-web IoT WS live stream broken — buildWsUrl uses undefined window.__API_BASE_URL__ | open | 2026-07-02 |  |
...
| 2 | bug | `code-review-ppt-web-core-perf-metrics-leak` | ppt-web usePerformanceMetrics leaks window listeners (load, visibilitychange) on unmount | open | 2026-07-02 |  |
...
| 1 | refactor | `code-review-ppt-web-core-sessions-unchecked-cast` | ppt-web SessionsPage double-casts API response to local shape — no runtime validation | open | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-messaging.rs` | Churn hotspot: messaging.rs — 3 touches this run | open | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-messaging.rs` | Churn hotspot: messaging.rs — 3 touches this run | open | 2026-07-02 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-tests-multi-currency-happy-path-tests.rs` | Churn hotspot: multi_currency_happy_path_tests.rs — 3 touches this run | open | 2026-07-02 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-07-11 16:43 UTC by routine</sub>
...
| 3 | bug | `bug-revoke-all-sessions-cookie-blindness` | revoke_all_sessions ignores refresh cookie — signs the caller out too | done | 2026-07-11 | [plan](plans/_archive/bug-revoke-all-sessions-cookie-blindness.md) |
...
| 2 | perf | `code-review-mobile-native-kmp-profilestats-sequential-fanout` | perf: ProfileStatsLoader.load() should fan out three independent calls concurrently | open | 2026-07-11 |  |
...
| 1 | bug | `bug-refresh-empty-cookie-shadows-body-token` | /refresh and /logout — empty refresh_token cookie shadows valid body token | done | 2026-07-11 |  |
| 1 | test-gap | `churn-hotspot-backend-servers-api-server-tests-airbnb-direct-connect-tests-rs` | Watch: airbnb_direct_connect_and_availability_sync_tests.rs — new hotspot spike from PR #2189 | open | 2026-07-11 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-ppt-web-features-settings-integrations-integrations-page-tsx` | Watch: IntegrationsPage.tsx — hotspot spike while wiring stabilises | open | 2026-07-11 |  |
| 1 | dx | `churn-hotspot-github-workflows-backend-yml` | Watch: backend.yml — CI shard rework from PR #2223 | open | 2026-07-11 |  |
| 1 | bug | `code-review-mobile-native-kmp-apiconfig-wsurl-naive-replace` | bug (latent): ApiConfig.wsUrl uses unanchored String.replace, will corrupt hosts/paths containing 'http' | open | 2026-07-11 |  |
...
| 0 | dx | `dx-routine-lag-catchup-2026-07` | Cloud routine cadence recovery — reduce 3–4d gaps between runs | open | 2026-07-11 |  |

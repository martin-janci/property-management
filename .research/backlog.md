# Backlog of vectors
<sub>Last regenerated: 2026-07-05 00:13 UTC by routine</sub>
...
| 1 | refactor | `churn-hotspot-frontend-apps-mobile-src-screens-messages-messagesscreen-tsx` | MessagesScreen churn hotspot (3 changes 2026-06-16..07-04) | open | 2026-07-05 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-services-scheduler-rs` | api-server scheduler.rs churn hotspot (3 changes 2026-06-16..07-04) | open | 2026-07-05 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-integrations-booking-channel-rs` | booking_channel.rs churn hotspot (3 changes 2026-06-16..07-04) | open | 2026-07-05 |  |
...
| 0 | refactor | `code-review-api-core-osrng-expect` | crypto.rs:127 SysRng.try_fill_bytes(...).expect() panics if OS CSPRNG errors during integration-credential enc | dropped | 2026-07-05 |  |

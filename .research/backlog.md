# Backlog of vectors
<sub>Last regenerated: 2026-08-01 08:23 UTC by routine</sub>
...
| 3 | security | `code-review-reality-server-agency-invitation-idor` | SECURITY: reality-server create_invitation + accept_invitation lack membership + email checks — any auth'd user joins any agency at any role | ready | 2026-08-01 | [plan](plans/security-reality-server-agency-invitation-idor.md) |
...
| 2 | bug | `code-review-reality-server-paginated-total-truncated` | BUG: reality-server /reports/mine + /imports return .len() as total after LIMIT/OFFSET — pagination lies | open | 2026-08-01 |  |
| 2 | test-gap | `code-review-reality-server-invitation-idor-test-gap` | TEST-GAP: agencies_authz_tests only covers 401 paths for create/accept invitation — missing IDOR + email-mismatch regressions | open | 2026-08-01 |  |
...
| 1 | refactor | `refactor-churn-hotspot-booking-messages-2026-08-01` | booking/messages.rs — new 605-line submodule from PR #2619 decomposition; monitor for stability | open | 2026-08-01 |  |
| 1 | refactor | `refactor-churn-hotspot-booking-client-2026-08-01` | booking/client.rs — new 552-line submodule from PR #2619 decomposition; monitor for stability | open | 2026-08-01 |  |

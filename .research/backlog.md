# Backlog of vectors
<sub>Last regenerated: 2026-06-20 03:30 UTC by routine</sub>
...
| 3 | bug | `bug-ios-searchview-uncompilable` | iOS SearchView.swift does not compile — performSearch/scheduleSearch undefined, resultsGrid corrupted | done | 2026-06-20 | [plan](plans/_archive/bug-ios-searchview-uncompilable.md) |
| 3 | security | `unchecked-todo-pr-1460` | PR #1460 (fix(db): FORCE RLS on developer_oauth_apps/grants/api_key_usage_logs (BIT-76, #1303)) merged with unchecked TODO checkboxes — verify manual checks | open | 2026-06-20 |  |
| 3 | bug | `unchecked-todo-pr-1465` | PR #1465 (fix(mobile-native): iOS stale-response guard, staging deep-link host, orphaned plist, xcconfig drift) merged with unchecked TODO checkboxes — verify manual checks | open | 2026-06-20 |  |
| 3 | bug | `unchecked-todo-pr-1468` | PR #1468 (fix(disputes): watch subscription + flush-on-unmount + i18n keys (GH #1364, #1404)) merged with unchecked TODO checkboxes — verify manual checks | open | 2026-06-20 |  |
| 3 | security | `unchecked-todo-pr-1606` | PR #1606 (feat(accounting): manager-only role gate for list_contacts (PAP-281)) merged with unchecked TODO checkboxes — verify manual checks | open | 2026-06-20 |  |
...
| 2 | bug | `bug-ios-deeplink-info-plist-missing` | iOS deep-link layer dead at runtime — Info.plist missing CFBundleURLTypes + applinks entitlement | done | 2026-06-20 |  |
| 2 | dx | `unchecked-todo-pr-1441` | PR #1441 (feat(gh-1375): add pre-push cargo fmt + clippy gate) merged with unchecked TODO checkboxes — verify manual checks | open | 2026-06-20 |  |
| 2 | refactor | `unchecked-todo-pr-1442` | PR #1442 (refactor(tests): replace duplicate seed_membership with canonical common:: import (GH #1373)) merged with unchecked TODO checkboxes — verify manual checks | open | 2026-06-20 |  |
| 2 | test-gap | `unchecked-todo-pr-1443` | PR #1443 (test(reports): add cron validator drift guard (GH #1368)) merged with unchecked TODO checkboxes — verify manual checks | open | 2026-06-20 |  |
| 2 | test-gap | `screen-map-drift-pr-1621-ppt` | Screen-map drift: PR #1621 touched ppt-web routes without updating docs/screens/ppt/* (payment-matching relocate) | open | 2026-06-20 |  |
| 2 | test-gap | `screen-map-drift-pr-1621-reality` | Screen-map drift: PR #1621 touched reality-web routes without updating docs/screens/reality/* (payment-matching relocate) | open | 2026-06-20 |  |
...
| 1 | bug | `code-review-mobile-native-kmp-deeplink-token-not-url-decoded` | DeepLinkRouter skips URL-decoding while Android Uri.getQueryParameter decodes — SSO tokens diverge per platform | open | 2026-06-20 |  |
| 1 | bug | `code-review-mobile-native-kmp-search-stale-response-race` | SearchScreen stale-response race — overlapping searches can clobber newer results | open | 2026-06-20 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→18:30Z) | open | 2026-06-20 |  |
| 1 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-rs` | Churn hotspot: backend/crates/integrations/src/booking.rs (+404/−29 in PR #1294 Booking.com OTA retry) | open | 2026-06-20 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-rental-rs` | Churn hotspot: 2837 lines changed in backend/crates/db/src/repositories/rental.rs (window 2026-06-16→2026-06-20) | open | 2026-06-20 |  |
...
| 0 | refactor | `churn-hotspot-mobile-native-listing-detail-kt` | Churn hotspot: ListingDetailScreen.kt — +1279 LOC this run (gap-82-4 reality mobile favorite toggle) | dropped | 2026-06-20 |  |
| 0 | refactor | `churn-hotspot-mobile-native-search-screen-kt` | Churn hotspot: SearchScreen.kt — +1293 LOC this run (gap-82-3 reality mobile search/filters) | dropped | 2026-06-20 |  |
| 0 | refactor | `code-review-mobile-native-kmp-deeplink-android-bypasses-shared-router` | MainActivity reimplements deep-link dispatch instead of calling shared DeepLinkRouter — drift trap | dropped | 2026-06-20 |  |
...
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected by deploy-server (staging/prod) | dropped | 2026-06-20 |  |

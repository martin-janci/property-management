# Backlog of vectors
<sub>Last regenerated: 2026-07-12 03:13 UTC by routine</sub>
...
| 3 | security | `security-sso-client-role-escalation` | reality-server SSO exchange trusts client-supplied roles — portal privilege escalation | ready | 2026-07-12 | [plan](plans/security-sso-client-role-escalation.md) |
...
| 2 | test-gap | `test-gap-screen-map-drift-pr-2217-ppt-integrations` | PR #2217 wired /settings/integrations without updating docs/screens/ppt/settings-integrations.md | open | 2026-07-12 |  |
...
| 1 | bug | `bug-mobile-native-kmp-no-http-timeout` | KMP shared HttpClient has no HttpTimeout plugin — stalled connections hang UI spinners | open | 2026-07-12 |  |
| 1 | refactor | `refactor-repeated-churn-api-server-routes-auth-rs` | routes/auth.rs repeated-churn (runs_seen 2→3) — third window with meaningful churn | open | 2026-07-12 |  |
| 1 | refactor | `refactor-repeated-churn-integrations-booking-mod-rs` | integrations/booking/mod.rs repeated-churn (runs_seen 1→2) | open | 2026-07-12 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-06-19 00:32 UTC by routine</sub>
...
| 2 | test-gap | `test-gap-screen-map-drift-pr-1453-reality` | Screen-map drift: PR #1453 added reality-web /accounting page without docs/screens/reality/ update | open | 2026-06-19 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1454-ppt` | Screen-map drift: PR #1454 (native accounting MVP + @hey-api migration) modified ppt-web routes without docs/screens/ppt/ update | open | 2026-06-19 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1545-reality` | Screen-map drift: PR #1545 modified reality-web /accounting layout without docs/screens/reality/ update | open | 2026-06-19 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1555-ppt` | Screen-map drift: PR #1555 (gap-79-1 FaultsPage wiring) modified ppt-web faults route without docs/screens/ppt/ update | open | 2026-06-19 |  |
| 2 | test-gap | `test-gap-screen-map-drift-pr-1559-ppt` | Screen-map drift: PR #1559 (announcement comments optimistic add) modified ppt-web announcements route without docs/screens/ppt/ update | open | 2026-06-19 |  |
| 2 | bug | `bug-risky-churn-pr-1469-document-rs` | Risky churn: PR #1469 schema-drift SQL fix in document.rs (top-churn file) shipped without a regression test | open | 2026-06-19 |  |
| 2 | bug | `bug-risky-churn-pr-1485-booking-rs` | Risky churn: PR #1485 Booking.com client timeout/Retry-After/RateLimited in booking.rs (top-churn file) shipped without a regression test | open | 2026-06-19 |  |
| 2 | bug | `bug-risky-churn-pr-1537-rental-rs` | Risky churn: PR #1537 rental_guests/forms enum write-path fix in rental.rs (top-churn file) shipped without a regression test | open | 2026-06-19 |  |
| 2 | bug | `bug-risky-churn-pr-1551-document-rs` | Risky churn: PR #1551 document_category cast in count_accessible_rls (top-churn file) shipped without a regression test | open | 2026-06-19 |  |
| 2 | bug | `bug-risky-churn-pr-1565-document-rs` | Risky churn: PR #1565 document get-by-id read path (top-churn file) shipped without a regression test | open | 2026-06-19 |  |
...
| 1 | test-gap | `test-gap-screen-map-drift-pr-1100-ppt` | Screen-map drift: PR #1100 modified ppt-web App.tsx (FileDisputePageRoute extraction) without screen-doc update | open | 2026-06-19 |  |
...
| 1 | refactor | `refactor-churn-hotspot-mobile-announcements` | Churn hotspot: AnnouncementsScreen.tsx — 4 PRs this run, instability proxy | done | 2026-06-19 |  |
...
| 1 | refactor | `refactor-repeated-churn-document-rs` | Instability proxy: db/repositories/document.rs hotspot 2 runs in a row — consider extraction or stabilization pass | open | 2026-06-19 |  |
| 1 | refactor | `refactor-repeated-churn-booking-rs` | Instability proxy: integrations/src/booking.rs hotspot 2 runs in a row — consolidate OTA error-handling surface | open | 2026-06-19 |  |

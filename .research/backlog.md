# Backlog of vectors
<sub>Last regenerated: 2026-06-25 06:30 UTC by routine</sub>
...
| 3 | refactor | `refactor-revert-pr-1713-delegations` | Revert PR #1713: delegation frontend re-added in #1690 then rolled back — verify retirement is final (BIT-213) | open | 2026-06-25 |  |
...
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixe | done | 2026-06-25 |  |
| 2 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcod | done | 2026-06-25 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-tests-form-rls-repo-tests-rs` | Churn hotspot: backend/crates/db/tests/form_rls_repo_tests.rs touched 2x since 2026-06-12 (window 2026-06-12→2 | done | 2026-06-25 |  |
...
| 1 | refactor | `code-review-api-core-osrng-expect` | crypto.rs:127 SysRng.try_fill_bytes(...).expect() panics if OS CSPRNG errors during integration-credential enc | done | 2026-06-25 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-rental-rs` | Churn hotspot: 2933 lines changed in backend/crates/db/src/repositories/rental.rs (window 2026-06-16→2026-06-2 | open | 2026-06-25 |  |
...
| 0 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despit | dropped | 2026-06-25 |  |
...
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET no | dropped | 2026-06-25 |  |
| 0 | dx | `dx-lag-warning-2026-06-25` | Routine ran with 9d 0h lag — silent gap 2026-06-16 → 2026-06-25 needs cron diagnosis | open | 2026-06-25 |  |

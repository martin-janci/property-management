# Backlog of vectors
<sub>Last regenerated: 2026-06-18 10:18 UTC by routine</sub>
...
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-forms-rs` | Churn hotspot: backend/servers/api-server/src/routes/forms.rs touched 2x since 2026-06-12 (window 2026-06-12→2026-06-13) | open | 2026-06-18 |  |
| 1 | dx | `closed-not-merged-pr-1511` | PR #1511 'fix(api-server): resolve clippy lints blocking dev fmt-clippy gate' closed unmerged 2026-0 | open | 2026-06-18 |  |

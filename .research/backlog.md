# Backlog of vectors
<sub>Last regenerated: 2026-06-26 06:30 UTC by routine</sub>
...
| 3 | refactor | `revert-pr-1713` | Revert PR #1713 — delegations frontend removed (BIT-213 retirement) | needs-human-judgement | 2026-06-26 |  |
| 3 | bug | `unchecked-todo-pr-1717` | Unchecked TODO checklist after merge — financial reports + PDF/xlsx export (Story 11.7) | open | 2026-06-26 |  |
...
| 2 | bug | `code-review-mobile-rn-screens-mock-data` | Mobile RN production screens (Buildings/Meters/Leases/PersonMonths/Notifications/Threads/Forms) render hardcoded MOCK_* arrays — no API wiring | done | 2026-06-26 |  |
| 2 | bug | `code-review-ppt-web-core-rentals-auth-hook-misuse` | rentals.tsx: useRentalsAuth() reads getToken() non-reactively — stale Authorization header on refresh + permanently-disabled queries on initial unauthenticated mount | open | 2026-06-26 |  |
| 2 | bug | `code-review-ppt-web-core-rentals-mutations-no-error-ui` | rentals.tsx: useMutation calls (createConnection, syncPlatforms, checkIn, checkOut) have no onError handler — silent failure | open | 2026-06-26 |  |
| 2 | refactor | `unchecked-todo-pr-1709` | Unchecked TODO checklist after merge — payment reminders + auto-overdue (Story 11.6 / BIT-176) | open | 2026-06-26 |  |
| 2 | refactor | `unchecked-todo-pr-1723` | Unchecked TODO checklist after merge — rustfmt compliance on financial routes | open | 2026-06-26 |  |
| 2 | refactor | `unchecked-todo-pr-1768` | Unchecked TODO checklist after merge — messaging camelCase wire contract (BIT-239) | open | 2026-06-26 |  |
| 2 | refactor | `unchecked-todo-pr-1844` | Unchecked TODO checklist after merge — Epic 6 6-5 direct-messaging reconcile | open | 2026-06-26 |  |
...
| 1 | bug | `bug-ios-deeplink-info-plist-missing` | iOS deep-link layer dead at runtime — Info.plist missing CFBundleURLTypes + applinks entitlement | open | 2026-06-26 |  |
| 1 | bug | `bug-risky-churn-pr-963-api-main-rs` | Risky churn: api-server main.rs security-headers wiring shipped without a middleware smoke test | open | 2026-06-26 |  |
...
| 1 | triage | `closed-not-merged-pr-1505` | PR #1505 closed without merge — fix(db): cast rental enum columns to text across rental.rs queries (PAP-158) | open | 2026-06-26 |  |
| 1 | triage | `closed-not-merged-pr-1506` | PR #1506 closed without merge — fix(api-server): seed_membership role in booking-oauth non-manager test | open | 2026-06-26 |  |
| 1 | triage | `closed-not-merged-pr-1511` | PR #1511 closed without merge — fix(api-server): resolve clippy lints blocking dev fmt-clippy gate (accounting routes) | open | 2026-06-26 |  |
| 1 | triage | `closed-not-merged-pr-1634` | PR #1634 closed without merge — [PM #1627] saved-search alerts list: signal truncation past LIMIT 100 | open | 2026-06-26 |  |
| 1 | triage | `closed-not-merged-pr-1636` | PR #1636 closed without merge — fix(reality-server): reconcile portal import authz + dedup principal extractor | open | 2026-06-26 |  |
| 1 | triage | `closed-not-merged-pr-1647` | PR #1647 closed without merge — feat(iot): sensor register + edit + standalone list [BIT-147] | open | 2026-06-26 |  |
| 1 | triage | `closed-not-merged-pr-1698` | PR #1698 closed without merge — feat(epic-3): story 3.2 - unit management UI (BIT-188) | open | 2026-06-26 |  |
| 1 | triage | `closed-not-merged-pr-1720` | PR #1720 closed without merge — fix(ppt-web): add Leases nav link + home tile (#977) | open | 2026-06-26 |  |
| 1 | triage | `closed-not-merged-pr-1727` | PR #1727 closed without merge — fix(ci): unblock backend gate — organizations fmt + notification_event RLS baseline | open | 2026-06-26 |  |
| 1 | triage | `closed-not-merged-pr-1749` | PR #1749 closed without merge — fix(mobile): exclude app.config.icon.test.ts from tsc typecheck — unblock dev frontend CI | open | 2026-06-26 |  |
...
| 1 | bug | `code-review-mobile-native-kmp-deeplink-token-not-url-decoded` | DeepLinkRouter skips URL-decoding while Android Uri.getQueryParameter decodes — SSO tokens diverge per platform | open | 2026-06-26 |  |
| 1 | bug | `code-review-mobile-native-kmp-search-stale-response-race` | SearchScreen stale-response race — overlapping searches can clobber newer results | open | 2026-06-26 |  |
| 1 | refactor | `code-review-ppt-web-core-rentals-hardcoded-strings` | rentals.tsx: hardcoded 'Booking not found' string not in t() — i18n gap (no useTranslation import) | open | 2026-06-26 |  |
...
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new regression test | open | 2026-06-26 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1288-webhook-rls` | Webhook handlers RLS migration (PR #1288, PAP-170) shipped without a new regression test for repo-layer methods | open | 2026-06-26 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression test for the public-connection routing | open | 2026-06-26 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixed in PR #1287 | open | 2026-06-26 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-959-reality-listings-pagination` | Reality-server listings pagination clamp (PR #959) shipped without a regression test for limit=-1 | open | 2026-06-26 |  |
| 1 | test-gap | `test-gap-screen-map-drift-pr-1085-reality` | Screen-map drift: PR #1085 modified reality-web listing detail metadata + page without screen-doc update | open | 2026-06-26 |  |
| 1 | test-gap | `test-gap-screen-map-drift-pr-1100-ppt` | Screen-map drift: PR #1100 modified ppt-web App.tsx (FileDisputePageRoute extraction) without screen-doc update | open | 2026-06-26 |  |
...
| 0 | refactor | `churn-hotspot-backend-crates-db-src-repositories-reality-portal-rs` | Churn hotspot: backend/crates/db/src/repositories/reality_portal.rs (+59/−28 in PR #1297 PAP-142 IDOR scoping) | dropped | 2026-06-26 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-api-ecosystem-rs` | Churn hotspot: backend/servers/api-server/src/routes/api_ecosystem.rs (+106/−27 in PR #1293 PAP-171; second touch in 24h) | dropped | 2026-06-26 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-iot-rs` | Churn hotspot: backend/servers/api-server/src/routes/iot.rs (+278/-403 in PR #1321/#1322 PAP-151 re-land + fmt) | dropped | 2026-06-26 |  |
| 0 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-vendors-rs` | Churn hotspot: 929 lines changed in backend/servers/api-server/src/routes/vendors.rs (window 2026-06 | dropped | 2026-06-26 |  |
| 0 | refactor | `churn-hotspot-mobile-native-listing-detail-kt` | Churn hotspot: ListingDetailScreen.kt — +1279 LOC this run (gap-82-4 reality mobile favorite toggle) | dropped | 2026-06-26 |  |
| 0 | refactor | `churn-hotspot-mobile-native-search-screen-kt` | Churn hotspot: SearchScreen.kt — +1293 LOC this run (gap-82-3 reality mobile search/filters) | dropped | 2026-06-26 |  |
| 0 | dx | `closed-not-merged-pr-1274` | PR #1274 (cargo-minor-patch group, /backend, 9 updates) closed unmerged — superseded by #1313 after auto-rebase fix landed | dropped | 2026-06-26 |  |
| 0 | refactor | `code-review-mobile-native-kmp-deeplink-android-bypasses-shared-router` | MainActivity reimplements deep-link dispatch instead of calling shared DeepLinkRouter — drift trap | dropped | 2026-06-26 |  |
| 0 | refactor | `refactor-churn-hotspot-mobile-documents` | Churn hotspot: DocumentsScreen.tsx — 3 PRs this run | dropped | 2026-06-26 |  |
| 0 | triage | `triage-dispatcher-mcp-push-large-file-issue-1014` | Dispatcher action-list.json corruption when MCP push falls back from blocked git push | dropped | 2026-06-26 |  |
| 0 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despite metric=53 | dropped | 2026-06-26 |  |
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected by deploy-server (staging/prod) | dropped | 2026-06-26 |  |

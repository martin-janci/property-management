# Backlog of vectors
<sub>Last regenerated: 2026-07-06 04:15 UTC by routine</sub>
...
| 2 | bug | `bug-ppt-web-core-auth-env-var-mismatch` | AuthContext reads VITE_API_BASE_URL (undeclared); rest of app uses VITE_API_URL | open | 2026-07-06 |  |
| 2 | bug | `bug-ppt-web-core-perf-visibility-listener-leak` | usePerformanceMetrics leaks visibilitychange listener per re-mount | open | 2026-07-06 |  |
...
| 1 | refactor | `refactor-churn-hotspot-backend-crates-db-src-repositories-rental-bookings-rs` | Churn hotspot: backend/crates/db/src/repositories/rental/bookings.rs (527 lines this run) | open | 2026-07-06 |  |
| 1 | refactor | `refactor-churn-hotspot-backend-crates-db-src-repositories-rental-oauth-rs` | Churn hotspot: backend/crates/db/src/repositories/rental/oauth.rs (594 lines this run) | open | 2026-07-06 |  |

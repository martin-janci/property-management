...
| 2 | bug | `code-review-ppt-web-ui-facilities-hardcoded-manager` | ppt-web FacilitiesPage useIsManager() hardcoded to return true — Create/Edit UI shown to residents | open | 2026-08-23 |  |
| 2 | bug | `code-review-ppt-web-ui-bookfacility-hardcoded-english` | ppt-web BookFacilityPage error/fallback strings hardcoded English — sk/cs/de/pl/hu see raw en on fai | open | 2026-08-23 |  |
...
| 1 | bug | `code-review-ppt-web-ui-moderation-overdue-todo` | ppt-web ContentModerationPage 'Show overdue' button silently filters by status=pending (no overdue p | open | 2026-08-23 |  |
| 1 | refactor | `churn-hotspot-quiet-hours-drain-rs-2026-08-23` | quiet_hours_drain.rs repeated changes across PRs #2826 + #2834 — held-notification drain instability | open | 2026-08-23 |  |
| 1 | refactor | `churn-hotspot-aml-dashboard-page-tsx-2026-08-23` | AmlDashboardPage.tsx repeated changes across PRs #2829 + #2833 — AML dialog flow instability | open | 2026-08-23 |  |
| 1 | refactor | `churn-hotspot-review-assessment-dialog-tsx-2026-08-23` | ReviewAssessmentDialog.tsx new component churning during AML dashboard rework (153 lines this run) | open | 2026-08-23 |  |

...
| 2 | Portal webhook fail-closed fix (PR #874) shipped without a regression test for unverified-signature rejection | test-gap | PR #874 | 2026-06-01 | open |
| 2 | Mobile dev-review batch (PR #918, 5 files under frontend/apps/mobile/src) shipped without a regression test | test-gap | PR #918 | 2026-06-01 | open |
...
| 1 | Issue #920 (no labels, OPEN): Announcement targeting not enforced on read (intra-org disclosure) | triage | #920 | 2026-06-01 | open |

# Backlog of vectors
<sub>Last regenerated: 2026-06-21 10:13 UTC by routine</sub>
...
| 3 | bug | `bug-merged-pr-broke-dev-ci-pr-1625-issue-1645` | Issue #1645 (OPEN bug, 2026-06-21 10:12Z): dev backend CI red since #1625 (votin | open | 2026-06-21 |  |
...
| 2 | test-gap | `test-gap-hotfix-no-test-pr-1639-airbnb-manager-gate` | PR #1639 'fix(api-server): manager-gate Airbnb linked-listing config reads (clos | open | 2026-06-21 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-reality-portal-rs` | Churn hotspot: backend/crates/db/src/repositories/reality_portal.rs (+59/−28 in PR #1297 PAP-142 IDOR scoping) | open | 2026-06-21 |  |
| 1 | refactor | `churn-hotspot-backend-servers-reality-server-tests-imports_idor_tests-rs` | Churn hotspot: backend/servers/reality-server/tests/imports_idor_tests.rs — 3 co | open | 2026-06-21 |  |
| 1 | refactor | `churn-hotspot-frontend-packages-api-client-src-financial-api-ts` | Churn hotspot: frontend/packages/api-client/src/financial/api.ts — 3 commits thi | open | 2026-06-21 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-tests-search_alert_delivery_tests-rs` | Churn hotspot: backend/crates/db/tests/search_alert_delivery_tests.rs — 2 commit | open | 2026-06-21 |  |
| 1 | refactor | `churn-hotspot-backend-servers-reality-server-src-routes-saved_searches-rs` | Churn hotspot: backend/servers/reality-server/src/routes/saved_searches.rs — 2 c | open | 2026-06-21 |  |
| 1 | refactor | `repeated-churn-backend-crates-db-src-repositories-reality-portal-rs` | reality_portal.rs repeated-churn — runs_seen=2 across 2026-06-12 + 2026-06-21 wi | open | 2026-06-21 |  |
| 1 | dx | `closed-not-merged-pr-1636` | PR #1636 'fix(reality-server): reconcile portal import authz + dedup principal e | open | 2026-06-21 |  |
| 1 | dx | `closed-not-merged-pr-1511` | PR #1511 'fix(api-server): resolve clippy lints blocking dev fmt-clippy gate (ac | open | 2026-06-21 |  |
| 1 | dx | `closed-not-merged-pr-1505` | PR #1505 'fix(db): cast rental enum columns to text across rental.rs queries (PA | open | 2026-06-21 |  |
| 1 | dx | `closed-not-merged-pr-1493` | PR #1493 'fix(db): repair dev backend test failures from schema drift + remove b | open | 2026-06-21 |  |
| 1 | test-gap | `screen-map-seed-gap-ppt-accounting-financial` | PR #1621 added /accounting/payment-matching route in ppt-web; PR #1630 wired /ac | open | 2026-06-21 |  |
...
| 0 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despite metric=5 | dropped | 2026-06-21 |  |
...
| 0 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected | dropped | 2026-06-21 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-06-25 04:24 UTC by routine</sub>
...
| 3 | refactor | `revert-pr-1713` | Revert PR #1713 → #1690 — delegations frontend retired (BIT-213); reconcile screen-map/sitemap drift | done | 2026-06-25 |  |
...
| 1 | bug | `code-review-mobile-native-kmp-deeplink-token-not-url-decoded` | DeepLinkRouter skips URL-decoding while Android Uri.getQueryParameter decodes — SSO tokens diverge per platfor | open | 2026-06-25 |  |
...
| 1 | test-gap | `test-gap-screen-map-drift-pr-1100-ppt` | Screen-map drift: PR #1100 modified ppt-web App.tsx (FileDisputePageRoute extraction) without screen-doc updat | open | 2026-06-25 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-document-rs` | Churn hotspot: 2940 lines changed in backend/crates/db/src/repositories/document.rs (window 2026-06-10 03:05Z→ | done | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-subscription-rs` | Churn hotspot: 2856 lines changed in backend/crates/db/src/repositories/subscription.rs (window 2026-06-10 03: | done | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-aml-dsa-rs` | Churn hotspot: 2691 lines changed in backend/servers/api-server/src/routes/aml_dsa.rs (window 2026-06-10 03:05 | done | 2026-06-25 |  |
| 1 | triage | `triage-issue-1151` | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despit | done | 2026-06-25 |  |
| 1 | triage | `triage-issue-951` | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET no | done | 2026-06-25 |  |
...
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1288-webhook-rls` | Webhook handlers RLS migration (PR #1288, PAP-170) shipped without a new regression test for repo-layer method | open | 2026-06-25 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1287-rls-llm-sessions` | AI llm/sessions + integrations sync + subscriptions RLS migration (PR #1287, PAP-169) shipped without a new re | open | 2026-06-25 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1289-api-ecosystem` | api_ecosystem.rs RLS migration (PR #1289, PAP-167) — 162-line handler rework shipped without a regression test | open | 2026-06-25 |  |
| 1 | test-gap | `test-gap-hotfix-no-test-pr-1292-mfa-rls` | mfa.rs RLS migration (PR #1292, PAP-168) shipped without a regression test; also landed broken and was hotfixe | open | 2026-06-25 |  |
| 1 | dx | `closed-not-merged-pr-1274` | PR #1274 (cargo-minor-patch group, /backend, 9 updates) closed unmerged — superseded by #1313 after auto-rebas | done | 2026-06-25 |  |
...
| 1 | triage | `triage-issue-1331` | Issue #1331 (no labels, OPEN): Backend `test` job red/hanging on dev base — blocks the entire backend merge pi | done | 2026-06-25 |  |
| 1 | dx | `dx-stalled-review-pr-988` | Stalled review: PR #988 (Epic: reusable Playwright E2E framework + sitemap FlowRunner) open 10d, no reviewDeci | done | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-backend-servers-api-server-src-routes-forms-rs` | Churn hotspot: backend/servers/api-server/src/routes/forms.rs touched 2x since 2026-06-12 (window 2026-06-12→2 | done | 2026-06-25 |  |
| 1 | triage | `triage-issue-1380` | Issue #1380 (no labels, OPEN): Dispatcher stale gap-scan buffer + Tier-2 escalation endpoint misconfigured | done | 2026-06-25 |  |
...
| 1 | dx | `closed-not-merged-pr-1425` | PR #1425 (GH #1377 document presigned-URL tests) closed unmerged — superseded by merged #1394 | done | 2026-06-25 |  |
| 1 | dx | `dx-stalled-review-pr-1179` | PR #1179 (docs(epics) catalog backfill for 37 mounted-but-undocumented backend modules) — stalled at 7d, no re | done | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-ppt-web-src-routes-lazyroutes-tsx` | Churn hotspot: frontend/apps/ppt-web/src/routes/lazyRoutes.tsx — touched 13× in 9d (lazy-route registrations f | open | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-ppt-web-messages-sk-json` | Churn hotspot: frontend/apps/ppt-web/messages/sk.json — touched 12× in 9d (i18n keys for new features) | open | 2026-06-25 |  |
| 1 | refactor | `churn-hotspot-frontend-apps-ppt-web-messages-en-json` | Churn hotspot: frontend/apps/ppt-web/messages/en.json — touched 12× in 9d (i18n keys for new features) | open | 2026-06-25 |  |
| 1 | refactor | `code-review-ppt-web-core-performance-metrics-console-log` | usePerformanceMetrics.ts:179-189 logs LCP/FID/CLS/TTFB/FCP via console.log — ships to production browsers | open | 2026-06-25 |  |
| 1 | triage | `untriaged-issue-1828` | Issue #1828 (no labels, OPEN): Follow-up: accounting-web signup a11y + login li | open | 2026-06-25 |  |
| 1 | triage | `untriaged-issue-1827` | Issue #1827 (no labels, OPEN): Follow-up: 404 mapping left half-done in confirm | open | 2026-06-25 |  |
| 1 | triage | `untriaged-issue-1826` | Issue #1826 (no labels, OPEN): Follow-up: reality-web auth-callback "e2e" cover | open | 2026-06-25 |  |
| 1 | triage | `untriaged-issue-1793` | Issue #1793 (no labels, OPEN): Follow-up: fault notifications — two transitions | open | 2026-06-25 |  |
| 1 | triage | `untriaged-issue-1792` | Issue #1792 (no labels, OPEN): Follow-up: event bus retry — blocking per-subscr | open | 2026-06-25 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-tests-form-rls-repo-tests-rs` | Churn hotspot: backend/crates/db/tests/form_rls_repo_tests.rs touched 2x since 2026-06-12 (window 2026-06-12→2 | open | 2026-06-13 |  |
...
| 0 | dx | `lag-warning-2026-06-25` | Routine lag: 9d gap (2026-06-16 → 2026-06-25) — cloud cron likely paused while dispatcher continued | open | 2026-06-25 |  |

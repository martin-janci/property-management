# Backlog of vectors
<sub>Last regenerated: 2026-07-14 16:20 UTC by routine</sub>
...
| 3 | security | `security-news-articles-idor-2026-07-14` | Cross-tenant IDOR + data-loss in news_articles handlers (raw pool, no org scope, RLS not FORCEd) | open | 2026-07-14 |  |
...
| 1 | refactor | `refactor-churn-hotspot-backend-servers-api-server-src-routes-reports-rs-2026-07-14` | Churn hotspot: backend/servers/api-server/src/routes/reports.rs — 3,275 lines this run (report_schedules cadence work) | open | 2026-07-14 |  |
| 1 | refactor | `refactor-churn-hotspot-backend-crates-integrations-src-booking-mod-rs-2026-07-14` | Churn hotspot: backend/crates/integrations/src/booking/mod.rs — 3,049 lines this run (Booking.com fetch_property seam + tests) | open | 2026-07-14 |  |

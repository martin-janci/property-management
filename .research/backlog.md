...
| 3 | bug | `bug-revert-pr-1713` | Revert PR #1713 — delegation frontend stays retired (no code-fix follow-up needed) | open | 2026-06-26 |  |
...
| 2 | bug | `bug-ios-searchview-uncompilable` | iOS SearchView.swift does not compile — performSearch/scheduleSearch undefined, resultsGrid corrupted | ready | 2026-06-11 | [plan](plans/bug-ios-searchview-uncompilable.md) |
...
| 2 | security | `security-llm-doc-idor` | IDOR: ai.rs LLM-doc handlers publish/list/get any tenant's listing descriptions & photo enhancements unscoped | ready | 2026-06-01 | [plan](plans/security-llm-doc-idor.md) |
...
| 1 | refactor | `churn-hotspot-docs-screens-ppt-announcements-md` | docs/screens/ppt/announcements.md churn — 5 changes / 10d (epic-6 reconcile activity) | open | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-docs-screens-ppt-messages-md` | docs/screens/ppt/messages.md churn — 3 changes / 10d | open | 2026-06-26 |  |
| 1 | refactor | `churn-hotspot-backend-servers-reality-server-src-services-saved-search-alerts-rs` | reality-server saved_search_alerts.rs churn — 3 changes / 10d (epic-16 in-flight) | open | 2026-06-26 |  |

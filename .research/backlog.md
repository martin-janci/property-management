...
| 2 | bug | `code-review-api-handlers-reports-unwrap-or-default-silent-zero` | reports/mod.rs — 4 report handlers use .unwrap_or_default() on secondary DB queries; serve HTTP 200  | open | 2026-08-08 |  |
...
| 1 | refactor | `churn-hotspot-backend/servers/api-server/src/routes/layout/admin.rs` | layout/admin.rs churn hotspot — 330 lines dedupe'd across 10 handlers (PR #2713) | open | 2026-08-08 |  |
| 1 | security | `churn-hotspot-backend/servers/api-server/src/services/actions/api_call.rs` | api_call.rs churn hotspot — 139 lines closing memory-DoS + upcoming DNS-rebinding (PR #2707, #2710) | open | 2026-08-08 |  |
| 1 | dx | `closed-not-merged-pr-2705` | Closed unmerged: retry2 bump dtolnay/rust-toolchain 1.94.1 → 1.100.0 (PR #2705) | open | 2026-08-08 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-07-31 12:29 UTC by routine</sub>
...
| 3 | security | `code-review-reality-server-ssrf-ipv4-mapped-ipv6` | SSRF bypass: reality-server url_validator accepts IPv4-mapped IPv6 (::ffff:127.0.0.1) | ready | 2026-07-31 | [plan](plans/code-review-reality-server-ssrf-ipv4-mapped-ipv6.md) |
...
| 3 | security | `code-review-mobile-native-kmp-android-sso-deeplink-missing-csrf-state` | SECURITY: Android SSO deep-link handler skips CSRF state check — reality://sso?token=... enables account takeover | done | 2026-07-27 | [plan](plans/_archive/code-review-mobile-native-kmp-android-sso-deeplink-missing-csrf-state.md) |
| 3 | security | `code-review-api-handlers-community-cross-tenant-idor` | SECURITY: community.rs 5 write handlers (create_post/add_reaction/create_comment/rsvp_event/create_inquiry) accept cross-tenant IDs | done | 2026-07-23 | [plan](plans/_archive/code-review-api-handlers-community-cross-tenant-idor.md) |
...
| 3 | bug | `code-review-mobile-rn-report-fault-fake-submit` | ReportFaultScreen.tsx handleSubmit() fakes API call with setTimeout(1500) — fault reports never reach backend (App.tsx:126 wires this) | dropped | 2026-06-16 | [plan](plans/_archive/code-review-mobile-rn-report-fault-fake-submit.md) |
...
| 3 | bug | `code-review-reality-web-share-comparison-404` | Reality-web ComparisonUrlHandler hits non-existent /api/listings/${id} — every shared comparison URL 404s | dropped | 2026-06-14 | [plan](plans/_archive/code-review-reality-web-share-comparison-404.md) |
| 3 | bug | `bug-ios-searchview-uncompilable` | iOS SearchView.swift does not compile — performSearch/scheduleSearch undefined, resultsGrid corrupted | dropped | 2026-06-11 | [plan](plans/_archive/bug-ios-searchview-uncompilable.md) |
...
| 3 | security | `security-llm-doc-idor` | IDOR: ai.rs LLM-doc handlers publish/list/get any tenant's listing descriptions & photo enhancements unscoped | dropped | 2026-06-01 | [plan](plans/_archive/security-llm-doc-idor.md) |
...
| 2 | bug | `code-review-reality-server-ss-alert-watermark-swallow` | saved-search alert worker swallows mark_saved_search_matched Err — duplicate alert emails on transient DB failure | open | 2026-07-31 |  |
| 2 | bug | `code-review-reality-server-agent-review-body-unbounded` | public /agent_reviews create_review takes user body with no length/trim/non-empty check | open | 2026-07-31 |  |
| 2 | bug | `code-review-reality-server-redirect-backslash-bypass` | SSO check_redirect_uri_allowed permits backslash-prefixed open-redirect (/\evil.com) | open | 2026-07-31 |  |
...
| 1 | refactor | `refactor-churn-hotspot-admin-web-mobileconfigpage-tsx-2026-07-31` | Churn hotspot: frontend/apps/admin-web/src/pages/MobileConfigPage.tsx — 365 lines this window (PR #2601) | open | 2026-07-31 |  |
| 1 | refactor | `refactor-churn-hotspot-api-server-voice-webhooks-rs-2026-07-31` | Churn hotspot: backend/servers/api-server/src/routes/voice_webhooks.rs — 472 lines this window (PR #2604) | open | 2026-07-31 |  |
| 1 | bug | `code-review-api-core-push-fanout-reqwest-expect` | push_fanout FCM/APNs client builder calls .expect() on Result<Client, _> — panics on TLS init failure | open | 2026-07-31 |  |
| 1 | refactor | `refactor-churn-hotspot-api-server-scheduler-2026-07-30` | Churn hotspot: backend/servers/api-server/src/services/scheduler.rs — 347 lines this window (PRs #2567, #2576) | done | 2026-07-31 |  |

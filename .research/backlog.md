# Backlog of vectors
<sub>Last regenerated: 2026-07-04 08:16 UTC by routine</sub>
...
| 2 | refactor | `churn-hotspot-backend-servers-api-server-tests-oauth-integration-tests-rs` | oauth_integration_tests.rs churn hotspot — 2719 lines (runs_seen=3, sustained instability proxy) | open | 2026-07-04 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-rental-rs` | rental.rs churn hotspot — 2941 lines this run (post 16-day gap: PRs #1973 manager-gate + #2042 u.name schema d | open | 2026-07-04 |  |
| 1 | refactor | `churn-hotspot-backend-crates-integrations-src-booking-mod-rs` | booking/mod.rs churn hotspot — 2818 lines this run (Booking.com integration + XXE/dual-auth work) | open | 2026-07-04 |  |
| 1 | dx | `dx-stalled-review-pr-1797` | PR #1797 (fix(api-server): auth on OCR endpoints + manager-gate rental guest PII reads) — draft 10d, no review | open | 2026-07-04 |  |
| 1 | dx | `dx-stalled-review-pr-1812` | PR #1812 (churn-hotspot: split reality_portal.rs) — draft 10d, no reviewDecision | open | 2026-07-04 |  |

# Backlog of vectors
<sub>Last regenerated: 2026-06-21 08:30 UTC by routine</sub>
...
| 2 | security | `security-airbnb-listings-readable-by-residents` | IDOR (low): Airbnb linked-listing list is readable by any active org member incl. residents (#1626 / PR #1615) | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1545-reality` | Screen-map drift: PR #1545 (reality-web /accounting production-build unbreak) touched route file without scree | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1555-ppt` | Screen-map drift: PR #1555 (gap-79-1 faults wiring) touched routes/groups/faults.tsx + test without screen-doc | open | 2026-06-21 |  |
| 2 | test-gap | `screen-map-drift-pr-1621-ppt` | Screen-map drift: PR #1621 (payment-matching relocate to ppt-web) touched routes/groups/accounting.tsx + reali | open | 2026-06-21 |  |
...
| 1 | triage | `triage-issue-1380` | Issue #1380 (no labels, OPEN): Dispatcher stale gap-scan buffer + Tier-2 escalation endpoint misconfigured | done | 2026-06-21 |  |
...
| 1 | refactor | `churn-hotspot-backend-crates-db-src-repositories-rental-rs` | Churn hotspot: rental.rs +2837 lines this run (enum cast cascade + booking NULL-fee write path) | open | 2026-06-21 |  |
| 1 | triage | `triage-issue-1538` | Issue #1538 (ci label, OPEN): Backend `test` job is not a required check on `dev` — red-test PRs merge freely  | open | 2026-06-21 |  |
| 1 | triage | `triage-issue-1604` | Issue #1604 (needs-human-review, OPEN): Dispatcher backlog exhausted — coverage.json (2026-06-16) stale, produ | open | 2026-06-21 |  |
| 1 | triage | `triage-issue-1607` | Issue #1607 (research-routine, OPEN): Research dispatcher stalled — stale coverage.json + 14 quarantined rows  | open | 2026-06-21 |  |
| 1 | bug | `bug-saved-search-alerts-truncation` | Saved-search alerts list silently truncates at LIMIT 100 with no pagination (#1627 / PR #1622) | open | 2026-06-21 |  |

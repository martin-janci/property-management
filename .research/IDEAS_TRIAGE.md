...
|-------|-------|--------|---------|--------|
| 1 | issue #1520 created without label: wire preference-aware push dispatch-target se | issue #1520 | 2026-06-18 | open |
| 1 | issue #1521 created without label: payment-matching UI shipped in wrong app, wit | issue #1521 | 2026-06-18 | open |
| 1 | issue #1522 created without label: accounting UI bypasses shared API auth interc | issue #1522 | 2026-06-18 | open |
| 1 | issue #1532 created without label: wire useFolderTree / FOLDER_TREE_QUERY_KEY in | issue #1532 | 2026-06-18 | open |
| 1 | issue #1533 created without label: nextPageTriggerFlow in-flight race + missing  | issue #1533 | 2026-06-18 | open |
| 1 | issue #1538 created without label: Backend test job not required check on dev —  | issue #1538 | 2026-06-18 | open |
...
| 1 | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despite metric=5 | #1151 | 2026-06-07 | open |
...
| 1 | Issue #859 (no labels, OPEN): sqlx 0.9 breaks runtime decode of Postgres enum columns into Rust String (SELECT * reads 5 | #859, PR #871 | 2026-06-01 | done |
...
| 0 | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected | #951 | 2026-06-18 | dropped |

...
|-------|-------|--------|---------|--------|
| 1 | PR #1647 (IoT sensor register+edit, BIT-147) closed unmerged — superseded by #1646/#1653 | PR #1647 | 2026-06-22 | open |
| 1 | PR #1636 (reality-server portal-import authz dedup) closed unmerged — superseded by #1297 + #1603/#1 | PR #1636 | 2026-06-22 | open |
...
| 0 | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work  | #1151 | 2026-06-22 | dropped |
| 0 | Dispatcher action-list.json corruption when MCP push falls back from blocked git push | #1014 | 2026-06-22 | dropped |
| 0 | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK | #951 | 2026-06-22 | dropped |

...
|-------|-------|--------|---------|--------|
| 1 | Issue #1538 (OPEN, ci): Backend test job is not a required check on dev — red-test PRs merge freely | #1538 | 2026-06-20 | open |
| 1 | Issue #1521 (OPEN, follow-up): payment-matching UI in wrong app + broken auth + no i18n/tests | #1521, PR #1453 | 2026-06-20 | open |
| 1 | Issue #1604 (OPEN): Dispatcher backlog exhausted — coverage.json stale (2026-06-16) | #1604 | 2026-06-20 | open |
| 1 | Issue #1607 (OPEN, research-routine): Research dispatcher stalled — stale coverage + 14 quarantined  | #1607 | 2026-06-20 | open |
| 1 | Issue #1584 (OPEN, follow-up): PortalPrincipal bypasses reality_agency_members on agency_id=user_id  | #1584, PR #1561 | 2026-06-20 | open |
...
| 0 | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK | #951 | 2026-06-03 | dropped |

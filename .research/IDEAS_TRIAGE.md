...
|-------|-------|--------|---------|--------|
| 1 | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work  | #1151 | 2026-06-20 | done |
| 1 | Issue #1331 (no labels, OPEN): Backend `test` job red/hanging on dev base — blocks the entire backen | #1331 | 2026-06-20 | done |
| 1 | Issue #1604 (label: needs-human-review): Dispatcher backlog exhausted — coverage.json stale, produci | Issue #1604 (label: needs-human-review) | 2026-06-20 | open |
| 1 | Issue #1607 (label: research-routine): Research dispatcher stalled — stale coverage.json + 14 quaran | Issue #1607 (label: research-routine) | 2026-06-20 | open |
...
| 0 | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK | #951 | 2026-06-20 | dropped |

...
|-------|-------|--------|---------|--------|
| 1 | Issue #1331 (no labels, OPEN): Backend `test` job red/hanging on dev base — blocks the entire backen | #1331 | 2026-06-21 | done |
| 1 | Issue #1380 (no labels, OPEN): Dispatcher stale gap-scan buffer + Tier-2 escalation endpoint misconf | issue #1380, #1380 | 2026-06-21 | done |
| 1 | Issue #1538 (ci label, OPEN): Backend `test` job is not a required check on `dev` — red-test PRs mer | issue #1538 | 2026-06-21 | open |
| 1 | Issue #1604 (needs-human-review, OPEN): Dispatcher backlog exhausted — coverage.json (2026-06-16) st | issue #1604 | 2026-06-21 | open |
| 1 | Issue #1607 (research-routine, OPEN): Research dispatcher stalled — stale coverage.json + 14 quarant | issue #1607 | 2026-06-21 | open |
...
| 0 | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work  | #1151 | 2026-06-21 | dropped |
| 0 | Dispatcher action-list.json corruption when MCP push falls back from blocked git push | #1014 | 2026-06-21 | dropped |
| 0 | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK | #951 | 2026-06-21 | dropped |

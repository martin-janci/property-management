...
|-------|-------|--------|---------|--------|
| 1 | PR #1634 closed without merging | PR #1634 | 2026-06-25 | open |
| 1 | PR #1698 closed without merging | PR #1698 | 2026-06-25 | open |
| 1 | PR #1720 closed without merging | PR #1720 | 2026-06-25 | open |
| 1 | PR #1727 closed without merging | PR #1727 | 2026-06-25 | open |
| 1 | PR #1749 closed without merging | PR #1749 | 2026-06-25 | open |
| 1 | Research dispatcher: cron environment can&#39;t run core pipeline (fire-and-forget implementers die, no DB, git-push + archive-pus | issue #1680 | 2026-06-25 | open |
...
| 1 | Follow-up: persisted rental booking/guest PII reads (list_bookings/get_booking/get_booking_with_guests/get_guest) not manager-gate | issue #1766 | 2026-06-25 | open |
...
| 1 | Follow-up: Booking.com listing-push — currency validation is structural-only, duplicates existing SupportedCurrency allowlist (PR  | issue #1788 | 2026-06-25 | open |
| 1 | Follow-up: N-party conversations — tests assert snake_case against camelCase wire; start_thread response still 2-party-shaped (PR  | issue #1789 | 2026-06-25 | open |
...
| 1 | Issue #950 (no labels, OPEN): CI: trigger-deploy 403 marks all dev image builds red and blocks staging auto-deploy | #950, PR #1143 | 2026-06-07 | done |
| 1 | Issue #952 (no labels, OPEN): [staging] Reality SSO login dead-ends: redirect_uri callback 404s on reality apex | #952, PR #1144 | 2026-06-07 | done |
...
| 0 | Dispatcher action-list.json corruption when MCP push falls back from blocked git push | #1014 | 2026-06-25 | dropped |
| 0 | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despite metric=53 | #1151 | 2026-06-25 | dropped |
| 0 | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected by deploy | #951 | 2026-06-25 | dropped |

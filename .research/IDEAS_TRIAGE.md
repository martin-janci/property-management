...
|-------|-------|--------|---------|--------|
| 1 | Closed-not-merged PR #1749: fix(mobile): exclude app.config.icon.test.ts from  | PR #1749 | 2026-06-23 | open |
| 1 | Closed-not-merged PR #1727: fix(ci): unblock backend gate — organizations fmt  | PR #1727 | 2026-06-23 | open |
| 1 | Closed-not-merged PR #1698: feat(epic-3): story 3.2 - unit management UI (BIT- | PR #1698 | 2026-06-23 | open |
...
| 0 | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despit | #1151 | 2026-06-23 | dropped |
| 0 | Dispatcher action-list.json corruption when MCP push falls back from blocked git push | #1014 | 2026-06-23 | dropped |
| 0 | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET no | #951 | 2026-06-23 | dropped |

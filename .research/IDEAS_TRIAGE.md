...
| 1 | PR #1505 closed without merge — fix(db): cast rental enum columns to text across rental.rs queries (PAP-158) | PR #1505 | 2026-06-26 | open |
| 1 | PR #1506 closed without merge — fix(api-server): seed_membership role in booking-oauth non-manager test | PR #1506 | 2026-06-26 | open |
| 1 | PR #1511 closed without merge — fix(api-server): resolve clippy lints blocking dev fmt-clippy gate (accounting routes) | PR #1511 | 2026-06-26 | open |
| 1 | PR #1634 closed without merge — [PM #1627] saved-search alerts list: signal truncation past LIMIT 100 | PR #1634 | 2026-06-26 | open |
| 1 | PR #1636 closed without merge — fix(reality-server): reconcile portal import authz + dedup principal extractor | PR #1636 | 2026-06-26 | open |
| 1 | PR #1647 closed without merge — feat(iot): sensor register + edit + standalone list [BIT-147] | PR #1647 | 2026-06-26 | open |
| 1 | PR #1698 closed without merge — feat(epic-3): story 3.2 - unit management UI (BIT-188) | PR #1698 | 2026-06-26 | open |
| 1 | PR #1720 closed without merge — fix(ppt-web): add Leases nav link + home tile (#977) | PR #1720 | 2026-06-26 | open |
| 1 | PR #1727 closed without merge — fix(ci): unblock backend gate — organizations fmt + notification_event RLS baseline | PR #1727 | 2026-06-26 | open |
| 1 | PR #1749 closed without merge — fix(mobile): exclude app.config.icon.test.ts from tsc typecheck — unblock dev frontend CI | PR #1749 | 2026-06-26 | open |
...
| 0 | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despite metric=53 | #1151 | 2026-06-26 | dropped |
| 0 | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injected by deploy-server (staging/prod) | #951 | 2026-06-26 | dropped |

...
|-------|-------|--------|---------|--------|
| 1 | Issue #1520 (no labels, OPEN): Follow-up: wire preference-aware push dispatch-target selection to real user preference (PR #1450) | issue #1520 | 2026-06-19 | open |
| 1 | Issue #1521 (no labels, OPEN): Follow-up: payment-matching UI shipped in wrong app, with broken auth + no i18n/translations (PR #1453) | issue #1521 | 2026-06-19 | open |
| 1 | Issue #1522 (no labels, OPEN): Follow-up: accounting UI bypasses shared API auth interceptor after @hey-api migration (PR #1454) | issue #1522 | 2026-06-19 | open |
| 1 | Issue #1533 (no labels, OPEN): Follow-up: nextPageTriggerFlow in-flight race + missing multi-emission test coverage (PR #1447) | issue #1533 | 2026-06-19 | open |
| 1 | Issue #1538 (no labels, OPEN): Backend `test` job is not a required check on `dev` — red-test PRs merge freely | issue #1538 | 2026-06-19 | open |
| 1 | Issue #1584 (no labels, OPEN): Follow-up: PortalPrincipal bypasses reality_agency_members and rides on agency_id param (PR #1561) | issue #1584 | 2026-06-19 | open |
| 1 | Issue #1587 (no labels, OPEN): Follow-up: download/retry test harness diverges from real route container — error mode untested (PR #1548) | issue #1587 | 2026-06-19 | open |
| 1 | Issue #1588 (no labels, OPEN): Follow-up: harden fault delete + stats wiring on FaultsPage (PR #1555) | issue #1588 | 2026-06-19 | open |
| 1 | Issue #1589 (no labels, OPEN): Follow-up: mobile MoveFolderSheet 'Root (top level)' is a silent no-op + missing optimistic update | issue #1589 | 2026-06-19 | open |
| 1 | Issue #1590 (no labels, OPEN): Follow-up: pin-test asserts the constant, not the wiring; stale test comment (PR #1446) | issue #1590 | 2026-06-19 | open |
| 1 | Issue #1592 (no labels, OPEN): Follow-up: rustfmt `lint` job is not a blocking pre-merge gate on `dev` (PR #1581) | issue #1592 | 2026-06-19 | open |
| 1 | Issue #1593 (no labels, OPEN): Follow-up: make mark_invitation_viewed COALESCE-regression catch deterministic (PR #1564) | issue #1593 | 2026-06-19 | open |

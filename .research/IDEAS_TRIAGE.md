...
|-------|-------|--------|---------|--------|
| 1 | Follow-up issue #1904: harden migration-version collision guard — add a test + auto-discover dirs | issue #1904 | 2026-06-28 | open |
| 1 | Follow-up issue #1905: tenant-migration endpoints — duplicate migration number + import/export still | issue #1905 | 2026-06-28 | open |
| 1 | Follow-up issue #1906: regional-compliance quorum lookup is dead code + missing role checks/test gap | issue #1906 | 2026-06-28 | open |
| 1 | Follow-up issue #1851: harden PlatformAdminRepository against runtime-only SQL typos (use compile-ti | issue #1851 | 2026-06-28 | open |
| 1 | Follow-up issue #1852: favorite alert worker — use checked sqlx macros, batch per-org scans, tighten | issue #1852 | 2026-06-28 | open |
...
| 0 | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK | #951 | 2026-06-28 | dropped |

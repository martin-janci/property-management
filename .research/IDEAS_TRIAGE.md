...
| 1 | Issue #1997 (no labels): follow-up: finance test coverage overstated (from-merged-review) | issue #1997 | 2026-07-01 | open |
| 1 | Issue #1999 (no labels): follow-up: currency serialization bug (from-merged-review) | issue #1999 | 2026-07-01 | open |
| 1 | Issue #2000 (no labels): follow-up: alert drop (from-merged-review) | issue #2000 | 2026-07-01 | open |
| 0 | Dispatcher action-list.json corruption when MCP push falls back from blocked git push | #1014 | 2026-06-03 | dropped |
| 0 | Issue #951 (no labels, OPEN): Deploy blocker: api-server requires ESIGN_TOKEN_SECRET + ESIGN_WEBHOOK_SECRET not injec... | #951 | 2026-06-03 | dropped |
| 0 | Issue #1151 (no labels, OPEN): Research dispatcher: claimable buffer is stale — true claimable work = 0 despite metri... | #1151 | 2026-06-07 | dropped |
| 0 | Issue #1331 (no labels, OPEN): Backend `test` job red/hanging on dev base — blocks the entire backend merge pipeline | #1331 | 2026-06-13 | dropped |
| 0 | Issue #779 (no labels, OPEN): Current dev review: consolidated priority rollup (origin/dev snapshot) | #779 | 2026-06-13 | dropped |
| 0 | Issue #1380 (no labels, OPEN): Dispatcher stale gap-scan buffer + Tier-2 escalation endpoint misconfigured | issue #1380 | 2026-06-15 | dropped |

...
## Delivery digest — 2026-06-16 → 2026-06-24 (8 days)
...
Epic 6, 7A, 8A & 10A — Announcements, Documents, Notifications & OAuth: epics_done=1/6, stories_done=37, stories_partial=12
...
- [high] Reconcile sprint-status.yaml: flip 6-1/6-2/6-3/7a-2/7a-4/7a-5 to done where coverage.json + merged PRs agree; reset stale-review rows (pm-scrum-master)
- [high] Designate Epic ACC technical owner + merge-or-park decision on #1821; freeze further accounting-* PRs until decision lands (pm-tech-lead)
- [high] Add migration-number allocation gate (CI check or pre-commit) — block PR if migration filename collides with dev (pm-devops)
- [medium] Triage cluster #1758–#1791 + #1826–#1828 post-merge follow-ups: assign owner or close as won't-fix; cap auto-issue backlog growth (pm-qa)
- [high] Run pm-security pass on Stripe Checkout #1726 + idempotency middleware #1688 + Epic ACC payment-match #1811 before they get more callers (pm-security)

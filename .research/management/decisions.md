...
- **NEW (2026-07-05, pm-scrum-master):** Reconcile epic-level status rollups in `sprint-status.yaml` to match story-level `done` counts — epic-10b shows `in-progress` despite 7/7 done, epic-10a gated on possibly-resolved issues. Owner: pm-scrum-master (with pm-tech-lead).
- **NEW (2026-07-05, pm-scrum-master):** Disposition of stalled draft PRs #1812 (reality_portal split, 11d) and #1797 (backend-authz-ocr-and-rental-pii, 12d) — continue, reassign, or close? Owner: pm-tech-lead.
- **NEW (2026-07-05, pm-scrum-master):** Should the deferred mobile gaps (`8a-3` OS push, `82-5` inquiry thread / account UI) be formally split into new backlog stories rather than lingering as gap notes on stories already marked done? Owner: pm-scrum-master.
- **NEW (2026-07-05, pm-security):** Formally close or defer test-hardening batch items #480 and #484 now that their gated stories (8a-2, 8a-3) are already merged/done — the batch's own rule was violated. Owner: rust-backend / release manager.
- **NEW (2026-07-05, pm-security):** Prioritize `security-llm-doc-idor` fix against current sprint epics (10a OAuth, 6/7a) — plan already drafted, unclaimed. Owner: PM / tech lead.

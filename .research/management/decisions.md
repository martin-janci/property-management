...
## Decisions logged 2026-08-29 (Phase 1.6 — pm-scrum-master + pm-devops)

- **NEW (2026-08-29, pm-scrum-master):** Manually promote 84-1 + 84-2 as an implementer-pair window — dispatcher blindness confirmed (4 upkeep windows in a row: 2026-07-30 / 08-06 / 08-25 / 08-29 ranked-highest but never spawned). The 2026-08-25 "consider promoting" decision has not been acted on; formal upgrade to "promote this cycle" required. Owner: pm-frontend / pm-scrum-master.
- **NEW (2026-08-29, pm-scrum-master):** Close-vs-land call on accounting trio #2555/#2558/#2559 — 30+ days idle with `needs-human-judgement` label; 2026-07-30 reviewer-starvation risk has aged 4× without action; PRs are now bit-rotting against dev. Owner: pm-tech-lead.
- **NEW (2026-08-29, pm-devops):** Blocking-CI-on-scheduled-cargo-deny yes/no — chacha20 yank was detected only when a PR ran backend.yml (one dispatcher-run late); a scheduled 6-hourly cargo-deny --lockfile-only on dev that opens a GitHub issue on failure is proposed. Fail-fast (block push) vs warn-only (notify) is the open question. Owner: pm-tech-lead + pm-devops.
- **NEW (2026-08-29, pm-devops):** Ownership handoff for RUSTSEC advisories that lack a workspace-wide fix — temporary cargo-deny allow with hard expiry vs vendor-and-patch. RUSTSEC-2026-0258 (h2 DoS) has been open >11 days blocking every backend PR because no owner has been named. Owner: pm-security + pm-tech-lead.
- **NEW (2026-08-29, pm-scrum-master):** Emerging aml_dsa/moderation.rs hotspot — 5 of today's 6 PRs converged on this surface; same repeat-churn pattern that preceded the voice_webhooks structural-defect flag. Decide whether to draft an extraction plan now vs wait for a 3rd hotspot window. Owner: pm-tech-lead.

...
// ===========================================================================
// BIT-358 Wave 7 (documents-core): the two remaining documents endpoints that
// had no dedicated seed-based happy-path 2xx assertion — get_document, move_document.
// ===========================================================================
// ---------------------------------------------------------------------------

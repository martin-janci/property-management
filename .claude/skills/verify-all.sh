...
run "ppt-screens"         10 'test -f .claude/skills/ppt-screens/SKILL.md && [ -n "$(find docs/screens -name "*.md" -type f -not -name "_template.md" -not -name "README.md" 2>/dev/null | head -1)" ]'

...
import { TERMS_META, TERMS_SECTIONS } from './_content';
  ...
  return (
    ...
    >
      ...
      <main style={{ flex: 1, maxWidth: 800, margin: '0 auto', padding: '48px 24px' }}>
        ...
        >
          Účinné od: {TERMS_META.effective} · Naposledy aktualizované: {TERMS_META.lastUpdated}
        </p>
        ...
        >
          ...
          pred uvedením do produkcie podlieha právnemu posúdeniu.
        </p>
      </main>
      <Footer />
    </div>

...
export default function SecurityPage() {
  return (
    ...
    >
      ...
      <main style={{ flex: 1 }}>
        {/* Hero */}
        <section style={{ background: 'var(--ppt-bg-surface)', padding: '56px 24px', borderBottom: '1px solid var(--ppt-border-default, #e5e7eb)' }}>
          <div style={{ maxWidth: 800, margin: '0 auto', textAlign: 'center' }}>
            <div style={{ fontSize: '3rem', marginBottom: 16 }}>🔐</div>
            <h1 style={{ fontSize: 'clamp(1.75rem, 3vw, 2.5rem)', fontWeight: 800, color: 'var(--ppt-fg-primary)', marginBottom: 16 }}>
              Vaša bezpečnosť je naša priorita
            </h1>
            <p style={{ fontSize: '1.0625rem', color: 'var(--ppt-fg-secondary)', lineHeight: 1.7, maxWidth: 640, margin: '0 auto' }}>
        ...
        <section style={{ maxWidth: 960, margin: '0 auto', padding: '64px 24px' }}>
          <h2 style={{ fontSize: '1.5rem', fontWeight: 700, color: 'var(--ppt-fg-primary)', marginBottom: 32 }}>
            ...
            {MOCK_FRAUD_SCENARIOS.map((scenario) => (
              ...
              >
                <div style={{ display: 'flex', gap: 16, alignItems: 'flex-start' }}>
                  <span style={{ fontSize: '1.75rem', lineHeight: 1, flexShrink: 0 }}>{scenario.icon}</span>
                  <div>
                    <h3 style={{ fontSize: '1.0625rem', fontWeight: 700, color: 'var(--ppt-fg-primary)', margin: '0 0 8px' }}>
                      {scenario.title}
                    </h3>
                    <p style={{ color: 'var(--ppt-fg-secondary)', lineHeight: 1.65, margin: '0 0 12px' }}>
        ...
        <section style={{ background: 'var(--ppt-bg-subtle, #f8fafc)', padding: '64px 24px' }}>
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            <h2 style={{ fontSize: '1.5rem', fontWeight: 700, color: 'var(--ppt-fg-primary)', marginBottom: 32, textAlign: 'center' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 20 }}>
              {MOCK_GUARANTEES.map((guarantee) => (
                ...
                >
                  ...
                  <h3 style={{ fontSize: '1rem', fontWeight: 700, color: 'var(--ppt-fg-primary)', margin: '0 0 8px' }}>
                    {guarantee.title}
                  </h3>
                  <p style={{ fontSize: '0.875rem', color: 'var(--ppt-fg-secondary)', lineHeight: 1.6, margin: 0 }}>
        ...
        <section style={{ maxWidth: 960, margin: '0 auto', padding: '64px 24px', textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--ppt-fg-secondary)', marginBottom: 28, maxWidth: 560, margin: '0 auto 28px' }}>
            Nahláste ju okamžite. Náš tím to preverí do 24 hodín a ak je podozrenie opodstatnené, ponuku odstránime.
          </p>
          <Link
            href="/report"
            style={{

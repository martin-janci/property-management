 ...
 *
 * This is a deliberately small implementation that copies the focus-trap +
 * Escape pattern from DestructiveConfirmDialog so the 4 ad-hoc modals in
 * pages/{users,feature-flags,platform,MobileConfigPage} can share it. It does
 * NOT handle:

...
export const IotSensorThresholdPage = lazy(() =>
  import('../features/iot').then((m) => ({ default: m.SensorThresholdPage }))
);
export const IotSensorAlertsPage = lazy(() =>
  import('../features/iot').then((m) => ({ default: m.SensorAlertsPage }))
);

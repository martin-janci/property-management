...
|---|---|---|
| **DONE** — real handler **and** a passing happy-path test | **125** | **6.1%** |
| Partial — real handler, **no** happy-path test | 1813 | 87.9% |
...
- **Test-verified DONE = 6.1%.** This is the strict number the ticket defines: an
...
| [integrations-ecosystem](./groups/integrations-ecosystem.md) | 268 | 27 | 168 | 73 | 10.1% | 72.8% |
...
| **Total** | **2063** | **125** | **1813** | **125** | **6.1%** | **93.9%** |

...
**13.5% of backend endpoints are DONE (implemented *and* test-verified).**

| Status | Count | Share | Meaning |
|--------|------:|------:|---------|
| ✅ `done` | **274** | **13.5%** | Implemented **and** exercised by a passing test |
| 🟡 `partial` | **1642** | 80.8% | Implemented (real DB/logic) but no behaviour-asserting test |
...
| | **Total** | | **2033** | **274** | **1642** | **117** | **13.5%** |

> api-server alone: 1942 endpoints, 269 done (13.9%). reality-server: 91 endpoints, 5 done (5.5%).

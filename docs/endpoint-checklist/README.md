...
|---|---|---|
| **DONE** — real handler **and** a passing happy-path test | **138** | **6.7%** |
| Partial — real handler, **no** happy-path test | 1800 | 87.3% |
...
- **Test-verified DONE = 6.7%.** This is the strict number the ticket defines: an
...
| [integrations-ecosystem](./groups/integrations-ecosystem.md) | 268 | 40 | 155 | 73 | 14.9% | 72.8% |
...
| **Total** | **2063** | **138** | **1800** | **125** | **6.7%** | **93.9%** |

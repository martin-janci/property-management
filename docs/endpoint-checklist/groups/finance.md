...
| Method | Path | Handler | Status | Tests | Notes |
|---|---|---|---|---|---|
| POST | /api/v1/budgets/ | create_budget | done | budgets_tests.rs | happy-path: create_budget returns 201 + non-empty ID |
| GET | /api/v1/budgets/ | list_budgets | done | budgets_tests.rs | happy-path: list_budgets returns 200 + list |
| GET | /api/v1/budgets/{id} | get_budget | done | budgets_tests.rs | happy-path: get_budget returns 200 + details |
| PUT | /api/v1/budgets/{id} | update_budget | done | budgets_tests.rs | happy-path: update_budget returns 200 + updated name |
| DELETE | /api/v1/budgets/{id} | delete_budget | done | budgets_tests.rs | happy-path: delete_budget returns 204 |
| POST | /api/v1/budgets/{id}/submit | submit_budget | done | budgets_tests.rs | happy-path: submit_budget returns 200 |
| POST | /api/v1/budgets/{id}/approve | approve_budget | done | budgets_tests.rs | happy-path: approve_budget returns 200 |
| POST | /api/v1/budgets/{id}/activate | activate_budget | done | budgets_tests.rs | happy-path: activate_budget returns 200 |
| POST | /api/v1/budgets/{id}/close | close_budget | done | budgets_tests.rs | happy-path: close_budget returns 200 |
| GET | /api/v1/budgets/{id}/summary | get_budget_summary | done | budgets_tests.rs | happy-path: get_budget_summary returns 200 + summary |
| GET | /api/v1/budgets/{id}/variance | get_category_variance | done | budgets_tests.rs | happy-path: get_category_variance returns 200 + variance |
| GET | /api/v1/budgets/{id}/alerts | list_variance_alerts | done | budgets_tests.rs | happy-path: list_variance_alerts returns 200 |
| POST | /api/v1/budgets/{id}/items | add_budget_item | done | budgets_tests.rs | happy-path: add_budget_item returns 201 + details |
| GET | /api/v1/budgets/{id}/items | list_budget_items | done | budgets_tests.rs | happy-path: list_budget_items returns 200 + list |
| PUT | /api/v1/budgets/items/{item_id} | update_budget_item | done | budgets_tests.rs | happy-path: update_budget_item returns 200 + updated name |
| DELETE | /api/v1/budgets/items/{item_id} | delete_budget_item | done | budgets_tests.rs | happy-path: delete_budget_item returns 204 |
| POST | /api/v1/budgets/items/{item_id}/actuals | record_actual | done | budgets_tests.rs | happy-path: record_actual returns 201 |
| GET | /api/v1/budgets/items/{item_id}/actuals | list_actuals | done | budgets_tests.rs | happy-path: list_actuals returns 200 |
| POST | /api/v1/budgets/categories | create_category | done | budgets_tests.rs | happy-path: create_category returns 201 + category |
| GET | /api/v1/budgets/categories | list_categories | done | budgets_tests.rs | happy-path: list_categories returns 200 |
| PUT | /api/v1/budgets/categories/{id} | update_category | done | budgets_tests.rs | happy-path: update_category returns 200 |
| DELETE | /api/v1/budgets/categories/{id} | delete_category | done | budgets_tests.rs | happy-path: delete_category returns 204 |
| POST | /api/v1/budgets/alerts/{id}/acknowledge | acknowledge_alert | done | budgets_tests.rs | happy-path: acknowledge_alert returns 200 |
| GET | /api/v1/budgets/dashboard | get_dashboard | done | budgets_tests.rs | happy-path: get_dashboard returns 200 |
...
| Method | Path | Handler | Status | Tests | Notes |
|---|---|---|---|---|---|
| GET | /api/v1/accounting/invoices/ | invoices::list_invoices | done | accounting_invoices_tests.rs | happy-path: list_invoices returns 200 + list |
| POST | /api/v1/accounting/invoices/ | invoices::create_invoice | done | accounting_invoices_tests.rs | happy-path: create_invoice returns 201 + invoice |
| GET | /api/v1/accounting/invoices/{id} | invoices::get_invoice | done | accounting_invoices_tests.rs | happy-path: get_invoice returns 200 + details |
| PATCH | /api/v1/accounting/invoices/{id} | invoices::update_invoice | done | accounting_invoices_tests.rs | happy-path: update_invoice returns 200 + updated status |
| DELETE | /api/v1/accounting/invoices/{id} | invoices::delete_invoice | done | accounting_invoices_tests.rs | happy-path: delete_invoice returns 204 |
| GET | /api/v1/accounting/invoices/{id}/items | invoices::list_invoice_items | done | accounting_invoices_tests.rs | happy-path: list_invoice_items returns 200 + list |
| GET | /api/v1/accounting/contacts/ | contacts::list_contacts | done | accounting_invoices_tests.rs, accounting_contacts_authz_tests.rs | happy-path: manager_can_list_contacts (200) |

...
| `GET /signature-requests` (doc-scoped) | `signatures.rs:list_signature_requests_for_doc` | stub | — | `document_signature_router` unmounted |
| `POST /signature-requests` (doc-scoped) | `signatures.rs:create_signature_request_for_doc` | stub | — | `document_signature_router` unmounted |

## Tally
done: 19  partial: 42  stub: 2  missing: 0  total: 63

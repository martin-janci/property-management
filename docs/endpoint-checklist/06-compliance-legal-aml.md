...
| `GET /api/v1/data-residency/config` | `data_residency.rs:get_residency_config` | stub | — | hardcoded, ignores state |
| `POST /api/v1/data-residency/config` | `data_residency.rs:configure_residency` | stub | — | fabricated response |
| `PUT /api/v1/data-residency/config` | `data_residency.rs:update_residency_config` | stub | — | fabricated response |
| `GET /api/v1/data-residency/regions` | `data_residency.rs:list_available_regions` | stub | — | static enum list |
| `GET /api/v1/data-residency/routing/status` | `data_residency.rs:get_routing_status` | stub | — | hardcoded response |
| `POST /api/v1/data-residency/routing/log-access` | `data_residency.rs:log_cross_region_access` | stub | — | fabricated response |
| `GET /api/v1/data-residency/routing/access-logs` | `data_residency.rs:list_access_logs` | stub | — | hardcoded response |
| `POST /api/v1/data-residency/compliance/verify` | `data_residency.rs:run_compliance_verification` | stub | — | fabricated response |
| `GET /api/v1/data-residency/compliance/verification/{id}` | `data_residency.rs:get_verification_result` | stub | — | hardcoded response |
| `GET /api/v1/data-residency/compliance/export` | `data_residency.rs:export_compliance_report` | stub | — | fabricated response |
| `GET /api/v1/data-residency/audit` | `data_residency.rs:list_audit_logs` | stub | — | hardcoded response |
| `GET /api/v1/data-residency/audit/{id}` | `data_residency.rs:get_audit_entry` | stub | — | hardcoded response |
| `POST /api/v1/data-residency/audit/verify-chain` | `data_residency.rs:verify_audit_chain` | stub | — | fabricated response |
| `GET /api/v1/data-residency/dashboard` | `data_residency.rs:get_residency_dashboard` | stub | — | hardcoded response |
...
## Tally
done: 12  partial: 98  stub: 33  missing: 0  total: 143
